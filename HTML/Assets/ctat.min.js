...
g=f.length,h=a[c],m=0;m<g;m++){var n=f[m],y;y=f[m];for(var C=0,A=0;A<e.length;A++)if(y.rules[A]&&e[A]){if(e[A].s>=y.rules[A].s&&e[A].e<=y.rules[A].e)C=0,C+=Math.abs(e[A].s-y.rules[A].s),C+=Math.abs(y.rules[A].e-e[A].e);else{C="N/A";break}if(864E6<C){C="N/A";break}}y=C=b(e,c,C,y);"N/A"!==y&&(d[n.name]=y)}for(var r in d)if(d.hasOwnProperty(r))for(f=0;f<h.length;f++)if(h[f]===r)return r;return c},h=function(b){var a=function(){for(var b=[],a=0;a<jstz.olson.dst_rules.years.length;a++){var e;e=jstz.olson.dst_rules.years[a];
...
b[c]&&(b[c]=e[c])}return b}function e(b,a){return"string"==typeof b?b:b[a%b.length]}function h(a){this.opts=b(a||{},h.defaults,q)}function l(){function b(b,e){return a("<"+b+' xmlns="urn:schemas-microsoft.com:vml" class="spin-vml">',e)}v.addRule(".spin-vml","behavior:url(#default#VML)");h.prototype.lines=function(a,d){function f(){return c(b("group",{coordsize:l+" "+l,coordorigin:-m+" "+-m}),{width:l,height:l})}function h(a,h,l){g(n,g(c(f(),{rotation:360/d.lines*a+"deg",left:~~h}),g(c(b("roundrect",
{arcsize:d.corners}),{width:m,height:d.scale*d.width,left:d.scale*d.radius,top:-d.scale*d.width>>1,filter:l}),b("fill",{color:e(d.color,a),opacity:d.opacity}),b("stroke",{opacity:0}))))}var m=d.scale*(d.length+d.width),l=2*d.scale*m,w=-(d.width+d.length)*d.scale*2+"px",n=c(f(),{position:"absolute",top:w,left:w});if(d.shadow)for(w=1;w<=d.lines;w++)h(w,-2,"progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");for(w=1;w<=d.lines;w++)h(w);return g(a,n)};h.prototype.opacity=
function(b,a,e,c){b=b.firstChild;c=c.shadow&&c.lines||0;b&&a+c<b.childNodes.length&&(b=(b=(b=b.childNodes[a+c])&&b.firstChild)&&b.firstChild)&&(b.opacity=e)}}var m=["webkit","Moz","ms","O"],n={},p,v,q={lines:12,length:7,width:5,radius:10,scale:1,corners:1,color:"#000",opacity:.25,rotate:0,direction:1,speed:1,trail:100,fps:20,zIndex:2E9,className:"spinner",top:"50%",left:"50%",shadow:!1,hwaccel:!1,position:"absolute"};h.defaults={};b(h.prototype,{spin:function(b){this.stop();var e=this,d=e.opts,f=
e.el=a(null,{className:d.className});c(f,{position:d.position,width:0,zIndex:d.zIndex,left:d.left,top:d.top});b&&b.insertBefore(f,b.firstChild||null);f.setAttribute("role","progressbar");e.lines(f,e.opts);if(!p){var g=0,h=(d.lines-1)*(1-d.direction)/2,m,l=d.fps,w=l/d.speed,n=(1-d.opacity)/(w*d.trail/100),u=w/d.lines;(function G(){g++;for(var b=0;b<d.lines;b++)m=Math.max(1-(g+(d.lines-b)*u)%w*n,d.opacity),e.opacity(f,b*d.direction+h,m,d);e.timeout=e.el&&setTimeout(G,~~(1E3/l))})()}return e},stop:function(){var b=
this.el;b&&(clearTimeout(this.timeout),b.parentNode&&b.parentNode.removeChild(b),this.el=void 0);return this},lines:function(b,d){function h(b,e){return c(a(),{position:"absolute",width:d.scale*(d.length+d.width)+"px",height:d.scale*d.width+"px",background:b,boxShadow:e,transformOrigin:"left",transform:"rotate("+~~(360/d.lines*m+d.rotate)+"deg) translate("+d.scale*d.radius+"px,0)",borderRadius:(d.corners*d.scale*d.width>>1)+"px"})}for(var m=0,l=(d.lines-1)*(1-d.direction)/2,w;m<d.lines;m++)w=c(a(),
{position:"absolute",top:1+~(d.scale*d.width/2)+"px",transform:d.hwaccel?"translate3d(0,0,0)":"",opacity:d.opacity,animation:p&&f(d.opacity,d.trail,l+m*d.direction,d.lines)+" "+1/d.speed+"s linear infinite"}),d.shadow&&g(w,c(h("#000","0 0 4px #000"),{top:"2px"})),g(b,g(w,h(e(d.color,m),"0 0 1px rgba(0,0,0,.1)")));return b},opacity:function(b,a,e){a<b.childNodes.length&&(b.childNodes[a].style.opacity=e)}});if("undefined"!==typeof document){v=function(){var b=a("style",{type:"text/css"});g(document.getElementsByTagName("head")[0],
...
CTATDefaultLanguagePack[g]),CTATDefaultLanguagePack[g]):g}};CTATLanguageManager.prototype=Object.create(CTATBase.prototype);CTATLanguageManager.prototype.constructor=CTATLanguageManager;CTATLanguageManager.theSingleton=new CTATLanguageManager;var scrimIsUp=!1,errorScrim=!1,waitScrim=!0,warnScrim=!1,connectionScrim=!1,authorTimeSet=!0,inAuthorTime=!0,CTATScrim=function(){function a(){warnScrim=!1;w.scrimDown()}function g(b){"google"!=CTATConfig.platform&&(!0===scrimIsUp&&w.scrimDownForced(),w.ctatdebug("errScrimUp ("+b+")"),!0===errorScrim?!0===e&&(e=!1,getSafeElementById(ctatcontainer).removeChild(q)):!0===warnScrim&&(e=!0),w.scrimUp(b))}function f(b,a){w.ctatdebug("makeHTMLButton ()");var e=document.createElement("input");e.type="button";
e.value=a;b?(w.ctatdebug("clickHandle!=null"),e.onclick=b):(w.ctatdebug("clickHandle==null"),e.onclick=w.defaultClickHandler);e.id=a;e.setAttribute("class","scrimButton");return e}CTATBase.call(this,"CTATScrim","__undefined__");var d="",c=!1,b=!1,e=!1,h=null,l=null,m=new CTATCanvasComponent("CTAT Scrim"),n=[],p=null,v=null,q=null,u=null,w=this;this.scrimUp=function(g){if("google"!=CTATConfig.platform)if(w.ctatdebug("scrimUp ()"),g=CTATGlobals.languageManager.filterString(g),w.ctatdebug("Message: "+
g),!0===scrimIsUp?(d=!0===waitScrim?g:d+(" \n "+g),m.removeComponent(),w.removeHTMLElements()):(d=g,scrimIsUp=!0),w.ctatdebug("scrimUp() to call drawScrim() scrimIsUp "+scrimIsUp),w.ctatdebug("drawScrim ()"),"google"==CTATConfig.platform)w.ctatdebug("This is not available for now when we're in this environment");else if($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"),$("#scrim").css("z-index",1E3),"google"!=CTATConfig.platform&&($("#scrimpanel").empty(),$("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>'+
d+"<br><br></div></div></div>"),!0===e&&(waitScrim=!1,q=f(a,"close"),$(q).appendTo("#scrimpanel")),!0===c&&(waitScrim=!1,p=f(h,"yes"),$(p).appendTo("#scrimpanel"),c=!1),!0===b&&(waitScrim=!1,v=f(l,"no"),$(v).appendTo("#scrimpanel"),b=!1),!0===waitScrim)){w.ctatdebug("Adding spinner ...");$("#scrimpanel").append("<br>");g=$('<div id="scrim_spin">');g.css("width","100%");g.css("position","relative");$("#scrimpanel").append(g);try{var n=(new Spinner({className:"scrim_spinner"})).spin();$("#scrim_spin").append(n.el)}catch(C){(C instanceof
ReferenceError||C instanceof TypeError)&&w.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.',C,typeof C)}}};this.waitScrimUp=function(){w.ctatdebug("waitScrimUp () CTATConfig.platform "+CTATConfig.platform+", scrimIsUp "+scrimIsUp);"google"!=CTATConfig.platform&&(!0===scrimIsUp&&w.scrimDownForced(),waitScrim=!0,w.scrimUp(CTATGlobals.languageManager.getString("LOADING")),w.ctatdebug("return from waitScrimUp(): scrimIsUp "+
...
g[0]+", to: "+decodeURIComponent(g[1].replace(/\+/g," ")));h[decodeURIComponent(g[0])]="";for(var u=1;u<g.length;u++)h[decodeURIComponent(g[0])]+=(1<u?"=":"")+decodeURIComponent(g[u].replace(/\+/g," "));ctatdebug("Decoded args: "+h[decodeURIComponent(g[0])])}null!==h&&(ctatdebug("tutorPrep(): Assigning parsed arguments ..."),q=h);h=!1;for(var w in q)if(q.hasOwnProperty(w))switch(ctatdebug("Processing external FlashVar "+w+"("+q[w]+")"),w){case "GENERATED":"on"==q[w]&&(e.session_id=CTATGuid.guid(),
h=!0);break;case "BRD":e.question_file=q[w];break;case "BRMODE":e.BehaviorRecorderMode=q[w];break;case "PROBLEM":e.problem_name=q[w];break;case "DATASET":e.dataset_name=q[w];break;case "LEVEL1":e.dataset_level_name1=q[w];break;case "TYPE1":e.dataset_level_type1=q[w];break;case "LEVEL2":e.dataset_level_name2=q[w];break;case "TYPE2":e.dataset_level_type2=q[w];break;case "LEVEL3":e.dataset_level_name3=q[w];break;case "TYPE3":e.dataset_level_type3=q[w];break;case "LEVEL4":e.dataset_level_name4=q[w];break;
case "TYPE4":e.dataset_level_type4=q[w];break;case "USER":e.user_guid=q[w];break;case "SESSION":!1===h&&(e.session_id=q[w]);break;case "SOURCE":e.source_id=q[w];break;case "LOGTYPE":e.Logging=q[w];break;case "PORT":e.remoteSocketPort=q[w];break;case "REMOTEURL":e.remoteSocketURL=q[w];break;case "DISKDIR":e.log_to_disk_directory=q[w];break;case "log_service_url":e.log_service_url=q[w];break;case "URL":e.log_service_url=q[w];break;case "LOGURL":e.log_service_url=q[w];break;case "CONNECTION":e.tutoring_service_communication=
q[w];break;case "SUI":e.sui=q[w];break;case "VAR1":e.var1=q[w];break;case "VAL1":e.val1=q[w];break;case "VAR2":e.var2=q[w];break;case "VAL2":e.val2=q[w];break;case "VAR3":e.var3=q[w];break;case "VAL3":e.val3=q[w];break;case "VAR4":e.var4=q[w];break;case "VAL4":e.val4=q[w];break;case "SLOG":case "SessionLog":e.SessionLog=q[w];break;case "KEYBOARDGROUP":"Disabled"==q[w]&&(e.keyboard="disabled");"Auto"==q[w]&&(e.keyboard="auto");"On"==q[w]&&(e.keyboard="on");break;default:e[w]=q[w]}}return e};this.getCustomFields=
...
l=l+(d+"</event_descriptor>")+this.createCustomFields(g,f);l+="</tool_message>";a.ctatdebug("messageString = "+l);return l};this.createTutorMessage=function(d,c,b,e,h,l,m,n){a.ctatdebug("createTutorMessage()");var p=new Date;flashVars.getRawFlashVars();var v='<tutor_message context_message_id="'+this.getContextName()+'">';n||(v+=this.makeMetaElement(p));c='<semantic_event transaction_id="'+c+'" name="'+b+'"';""!==l&&(c+=' subtype="'+l+'"');v+=c+"/>";d="<event_descriptor>"+d.toXMLString(!0);v+=d+"</event_descriptor>";
d="<action_evaluation ";e.hasClassification()&&null!=e.getAttributeString()&&(d+=e.getAttributeString());d+=">"+e.getEvaluation()+"</action_evaluation>";v+=d;""!=h&&(v+="<tutor_advice>"+h+"</tutor_advice>");null!=m&&(a.ctatdebug("Adding skills to log message ..."),v+=m.toLogString());v+=this.createCustomFields(g,f);v+="</tutor_message>";a.ctatdebug("messageString = "+v);return v};this.createGenericMessage=function(d,c){a.ctatdebug("createGenericMessage()");flashVars.getRawFlashVars();var b='<message context_message_id="'+
...
f=!0));!0===f&&(CTATLogMessageBuilder.commLogMessageBuilder||(CTATLogMessageBuilder.commLogMessageBuilder=new CTATLogMessageBuilder),this.sendMessage(CTATLogMessageBuilder.commLogMessageBuilder.createLogSessionStart()))};this.logSemanticEvent=function(b,a,e,c,d,f,h){g.ctatdebug("logSemanticEvent ("+h+")");g.initCheck();C=a;var m=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(d,f);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tool_event_time",
CTATLogMessageBuilder.commLogMessageBuilder.formatTimeStamp(m)+" UTC");b=CTATLogMessageBuilder.commLogMessageBuilder.createSemanticEventToolMessage(a,b,e,c,!0,h);this.sendMessage(b)};this.logTutorResponse=function(b,a,e,c,d,f,h,m,l){g.ctatdebug("logTutorResponse ()");g.initCheck();C=a;var w=new Date;CTATLogMessageBuilder.commLogMessageBuilder.resetCustomFields();CTATLogMessageBuilder.commLogMessageBuilder.addCustomFields(m,l);CTATLogMessageBuilder.commLogMessageBuilder.addCustomField("tutor_event_time",
...
function(){this.generateSession()};this.then=function(b,a){return A&&"function"==typeof A.then?A.then(b,a):{then:function(){console.log("CTATLoggingLibrary.then() not supported")}}}};CTATLoggingLibrary.prototype=Object.create(CTATBase.prototype);CTATLoggingLibrary.prototype.constructor=CTATLoggingLibrary;var CTATArgument=function(){var a="",g="Undefined",f="String",d="text";this.setValue=function(a){g=a};this.getValue=function(){return g};this.setName=function(c){a=c};this.getName=function(){return a};this.setType=function(a){f=a};this.getType=function(){return f};this.setFormat=function(a){d=a};this.getFormat=function(){return d}};CTATArgument.prototype.clone=function(){var a=new CTATArgument;a.setValue(this.getValue());a.setType(this.getType());a.setFormat(this.getFormat());return a};
...
var v=!1;if(Array.isArray(a)&&Array.isArray(g)&&(Array.isArray(f)||null==f)&&(p.setSelectionArray(a),p.setActionArray(g),p.setInputArray(f),v=!0,0<a.length&&0<g.length)){p.setSAI(a[0],g[0],null==f?null:f[0],"String",d);return}null!==a&&""!==a&&p.setSelection(a);null!==a&&(p.setSAI(a,g,f,"String",d),v||(p.setSelectionArray(Array.isArray(a)?a:[a]),p.setActionArray(Array.isArray(g)?g:[g]),p.setInputArray(Array.isArray(f)?f:[f]),v=!0))};CTATSAI.prototype=Object.create(CTATBase.prototype);
...
var d=a,c=null,b=null;void 0==a&&(d=null);b="xml"==CTATConfig.parserType?new CTATXML:new CTATJSON;d&&(this.ctatdebug("messageParser "+b+", messageObj "+d),d.children&&this.ctatdebug(d.children));var e="ungraded",h=!1,l=!1,m=new CTATSkillSet,n="",p="",v="",q="",u="",w=!0,B,y=null,C=null,A=null,r=!1;this.setURL=function(b){B=b};this.getURL=function(){return B};this.assignSAI=function(b){l=!0;y=b};this.setTransactionID=function(b){p=b};this.getTransactionID=function(){return p};this.setGradeResult=function(b){e=
b};this.getGradeResult=function(){return e};this.getXMLObject=function(){return d};this.getSkillsObject=function(){return m};this.getCustomFields=function(){return C};this.getRules=function(){return A};this.getSuccessMessage=function(){return v};this.getBuggyMsg=function(){return q};this.getHighlightMsg=function(){return u};this.parse=function(){this.ctatdebug("parse ()");if(null!==d){this.ctatdebug("messageParser: "+b);this.ctatdebug("Root name: "+b.getElementName(d));"tool_message"==b.getElementName(d)?
...
p)}};this.parseSAI=function(){this.ctatdebug("parseSAI ()");var a="",c="",e="",w="",p=[],r=[],G=[];if("tool_message"==n){this.ctatdebug("Parsing s, a and i");a=b.getElementChildren(d);for(c=0;c<a.length;c++)if(e=a[c],"tool_message"==b.getElementName(e))for(e=b.getElementChildren(e),w=0;w<e.length;w++)p=e[w],"event_descriptor"==b.getElementName(p)&&(y=new CTATSAI,y.fromXMLInternal(p));l=!0}else{if(h){this.ctatdebug("isLogMessage ...");for(var I=b.getElementChildren(d),R=0;R<I.length;R++){var O=I[R];
if("event_descriptor"==b.getElementName(O))for(var O=b.getElementChildren(O),L=0;L<O.length;L++){var E=O[L];"selection"==b.getElementName(E)&&(a=b.getNodeTextValue(E),p.push(E));"action"==b.getElementName(E)&&(c=b.getNodeTextValue(E),r.push(E));"input"==b.getElementName(E)&&(e=b.getNodeTextValue(E),G.push(E));"prompt"==b.getElementName(E)&&(w=b.getNodeTextValue(E))}}}else for(this.ctatdebug("!isLogMessage ..."),I=b.getElementChildren(d),R=0;R<I.length;R++)if(O=I[R],"properties"==b.getElementName(O))for(O=
b.getElementChildren(O),L=0;L<O.length;L++){var E=O[L],M=b.getElementName(E);this.ctatdebug("Nodename: "+M);switch(M){case "URL":B=b.getNodeTextValue(E);break;case "Skills":m.parseByValue(E);break;case "SuccessMsg":v=a=b.getNodeTextValue(E);break;case "BuggyMsg":q=b.getNodeTextValue(E);break;case "Selection":a=b.getNodeTextValue(E);p.push(E);break;case "Action":c=b.getNodeTextValue(E);r.push(E);break;case "Input":e=b.getNodeTextValue(E);G.push(E);break;case "prompt":w=b.getNodeTextValue(E);break;
case "HighlightMsgText":u=b.getNodeTextValue(E);break;case "custom_fields":C=f(E);break;case "Rules":A=g(E)}}this.ctatdebug("SAI: "+a+","+c+","+e);""!==a&&null!==a?(y=new CTATSAI(a,c,e,w),y.setArrayFromElements(p),y.setArrayFromElements(r),y.setArrayFromElements(G),l=!0):(this.ctatdebug("No SAI found"),l=!1);this.ctatdebug("parseSAI () done, hassai: "+l+", ("+a+","+c+","+e+","+w+")")}};this.parseTransactionID=function(){this.ctatdebug("parseTransactionID()");if("tool_message"!=n){if(!h)for(var a=
...
m=!m||/tutor/i.test(m)?"tutor":m;f.updateLastActionTimestamp&&f.updateLastActionTimestamp();var l=b.getElementChildren(g);d.ctatdebug("Generated CTATMessage, now doing regular processing ...");for(var v=0;v<l.length;v++){var q=l[v];if("properties"==b.getElementName(q)){d.ctatdebug("Parsing properties ...");for(var u=b.getElementChildren(q),w=0;w<u.length;w++){var B=u[w];if("MessageType"==b.getElementName(B)){B=b.getNodeTextValue(B);d.ctatdebug("MessageType: "+B);switch(B){case "StateGraph":ctatdebug("Setting inStartState to true");
...
h);break;case "AssociatedRules":d.ctatdebug("Found: AssociatedRules ("+u.length+")");for(var y=B="",C="",A=0;A<u.length;A++){var r=u[A];switch(b.getElementName(r)){case "TutorAdvice":B=b.getNodeTextValue(r);break;case "Actor":m=b.getNodeTextValue(r);break;case "Indicator":y=b.getNodeTextValue(r);break;case "StepID":b.getNodeTextValue(r);break;case "LogAsResult":b.getNodeTextValue(r);break;case "tool_selection":case "StudentSelection":C=b.getNodeTextValue(r);break;case "Skills":d.ctatdebug("Processing skills ..."),
null===CTATSkillSet.skills&&(d.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."),CTATSkillSet.skills=new CTATSkillSet),CTATSkillSet.skills.parseByValue(r)}}f.processAssociatedRules(h,y,B,C);a.propagateShellEvent("AssociatedRules",h);break;case "BuggyMessage":d.ctatdebug("Found: BuggyMessage");f.processBuggyMessage(h);a.propagateShellEvent("BuggyMessage",h);break;case "SuccessMessage":d.ctatdebug("Found: SuccessMessage");f.processSuccessMessage(h);a.propagateShellEvent("SuccessMessage",
...
h);break;case "AuthorModeChange":d.ctatdebug("Found: AuthorModeChange");f.globalReset();a.propagateShellEvent("AuthorModeChange",h);break;case "ResetAction":d.ctatdebug("Found: ResetAction");f.globalReset();a.propagateShellEvent("ResetAction",h);break;case "ShowHintsMessage":d.ctatdebug("Found: ShowHintsMessage");B=!1;y=[];for(C=0;C<u.length;C++)if(A=u[C],"HintsMessage"==b.getElementName(A))for(A=b.getElementChildren(A),r=0;r<A.length;r++){var D=A[r];"value"==b.getElementName(D)&&(y.push(b.getNodeTextValue(D)),
...
case "ProblemSummaryResponse":d.ctatdebug("Found: ProblemSummaryResponse");f.processProblemSummaryResponse(h);a.propagateShellEvent("ProblemSummaryResponse",h);break;case "StartStateEnd":d.ctatdebug("Found: StartStateEnd");CTATShellTools.listComponents();null!==f?f.processStartState():this.ctatdebug("Error: no message handler object available to process start state");try{d.processStartStateActions()}catch(F){d.ctatdebug("Caught in the act: "+F.message)}CTATMessageHandler.inStartState=!1;a.propagateShellEvent("StartStateEnd",
...
a.length+")");for(var e="Unknown",c="Unknown",f=null,g=0;g<a.length;g++){var h=a[g];d.ctatdebug("Inspecting element: "+b.getElementName(h));"WidgetType"==b.getElementName(h)&&(d.ctatdebug("Widget type: "+b.getNodeTextValue(h)),e=b.getNodeTextValue(h));"CommName"==b.getElementName(h)&&(d.ctatdebug("Instance name: "+b.getNodeTextValue(h)),c=b.getNodeTextValue(h));if("serialized"==b.getElementName(h)){d.ctatdebug("Prepareing to de-serialize component ...");for(var l=b.getElementChildren(h),w=0;w<l.length;w++){var B=
l[w];-1!=b.getElementName(B).indexOf("CTAT")&&(f=B)}}"interface"==b.getElementName(h)&&(d.ctatdebug("Storing interface for post start-state reconstruction ..."),CTATGlobals.interfaceElement=h);"script"==b.getElementName(h)&&(d.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."),scriptElement=b.getNodeTextValue(h))}null!==f?this.deserializeComponent(e,c,f):d.ctatdebug("Error: unable to find CTAT serialization point of attachement");d.ctatdebug("processInterfaceDescription () done")};
...
"zIndex");null===l&&(l=-1);null===n&&(n=0);var y=new CTATComponentDescription;y.type=a;y.name=e;y.x=Math.floor(f);y.y=Math.floor(g);y.tabIndex=l;y.zIndex=n;y.width=Math.floor(h);y.height=Math.floor(m);CTATShellTools.registerComponentDescription(y);c=b.getElementChildren(c);for(f=0;f<c.length;f++){g=c[f];b.getElementName(g);if("Parameters"==b.getElementName(g))for(this.ctatdebug("Processing component parameters ..."),h=b.getElementChildren(g)[0],h=b.getElementChildren(h),m=0;m<h.length;m++){var C=
h[m];if("CTATComponentParameter"==b.getElementName(C)){this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");for(var n=l=void 0,C=b.getElementChildren(C),A=0;A<C.length;A++){var r=C[A];"name"==b.getElementName(r)&&(this.ctatdebug("Found parameter name: "+b.getNodeTextValue(r)),l=b.getNodeTextValue(r));"value"==b.getElementName(r)&&(this.ctatdebug("Found parameter value: "+b.getNodeTextValue(r)),n=b.getNodeTextValue(r).trim())}this.ctatdebug("Parameter name: "+l+", value: "+
n);void 0!==l&&(y.params[l]=n,"group"==l&&(y.groupName=n))}}if("Styles"==b.getElementName(g))for(this.ctatdebug("Processing component styles ..."),g=b.getElementChildren(g)[0],g=b.getElementChildren(g),h=0;h<g.length;h++)if(n=g[h],"CTATStyleProperty"==b.getElementName(n)){this.ctatdebug("Processing style property (CTATStyleProperty) ...");l=m="";n=b.getElementChildren(n);for(C=0;C<n.length;C++)A=n[C],"name"==b.getElementName(A)&&(m=b.getNodeTextValue(A)),"value"==b.getElementName(A)&&(l=b.getNodeTextValue(A).trim());
...
this.sleep=function(b){d.ctatdebug("sleep ("+b+")")}};CTATMessageHandler.prototype=Object.create(CTATBase.prototype);CTATMessageHandler.prototype.constructor=CTATMessageHandler;CTATMessageHandler.startStateHandlers=[];CTATMessageHandler.inStartState=!1;CTATMessageHandler.scriptElement="";var CTATSessionExpiry=function(a,g,f,d){function c(){var b=v&&v.getHTTPObject?v.getHTTPObject():null;h.ctatdebug("CTATSessionExpiry.processInactivityReply() refreshConnection "+v+", getHTTPObject "+b);v&&b&&h.ctatdebug("CTATSessionExpiry.processInactivityReply() readyState "+b.readyState+", status "+b.status+", responseText "+(4==b.readyState?b.responseText:null))}function b(){try{if(50>m)throw"No-op: time interval "+m+" too short: less than 50 ms";q=setInterval(function(){v.send.apply(v,[])},m);
return"ok"}catch(w){return w.toString()}}function e(){try{if(50>n)throw"No-op: time interval "+n+" too short: less than 50 ms";u=setInterval(function(){h.checkInactivity.apply(h,[])},n);return"ok"}catch(w){return w.toString()}}CTATBase.call(this,"CTATSessionExpiry",g);var h=this,l=1E3*g,m=1E3*(g-60),n=6E4,p=Date.now(),v=null,q=0,u=0;this.checkInactivity=function(){var b=Date.now(),a=p;h.ctatdebug("CTATSessionExpiry.checkInactivity() elapsed "+(b-a)+", limit "+l+",\n                 now "+Date(b)+
",\n lastActionTimestamp "+h.getLastActionTimestamp());if(!(b<a+l))try{h.cancelTimers();var e=new CTATConnection(CTATConfiguration.getRawFlashVars());e.setMethod("GET");e.setURL(f);e.assignReceiveFunction(c);e.send();return"ok"}catch(C){return C.toString()}};this.updateLastActionTimestamp=function(){p=Date.now()};this.getLastActionTimestamp=function(){return new Date(p)};this.toString=function(){return"CTATSessionExpiry sessionTimeoutMS "+l+", refreshIntervalMS "+m+", refreshTimer "+q+", inactivityTimer "+
...
function(){0!==u&&clearInterval(u);u=0};this.cancelTimers=function(){h.cancelRefreshTimer();h.cancelInactivityTimer()};this.getRefreshTimer=function(){return q};this.getInactivityTimer=function(){return u};v=new CTATConnection(a);v.setMethod("GET");v.setURL(d);v.assignReceiveFunction(function(){var b=v&&v.getHTTPObject?v.getHTTPObject():null;h.ctatdebug("CTATSessionExpiry.processRefreshReply() refreshConnection "+v+", getHTTPObject "+b);v&&b&&h.ctatdebug("CTATSessionExpiry.processRefreshReply() readyState "+
...
b.toString()+")");(b=b.data&&3<=b.data.length?new CTATSAI(b.data[0],b.data[1],b.data[2]):null)&&CTATCommShell.shell.processComponentAction(b,!1,!0,null,"ATTEMPT","Detector")};if(!l)a:{if("undefined"!=typeof TransactionMailerUsers&&"function"==typeof TransactionMailerUsers.create)try{l=l=TransactionMailerUsers.create("Assets",a,CTATConfiguration.get("process_detectors_url"),CTATConfiguration.get("authenticity_token"),CTATConfiguration.get("detectors"),CTATConfiguration.get("x_api_key_header"));break a}catch(v){console.trace("Error creating transaction mailer: "+
v);l=l=null;break a}l=void 0}this.isReady=function(){return null!=h.mailerProxy};this.toString=function(){return"transactions sent to ["+h.process_transactions_url+":]"};this.processCommShellEvent=function(a,q,u){console.trace("CTATTransactionListener.processCommShellEvent("+a+", "+q+", "+u+")");try{var w=null;switch(a){case "InterfaceAction":case "AssociatedRules":case "UntutoredAction":case "NextPressed":case "PreviousPressed":var v=q;q&&q.constructor!=CTATMessage&&(v=q.constructor!=Element?p.parse(v):
v,v=new CTATMessage(v));var y=v;h.ctatdebug("CTATTransactionListener.makeOrCompleteTransaction("+a+") pointer "+h+", problemInfo null, pointer.problemInfo "+(h?h.problemInfo:null));var C=v=null,A=!1;if(C=g(y)){var r,D;b:switch(a){case "UntutoredAction":D=!1;break b;case "InterfaceAction":D="tutor-performed"!=e(y,"subtype").toLowerCase();break b;default:D=!0}if(r=!(A=!D)){var z;D=C;var F=m[D];F?(delete m[D],--n,h.ctatdebug("CTATTransactionListener.removeIncompleteTransaction("+D+") count now "+n),
z=F):z=null;r=(v=z)&&(A=!0)}r||(v={meta:h.problemInfo.meta,context:h.problemInfo.context});switch(a){case "AssociatedRules":case "NextPressed":case "PreviousPressed":u=v;u.tutor_data&&console.log("Warning: CTATTransactionListener.addTutorInfo("+a+") tx has tutor_data with time "+u.tutor_data.tutor_event_time);u.tutor_data={};u.tutor_data.tutor_event_time=f(new Date);u.tutor_data.selection=e(y,"Selection");u.tutor_data.action=e(y,"Action");u.tutor_data.input=e(y,"Input");u.tutor_data.action_evaluation=
y.getIndicator();0<=u.tutor_data.action_evaluation.toLowerCase().indexOf("hint")&&(u.tutor_data.current_hint_number=e(y,"CurrentHintNumber"),u.tutor_data.total_hints_available=e(y,"TotalHintsAvailable"));u.tutor_data.tutor_advice=e(y,"TutorAdvice");var H=u.tutor_data;r=[];var J=CTAT.ToolTutor.tutor&&CTAT.ToolTutor.tutor.getProblemSummary()?CTAT.ToolTutor.tutor.getProblemSummary().getSkills():null,x=y.getSkillsObject().getSkillSet();for(z=0;z<x.length;++z){var G=x[z],I=CTATSkillSet.skills?CTATSkillSet.skills.getSkill(G.getSkillName()):
null;if(I){F={};F.name=I.getSkillName();F.category=I.getCategory();var R=null==F.category||""==F.category.trim()?F.name:F.name+" "+F.category,O=J?J.getSkill(R):null,L;O?(F.pKnown=isNaN(L=O.getPKnown())?"":L,F.pGuess=isNaN(L=O.getPGuess())?"":L,F.pSlip=isNaN(L=O.getPSlip())?"":L,F.pLearn=isNaN(L=O.getPLearn())?"":L,F.history=isNaN(L=O.getHistory())?"":L,F.opportunityCount=isNaN(L=O.getOpportunityCount())?"":L):(F.pKnown=isNaN(L=I.getPKnown())?"":L,F.pGuess=isNaN(L=I.getPGuess())?"":L,F.pSlip=isNaN(L=
I.getPSlip())?"":L,F.pLearn=isNaN(L=I.getPLearn())?"":L);h.ctatdebug("CTATTransactionListener.createSkills() ssSk "+I+", tracerSk "+O+", skElt "+F);r.push(F)}}H.skills=r;u.tutor_data.step_id=e(y,"StepID");u.tutor_data.rule_names=b(y,"Rules");var E=u.tutor_data,M=y.getCustomFields();h.ctatdebug("CTATTransactionListener.createCustomFields() result "+M);E.custom_fields=M;break;default:v.meta.date_time=f(new Date);H=v;if(!(H.transaction_id=g(y)))throw Error("Message has no transaction_id: eventType "+
a+", msg\n  "+y);H.semantic_event="UntutoredAction"==a?"UNTUTORED-ACTION":c(a,y)?"HINT-REQUEST-HINTS":"ATTEMPT-RESULT";H.actor=u?u:"student";H.tool_data&&console.log("Warning: CTATTransactionListener.addToolInfo("+a+") tx has tool_data with time "+H.tool_data.tool_event_time);H.tool_data={};H.tool_data.tool_event_time=f(new Date);H.tool_data.selection=e(y,"Selection");H.tool_data.action=e(y,"Action");H.tool_data.input=e(y,"Input")}var V;if(A)V=v;else{var H=C,J=v,P=m[H];P&&(console.log("Warning: CTATTransactionListener.storeIncompleteTransaction() found tx with ID "+
H,P),--n);m[H]=J;++n;h.ctatdebug("CTATTransactionListener.storeIncompleteTransaction("+H+") count now "+n);V=null}w=V}else w=null;break;case "StartProblem":h.ctatdebug("CTATTransactionListener.createContextMessage()");V={};var S=new Date;h.ctatdebug("TX.makeMetaElement ()");P={};P.date_time=f(S);P.session_id=CTATConfiguration.get("session_id");P.user_guid=CTATConfiguration.get("user_guid");V.meta=P;V.context={};A=V.context;P=null;CTATLogMessageBuilder&&CTATLogMessageBuilder.commLogMessageBuilder&&
(P=CTATLogMessageBuilder.commLogMessageBuilder.getContextName());P||(P=CTATLogMessageBuilder.contextGUID);if(!P)throw Error("Context message ID not yet defined");A.context_message_id=P;var Q=V.context,U;U=CTATConfiguration.get("class_name");Q.class_name=U?U:"";U=CTATConfiguration.get("school_name");Q.class_school=U?U:"";U=CTATConfiguration.get("period_name");Q.class_period_name=U?U:"";U=CTATConfiguration.get("class_description");Q.class_description=U?U:"";U=CTATConfiguration.get("instructor_name");
Q.class_instructor_name=U?U:"";var T=V.context,W=CTATConfiguration.get("dataset_name");T.dataset_name=W?W:"";d(T,"dataset_level");prop=CTATConfiguration.get("problem_name");T.problem_name=prop?prop:"";prop=CTATConfiguration.get("problem_context");T.problem_context=prop?prop:"";prop=CTATConfiguration.get("problem_tutorflag");T.problem_tutorFlag=prop?prop:"";d(T,"study_condition");v=V.context;P=0;if(y=CTATConfiguration.getCustomFields())for(C in v.custom_fields={},y)y.hasOwnProperty(C)&&(v.custom_fields[C]=
y[C],++P);h.ctatdebug("CTATTransactionListener.createCustomFields() nAdded "+P+", cfs "+y);h.problemInfo=V;break;case "ProblemRestoreEnd":h.initializing=!1}w&&!h.initializing&&l.sendTransaction(w)}catch(Z){console.log("Error in CTATTransactionListener.processCommShellEvent("+a+"): "+Z,Z.stack)}};ctatdebug("**<end of CTATTransactionListener constructor, process_transactions_url "+a+", mailerProxy "+l)};
...
function(e){b.ctatdebug("processClientBRDLoad()");var c=a.getURL();a.sendXML("<message><verb>NotePropertySet</verb><properties><MessageType>GetURLResponse</MessageType><URL><![CDATA[ "+c+" ]]\x3e</URL><content><![CDATA[ "+window.btoa(e)+" ]]\x3e</content></properties></message>")};this.processCorrectAction=function(a){b.ctatdebug("processCorrectAction()");a.setGradeResult("correct");b.clearFeedbackComponents();null!=v&&(ctatdebug("Calling custom grading processor ..."),v("CORRECT",a));var e=a.getSelection();
...
null!=v&&(ctatdebug("Calling custom grading processor ..."),v("INCORRECT",a));var e=a.getSelection();if(l[e]&&null!=m)m("INCORRECT",a);else{var c=CTATShellTools.findComponent(e);if(null!==c)for(e=0;e<c.length;e++)ctatdebug("Calling setIncorrect on component ("+c[e].getClassName()+")..."),c[e].setIncorrect&&c[e].setIncorrect(a);else b.ctatdebug("Error: component is null for selection "+e)}};this.processHighlightMsg=function(a){b.ctatdebug("processHighlightMsg()");var e=a.getSelection(),c=CTATShellTools.findComponent(e);
...
e.getIndicator()?m.setEvaluation("CORRECT"):m.setEvaluation("INCORRECT"),h="RESULT");ctatdebug("Adding custom field names ...");var l=[],n=[];l.push("step_id");n.push(e.getProperty("StepID"));var p=e.getRules();p&&(l.push("rule_names"),n.push(p.toString()));var p=e.getCustomFields(),w;for(w in p)l.push(w),n.push(p[w]);w=e.getSkillsObject();b.updateSkillWindow(w);ctatdebug("Sending log message ...");null!=commLoggingLibrary?u?commLoggingLibrary.logTutorResponse(e.getTransactionID(),logHintSAI,h,"",
m,f,w,l,n):e.suppressLogging():this.ctatdebug("Info: no logging library available!");"done"==logHintSAI.getSelection()&&"ButtonPressed"==logHintSAI.getAction()&&"Correct"==e.getIndicator()&&(h=d.createProblemSummaryRequestMessage(),a.sendXML(h,!1))}else b.updateSkillWindow(null);if((g=g&&CTATShellTools.findComponent(g))&&g.length)for(h=0;h<g.length;h++)ctatdebug("Calling processAssociatedRules on component ("+g[h].getClassName()+")..."),g[h].processAssociatedRules&&g[h].processAssociatedRules(e,c,
f);b.ctatdebug("processAssociatedRules() done")};this.processBuggyMessage=function(a){b.ctatdebug("processBuggyMessage()");this.showFeedback(a.getBuggyMsg())};this.processSuccessMessage=function(a){b.ctatdebug("processSuccessMessage()");this.showFeedback(a.getSuccessMessage())};this.processUntutoredAction=function(a,e){b.processInterfaceAction(a,e)};this.processInterfaceAction=function(a,e){b.ctatdebug('CTATCommShell.processInterfaceAction ("'+a.getMessageType()+'")');var c=a.getProperty("trigger"),
c=a.getProperty("subtype")||(c&&"data"==c.toLowerCase()?"tutor-performed":"");null!=commLoggingLibrary?u&&commLoggingLibrary.logSemanticEvent(a.getTransactionID(),a.getSAI(),"ATTEMPT",c):this.ctatdebug("Info: no logging library available!");if("root"==a.getSelection()||"_root"==a.getSelection()){b.ctatdebug("Info: selection is 'root', we'll call the function straight up ...");for(var c=[window,CTATCommShell.commShell],d=a.getAction(),f=a.getInput(),g=0;g<c.length&&"function"!=typeof c[g][d];++g);
if(g>=c.length)b.ctatdebug("Internal error: unable to find function: "+d);else{b.ctatdebug("Calling as: "+d+"("+f+")");try{c[g][d](f)}catch(z){b.ctatdebug("Internal error: unable to execute function: "+z.message)}}}else if(c=CTATShellTools.findComponent(a.getSelection()),null===c)b.ctatdebug("Internal error: unable to find pointer to component object");else if(0==c.length)b.ctatdebug("Error: no component found to call interface action on");else{d=c.length;b.ctatdebug("Call the action on the component(s) -> ("+
d+")...");for(f=0;f<d;f++)if(b.ctatdebug("About to call "+a.getAction()+" ("+a.getInput()+") on: "+a.getSelection()),g=c[f],"function"==typeof g.executeSAI&&g.executeSAI(a),b.ctatdebug("Method executed, continuing with post-processing ..."),1==commMessageHandler.getInStartState()){var h=a.getAction();h&&h.toLowerCase().startsWith("updatetext")&&!g.getDivWrap().className.includes("CTATTextField")&&g.setEnabled(!e)}b.ctatdebug("processInterfaceAction() Done")}};this.removeComponent=function(b){CTATTutor.removeComponent(b)};
this.processInterfaceIdentification=function(a){b.ctatdebug("processInterfaceIdentification()")};this.processAuthorModeChange=function(a){b.ctatdebug("processAuthorModeChange()")};this.processShowHintsMessage=function(a){b.ctatdebug("processShowHintsMessage()")};this.processConfirmDone=function(a){b.ctatdebug("processConfirmDone()")};this.processVersionInfo=function(a){b.ctatdebug("processVersionInfo()")};this.updateLastActionTimestamp=function(){g&&g.updateLastActionTimestamp()};this.processTutoringServiceAlert=
function(a){b.ctatdebug("processTutoringServiceAlert()");for(var e="",c=0;c<a.length;c++){var d=a[c];"ErrorType"==h.getElementName(d)&&h.getNodeTextValue(d);"Details"==h.getElementName(d)&&(e=h.getNodeTextValue(d))}CTATScrim.scrim.scrimUp(e)};this.processTutoringServiceError=function(a){b.ctatdebug("processTutoringServiceError()");var e=a.getProperty("ErrorType");a=a.getProperty("Details");CTATScrim.scrim.scrimDown();CTATScrim.scrim.errorScrimUp(e+" - "+a)};this.processProblemSummaryResponse=function(a,
c){b.ctatdebug("processProblemSummaryResponse() iscb "+c);if(commLoggingLibrary&&!c)commLoggingLibrary.then(b.processProblemSummaryResponse(a,!0));else if(CTATLMS.processProblemSummary&&CTATLMS.processProblemSummary(a.getXMLObject()),CTATLMS.closeLMSConnection&&CTATLMS.closeLMSConnection(),null!=p){var d=a.getXMLObject(),g=d.getElementsByTagName("ProblemSummary"),h=d.getElementsByTagName("cmi.core.lesson_status"),m=d.getElementsByTagName("cmi.core.score.raw"),l=d.getElementsByTagName("cmi.core.exit"),
d=d.getElementsByTagName("cmi.core.session_time"),g=$("<div>").html(g[0].innerHTML).text(),h="<cmi.core.lesson_status>"+$("<div>").html(h[0].innerHTML).text()+"</cmi.core.lesson_status>",m="<cmi.core.score.raw>"+$("<div>").html(m[0].innerHTML).text()+"</cmi.core.score.raw>",l="<cmi.core.exit>"+$("<div>").html(l[0].innerHTML).text()+"</cmi.core.exit>",d="<cmi.core.session_time>"+$("<div>").html(d[0].innerHTML).text()+"</cmi.core.session_time>";p(g,"<scorm>"+h+m+l+d+"</scorm>");p=null}else l=new CTATXML,
null!=e?e(l.xmlToString(a.getXMLObject())):f.sendSummary(a)};this.setGotProblemRestoreEnd=function(b){u=b};this.processProblemRestoreEnd=function(a){b.ctatdebug("processProblemRestoreEnd() scrimIsUp "+scrimIsUp);u=!0;CTATScrim.scrim.scrimDown()};this.clearFeedbackComponents=function(){b.ctatdebug("clearFeedbackComponents ()");CTATShellTools.showHints(null)};this.processHintResponse=function(a,e){b.ctatdebug("processHintResponse()");unhighlightall();CTATShellTools.showHints(e);var c=a.getSAI();if(null!=
c)if(c=c.getSelection(),null!=c)if(b.ctatdebug("Highlighting selection for hint: "+c),c=CTATShellTools.findComponent(c),null!=c)for(var d=0;d<c.length;d++)1==CTATCommShell.detailedFeedback&&"function"==typeof c[d].setHintHighlight&&c[d].setHintHighlight(!0,a);else b.ctatdebug("Unable to find component name in list: "+c);else b.ctatdebug("Error: no highlight selection present in SAI");else b.ctatdebug("Warning: no SAI found in highlight message");CTATCommShell.detailedFeedback=!0;b.ctatdebug("processHintResponse() done")};
this.showHighlightSelection=function(a,e){b.ctatdebug("showHighlightSelection ("+a+")");var c=CTATShellTools.findComponent(a);if(null!=c)for(var d=0;d<c.length;d++)1==CTATCommShell.detailedFeedback&&(0===d?c[d].moveHintHightlight&&c[d].moveHintHighlight(!0,e):c[d].setHintHighlight&&c[d].setHintHighlight(!0,e));else b.ctatdebug("Unable to find component name in list: "+c)};this.globalReset=function(){b.ctatdebug("globalReset ()");CTATMessageHandler.scriptElement=""};this.nextProblem=function(e){b.ctatdebug("nextProblem ()");
if(CTATGlobalFunctions.isBlank(e))b.ctatdebug("Message is blank, requesting next problem ..."),e=flashVars.getRawFlashVars().run_problem_url,a.send(e);else{b.ctatdebug("Message contains html data, writing ...");try{document.close()}catch(B){alert("Error closing document: "+B.message)}try{document.write(e)}catch(B){alert("Error writing document: "+B.message)}}};this.updateSkillWindow=function(a){b.ctatdebug("updateSkillWindow()");CTATSkillSet.skills.untouchSkills();var e=CTATShellTools.findComponentByClass("CTATSkillWindow");
...
null;b.ctatdebug("processComponentFocus() done")};this.showFeedback=function(a){null!=a&&void 0!=a&&/\S/.test(a)&&" "!=a?(b.ctatdebug("showFeedback("+a+") -> l: "+a.length),CTATShellTools.showFeedback(a),null!=n&&n(a)):b.ctatdebug("showFeedback(): False alarm: empty message. This can happen when the commshell is trying to clear the hint window and there is no hint window.")};this.assignFeedbackHandler=function(a){b.ctatdebug("assignFeedbackHandler()");n=a};this.gradeSAI=function(a,e,c){b.ctatdebug("gradeSAI()");
l[a]=c;a=new CTATSAI(a,e,c);b.processComponentAction(a,!0,!0)};this.assignGradingHandler=function(a){b.ctatdebug("assignGradingHandler()");m=a};this.assignAnonymousGradingProcessor=function(b){v=b};this.assignDoneProcessor=function(b){e=b};this.addEventListener=function(b,a){};this.addGlobalEventListener=function(a){b.ctatdebug("addGlobalEventListener( "+a+")");a&&q.push(a)};this.sendToTools=function(b){a&&a.sendToToolsOrCollaborators(a.getURL(),b,!1)};this.closeWSConnection=function(b,e,c){(b=a.findWSConnection(b))?
...
CTATComponentReference.getComponentFromID=function(a){var g=CTATComponentReference.components;return g.hasOwnProperty(a)?(a=g[a],a.getElement()?a.getElement():null):null};CTATComponentReference.add=function(a,g){var f=new CTATComponentReference(a,g);return CTATComponentReference.components[f.getDiv().getAttribute("id")]=f};var CTATCompBase=function(a,g,f,d,c,b){CTATBase.call(this,a,g);var e=f||0,h=d||0,l=c||-2,m=b||-2,n=50,p=25,v=!1,q=!1,u="",w=!1,B=!0,y=null,C="",A=null;this.isTabIndexable=!0;var r=0,D=null,z=this,F=null,H="hidden",J=CTATGlobalFunctions.gensym.z_index(),x=CTATGlobalFunctions.gensym.div_id(),G=CTATGlobalFunctions.gensym.z_index(),I=CTATGlobalFunctions.gensym.div_id();this.setIsAbstractComponent=function(b){v=b};this.isAbstractComponent=function(){return v};this.setIsFeedbackComponent=function(b){q=
b};this.isFeedbackComponent=function(){return q};this.setTabIndex=function(b){!0===this.isTabIndexable?(A=b,0>A?(A=CTATGlobals.Tab.Tracker,CTATGlobals.Tab.Tracker++):CTATGlobals.Tab.Tracker=A):A=-1};this.getTabIndex=function(){return A||this.getComponent().getAttribute("tabindex")};this.setZIndex=function(b){z.ctatdebug("Setting z index to: "+b);r=b;null!==y&&(y.style.zIndex=b)};this.getZIndex=function(){return r};this.setDefaultWidth=function(b){n=b};this.getDefaultWidth=function(){return n};this.setDefaultHeight=
...
this);b.appendChild(y)};this.setDivWrapper=function(b){(y=b)&&y.setAttribute("data-ctat-component",this.getClassName())};var R=this.setClassName;this.setClassName=function(b){R(b);y&&y.setAttribute("data-ctat-component",this.getClassName())};this.wrapComponent=function(b){z.ctatdebug("wrapComponent ()");z.makeDivWrapper(b);z.ctatdebug("wrapComponent () done")};this.createCanvas=function(){z.ctatdebug("createCanvas ()");F=document.createElement("canvas");F.setAttribute("id",I);F.setAttribute("onkeypress",
"return noenter(event)");F.setAttribute("width",l+canvasCalibrate+"px");F.setAttribute("height",m+canvasCalibrate+"px");F.setAttribute("style","border: 1px "+this.borderColor+" solid; "+("hidden"==H?"visibility: hidden; ":"")+"z-index:"+G+";");y.firstChild?y.insertBefore(F,y.firstChild):y.appendChild(F);return F};this.redraw=function(){var b=y.style.display;y.style.display="none";y.style.display=b};this.setCanvasVisibility=function(b){H=b};this.getSubCanvasCtx=function(){if(F)return F.getContext("2d")};
this.getSubCanvas=function(){return F};this.getX=function(){return e};this.getY=function(){return h};this.getWidth=function(){if(0>=l){var b;D?b=window.getComputedStyle(D):y&&(b=window.getComputedStyle(y));if(b)return parseFloat(b.width)}return l};this.getHeight=function(){if(0>=m&&y){var b=window.getComputedStyle(y);return parseFloat(b.getPropertyValue("height"))}return m};this.getText=function(){return u};this.getEnabled=function(){return B};this.assignEnabled=function(b){B=b;y.setAttribute("data-ctat-enabled",
B)};this.setEnabled=function(b){z.ctatdebug("setEnabled ("+b+")");z.assignEnabled(b);D?D.disabled=!B:z.ctatdebug("Error: component pointer is null")};this.lock=this.setEnabled.bind(z,!1);this.unlock=this.setEnabled.bind(z,!0);this.getDivWrap=function(){return y};this.getComponent=function(){return D};this.component=null;Object.defineProperty(this,"component",{get:function(){return D}});this.getCanvasZIndex=function(){return G};this.getComponentGroup=function(){return C};this.setComponent=function(b){D=
b;this.setEnabled(this.getEnabled())};this.getTopDivZIndex=function(){return J};this.getTopDivID=function(){return x};this.setComponentGroup=function(b){C=b;D&&(D.name=b)};this.assignText=function(b){u=b};this.init=function(){z.ctatdebug("THIS IS THE BASE INIT METHOD")};this.initialize=function(){z.ctatdebug("initialize ()");z.configFromDescription();z.init();z.processSerialization();z.render();z.processTabOrder();z.ctatdebug("initialize () done")};this.getInitialized=function(){return w};this.setInitialized=
...
z.getDivWrap().classList.add("CTATComponent");z.ctatdebug("setInitialized () done")};this.addSafeEventListener=function(b,a,e){z.ctatdebug("addSafeEventListener ("+b+")");z.ctatdebug("Adding event listener to: "+e);e?e.addEventListener(b,a):(D?(z.ctatdebug("Adding eventlistener to component instead of target"),D.addEventListener(b,a)):z.ctatdebug("Error: pointer to component is null, can't add event listener"),z.ctatdebug("addSafeEventListener () done"))};this.drawComponent=function(){};this.addComponentReference=
...
"data-selected",e);b.setAttributeNS(null,"data-value",a.toString());b.dataValue=a;this.getEnabled()&&(b.style.cursor="pointer");b.addEventListener("click",this.clickHandler);q.push(b)};var y=this.setEnabled;this.setEnabled=function(b){y(b);q.forEach(function(a){a.style.cursor=b?"pointer":"default"})};this.clear=function(){q=[]};var C=function(b,a){var e=b.toString();!1===a&&(e="(0*"+e+")");return e};this.AddPiece=function(b,a){if(b){var e=new CTAT.Math.Fraction(b);if(0<CTAT.Math.round(e.valueOf())){var c=
h.split("+");c.push(C(e,a));u.setValue(c.join("+"))}}};this.AddToValue=function(b,a){if(b){var e=new CTAT.Math.Fraction(b);if(0<CTAT.Math.round(e.valueOf())){var c=h.split("+");c.push(C(e,a));h=c.join("+")}}return h};var A=-1,r=function(b){isNaN(b)&&this.get_denominator();b=Math.max(b,1);1<A&&(b=Math.min(b,A));return b}.bind(this);this.set_max_denominator=function(b){b=parseInt(b);isNaN(b)||(A=b)};this.set_denominator=function(b){u.setHintHighlight(!1);var a="string"===typeof b?parseInt(b):b;if(!isNaN(a)&&
(a=r(a),this.get_denominator()!=b)){var e=u.evaluate();u.clear();b=[];e.set_denominator(a);for(var c=new CTAT.Math.Fraction(1,a),d=Math.floor(e.numerator),f=a-d,g=0;g<d;g++)b.push(C(c,!0));a=new CTAT.Math.Fraction(e.numerator-d,a);a.equals(0)||(b.push(C(a,!0)),b.push(C(c.subtract(a),!1)),f--);for(a=0;a<f;a++)b.push(C(c,!1));this.setValue(b.join("+"));u.setActionInput("SetPieces",h);u.processAction();return h}};this.get_denominator=function(){return q.reduce(function(b,a,e,c){return Math.min(b,a.dataValue.denominator)},
Infinity)};this.change_denominator=function(b){return this.set_denominator(this.get_denominator()+Number(b))};this.set_number_pieces=function(b){u.setHintHighlight(!1);b="string"===typeof b?parseInt(b):b;if(!isNaN(b)){b=r(b);var a=u.numActive();u.clear();for(var e=[],c=new CTAT.Math.Fraction(1,b),d=0;d<b;d++)e.push(C(c,0<a)),a--;this.setValue(e.join("+"));u.setActionInput("SetPieces",h);u.processAction();return h}};this.change_number_pieces=function(b){this.set_number_pieces(q.length+b)};this.set_numerator=
...
f=f.bind(this,"data-ctat-ctrl-numerator");d=function(b,a){return 0<=b().indexOf(a)};var D=d.bind(null,a),z=d.bind(null,g),F=d.bind(null,f),H=function(b){var a=null;if(b instanceof CTAT.Component.Base.Tutorable)b!=this&&(a=b.getName());else if(b instanceof CTATSAI)b.getSelection()!=u.getName()&&(a=b.getSelection());else if(b instanceof String)b!=u.getName()&&(a=b);else if(b instanceof Element)b!=u.getComponent()&&(a=b.id);else return null;if(a){if(D(a))return J.bind(this,this.change_denominator,this.set_denominator);
if(F(a))return J.bind(this,this.change_numerator,this.set_numerator);if(z(a))return J.bind(this,this.change_number_pieces,this.set_number_pieces)}return null}.bind(this);a=CTAT.Component.Base.Tutorable.EventType;CTATConfiguration.get("previewMode")||document.addEventListener(a.action,function(b){var a=b.detail.sai;b=H(b.detail.component);a&&null!==b&&b(a)},!1);var J=function(b,a,e){var c=parseInt(e.getInput());if(!isNaN(c)){switch(e.getAction()){case "ButtonPressed":b.call(this,c);break;case "Update":case "UpdateTextField":case "UpdateTextArea":a.call(this,
...
this.drawPieces=function(){if(this.baseGroup){this.clear();for(var a=this.parseValue(),c=0,d=document.createDocumentFragment(),f=0;f<a.length;f++){var g=a[f],p=100*g,v=document.createElementNS(b,"rect");v.classList.add("CTATFractionBar--piece");v.setAttributeNS(null,"height","100%");v.setAttributeNS(null,"width",p+"%");v.setAttributeNS(null,"y",0);v.setAttributeNS(null,"x",c+"%");this.addPieceElem(v,g,g.selected);d.appendChild(v);var q=document.createElementNS(b,"text");q.classList.add("CTATFractionBar--label");
q.setAttributeNS(null,"text-anchor","middle");q.setAttributeNS(null,"dominant-baseline","middle");d.appendChild(q);var v=""+String(g.numerator),g=""+String(g.denominator),u=document.createElementNS(b,"tspan"),w=document.createElementNS(b,"tspan");u.appendChild(document.createTextNode(v));w.appendChild(document.createTextNode(g));q.appendChild(u);q.appendChild(w);q=c+p/2;u.setAttributeNS(null,"x",q+"%");u.setAttributeNS(null,"y","60%");u.setAttributeNS(null,"dy","-1em");w.setAttributeNS(null,"x",q+
...
a.classList.add("CTATHintWindow--hint-button-area");p.appendChild(a);if(w)m=document.createElement("button"),m.classList.add("CTATHintWindow--previous"),m.innerHTML=w;else{m=document.createElement("button");m.classList.add("CTATHintWindow--previous");var e=document.createElement("span");e.classList.add("CTATHintWindow--button-icon");e.textContent="\u25c0";m.appendChild(e);q&&(e.style.cssFloat="left",m.appendChild(document.createTextNode(q)))}m.addEventListener("click",function(b){CTATShellTools.showPrevHint()},
...
[];a=document.createDocumentFragment();a.appendChild(h.generate());a.appendChild(l.generate());a.appendChild(m.generate());this._tick_mark_group.innerHTML="";this._tick_mark_group.appendChild(a);a=this._point_group.children;for(c=0;c<a.length;c++)b=a[c],d=this.X_Axis.getPosition(b.value),f=new DOMPoint(b.cx.baseVal.value,b.cy.baseVal.value),1<d.distance(f)&&(b.cx.baseVal.value=d.x,b.cy.baseVal.value=d.y)}}.bind(this),u=0,w=null,B=new DOMPoint(-30,-30),y=!1,C=function(b){B.x=b.clientX;B.y=b.clientY},
A=function(b){cancelAnimationFrame(u);w.style.visibility="hidden";y=!1},r=function(b){if(!0===this.getEnabled()&&0<n){this.setHintHighlight(!1);var a;v?(b=H(b.clientX,b.clientY),a=b.location,b=b.data):(b=z(b.clientX,b.clientY),a=this.X_Axis.getProjectedPoint(b),b=this.X_Axis.getAxisValue(b));var c=document.createElementNS(e,"circle");c.classList.add("CTATNumberLine--point");c.setAttributeNS(null,"cx",a.x);c.setAttributeNS(null,"cy",a.y);c.setAttributeNS(null,"r",p);c.value=b;if(this._point_group.children.length>=
...
this.component.appendChild(this._point_group);this.component.appendChild(w);this.X_Axis.svg_group=this._axis_line_group;q();this.addComponentReference(this,this.getDivWrap());this.component.addEventListener("mousemove",C);this.component.addEventListener("mouseleave",A);var b=this.getEnabled;this.component.addEventListener("mouseenter",function(){!0===b()&&0<n&&(y=!0,w.style.visibility=null,u=requestAnimationFrame(J))});this.component.addEventListener("click",r);this.component.addEventListener("focus",
...
a.setInput(c.attr("data-ctat-denominator")),b.push(a));return b};var D=-1<navigator.userAgent.toLowerCase().indexOf("firefox"),z=function(b,a){this.svgPoint=this.svgPoint?this.svgPoint:this.component.createSVGPoint();this.svgPoint.x=b;this.svgPoint.y=a;var c=this._axis_line_group.getScreenCTM().inverse();this.svgPoint=this.svgPoint.matrixTransform(c);c=new DOMPoint(this.svgPoint.x,this.svgPoint.y);if(D){var e=$(this.component),d=parseInt(e.css("borderLeftWidth"))+parseInt(e.css("paddingLeft"))+parseInt(e.css("marginLeft")),
e=parseInt(e.css("borderTopWidth"))+parseInt(e.css("paddingTop"))+parseInt(e.css("marginTop"));c.x-=d;c.y-=e}return c}.bind(this),F=function(b,a){return this.getProjectedPoint(z(b,a))}.bind(this.X_Axis),H=function(b,a){for(var c=F(b,a),e=null,d=Number.POSITIVE_INFINITY,f,g,h=0;h<this._tickmarks.length;h++)f=this._tickmarks[h],g=c.distance(f.location),g<d&&(e=f,d=g);return e}.bind(this),J=function(){if(y&&!0===this.getEnabled()){if(v){var b=H(B.x,B.y);w.setAttributeNS(null,"transform","translate"+
CTAT.Geom.Point.to2DString(b.location,!0))}else w.setAttributeNS(null,"transform","translate"+CTAT.Geom.Point.to2DString(F(B.x,B.y),!0));u=requestAnimationFrame(J)}}.bind(this);this.render=function(){q()};this.calcXCoordinate=function(a){a=new b(a);var c=this.getWidth()-30,c=Math.abs(c-30),e=max.subtract(min);return 30+a.subtract(min).divide(e)/c};this.calcNum=function(b){var a=this.getWidth()-30,a=Math.abs(a-30);b=max.subtract(min).multiply((b-30)/a);return min.add(b)};var x=function(b,a){switch(a.getClassName()){case "CTATMessage":a=
...
this.setEnabled(!1):this.setEnabled(!0)));break;case "Points":a=this._point_group.children;for(c=0;c<a.length;c++){var e=a[c];e.classList.remove("CTAT--incorrect");e.classList.remove("CTAT--hint");e.classList.add("CTAT--correct")}break;case "set_minimum":W(S()).forEach(c);break;case "set_maximum":W(P()).forEach(c);break;case "set_large_step":W(Q()).forEach(c);break;case "set_small_step":W(U()).forEach(c);break;case "set_denominator":W(T()).forEach(c);break;default:console.log("Unhandled Action in",
...
e.classList.add("CTAT--incorrect")}break;case "set_minimum":W(S()).forEach(c);break;case "set_maximum":W(P()).forEach(c);break;case "set_large_step":W(Q()).forEach(c);break;case "set_small_step":W(U()).forEach(c);break;case "set_denominator":W(T()).forEach(c);break;default:console.log("Unhandled Action in",this.getName(),a)}};var G=this.setEnabled;this.setEnabled=function(b){G(b);w&&y&&(w.style.visibility=this.getEnabled()?null:"hidden")};this.set_minimum=function(b){this.Minimum=b;this.render()};
this.change_minimum=function(a){a=new b(a);0!==a.valueOf()&&(this.Minimum=this.Minimum.add(a),this.render())};var I=function(){this.setActionInput("set_minimum",this.Minimum)}.bind(this);this.set_maximum=function(b){this.Maximum=b;this.render()};this.change_maximum=function(a){a=new b(a);0!==a.valueOf()&&(this.Maximum=this.Maximum.add(a),this.render())};var R=function(){this.setActionInput("set_maximum",this.Maximum)}.bind(this);this.set_max_user_entries=function(b){this.setMaxPoints(parseInt(b))};
a=function(b,a){b.setStep(a);this.render()};this.set_large_step=a.bind(this,h);var O=function(){this.setActionInput("set_large_step",h.step.toString())}.bind(this);this.set_small_step=a.bind(this,l);var L=function(){this.setActionInput("set_small_step",l.step.toString())}.bind(this);this.set_denominator=function(a){0===parseInt(a)?m.setStep(0):m.setStep((new b(a)).reciprocal());this.render()};var E=function(){var b=0===m.step.valueOf()?0:m.step.reciprocal();this.setActionInput("set_denominator",b.toString())}.bind(this);
a=function(a,c){if(0!==(new b(c)).valueOf()){var e=a.step.add(c);0>e.valueOf()&&e.set(0,1);a.setStep(e);this.render()}};this.change_large_step=a.bind(this,h);this.change_small_step=a.bind(this,l);this.change_denominator=function(a){a=new b(a);0!==a.valueOf()&&(a=a.add(m.step.denominator),m.setStep(a.reciprocal()),this.render())};var M=void 0;this.set_precision=function(b){M=parseInt(b);this.render()};this.AddPoint=function(a,c){var d=new b(a),f=this.X_Axis.getPosition(d),g=document.createElementNS(e,
...
e.getInput())}c.call();this.processAction(!1,!0)};a=function(b){return(b=$(this.getDivWrap()).attr(b))?b.split(/\s*;\s*/).map(function(b){return b.trim()}):[]};var P=a.bind(this,"data-ctat-ctrl-max"),S=a.bind(this,"data-ctat-ctrl-min"),Q=a.bind(this,"data-ctat-ctrl-large-tick"),U=a.bind(this,"data-ctat-ctrl-small-tick"),T=a.bind(this,"data-ctat-ctrl-denominator"),W=function(b){return b.map(function(b){return $("#"+b).data("CTATComponent")})},Z=function(b){var a=null;if(b instanceof CTAT.Component.Base.Tutorable)b!=
this&&(a=b.getName());else if(b instanceof CTATSAI)b.getSelection()!=pointer.getName()&&(a=b.getSelection());else if(b instanceof String)b!=pointer.getName()&&(a=b);else if(b instanceof Element)b!=pointer.getComponent()&&(a=b.id);else return null;if(a){if(ha(a))return V.bind(this,this.change_denominator,this.set_denominator,E);if(fa(a))return V.bind(this,this.change_small_step,this.set_small_step,L);if(ia(a))return V.bind(this,this.change_large_step,this.set_large_step,O);if(ka(a))return V.bind(this,
this.change_minimum,this.set_minimum,I);if(ea(a))return V.bind(this,this.change_maximum,this.set_maximum,R)}return null}.bind(this);CTATConfiguration.get("previewMode")||document.addEventListener(CTAT.Component.Base.Tutorable.EventType.action,function(b){var a=b.detail.sai;b=Z(b.detail.component);a&&null!==b&&b(a)},!1);this.setMaxControllers=function(b){$(this.getDivWrap()).attr("data-ctat-ctrl-max",b)};this.setParameterHandler("MaxValueControllers",this.setMaxControllers);this.setMinControllers=
...
g.getLevel()+" ...");var v=document.createElement("div");v.classList.add("CTATSkillWindow--skill");var q=document.createElement("div");q.classList.add("CTATSkillWindow--bar");var u=document.createElement("div"),w=g.getLevel();w<d?u.classList.add("CTATSkillWindow--bar--nonmastered"):u.classList.add("CTATSkillWindow--bar--mastery");u.style.width=w>d?"100%":100*w+"%";q.appendChild(u);v.appendChild(q);c.appendChild(v);q=document.createElement("div");q.textContent=g.getDisplayName()||"no-name";q.classList.add("CTATSkillWindow--label");
v.appendChild(q)}e.innerHTML="";e.appendChild(c)}}}};CTATSkillWindow.prototype=Object.create(CTAT.Component.Base.Graphical.prototype);CTATSkillWindow.prototype.constructor=CTATSkillWindow;CTAT.ComponentRegistry.addComponentType("CTATSkillWindow",CTATSkillWindow);var CTATSubmitButton=function(a,g,f,d,c){CTATButton.call(this,a,g,f,d,c);this.setClassName("CTATSubmitButton");CTATConfiguration.get("previewMode");var b=this;this.setParameterHandler("target_components",function(b){this.getDivWrap().setAttribute("data-ctat-target",b);return this});var e=this.init;this.init=function(){e();this.setParameter("tutorComponent",CTAT.Component.Base.Tutorable.Options.DO_NOT_TUTOR);this.component.addEventListener("focus",this.processFocus)};var h=function(a){var c=b.getTargets();
...
g=document.createElement("canvas"),g.id="main-canvas",g.innerHTML="Your browser does not support CTAT. Please update or use another browser.",ctatdebug("Setting canvas to: 0,0,"+d+" , "+c),getSafeElementById(ctatcontainer).appendChild(g)):(ctatdebug("Setting canvas to: 0 , 0, "+d+" , "+c),g.style.top="0",g.style.left="0");g.style.width=d+"px";g.style.height=c+"px";return g};(function(a){function g(){var b=arguments[0],a=g.cache;a[b]&&a.hasOwnProperty(b)||(a[b]=g.parse(b));return g.format.call(null,a[b],arguments)}function f(b){return Object.prototype.toString.call(b).slice(8,-1).toLowerCase()}var d=/[^s]/,c=/[def]/,b=/^[^\x25]+/,e=/^\x25{2}/,h=/^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/,l=/^([a-z_][a-z_\d]*)/i,m=/^\.([a-z_][a-z_\d]*)/i,n=/^\[(\d+)\]/,p=/^[\+\-]/;g.format=function(b,a){var e=1,h=b.length,m,l=[],n,q,v,u,F=!0,
H="";for(n=0;n<h;n++)if(m=f(b[n]),"string"===m)l[l.length]=b[n];else if("array"===m){v=b[n];if(v[2])for(m=a[e],q=0;q<v[2].length;q++){if(!m.hasOwnProperty(v[2][q]))throw Error(g("[sprintf] property '%s' does not exist",v[2][q]));m=m[v[2][q]]}else m=v[1]?a[v[1]]:a[e++];"function"==f(m)&&(m=m());if(d.test(v[8])&&"number"!=f(m)&&isNaN(m))throw new TypeError(g("[sprintf] expecting number but found %s",f(m)));c.test(v[8])&&(F=0<=m);switch(v[8]){case "b":m=m.toString(2);break;case "c":m=String.fromCharCode(m);
break;case "d":m=parseInt(m,10);break;case "e":m=v[7]?m.toExponential(v[7]):m.toExponential();break;case "f":m=v[7]?parseFloat(m).toFixed(v[7]):parseFloat(m);break;case "o":m=m.toString(8);break;case "s":m=(m=String(m))&&v[7]?m.substring(0,v[7]):m;break;case "u":m>>>=0;break;case "x":m=m.toString(16);break;case "X":m=m.toString(16).toUpperCase()}if(!F||c.test(v[8])&&v[3])H=F?"+":"-",m=m.toString().replace(p,"");q=v[4]?"0"==v[4]?"0":v[4].charAt(1):" ";u=v[6]-(H+m).length;u=v[6]?Array(u+1).join(q):
"";l[l.length]=v[5]?H+m+u:0==q?H+u+m:u+H+m}return l.join("")};g.cache={};g.parse=function(a){for(var c,d=[],f=0;a;){if(null!==(c=b.exec(a)))d[d.length]=c[0];else if(null!==(c=e.exec(a)))d[d.length]="%";else if(null!==(c=h.exec(a))){if(c[2]){var f=f|1,g=[],p=c[2],q;if(null!==(q=l.exec(p)))for(g[g.length]=q[1];""!==(p=p.substring(q[0].length));)if(null!==(q=m.exec(p)))g[g.length]=q[1];else if(null!==(q=n.exec(p)))g[g.length]=q[1];else throw new SyntaxError("[sprintf] failed to parse named argument key");
...
c.object&&(e=a.aliases[d]);e?b[e]=c:console.warn("no alias found for "+JSON.stringify(c))});return b}function d(c,b){var e={},d="NotNode"===b.nodeType||"FromNotNode"===b.nodeType;switch(b.nodeType){case "BetaNode":case "NotNode":case "ExistsNode":var f=b.rightMemory,g,n=[],p;for(p in f)g=f[p].data.match,n.push(a(g));e.factBindings=n;break;case "JoinNode":var n=b.leftMemory,v,q=[];for(f in n)for(g in v=n[f].data.rightMatches,v)p=v[g].match,q.push(a(p));e.factBindings=q;break;case "FromNode":case "FromNotNode":f=
b.fromMemory;q=[];for(n in f)for(v in g=f[n],g)p=g[v][1],p.match&&q.push(a(p.match));e.factBindings=q;break;default:e.factBindings=[]}e.isMatch=e.factBindings.length&&!d||!e.factBindings.length&&d;return e}return function(a,b){var c=!0,f=a.getRuleData(b),g="";if(f){var m=f.memoryNodes,f=[].concat(f.patterns),n={},p=null,v,q,u,w=/("([^"]*)"):/g;try{for(var B=0;B<f.length;B++){var g=g+(p?"\n\t":'\npattern: "'),y=f[B];y.disjuncts&&(g+="or (\n\t",p=B-1+y.disjuncts.length,f.splice.apply(f,[].concat([B,
1],$jscomp.arrayFromIterable(y.disjuncts))),y=f[B]);g+=y.string+(p?"":'"');v=y.alias;n[v]||(n[v]=0);q=d(y,m[v][n[v]++]);q.isMatch||(g+=" NOT");g+=" MATCHED";(u=q.factBindings).length&&(g+=" - Possible bindings: ",u.forEach(function(b,a){for(var c in b)if("__i__"!==c){for(var e=JSON.stringify(b[c].object),d;d=w.exec(e);)e=e.replace(d[1],d[2]);g+="\n\t"+(p?"\t":"")+c+": "+e+" (fact ID "+b[c].id+")"}g+="\n"}));B===p&&(g+='\n)"',p=null);if(!q.isMatch){c=!1;break}}return g+"\nRule "+(c?"":"not ")+"matched"}catch(C){throw console.log("got here: "+
g),C;}}else return"Rule "+b+" not found"}}();this.printBreakpoints=function(a){return"breakpoints set for rules: "+a.getBreakpoints().join(", ")}};var CTATNoolsTracerWrapper=function(a){this.printAgenda=function(){a.printAgenda("override")};this.printConflictTree=function(g){a.printConflictTree("override",g)};this.printPregenTrees=function(g){a.printPregenTrees("override",g)};this.printFact=function(g){a.printFact(g)};this.getFact=function(g){return a.getFact(g)};this.printFacts=function(g){a.printFacts(g)};this.getFacts=function(g){return a.getFacts(g)};this.printRules=function(g){a.printRules(g)};this.printMatch=function(g){a.printCtNodeMatch(g)};
this.printRuleNodes=function(g){a.printRuleNodes(g)};this.setStepperMode=function(g){a.setInStepMode(g)};this.takeSteps=function(g,f){a.takeSteps(g,f)};this.setBreakpoint=function(g,f){a.setBreakpoint(g,f)};this.printBreakpoints=function(){a.printBreakpoints()};this.resume=function(){a.resume()};this.getProblemStateStatus=function(){return a.getProblemStateStatus()}};var CTATNoolsTracer=function(a,g,f){var d,c,b,e;function h(b){va=[];N.setDoBacktracking(!1);K("debug","starting initial match");wa=function(){K("debug","done initial match");la=ma=!0;N.setPruneOldActivations(Y.prune_old_activations);N.setDoBacktracking(Y.use_backtracking);N.setSearchAllPermutations(Y.search_all_permutations);ga=!0;"function"===typeof b&&b()};A()}function l(){K("debug","start conflict tree pregeneration...");ja=!0;da=[];var b=0;0===na.length&&na.push({selection:"not_specified",action:"not_specified",
input:"not_specified"});var a=function(){++b>=na.length?c():m(na[b],a)},c=function(){K("debug","done conflict tree pregeneration");ja=!1;xa();xa=function(){}};Y.use_hint_fact?(b--,m(null,a,!0)):m(na[b],a)}function m(b,a,c){N.prepForMatch();J();var e;e=c?C():y(b,!0);A(null,function(){N.retract(e);la=!0;var d=N.getConflictTree();c?da.__hintTree=[X,d]:da.push([b,X,d]);a()})}function n(b,a,c){var e=null,d=null,f=null;if("untutored_action"===c)return y(b,!1),l(),!0;"hint"===c&&da.__hintTree&&(d=z(!0,b.selection,
da.__hintTree[0]));if(!d)for(var g=0;g<da.length;g++){var h=da[g][0],m=da[g][1],n=m.firstPredictedSolution,m=m.selectionMap;!f&&("hint"!==c||0<n.hints.length)&&(f=n);if(H(b,h).isMatch){!d&&("hint"!==c||0<n.hints.length)&&(d=n);for(var p in m){if(m.hasOwnProperty(p))for(h=m[p],n=0;n<h.length;n++){var q=h[n];if("tutored_action"===c){if(H(b,q.sai,q.saiComparator).isMatch){e=q;break}}else!d&&0<q.hints.length&&(d=q)}if(e||"hint"===c&&d)break}}}if(e)K("debug","Matched w/ pregen tree, refiring chain: "+
e.activationIds.join(" , ")),sa=e,na=[],N.prepForMatch(),J(),y(b,!0),A(null,function(){K("debug","done refiring activations, returning result");var b=sa.sai.isCorrect?"correct":"bug";1===e.halted&&(e.halted=2);ma="correct"===b;la=!0;sa=ba=null;a(b,e);l()},e.activationIds);else return d||(f||(f=new ra),d=f),"tutored_action"===c?(K("debug","didn't get a match :( "),a("no_model",d)):a(d),!0}function p(b,a){"string"===typeof b&&(d[d.length-1].successOrBugMsg={message:b,priority:a||0})}function v(b){var a=
d[d.length-1].sai;b.selection&&(a.selection=b.selection);b.action&&(a.action=b.action);b.input&&(a.input=b.input)}function q(b,a,c,e,d,f,g){K("debug","handleImports for "+a);c=c||{};d=d||{count:0,chunks:[]};f=f||0;g=g||0;for(var h=/\bimport\s?\(('|")?([^()'"\s]*)\1?\);/g,m,l=[];null!=(m=h.exec(b));){var n=aa.relativeToAbsolute(m[2],a);c[n]?K("debug","skipping duplicate import: "+n):(l.push(n),c[n]=!0);b=b.replace(m[0],"");h.lastIndex-=m[0].length}d.chunks[f]||(d.chunks[f]=[]);d.chunks[f][g]=b;d.count+=
...
{getRuntime:function(){return Ca},getStudentInput:function(){return ca.getLastStudentSAI()},getStudentSAIs:function(){return ca.getStudentSAIs()},checkSAI:F,setTutorSAI:v,setSuccessOrBugMsg:p,setProblemAttribute:x,getInitialized:function(){return ca.getInitialized()},backtrack:function(){N.setAboutToBacktrack()},assert:I,modify:O,retract:R,undoAll:E,addPregenSAI:M,halt:L};[CTATAlgebraParser,CTATLogicParser,CTATChemParser,CTATFormulaParser].forEach(function(b){var a=new b;b={};for(var e in a)b.f=e,
"function"===typeof a[b.f]&&(c[b.f]=function(b){return function(){return a[b.f].apply(a,arguments)}}(b)),b={f:b.f}});try{pa=nools.compile(b,{name:a||"CTATFlow",scope:c})}catch(Ha){return K("error","Error compiling rule file"),ga=!1,Ha}B();return!0}function B(){var b,a;b=pa.__scope;var c={};pa.__rules.forEach(function(b){c[b.name]=!0});if(b&&b.skill_definitions)if(b=b.skill_definitions,b instanceof Array)b.forEach(function(b){a=b.ruleName.split(",");a.forEach(function(a){a=a.trim();if(c[a])ya[a]={name:b.skillName||
...
}function y(b,a){K("debug","Assert sai ("+(a?"":"un")+"tutored) : "+JSON.stringify(b));var c=ta[b.selection];if(c&&N.factExists(c))c.input=b.input,c.tutored=a,N.modify(c);else{c=pa.getDefined("StudentValues");if(!c)throw Error("StudentValues type not defined");c=new c(b.selection,b.action,b.input);c.tutored=a;N.assert(c,"_student_input_"+Da);ta[b.selection]=c;ja||Da++}return ba=c}function C(){K("debug","Asserting hint fact...");if(!ua){var b=pa.getDefined("IsHintMatch");if(!b)throw Error("IsHintMatch type not defined");
ua=new b}return N.assert(ua,"_isHintMatch")}function A(b,a,c){oa=!1;N.match(function(b){ja||(Ea=N.getConflictTree());if(b)throw K("error","nools encountered an error: "+b),b;a&&"function"===typeof a?a():oa&&(qa&&K("override","search complete, returning result"),wa())},b,!1,la,c);la=!1}function r(b){var a="no_model",c,e;X.matchChain?(c=X.matchChain,a="correct"):(X.bugMatchChain&&(c=X.bugMatchChain,a="bug",e=c.msg),c=z(!1),e&&(c.msg=e));ma="correct"===a;c.tpas=za;la=!0;ba=null;b(a,c)}function D(b,a,
c){c=z(!0,c);a&&(ma=Aa=!1,la=!0,ba=null,Y.use_hint_fact&&N.retract(ua));b(c)}function z(b,a,c){var e;c=c||X;var d=c.selectionMap;a=a||(ba?ba.selection:"");var f=c.firstPredictedSolution,g=c.firstTutorSelection,h=function(a){a=d[a];for(var c=0;c<a.length;c++)if(a[c].sai.isCorrect&&(!b||0<a[c].hints.length))return a[c];return null};"hint"!==a&&d[a]&&(e=h(a));if(!e){f&&(e=b?h(g):f);for(s in d){if(e)break;e=h(s)}if(!e)for(c=c.numChains,a=0;a<c&&(!(f=d["_default_key"+a])||!(e=f[0])||b&&!(0<e.hints.length));a++);
e||(e=new ra)}return e}function F(a,c,e){var f=!1,g=a.selection,h=a.action,m=a.input,l=d,l=l[l.length-1],n="not_specified"===g||"not_specified"===h||"not_specified"===m;K("sai_check","check SAI against: "+JSON.stringify(a));if(Y.pregen_conflict_tree)return K("sai_check","in pregen mode, skipping check  (was "+(e?"":"not")+" a buggy step)"),l.sai={selection:g,action:h,input:m,isCorrect:!e&&!n},l.comparator=c,sa&&(K("sai_check","currently re-firing; updating sai in matched chain..."),sa.sai=l.sai),
!0;if(!ba)return K("sai_check","no student input to check, returning false"),!1;K("sai_check","student input: "+JSON.stringify(ba));l.sai={selection:null!==g&&void 0!==g&&"not_specified"!==g&&"don't_care"!==g?g:"",action:null!==h&&void 0!==h&&"not_specified"!==h&&"don't_care"!==h?h:"",input:null!==m&&void 0!==m&&"not_specified"!==m&&"don't_care"!==m?m:"",isCorrect:!e&&!n};Aa?K("sai_check","Skipping check, we're hint matching"):(f=H(ba,a,c),K("sai_check",(f.isMatch?"Match":"No match")+", "+(e?"was":
"was not")+" a buggy step"),b=f.isMatch?e?"buggy":"match":null,N.setNodeMatcherResult(f));return f.isMatch}function H(b,a,c){var e=a.selection,d=a.action,f=a.input,g=b.selection,h=b.action,m=b.input,l=["-","-","-"],n={student:b,tutor:a,isMatch:!1,matchedFields:null},m=isNaN(m)?m:parseInt(m,10),f=isNaN(f)?f:parseInt(f,10),p=function(b,a,c){return"don't_care"===b?"*":"not_specified"===b?" ":b===a?c:"-"};l[0]=p(e.toLowerCase(),g.toLowerCase(),"S");l[1]=p(d.toLowerCase(),h.toLowerCase(),"A");l[2]=p(f,
m,"I");n.matchedFields=l;if(c&&"function"===typeof c)n.isMatch=c(b,a);else for(n.isMatch=!0,b=0;3>b;b++)if("-"===l[b]){n.isMatch=!1;break}return n}function J(){X=new ha;d=[];c=[];b=null;oa=e=!1}function x(b,a){K("debug","setProblemAttribute ("+b+", "+a+")");Y[b]=a}function G(){for(var a=d,c=X.selectionMap,f,g,h={message:"",priority:Number.NEGATIVE_INFINITY},m,l=[],n=[],p=[],q=[],v=[],r,u={selection:"",action:"",input:""},z=null,w={},y=e?ja?1:2:0,B=0;B<a.length;B++)f=a[B],g=f.sai,n.push(f.ruleName),
(m=ya[f.ruleName])&&p.push(m.name+" "+m.category),p=p.concat(f.skills),q=q.concat(f.hints),v=v.concat(f.tpas),l.push(f.activationId),f.successOrBugMsg&&f.successOrBugMsg.priority>h.priority&&(h=f.successOrBugMsg),g&&(g.selection&&(r=u.selection=g.selection),g.action&&(u.action=g.action),g.input&&(u.input=g.input),u.isCorrect=g.isCorrect,f.comparator&&"function"===typeof f.comparator&&(z=f.comparator)),f.customFields.forEach(function(b){return w[b.name]=b.value});q.sort(function(b,a){var c=a.precedence-
b.precedence;0===c&&(c=b.pos-a.pos);return c});r?X.firstTutorSelection||(X.firstTutorSelection=r):r="_default_key"+X.numChains;c[r]||(c[r]=[]);a=new ra(u,n,p,q,h,w,l,z,v,y);u.isCorrect&&!X.firstPredictedSolution&&(X.firstPredictedSolution=a);c[r].push(a);switch(b){case "buggy":X.bugMatchChain=a;break;case "match":X.matchChain=a}X.numChains++;za=v;K("debug","stored last chain: \n\trules: "+n+"\n\tskills: "+p+"\n\tfinalSAI: "+JSON.stringify(u)+"\n\tmatchType: "+b)}function I(b){Y.use_backtracking&&
N.pushUndo("assert",b);return N.assert(b)}function R(b){Y.use_backtracking&&N.pushUndo("retract",b);return N.retract(b)}function O(b,a,c){if(Y.use_backtracking)N.pushUndo("modify",b,a);else if(3>arguments.length)return N.modify.apply(N,arguments);b[a]=c;return N.modify(b)}function L(){e=!0;ja?N.setAboutToBacktrack():(N.halt(!0),oa=!0)}function E(){N.undoAll(!0)}function M(){if(!ja)for(var b=0;b<arguments.length;b++){var a=arguments[b];!a.selection&&(a.selection="not_specified");!a.action&&(a.action=
"not_specified");!a.input&&(a.input="not_specified");na.push(a)}}function V(){G()}function P(b){Ba||c.pop();Ba=!1;za=[];K("backtrack","backtracking, initiated by "+(b?"model":"engine"))}function S(b,a,c,e){var f;try{f=JSON.stringify(b)}catch(Ia){f="< Error converting fact to JSON >"}K("assert",a+" fact asserted with ID "+e+": "+f);c=d[d.length-1];switch(a){case "tpa":K("tpa","TPA asserted: "+JSON.stringify(b));ga?Y.use_backtracking?c.tpas.push(b):Ga(b):va.push(aa.buildStartStateMsg(b));break;case "hint":ga&&
(b.pos=+(d.length+"."+c.hints.length),c.hints.push(b));break;case "skill":ga&&c.skills.push(b.name+" "+b.category);break;case "customfield":ga&&c.customFields.push(b)}}function Q(b,a,c,e){K("modify",a+" fact modified with ID "+e)}function U(b,a,c,e){K("retract",a+" fact retracted with ID "+e)}function T(a){K("state_save","Hit branch point, agenda: "+JSON.stringify(a.agenda)+", factIdCntr: "+a.state.factIdCounter);c.push({numLinks:d.length,matchType:b})}function W(a){K("state_restore","State restored, agenda: "+
JSON.stringify(a.agenda)+", factIdCntr: "+a.state.factIdCounter);a=c;a=a[a.length-1];links=d;links.splice(a.numLinks);b=a.matchType}function Z(b,a,c){K("fire","Firing activation: "+c);d.push(new Fa(b,c));Ba=!0}function ea(b,a,c){K("agenda_insert",b+" added to agenda, is "+(a?" ":"not ")+"new, was "+(c?" ":"not ")+"skipped")}function ka(b){K("agenda_retract",b+" removed from agenda")}function ia(){K("agenda_empty","No more activations in agenda, all branches have been explored");oa=!0}function fa(b){K("override",
"hit breakpoint on rule "+b+" (call resume() to resume matching)")}var ha=function(){this.firstTutorSelection=null;this.selectionMap={};this.bugMatchChain=this.matchChain=null;this.numChains=0;this.firstPredictedSolution=null},ra=function(b,a,c,e,d,f,g,h,m,l){this.sai=b||{selection:"",action:"",input:""};this.rules=a||[];this.skills=c||[];this.hints=e||[];this.msg=d?d.message:"";this.customFields=f||{};this.activationIds=g||[];this.saiComparator=h||null;this.tpas=m||[];this.halted=l},Fa=function(b,
a){this.ruleName=b;this.activationId=a;this.hints=[];this.tpas=[];this.skills=[];this.customFields=[]},K=a,Ga=g,Ca=f,ca=this,ga=!1,pa=null,N=null,ta={},X=new ha,ba=null,Da=0;d=[];c=[];b=null;var Ba=e=!1,aa=null,va=[],Y={use_backtracking:!1,prune_old_activations:!1,use_hint_fact:!1,search_all_permutations:!0,hint_out_of_order:!1,substitute_input:!1},ma=!0,Aa=!1,ua=null,ya={},za=[],qa=!1,la=!0,wa=function(){},oa=!1,na=[],ja=!1,xa=function(){},da=[],sa=null,Ea=null;this.getSession=function(){return N};
this.getInitialized=function(){return ga};this.getSkills=function(){return ya};this.getProblemAttribute=function(b){return Y[b]};this.getProblemStateStatus=function(){return Ca.getOutputStatus()};this.init=function(b,a,c){K("debug","noolstracer init w/ source file: "+b);if(nools){aa=new CTATNoolsTracerUtil;var e=aa.relativeToAbsolute(b);$.ajax(b,{dataType:"text",success:function(d){q(d,e,null,function(e){K("debug","compiling model...");!0!==(e=w(e,b))?(K("error","CTATNoolsTracer: Error compiling model"),
...
this.createSession=function(){K("debug","creating session...");(N=pa.getSession({iAmEventListeners:!0,assert:S,retract:U,modify:Q,state_save:T,state_restore:W,backtrack:P,fire:Z,agenda_insert:ea,agenda_retract:ka,agenda_empty:ia,endOfChain:V,breakpoint:fa}))&&K("debug","session created");return!!N};this.evaluate=function(b,a,c){K("debug","noolsTracer.evaluate, matchType = "+c+", sai "+JSON.stringify(b)+", "+ma);if(Y.pregen_conflict_tree)return n(b,a,c);var e=r.bind(ca,a);N.prepForMatch();switch(c){case "hint":if(ma||
Y.use_hint_fact)Aa=!0,e=D.bind(ca,a,!0),Y.use_hint_fact&&C();else return K("debug","re-using hints from last match"),D(a,!1,b.selection),!0;case "tutored_action":J();y(b,!0);wa=function(){N.prepForMatch();N.restoreAgenda();ca.printAgenda("agenda_post");ca.printConflictTree("conflict_tree");e()};qa||(ca.printAgenda("agenda_pre"),A());break;case "untutored_action":return y(b,!1),!0}return!1};this.setListener=function(b,a){N&&N.on(b,a)};this.getStudentSAIs=function(){return ta};this.getLastStudentSAI=
function(){return ba};this.getTutorSAIs=function(){return X.selectionMap};this.reset=function(b){ca.createSession();ga=!1;ta={};X=new ha;ba=null;ma=!0;h(b)};this.printAgenda=function(b){K(b,("override"!==b?"["+b+"]: ":"")+aa.printAgenda(N))};this.printConflictTree=function(b,a){K(b,"\n"+Ea.toString(a))};this.printPregenTrees=function(b,a){da.__hintTree&&K(b," hint tree: \n"+da.__hintTree[1].toString(a));da.forEach(function(c){K(b," tree for sai: "+JSON.stringify(c[0])+"\n"+c[2].toString(a))})};this.printFact=
function(b){K("override",aa.printFact(N,b))};this.printFacts=function(b){K("override",aa.printFacts(N,b))};this.printRules=function(b){K("override",aa.printRules(N,b))};this.getFact=function(b){return aa.getFact(N,b)};this.getFacts=function(b){return aa.getFacts(N,b)};this.printCtNodeMatch=function(b){K("override",aa.printCtNodeMatch(N,b))};this.printRuleNodes=function(b){K("override",aa.printRuleNodes(N,b))};this.printBreakpoints=function(){K("override",aa.printBreakpoints(N))};this.setInStepMode=
function(b){b=b&&"false"!==b;K("override","Stepper mode "+(b?"on":"off"));!qa||b||oa||A();qa=b};this.takeSteps=function(b){qa?ba?(b=b||1,K("override","taking "+b+" steps"),A(b)):K("override","no new student input, ignoring"):K("override","not in step mode, ignoring")};this.setBreakpoint=function(b,a){b?(a=a||"first",N.setBreakpoint(b,a)?K("override","breakpoint "+("none"===a?"cleared":"set")+" for rule "+b):K("override","breakpoint not "+("none"===a?"cleared":"set")+" -- rule "+b+" doesn't exist")):
K("override","need a rule name to break on")};this.resume=function(){qa?K("override","can't resume; engine is in stepper mode"):oa?K("override","not at a breakpoint, ignoring"):A()};this.getIAmPregenerating=function(){return ja};this.setDonePregenCallback=function(b){K("debug","setDonePregenCallback()");xa=b}};var CTATLogger=function(a){var g={},f=0;a&&a.forEach(function(a){g[a]=!1});this.isSet=function(a){return!!g[a]};this.set=function(d){if(a&&!(d in g))return!1;f++;return g[d]=!0};this.unset=function(d){if(a&&!(d in g))return!1;f--;return!(g[d]=!1)};this.getFlags=function(){return g};this.getNFlagsSet=function(){return f};this.log=function(a,c){(g[a]||"override"===a)&&console.log(("override"!==a?"["+a+"]: ":"")+c)}};var CTATRuleTracerGlobals={},NOOLS_LOG_FLAGS="conflict_tree assert modify retract state_save state_restore backtrack agenda_insert agenda_retract agenda_empty fire error debug sai_check agenda_pre agenda_post tpa".split(" "),CTATNoolsTracerLogger=new CTATLogger(NOOLS_LOG_FLAGS),globalTracerRef=null;function registerTracerWrapper(a){globalTracerRef=a}function setTracerLogFlag(a){a=CTATNoolsTracerLogger.set(a)?"set flag "+a:"Error - invalid flag: "+a;CTATNoolsTracerLogger.log("override",a)}
...
a}).call(this);var CTATAlgebraGrammar=function(){function a(){this.yy={}}var g=function(b,a,c,e){c=c||{};for(e=b.length;e--;c[b[e]]=a);return c},f=[1,6],d=[1,7],c=[1,10],b=[1,11],e=[1,12],h=[1,13],l=[1,21],m=[1,22],n=[5,7,8,9,10,11,12,13,15,26],p=[1,23],v=[1,24],q=[1,26],u=[1,27],w=[5,7,8,9,10,11,12,13,15,16,18,20,21,24,25,26,27,28],B=[5,7,8,9,10,11,12,13,15,16,18,20,21,23,24,25,26,27,28],g={trace:function(){},yy:{},symbols_:{error:2,expression:3,relational:4,EOF:5,arithmetic:6,LESS:7,GREATER:8,LESSEQUAL:9,GREATEREQUAL:10,
...
4:2,6:3,13:f,14:4,15:d,17:5,19:8,22:9,24:c,25:b,27:e,28:h},{1:[3]},{5:[1,14]},{5:[2,8],7:[1,15],8:[1,16],9:[1,17],10:[1,18],11:[1,19],12:[1,20],13:l,15:m},g(n,[2,11],{22:9,19:25,16:p,18:v,20:q,21:u,24:c,25:b,27:e,28:h}),g(w,[2,17]),{13:f,15:d,17:28,19:8,22:9,24:c,25:b,27:e,28:h},{13:f,15:d,17:29,19:8,22:9,24:c,25:b,27:e,28:h},g(w,[2,20]),g(w,[2,23],{23:[1,30]}),{13:f,15:d,17:31,19:8,22:9,24:c,25:b,27:e,28:h},{6:32,13:f,14:4,15:d,17:5,19:8,22:9,24:c,25:b,27:e,28:h},g(B,[2,25]),g(B,[2,26]),{1:[2,1]},
...
15:d,17:42,19:8,22:9,24:c,25:b,27:e,28:h},g(w,[2,14]),{13:f,15:d,17:43,19:8,22:9,24:c,25:b,27:e,28:h},{13:f,15:d,17:44,19:8,22:9,24:c,25:b,27:e,28:h},g(w,[2,18]),g(w,[2,19]),{13:f,15:d,17:45,19:8,22:9,24:c,25:b,27:e,28:h},g(w,[2,22]),{13:l,15:m,26:[1,46]},{5:[2,2],13:l,15:m},{5:[2,3],13:l,15:m},{5:[2,4],13:l,15:m},{5:[2,5],13:l,15:m},{5:[2,6],13:l,15:m},{5:[2,7],13:l,15:m},g(n,[2,9],{22:9,19:25,16:p,18:v,20:q,21:u,24:c,25:b,27:e,28:h}),g(n,[2,10],{22:9,19:25,16:p,18:v,20:q,21:u,24:c,25:b,27:e,28:h}),
g(w,[2,12]),g(w,[2,13]),g(w,[2,15]),g(w,[2,16]),g(w,[2,21]),g(B,[2,24])],defaultActions:{14:[2,1]},parseError:function(b,a){if(a.recoverable)this.trace(b);else{var c=Error(b);c.hash=a;throw c;}},parse:function(b){var a=[0],c=[null],e=[],d=this.table,f="",g=0,h=0,m=0,l=e.slice.call(arguments,1),n=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,q)&&(p[q]=this.yy[q]);n.setInput(b,p);p.lexer=n;p.parser=this;"undefined"==typeof n.yylloc&&(n.yylloc={});q=n.yylloc;
e.push(q);var v=n.options&&n.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var u,w,B,y,P={},S,Q;;){B=a[a.length-1];if(this.defaultActions[B])y=this.defaultActions[B];else{if(null===u||"undefined"==typeof u)u=n.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);y=d[B]&&d[B][u]}if("undefined"===typeof y||!y.length||!y[0]){var U;Q=[];for(S in d[B])this.terminals_[S]&&2<S&&Q.push("'"+this.terminals_[S]+"'");U=n.showPosition?
"Parse error on line "+(g+1)+":\n"+n.showPosition()+"\nExpecting "+Q.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(U,{text:n.match,token:this.terminals_[u]||u,line:n.yylineno,loc:q,expected:Q})}if(y[0]instanceof Array&&1<y.length)throw Error("Parse Error: multiple actions possible at state: "+B+", token: "+u);switch(y[0]){case 1:a.push(u);c.push(n.yytext);e.push(n.yylloc);a.push(y[1]);
u=null;w?(u=w,w=null):(h=n.yyleng,f=n.yytext,g=n.yylineno,q=n.yylloc,0<m&&m--);break;case 2:Q=this.productions_[y[1]][1];P.$=c[c.length-Q];P._$={first_line:e[e.length-(Q||1)].first_line,last_line:e[e.length-1].last_line,first_column:e[e.length-(Q||1)].first_column,last_column:e[e.length-1].last_column};v&&(P._$.range=[e[e.length-(Q||1)].range[0],e[e.length-1].range[1]]);B=this.performAction.apply(P,[f,h,g,p,y[1],c,e].concat(l));if("undefined"!==typeof B)return B;Q&&(a=a.slice(0,-2*Q),c=c.slice(0,
-1*Q),e=e.slice(0,-1*Q));a.push(this.productions_[y[1]][0]);c.push(P.$);e.push(P._$);y=d[a[a.length-2]][a[a.length-1]];a.push(y);break;case 3:return!0}}}},f=function(){return{EOF:1,parseError:function(b,a){if(this.yy.parser)this.yy.parser.parseError(b,a);else throw Error(b);},setInput:function(b,a){this.yy=a||this.yy||{};this._input=b;this._more=this._backtrack=this.done=!1;this.yylineno=this.yyleng=0;this.yytext=this.matched=this.match="";this.conditionStack=["INITIAL"];this.yylloc={first_line:1,
...
g[b],e.lexer.matched);this.$=new e.CTATLogicRelationNode("NOT",null,f[b],f[b-1]);break;case 10:this.$=f[b];break;case 11:this.$=f[b-1].setParens();break;case 12:this.$=new e.CTATLogicVariableNode(e.variableTable,f[b]);break;case 13:this.$=new e.CTATLogicConstantNode(!0,f[b]);break;case 14:this.$=new e.CTATLogicConstantNode(!1,f[b])}},table:[{3:1,4:2,13:f,14:4,15:d,17:c,18:b,19:e},{1:[3]},{5:[1,9],6:h,7:l,8:m,9:n,10:p,11:v,12:q},{4:17,13:f,14:4,15:d,17:c,18:b,19:e},g(u,[2,10]),{4:18,13:f,14:4,15:d,
17:c,18:b,19:e},g(u,[2,12]),g(u,[2,13]),g(u,[2,14]),{1:[2,1]},{4:19,13:f,14:4,15:d,17:c,18:b,19:e},{4:20,13:f,14:4,15:d,17:c,18:b,19:e},{4:21,13:f,14:4,15:d,17:c,18:b,19:e},{4:22,13:f,14:4,15:d,17:c,18:b,19:e},{4:23,13:f,14:4,15:d,17:c,18:b,19:e},{4:24,13:f,14:4,15:d,17:c,18:b,19:e},{4:25,13:f,14:4,15:d,17:c,18:b,19:e},g(u,[2,9]),{6:h,7:l,8:m,9:n,10:p,11:v,12:q,16:[1,26]},g(u,[2,2]),g(w,[2,3],{6:h,8:m}),g(w,[2,4],{6:h}),g([5,10,11,12,16],[2,5],{6:h,7:l,8:m}),g([5,11,12,16],[2,6],{6:h,7:l,8:m,9:n,
10:p}),g([5,12,16],[2,7],{6:h,7:l,8:m,9:n,10:p,11:v}),g([5,16],[2,8],{6:h,7:l,8:m,9:n,10:p,11:v,12:q}),g(u,[2,11])],defaultActions:{9:[2,1]},parseError:function(b,a){if(a.recoverable)this.trace(b);else{var c=Error(b);c.hash=a;throw c;}},parse:function(b){var a=[0],c=[null],e=[],d=this.table,f="",g=0,h=0,m=0,l=e.slice.call(arguments,1),n=Object.create(this.lexer),p={},q;for(q in this.yy)Object.prototype.hasOwnProperty.call(this.yy,q)&&(p[q]=this.yy[q]);n.setInput(b,p);p.lexer=n;p.parser=this;"undefined"==
typeof n.yylloc&&(n.yylloc={});q=n.yylloc;e.push(q);var v=n.options&&n.options.ranges;this.parseError="function"===typeof p.parseError?p.parseError:Object.getPrototypeOf(this).parseError;for(var u,w,B,M,V={},P,S;;){B=a[a.length-1];if(this.defaultActions[B])M=this.defaultActions[B];else{if(null===u||"undefined"==typeof u)u=n.lex()||1,"number"!==typeof u&&(u=this.symbols_[u]||u);M=d[B]&&d[B][u]}if("undefined"===typeof M||!M.length||!M[0]){var Q;S=[];for(P in d[B])this.terminals_[P]&&2<P&&S.push("'"+
this.terminals_[P]+"'");Q=n.showPosition?"Parse error on line "+(g+1)+":\n"+n.showPosition()+"\nExpecting "+S.join(", ")+", got '"+(this.terminals_[u]||u)+"'":"Parse error on line "+(g+1)+": Unexpected "+(1==u?"end of input":"'"+(this.terminals_[u]||u)+"'");this.parseError(Q,{text:n.match,token:this.terminals_[u]||u,line:n.yylineno,loc:q,expected:S})}if(M[0]instanceof Array&&1<M.length)throw Error("Parse Error: multiple actions possible at state: "+B+", token: "+u);switch(M[0]){case 1:a.push(u);c.push(n.yytext);
e.push(n.yylloc);a.push(M[1]);u=null;w?(u=w,w=null):(h=n.yyleng,f=n.yytext,g=n.yylineno,q=n.yylloc,0<m&&m--);break;case 2:S=this.productions_[M[1]][1];V.$=c[c.length-S];V._$={first_line:e[e.length-(S||1)].first_line,last_line:e[e.length-1].last_line,first_column:e[e.length-(S||1)].first_column,last_column:e[e.length-1].last_column};v&&(V._$.range=[e[e.length-(S||1)].range[0],e[e.length-1].range[1]]);B=this.performAction.apply(V,[f,h,g,p,M[1],c,e].concat(l));if("undefined"!==typeof B)return B;S&&(a=
a.slice(0,-2*S),c=c.slice(0,-1*S),e=e.slice(0,-1*S));a.push(this.productions_[M[1]][0]);c.push(V.$);e.push(V._$);M=d[a[a.length-2]][a[a.length-1]];a.push(M);break;case 3:return!0}}},checkStrict:function(b,a,c){var e=c+"\n"+"-".repeat(a.first_column)+"^",d=["'LPAREN'","'VARIABLE'","'TRUE'","'FALSE'"],e="Parse error on line "+a.first_line+":\n"+e+"\nExpecting "+d.join(", ")+" got '"+c[a.first_column]+"'";this.yy.strictMode&&!b.checkParens()&&this.parseError(e,{text:c,token:b.operator,line:a.first_line,
...
b.operator}}(this))?a||this.clone(!0).flatten():!a&&this};c.prototype.distributivity=function(b,a){var e,d,f,g,p,v;null==b&&(b=!1);null==a&&(a=!1);return!b&&this.junctionOp()&&-1!==(d=this.terms.findIndex(function(b){return function(a){return a.junctionOp()&&a.operator!==b.operator}}(this)))?(e=this.terms[d],v=CTATLogicTreeNode.removeIndex(this.terms,d),a||new c(e.operator,e.terms.map(function(b){return function(a){return new c(b.operator,v.concat([a]))}}(this)))):b&&this.junctionOp()&&this.terms.every(function(b){return function(a){return a.junctionOp()&&
...
this.evaluate()%2};c.prototype.set=function(a,c){this.exp=1;this.value=Math.abs(a);this.sign=Math.sign(a);return this.precision=c||void 0};return c}(CTATChemTreeNode);"undefined"!==typeof module&&null!==module?module.exports=a:this.CTATChemConstantNode=a}).call(this);var CTATChemGrammar=function(){function a(){this.yy={}}var g=function(a,b,c,d){c=c||{};for(d=a.length;d--;c[a[d]]=b);return c},f=[1,6],d=[1,7],c=[1,11],b=[1,12],e=[1,13],h=[1,14],l=[1,15],m=[1,23],n=[1,24],p=[5,7,8,9,10,11,12,13,15,30],v=[1,25],q=[1,26],u=[1,29],w=[1,30],B=[5,7,8,9,10,11,12,13,15,16,18,21,22,28,29,30,31,32,33],y=[1,34],C=[5,7,8,9,10,11,12,13,15,16,18,21,22,25,28,29,30,31,32,33],A=[1,37],r=[1,38],D=[5,7,8,9,10,11,12,13,15,16,18,21,22,25,27,28,29,30,31,32,33],g={trace:function(){},
...
d,!0)};a.prototype.polyTermsEqual=function(f,d){return this.parser.parse(f).simplify(a.partial).equals(this.parser.parse(d).simplify(a.partial))};a.prototype.algebraicMatches=function(a,d){return this.chemEquivalent(a,d,!0)};a.prototype.expressionMatches=a.prototype.algebraicMatches;a.prototype.chemGetQuadraticCoefficients=function(a,d){var c,b,e,f,g,m,n,p,v,q,u,w;c=d?this.chemSimplify(a,!1,!0):a;b=this.chemParse(c);c=null;q=[];w=null;"EQUAL"===b.operator?"PLUS"===b.left.operator&&"CONST"===b.right.operator&&
0===b.right.value?c=b.left:"PLUS"===b.right.operator&&"CONST"===b.left.operator&&0===b.left.value&&(c=b.right):"PLUS"===b.operator&&(c=b);if(c&&1<c.terms.length&&4>c.terms.length){b=function(a){var b,c,d,e;c=e=b=null;d=1;"TIMES"===a.operator&&2===a.factors.length?(a.factors.forEach(function(b){return function(b,d){if("EXP"===b.operator)return e=b,c=a.factors[0===d?1:0]}}(this)),d=a.sign):"EXP"===a.operator&&(e=a);!e||"VAR"!==e.base.operator||2!==e.exponent.value||w&&e.base.variable!==w||((w||(w=e.base.variable),
!c||"CONST"!==c.operator&&"UMINUS"!==c.operator)?c||(b=a.sign):b=c.evaluate()*d);return b};e=function(a){var b,c,d;c=d=b=null;"TIMES"===a.operator&&2===a.factors.length?a.factors.forEach(function(b){return function(b,e){if("VAR"===b.operator&&(!w||b.variable===w))return w||(w=b.variable),d=b,c=a.factors[0===e?1:0]}}(this)):"VAR"!==a.operator||w&&a.variable!==w||(w||(w=a.variable),d=a);d&&(c&&"CONST"===c.operator?b=c.evaluate()*a.sign:c||(b=a.sign));return b};f=function(a){var b;b=null;"CONST"===a.operator&&
(b=a.evaluate());return b};b={a:b,b:e,c:f};m=["a","b","c"];for(f=g=0;3>g;f=++g)if(c.terms[f]){u=v=null;e=n=0;for(p=m.length;0<=p?n<p:n>p;e=0<=p?++n:--n)if(b[m[e]]&&(v=b[m[e]](c.terms[f]))){u=e;break}if(null===v)return null;q[u]=v;delete b[m[u]]}if(!q[0]||!q[1])return null;q[2]||(q[2]=0);return q}};a.prototype.chemSolveQuadratic=function(a,d,c){var b;b=Math.pow(d,2)-4*a*c;c=[];0===b?c.push(""+-d/(2*a)):0<b?(b=Math.sqrt(b),c.push(""+(-d+b)/(2*a)),c.push(""+(-d-b)/(2*a))):(b=Math.sqrt(Math.abs(b)),a*=
2,b/=a,d=-d/a,c.push(d+"+"+b+"i"),c.push(d+"-"+b+"i"));return c};a.prototype.chemGetVariables=function(a){var d,c;a=this.chemParse(a).getVariables();c=[];d={};a.forEach(function(a){return function(a){if(!d[a])return c.push(a),d[a]=!0}}(this));return c};a.prototype.chemSetVariable=function(a,d,c){a=this.chemParse(a);if("VAR"===a.operator)return a.variable===d?this.chemParse(c):a;a.setVariable(d,c,this.chemParse.bind(this,c));return a};a.prototype.chemSetDecimalPrecision=function(f){return f&&"number"===
...
b){return function(){var d;d=1<=arguments.length?c.call(arguments,0):[];return a.apply(b,d)}}(CTATFormulaActions[b],CTATFormulaActions))}a.prototype.evaluate=function(a,e,m,n){var h,l,q,u,w,B,y,C,A,r,D,z;try{C="undefined"!==typeof window&&null!==window?window:global;h=function(){var a;a=[];for(u in C)a.push(u);return a}().concat(["selection","action","input"]);A=a.split(d);l=0;for(w=A.length;l<w;l++)for(y=A[l],D=null!=(r=y.match(g))?r:[],q=0,B=D.length;q<B;q++)u=D[q],0>b.call(f,u)&&0>b.call(h,u)&&
0>b.call(this.keys,u)&&CTATFormulaFunctions.assign(u,void 0);for(u in z=this.variableTable.getTable())C[u]=z[u];return function(a,b,c){c.prototype=a.prototype;c=new c;a=a.apply(c,b);return Object(a)===a?a:c}(Function,["selection","action","input"].concat(c.call(this.keys),["return "+a.trim()]),function(){}).apply(C,[e,m,n].concat(c.call(this.values)))}catch(F){return console.log(F),null}finally{for(u in C)null!=u&&0>b.call(h,u)&&(z[u]=C[u],delete C[u])}};a.prototype.interpolateSplitPattern=/<%=|%>/;
...
function(){return e};this.setTransactionID=function(a){e=a};this.getXMLString=function(a){if(messageObj.xml)return messageObj.xml;if(XMLSerializer)return(new XMLSerializer).serializeToString(messageObj);alert("ERROR: Extremely old browser");return""};this.getTutorSAI=function(a,b){return D.getMatcher().getTutorSAI(a,b,D.getActionType())};this.getEvaluatedInput=function(a,b){return D.getMatcher().getEvaluatedInput(a,b)};this.setDepth=function(a){c=a};this.getMaxTraversals=function(){return n};this.getMaxTraversalsStr=
function(){return C};this.isDone=function(){var a=String(D.getDefaultSAI().getSelection()).toLowerCase(),b=String(D.getDefaultSAI().getAction()).toLowerCase(),a=CTATMsgType.DONE.toLowerCase()==a&&CTATMsgType.BUTTON_PRESSED.toLowerCase()==b;D.ctatdebug("CTATExampleTracerLink.isDone() returns "+a);return a};this.interpolateHints=function(a){D.ctatdebug("CTATExampleTracerLink --\x3e interpolateHints("+a+")");var b=[];if(null===q||"undefined"===typeof q||0===q.length)return b;null==a&&(a=new CTATVariableTable);
var c=new CTATFormulaParser(a);q.forEach(function(a){if(!(1>String(a).trim().length)){var d=D.getDefaultSAI().getSelection(),e=D.getDefaultSAI().getAction(),f=CTATVariableTable.standardizeType(D.getDefaultSAI().getInput());D.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate("+a+", "+d+", "+e+", "+f+")");a=c.interpolate(a,d,e,f);D.ctatdebug("CTATExampleTracerLink.interpolateHints() calling fp.interpolate() returns "+a);b.push(a)}});D.ctatdebug("CTATExampleTracerLink --\x3e out of interpolateHints "+
b);return b};this.getHints=function(){D.ctatdebug("CTATExampleTracerLink --\x3e in getHints");var a=[];D.interpolateHints(null).forEach(function(b){D.ctatdebug("CTATExampleTracerLink --\x3e in getHints loop");b.toString()!=="".toString()&&a.push(b)});D.ctatdebug("CTATExampleTracerLink --\x3e out of getHints");return a};this.getAllNonEmptyHints=function(){var a=[];q.forEach(function(b){b.trim().toString()!=="".toString()&&a.push(b)});return a};this.isTraversable=function(){return 1>D.getMaxTraversals()?
!1:CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()==D.getActionType().toString().toUpperCase()||CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()==D.getActionType().toString().toUpperCase()?!0:!1};this.replaceInput=function(){return CTATExampleTracerLink.CORRECT_ACTION.toString().toUpperCase()!==D.getActionType().toString().toUpperCase()&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString().toUpperCase()!==D.getActionType().toString().toUpperCase()?!1:D.getMatcher().replaceInput()};
this.evaluateReplacement=function(a,b,c){return D.getMatcher().evaluateReplacement(a,b,c)};this.getActor=function(){return D.getMatcher().getActor()};this.getDefaultSAI=function(){D.ctatdebug(D.toString()+".getSAI(): "+(m?m.getDefaultSAI():"(matcher null)"));return m.getDefaultSAI()};this.getActionType=function(){return v};this.getMinTraversals=function(){return p};this.getMinTraversalsStr=function(){return y};this.getIsPreferredLink=function(){return u};this.getAllHints=function(){return q};this.setMatcher=
function(a){m=a};this.addHint=function(a){null!==a&&"undefined"!==typeof a&&a.toString()!=="".toString()&&q.push(a)};this.setSelection=function(a){D.getMatcher().setDefaultSelection(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setAction=function(a){D.getMatcher().setDefaultAction(null===a[0]||"undefined"===typeof a[0]?"":a[0].toString())};this.setActionType=function(a){if(null===a||"undefined"===typeof a||a.toString()!==CTATExampleTracerLink.CORRECT_ACTION.toString()&&a.toString()!==
...
a};this.setMinTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)y="1",p=1;else try{y=a,p=parseInt(a.trim()),isNaN(p)&&(p=1)}catch(F){p=1}};this.setMaxTraversalsStr=function(a){if(null===a||"undefined"===typeof a||1>a.length)C=y,n=p;else try{C=a,n=parseInt(a.trim()),isNaN(n)&&(n=1)}catch(F){n=p}};this.setUniqueID=function(a){d=a};this.addSkillName=function(a){D.ctatdebug("ETLink["+d+"].addSkillName("+a+")");if("unnamed"!==a){if(null===r||"undefined"===typeof r)r=[];-1<r.indexOf(a)||
(r.push(a),D.ctatdebug("ETLink.addSkillName() return with skillNames "+r))}};this.getSkillNames=function(){if(null===r||"undefined"===typeof r)r=[];return r};this.isTutorPerformed=function(a){if(CTATExampleTracerLink.CORRECT_ACTION.toUpperCase()!==D.getActionType().toUpperCase())return!1;var b=D.getMatcher();if(null===b||"undefined"===typeof b||null!==a&&"undefined"!==typeof a&&a!==b.isLinkTriggered())return!1;a=D.getActor();return CTATMatcher.isTutorActor(a,!0)?!0:!1};this.setIsPreferredLink=function(a){D.ctatdebug("ETLink.setIsPreferredLink() was "+
u+", now "+a);u=a};this.setVisualData=function(a){A=a};this.getVisualData=function(){return A}};
...
f.getUniqueID());ctatdebug("CTATExampleTracerLinkComparator --\x3e in compare l2.getUniqueID(): "+d.getUniqueID());return f.getUniqueID()<d.getUniqueID()?-1:1}};CTATExampleTracerLinkComparator.prototype=Object.create(CTATBase.prototype);CTATExampleTracerLinkComparator.prototype.constructor=CTATExampleTracerLinkComparator;"undefined"!==typeof module&&(module.exports=CTATExampleTracerLinkComparator);var CTATExampleTracerEvent=function(a,g,f){CTATBase.call(this,"CTATExampleTracerEvent",g?g.toString():"null");var d="",c=!1,b=CTATExampleTracerLink.NO_MODEL,e=!1,h=null,l=null,m="student",n=null,p=null,v="",q=null,u="",w=null,B=null,y=null,C=null,A=[],r=!1,D=null,z=null,F=this,H=null,J=[],x=[],G={};this.getMsgToRestore=function(){return H};this.setMsgToRestore=function(a){H=a};this.getActor=function(){return m};this.setActor=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e setActor("+a+")");
m=a};this.getStudentSAI=function(){F.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type "+typeof h+", value "+h);return h};this.setStudentSAI=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI("+a+")");null!==a&&"undefined"!==typeof a&&(h=a);F.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI")};this.getPreloadedLinkMatches=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");return w};this.setTutorSAI=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
null!==a&&"undefined"!==typeof a&&(l=a);F.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI")};this.setNumberOfInterpretations=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( "+a+" )")};this.getTransactionID=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning "+d);return d};this.setTransactionID=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( "+a+" )");d=a};this.setDoneStepFailed=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( "+
a+" )");c=a};this.setHintRequest=function(a){e=a};this.getHintRequest=function(){return e};this.setResult=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( "+a+" )");b=a};this.isBuggyResult=function(){return b.toString()===CTATExampleTracerLink.BUGGY_ACTION||b.toString()===CTATExampleTracerLink.FIREABLE_BUGGY_ACTION};this.isSolverResult=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");return!1};this.getResult=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning "+
b);return b};this.setReportableLink=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink("+a+")");n=a};this.setReportableInterpretation=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation("+a+")");p=a};this.setStepID=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID("+a+")");v=a?a.toString():""};this.setReportableVariableTable=function(a){y=a.clone()};this.setSuccessOrBuggyMsg=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg("+
a+")");C=a};this.setReportableHints=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints("+a+")");A=Array.isArray(a)&&0<a.length?a:[]};this.getWantReportableHints=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning "+r);return r};this.setOutOfOrder=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder("+a+")");q=a};this.isOutOfOrder=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning "+
q);return q};this.setTraceOutcome=function(a){u=a};this.getTraceOutcome=function(){return u};this.setEvaluatedInput=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput("+a+")");if(null===B||"undefined"===typeof B)B=[];B.push(a)};this.addPreloadedLinkMatch=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch("+a+")");if(null===w||"undefined"===typeof w)w=[];w.push(a)};this.setInterpolatedSAI=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI("+
a+")");a&&(D=a)};this.getInterpolatedSAI=function(){return D?D:F.getStudentSAI()};this.setInterpolatedHints=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints("+a+")");z&&(z.length=0);a&&(z=a.slice(0));F.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints")};this.setWantReportableHints=function(a){F.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints("+a+")");r=a};this.setAssociatedRules=function(a){J=a instanceof Array?a:a instanceof String?
[a]:[]};this.setAssociatedSkills=function(a){x=a instanceof Array?a:a instanceof String?[a]:[]};this.setCustomFields=function(a){G=a instanceof Object?a:{}};this.getSuccessOrBuggyMsg=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning "+C);return C};this.getReportableHints=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning "+A);return A};this.getReportableLink=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning "+
n);return n};this.getReportableVariableTable=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning "+y);return y};this.getReportableInterpretation=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning "+p);return p};this.getStepID=function(){F.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning "+v);return v};this.getTutorSelection=function(){return null===l||"undefined"===typeof l?null:l.getSelectionArray()};
this.getTutorAction=function(){return null===l||"undefined"===typeof l?null:l.getActionArray()};this.getTutorInput=function(){return null!==B&&"undefined"!==typeof B?F.getEvaluatedInputArray():null!==l&&"undefined"!==typeof l?l.getInputArray():null};this.getEvaluatedInputArray=function(){return B};this.toString=function(){var a;a="["+F.getResult();null!==F.getStudentSAI()&&"undefined"!==typeof F.getStudentSAI()&&(a+=", StudentSAI "+F.getStudentSAI());null!==F.getReportableLink()&&"undefined"!==typeof F.getReportableLink()&&
(a+=", reportableLink "+F.getReportableLink());!0===F.isDoneStepFailed()&&(a+=", doneStepFailed");null!==F.getTutorSAI()&&"undefined"!==typeof F.getTutorSAI()&&(a+=", TutorSAI "+F.getTutorSAI());return a+"]"};this.isDoneStepFailed=function(){return c};this.getTutorSAI=function(){return l};this.getAssociatedRules=function(){return J};this.getAssociatedSkills=function(){return x};this.getCustomFields=function(){return G};this.setStudentSAI(g);this.setActor(f)};CTATExampleTracerEvent.prototype=Object.create(CTATBase.prototype);
...
b.getVariableTable(),a.getStudentSAI())),b==e&&(x.ctatdebug('ETT.finishEvaluate() successOrBuggyMsg "'+c+'"'),a.setSuccessOrBuggyMsg(c)))});if(b){D.push(a.getStudentSAI());d!=e.getLastMatchedLink()&&(e.addLink(d),a.setResult(d.getActionType()),a.setTraceOutcome(d.getActionType()));if(c.toString()===CTATExampleTracerLink.CORRECT_ACTION.toString()||c.toString()===CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()){x.ctatdebug("In evaluate -- in first branch doUpdate()");g.forEach(function(a){a.getLastMatchedLink().getType().toString()===
CTATExampleTracerLink.BUGGY_ACTION.toString()&&(x.ctatdebug("In evaluate -- deleting an incorrect interp"),g["delete"](a))});x.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size "+g.size);0<g.size&&(v(g),H=e);for(var h in r)r.hasOwnProperty(h)&&delete r[h];x.ctatdebug("In evaluate -- out of DoUpdate if branch")}else{x.ctatdebug("In evaluate -- in else branch of doUpdate");a.setNumberOfInterpretations(0);for(var l in r)r.hasOwnProperty(l)&&delete r[l];g.forEach(function(a){r[a.getLastMatchedLink().getUniqueID()]=
a.getLastMatchedLink()})}c.toString()===CTATExampleTracerLink.BUGGY_ACTION.toString()&&D.splice(D.length-1,1)}a.isSolverResult()||(x.ctatdebug("In evaluate inside the NOT solver result if condition "+c),a.setResult(c),a.setTraceOutcome(c));x.ctatdebug("In evaluate out the solver result if condition");a.setReportableLink(d);a.setAssociatedSkills(d.getSkillNames());a.setStepID(d.getUniqueID());a.setReportableInterpretation(e);a.setInterpolatedSAI(e.getInterpolatedSAI());a.setReportableVariableTable(e.getVariableTable());
...
" set");var r=c(a,b,e,f);if(null!==r)return r;if(0===f.size)return x.ctatdebug("In evaluate -- if condition no new interpretations"),0!==g.length&&!0===g[0].isDone()&&a.setDoneStepFailed(!0),a.setResult(CTATExampleTracerLink.NO_MODEL),a.setTraceOutcome(CTATExampleTracerLink.NO_MODEL),x.ctatdebug("In evaluate -- if condition no new interpretations returning false"),!1;r=p(f);x.ctatdebug("In evaluate -- just found bestInterp");var q=null;!0===a.isSolverResult()?(x.ctatdebug("In evaluate -- in if branch of isSolverResult"),
q=CTATExampleTracerLink.NO_MODEL.toString().toUpperCase()===a.getResult().toString().toUpperCase()?CTATExampleTracerLink.BUGGY_ACTION.toString():a.getResult().toString()):(x.ctatdebug("In evaluate -- in else branch of isSolverResult"),q=r.getLastMatchedLink().getType());return d(a,e,q,null,r,f)}function h(a,b,c,d,e){var f=b&&c.isCorrect();if("undefined"!=typeof J[c.getUniqueID()]||c.matchesSAIforHint(a,d,null,e))J[c.getUniqueID()]=f;x.ctatdebug("updateMatchedSelections(): link "+c.getUniqueID()+", matched "+
...
A.length=0;0===a.size?x.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations"):(x.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: "+a.size),a.forEach(function(a){A.push(a)}),H=null,x.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"))}function q(){x.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");var a=z.findAllPaths();x.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths "+a.size);a.forEach(function(a){x.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");
...
var C=!1,A=null,r=null,D=null,z=a,F=null;CTATExampleTracerTracer_count++;var H=null,J={},x=this;this.getModelInitialized=function(){return C};this.setModelInitialized=function(a){C=a};this.goToDone=function(a,b,c){return(a=a.getPathToDone(b))?c.traceLinks(a.getSortedLinks()):!1};this.getMatchedSelections=function(){return J};this.getLastResult=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");return F};this.resetTracer=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");
null===A||"undefined"===typeof A?(x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"),A=[]):(x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"),A.length=0);var a=new CTATExampleTracerInterpretation(q());x.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp "+a);null!==g&&"undefined"!==typeof g&&(x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"),a.setVariableTable(g));
A.push(a);H=a;if(null===r||"undefined"===typeof r)x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"),r={};else{x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");for(var b in r)r.hasOwnProperty(b)&&delete r[b]}J={};null===D||"undefined"===typeof D?(x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"),D=[]):(x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"),
D.length=0);x.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");z.getLinks().forEach(function(a){a.getMatcher().resetMatcher()});x.ctatdebug("CTATExampleTracerTracer --\x3e out of resetTracer")};this.evaluate=function(a){x.ctatdebug("CTATExampleTracerTracer --\x3e in public evaluate(), calling private _evaluate; given event "+a);return e(a,!1,!0)};this.nonEmptyHints=function(a,b){x.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints");
...
function(a,b){x.ctatdebug("CTATExampleTracerTracer --\x3e in doHint");var c=x.matchForHint(a);Array.isArray(b)&&(x.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"),b.push(a));x.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: "+c);return c};this.getBestInterpretation=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");if(null===H||"undefined"===typeof H)x.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"),
H=p(x.getInterpretationsInternal());x.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation "+(null===H||void 0===H));return H};this.getInterpretationsInternal=function(){x.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");return A};this.toString=function(){var a="TracerState\n";null===A?a+="(no interpretations)\n":A.forEach(function(b){a+=b.toString()+"\n"});return a};this.addInterfaceVariablesFromEvent=function(a){if(a){var b=a.getTutorSelection();a=a.getTutorInput();
x.addInterfaceVariables(b,a)}};this.addInterfaceVariables=function(a,b){x.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables("+a+", "+b+")");if(a&&b){var c=a.length;c>b.length&&(c=b.length);for(var d=0;d<c;d++)a[d]&&(g.put(a[d],CTATVariableTable.standardizeType(b[d])),g.put(CTATVariableTable.nameAsString(a[d]),CTATVariableTable.valueAsString(b[d])));x.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT "+g);A&&A.forEach(function(d){if(d=d.getVariableTable()){for(var e=0;e<
...
-1<c.indexOf(m)||m instanceof CTATLinkGroup&&!0===p(m,c))?!1:!0}function h(a,b){var c=Number.MAX_VALUE,d=null;I.getGroupLinks(a).forEach(function(a){a.getDepth()<c&&!0===b.has(a)&&(c=a.getDepth(),d=a)});return d}function l(a,b){for(var c=0,d=0;d<a.length;d++)b===a[d]&&c++;E.ctatdebug("CTATETGraph.getTraversalCount("+b+"): "+c);return c}function m(a,b,c){var d=!1,e=!0,f=!1;(new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b){if(!1!==e&&!0!==f){if(!1===d)!0===I.isLinkInGroup(a,b)&&(d=
...
0;a<C.length;a++)C[a].clearInLinks();var b=E.getStartNode();null!==b&&"undefined"!==typeof b&&null!==b.getOutLinks()&&"undefined"!==typeof b.getOutLinks()&&(a=0,b.getOutLinks().forEach(function(b){u(b,a++)}))}function u(a,b){ctatdebug("updateInLinkSubGraph("+a+", "+b+")");var c=E.getNode(a.getNextNode());if(null!==c&&"undefined"!==typeof c){c.addInLink(a);var d=0;c.getOutLinks().forEach(function(a){u(a,d++)})}}function w(a){var b=E.getNode(a.getPrevNode());if(null!==b&&"undefined"!==typeof b){var c=
-1;b.getInLinks().forEach(function(a){-1===a.getDepth()&&w(a);a.getDepth()>c&&(c=a.getDepth())});a.setDepth(c+1)}}function B(a){var b=E.getGroupModel(),c=b.getTopLevelGroup(),d="",e=c.getSubgroups(),d=a+'<EdgesGroups ordered="'+c.getIsOrdered()+'">\n';e.forEach(function(c){d+=c.toXML(a+"    ",b)});return d+=a+"</EdgesGroups>\n"}CTATBase.call(this,"CTATExampleTracerGraph","visualdata");var y=null,C=null,A=null,r=null,D=null,z=null,F="",H=[],J=new Set,x=new Set,G=null,I=null,R=!0,O=!0,L=CTATMsgType.SHOW_ALL_FEEDBACK,
E=this;this.getAllNodes=function(){var a=[],b;for(b in r)a.push(r[b]);return a};this.getFeedbackPolicy=function(){return L};this.setFeedbackPolicy=function(a){E.ctatdebug("Graph.setFeedbackPolicy("+a+") old policy "+L);L="false"===a?CTATMsgType.SHOW_ALL_FEEDBACK:"true"===a?CTATMsgType.HIDE_ALL_FEEDBACK:a};this.hideButRequireSteps=function(){return L==CTATMsgType.HIDE_BUT_COMPLETE};this.hideAllFeedback=function(){return L==CTATMsgType.HIDE_ALL_FEEDBACK};this.relaxOrderConstraints=function(){return E.hideAllFeedback()||
E.hideButRequireSteps()||L==CTATMsgType.DELAY_FEEDBACK};this.exitOnIncorrectDone=function(){switch(L){case CTATMsgType.HIDE_ALL_FEEDBACK:case CTATMsgType.HIDE_BUT_ENFORCE:return!0;default:return!1}};this.getDefaultBuggyMsg=function(){return I.getTopLevelGroup()?I.getTopLevelGroup().getDefaultBuggyMsg():null};this.getLinks=function(){E.ctatdebug("CTATExampleTracerGraph --\x3e in getLinks");return A};this.addLink=function(a,b){E.ctatdebug("CTATExampleTracerGraph --\x3e in addLink");A.push(a);a.isDone()?
x.add(a):x["delete"](a);null===b||"undefined"===typeof b?I.addLinkToGroup(I.getTopLevelGroup(),a):I.addLinkToGroup(b,a);E.ctatdebug("CTATExampleTracerGraph --\x3e out of addLink")};this.addNode=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in addNode");C.push(a);r[a.getNodeID()]=a;E.ctatdebug("CTATExampleTracerGraph --\x3e out of addNode")};this.findAllPaths=function(){ctatdebug("CTATExampleTracerGraph --\x3e in findAllPaths "+E.getStartNode().getNodeID());return E.findPathsFromNode(E.getStartNode())};
this.pathToLinkIsSubset=function(a,b){var c=E.getNode(a.getPrevNode());E.ctatdebug("pathToLinkIsSubset("+a+") sourceNode "+c.getNodeID());if(0<a.getMinTraversals()&&"undefined"==typeof b[a.getUniqueID()])return!1;if(c==E.getStartNode())return!0;for(c=c.getInLinks().values();!(c=c.next()).done;)return E.pathToLinkIsSubset(c.value,b);return!1};this.observesOrderingConstraints=function(a,b,e,f){E.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints");null!==f&&"undefined"!==typeof f&&
(E.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints initializing out of order false"),f.setOutOfOrder(!1));if(null===e||"undefined"===typeof e||0===e.size||null===b||"undefined"===typeof b)return E.ctatdebug("CTATExampleTracerGraph --\x3e returning first true observesOrderingConstraints"),!0;if(b.isDone()&&E.exitOnIncorrectDone())return E.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning true for doneStep && exitOnIncorrectDone"),!0;if(!0===e.has(b)&&
!0===d(a,b,e)&&!0===c(a,b,e))return E.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning isOrderOK true && isisReenteringOK() true"),!0;null!==f&&"undefined"!==typeof f&&(E.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints setting out of order true"),f.setOutOfOrder(!0));E.ctatdebug("CTATExampleTracerGraph --\x3e returning false observesOrderingConstraints");return!1};this.isIncorrectLinkOK=function(a,b,c,e){E.ctatdebug("CTATExampleTracerGraph --\x3e in isIncorrectLinkOK");
var f=!1,g=null,h=!0,l=!1;E.getNode(b.getPrevNode()).getOutLinks().forEach(function(b){!0!==l&&!1!==h&&b.getType().toString()!==CTATExampleTracerLink.BUGGY_ACTION.toString()&&!0===c.has(b)&&(f=!0,!1===d(a,b,c)?h=!1:(g=b,l=!0))});if(!1===h||null===g||"undefined"===typeof g)return!1;if(!1===f)return E.ctatdebug("isIncorrectLinkOK(): no siblings of link in path"),!1;if(!0===f&&(b=E.getSmallestContainingGroup(b),!0===I.isLinkInGroup(b,g)&&!1===I.isGroupOrdered(b)&&!0===m(b,c,e)))return!1;E.ctatdebug("CTATExampleTracerGraph --\x3e out of isIncorrectLinkOK");
return!0};this.toXML=function(a){var b=this.getLinks(),c=E.getGroupModel().getTopLevelGroup().getIsOrdered(),d;d='<?xml version="1.0" standalone="yes"?>\n<stateGraph firstCheckAllStates="true" caseInsensitive="'+E.getCaseInsensitive();d=d+('" unordered="'+!c)+('" lockWidget="'+E.getLockWidget());d+='" hintPolicy="'+E.getHintPolicy();d=d+'" version="4.0'+('" suppressStudentFeedback="'+E.isFeedbackSuppressed());d+='" highlightRightSelection="'+E.isHighlightRightSelection();d+='" confirmDone="'+a.getConfirmDone();
d+='" startStateNodeName="'+E.getStudentStartStateNodeName();d+='" tutorType="Example-tracing Tutor">\n';for(var c=this.getStartStateMsgs(),e="    <startNodeMessages>\n",f=0;f<c.length;f++)e+="        "+c[f].outerHTML+"\n";d+=e+"    </startNodeMessages>\n";for(c=0;c<C.length;c++)d+=C[c].toXML("    ")+"\n";for(c=0;c<b.length;c++)d+=b[c].toXML("    ")+"\n";b=d;a=a.getGraphSkills();d="";for(c=0;c<a.length;c++)d+="    <productionRule>\n",d+="        <ruleName>"+CTATExampleTracerSkill.getName(a[c].getSkillName())+
"</ruleName>\n",d+="        <productionSet>"+a[c].getCategory()+"</productionSet>\n",d+="        <label>"+a[c].getLabel()+"</label>\n",d+="        <description>"+a[c].getDescription()+"</description>\n",d+="    </productionRule>\n";d=b+d+B("    ");return d+="</stateGraph>\n"};this.addGroup=function(a,b,c){};this.getCaseInsensitive=function(){return O};this.setCaseInsensitive=function(a){O=a};this.getLockWidget=function(){return R};this.setLockWidget=function(a){R=a};this.getHintPolicy=function(){return hintPolicy};
this.setHintPolicy=function(a){hintPolicy=CTATHintPolicyEnum.lookup(a)};this.isFeedbackSuppressed=function(){return feedbackSuppressed};this.setFeedbackSuppressed=function(a){feedbackSuppressed="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;E.ctatdebug("setFeedbackSuppressed("+a+"): "+feedbackSuppressed);problemSummary&&problemSummary.setCountOnlyLastResults(feedbackSuppressed)};
this.isHighlightRightSelection=function(){return highlightRightSelection};this.setHighlightRightSelection=function(a){highlightRightSelection=a};this.getStartStateMsgs=function(){return H};this.setStartStateMsgs=function(a){H=a};this.getNode=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in getNode("+a+") returning "+r[a]);return r[a]};this.findNode=function(a){if(a){a=a.toLowerCase();for(var b in r)if(r[b].getNodeName().toLowerCase()==a)return E.getNode(b);if("start"==a)return E.getStudentStartsHereNode()||
E.getStartNode()}return null};this.findPathsFromNode=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in findPathsFromNode outlinks "+a.getOutLinks().size);var b=new Set;if(!a||0===a.getOutLinks().size)return b.add(new CTATExampleTracerPath(null)),b;E.ctatdebug("CTATExampleTracerGraph --\x3e before forEach ");a.getOutLinks().forEach(function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in forEach "+a.getType().toString());if(a.getType().toString()!=CTATExampleTracerLink.BUGGY_ACTION.toString()){var c=
E.findPathsFromNode(E.getNode(a.getNextNode()));E.ctatdebug("findPathsFromNode childPaths.size "+c.size);c.forEach(function(c){E.ctatdebug("findPathsFromNode childPath.size "+c.size+", outLink "+a);c.addLink(a);b.add(c)})}},a);0===b.size&&b.add(new CTATExampleTracerPath(null));E.ctatdebug("CTATExampleTracerGraph --\x3e out of findPathsFromNode "+b.size);return b};this.getDoneStates=function(){return J};this.checkForDoneState=function(a){if(a.isDone()&&a.isTraversable()){var b=E.getNode(a.getNextNode());
...
D);return D};this.getLinkByID=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in getLinkByID");for(var b=0;b<A.length;b++)if(A[b].getUniqueID()===a)return A[b];E.ctatdebug("CTATExampleTracerGraph --\x3e out of getLinkByID");return null};this.setStartNode=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in setStartNode("+a+")");D=a};this.getStudentStartsHereNode=function(){return null!=z?z:getStartNode()};this.setStudentStartsHereNode=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in setStudentStartsHereNode("+
a+")");z=a};this.setStudentStartStateNodeName=function(a){F=a};this.getStudentStartStateNodeName=function(){return F};this.getExampleTracer=function(){E.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning "+y);return y};this.forDebugging=function(){E.ctatdebug("CTATExampleTracerGraph --\x3e in forDebugging");E.ctatdebug("Nodes in the graph -- ids");C.forEach(function(a){E.ctatdebug(a.getNodeID())});E.ctatdebug("Links in the graph -- ids, from, to");A.forEach(function(a){E.ctatdebug(a)})};
this.getSmallestContainingGroup=function(a){return I.getLowestLevelGroupOfLink(a)};this.redoLinkDepths=function(){q();E.getLinks().forEach(function(a){a.setDepth(-1)});E.getLinks().forEach(function(a){-1===a.getDepth()&&w(a)})};this.getGroupModel=function(){return I};this.setVisualData=function(a){E.ctatdebug("CTATExampleTracerGraph --\x3e in setVisualData");G=a};this.getVisualData=function(){E.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning "+G);return G};this.getDoneLinks=
function(){return x};(function(a,b){E.ctatdebug("CTATExampleTracerGraph --\x3e in initGraph ("+a+" , "+b);A=[];C=[];r={};if(null===I||"undefined"===typeof I)I=new CTATDefaultGroupModel,E.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");I.clear();I.setDefaultReenterable(!b);I.setGroupOrdered(I.getTopLevelGroup(),a);I.setGroupName(I.getTopLevelGroup(),CTATExampleTracerGraph.TOP_LEVEL);y=new CTATExampleTracerTracer(E,f);E.ctatdebug("CTATExampleTracerGraph --\x3e out of initGraph")})(!a,
...
CTATExampleTracerGraph.prototype.constructor=CTATExampleTracerGraph;"undefined"!==typeof module&&(module.exports=CTATExampleTracerGraph);var CTATGraphParser=function(){function a(a){ctatdebug("processEdge()");for(var c=new CTATExampleTracerLink(null,null,null),f=e.getElementChildren(a),h,l,m,p,r,q=a=-1,v=CTATMsgType.DEFAULT_ACTOR,F=!1,H=0;H<f.length;H++){"sourceID"===e.getElementName(f[H])&&(a=parseInt(e.getNodeTextValue(f[H])),c.setPrevNode(a));"destID"===e.getElementName(f[H])&&(q=parseInt(e.getNodeTextValue(f[H])),c.setNextNode(q));if("rule"===e.getElementName(f[H]))for(var J=e.getElementChildren(f[H]),x=0;x<J.length;x++)"text"===
e.getElementName(J[x])&&c.addSkillName(e.getNodeTextValue(J[x]).toString());if("actionLabel"===e.getElementName(f[H]))for(c.setIsPreferredLink("false"!=e.getElementAttr(f[H],"preferPathMark")),c.setMinTraversalsStr(e.getElementAttr(f[H],"minTraversals")),c.setMaxTraversalsStr(e.getElementAttr(f[H],"maxTraversals")),J=e.getElementChildren(f[H]),x=0;x<J.length;x++){"uniqueID"===e.getElementName(J[x])&&(r=e.getNodeTextValue(J[x]),c.setUniqueID(parseInt(e.getNodeTextValue(J[x]))));"message"===e.getElementName(J[x])&&
(p=new CTATMessage(J[x]),c.setDemoMsgObj(p));"actionType"===e.getElementName(J[x])&&c.setActionType(e.getNodeTextValue(J[x]));"buggyMessage"===e.getElementName(J[x])&&c.setBuggyMsg(e.getNodeTextValue(J[x]));"successMessage"===e.getElementName(J[x])&&c.setSuccessMsg(e.getNodeTextValue(J[x]));"hintMessage"===e.getElementName(J[x])&&c.addHint(e.getNodeTextValue(J[x]));if("matchers"===e.getElementName(J[x]))for(var G=e.getElementChildren(J[x]),I=0;I<G.length;I++)"Selection"===e.getElementName(G[I])&&
(h=g(G[I],0)),"Action"===e.getElementName(G[I])&&(l=g(G[I],1)),"Input"===e.getElementName(G[I])&&(m=g(G[I],2)),"Actor"===e.getElementName(G[I])&&(v=e.getNodeTextValue(G[I]),F=(F=e.getElementAttr(G[I],"linkTriggered"))&&"false"!=F.toLowerCase().trim()?!0:!1);if("matcher"===e.getElementName(J[x])){m=J[x];l=p;h=e.getElementAttr(m,"replacementFormula");var R=e.getElementChildren(m),O=G=void 0,L,E=void 0,I=CTATMsgType.DEFAULT_ACTOR;m=new CTATExactMatcher(CTATMatcher.SELECTION,null);v=new CTATExactMatcher(CTATMatcher.ACTION,
null);d.ctatdebug("processMatcher(): nChildren "+R.length+", saiMessage "+l);for(var M=0;M<R.length;M++)"matcherType"===e.getElementName(R[M])&&(L=e.getNodeTextValue(R[M]),"ExactMatcher"===L&&(O=CTATExactMatcher),"RegexMatcher"===L&&(O=CTATRegexMatcher),"AnyMatcher"===L&&(O=CTATAnyMatcher),"RangeMatcher"===L&&(O=CTATRangeMatcher),"WildcardMatcher"===L&&(O=CTATWildcardMatcher),"ExpressionMatcher"===L&&(O=CTATExpressionMatcher),d.ctatdebug("processMatcher(): child "+M+", eltText "+L+", matcher "+O)),
"matcherParameter"===e.getElementName(R[M])&&(L=e.getElementAttr(R[M],"name"),E=e.getNodeTextValue(R[M]),"selection"==L&&m.setParameter(E),"action"==L&&v.setParameter(E),"input"==L&&(G=G?G:new O(CTATMatcher.INPUT,null),G.setParameter(E)),"actor"==L&&(I=E),"minimum"==L&&(G=G?G:new O(CTATMatcher.INPUT,null),G.setParameter(E,"minimum")),"maximum"==L&&(G=G?G:new O(CTATMatcher.INPUT,null),G.setParameter(E,"maximum")),"InputExpression"==L&&(G=G?G:new O(CTATMatcher.INPUT,null),G.setParameter(R[M],L,e)),
"relation"==L&&(G=G?G:new O(CTATMatcher.INPUT,null),G.setParameter(R[M],L,e)),d.ctatdebug("processMatcher(): child "+M+", eltAttrName "+L+", inputMatcher "+G));G||(G=O?new O(CTATMatcher.INPUT,null):new CTATExactMatcher(CTATMatcher.INPUT,null),G.setParameter(E?E:""),"undefined"!=typeof l&&"function"==typeof l.getSAI&&(l=l.getSAI(),m.setSingle(l.getSelection()),v.setSingle(l.getAction()),G.setSingle(l.getInput())));G.setReplacementFormula(h);v=[[m],[v],[G],I];h=v[0];l=v[1];m=v[2];v=v[3]}}}b.getStartNode()&&
q==b.getStartNode().getNodeID()&&console.log("***WARNING*** edge "+r+" destination is graph startNode "+b.getStartNode());r=new CTATVectorMatcher(h,l,m,v);r.setDefaultSAI(p.getSAI());r.setCaseInsensitive(n);r.setLinkTriggered(F);c.setMatcher(r);ctatdebug("GraphParser.processEdge() "+a+"->"+q+", edge "+c);b.getNode(a).addOutLink(c);b.checkForDoneState(c);return c}function g(a,b){d.ctatdebug("processMatchers()");for(var c=e.getElementChildren(a),f=[],g=0;g<c.length;g++)if("matcher"===e.getElementName(c[g])){for(var h=
...
n.length;p++){if("link"===e.getElementName(n[p])){var q=Number(e.getElementAttr(n[p],"id")),v=b[q];if(null!==v||void 0!==v)ctatdebug("Added link ID : "+q),c.add(v)}"group"===e.getElementName(n[p])&&(ctatdebug("encountered a subgroup"),f(n[p],b).forEach(l))}m.addGroup(d,g,c);m.setGroupReenterable(m.getGroupByName(d),h);return c}CTATBase.call(this,"CTATGraphParser","__undefined__");var d=this,c,b,e=new CTATXML,h=null,l=[];new XMLSerializer;var m,n=!0,p=!0,v=[];this.getLockWidget=function(){return p};
...
var C=e.getElementChildren(d),y=e.getElementAttr(d,"suppressStudentFeedback");if(null===y||void 0===y)y=CTATMsgType.SHOW_ALL_FEEDBACK;b.setFeedbackPolicy(y);g.setFeedbackSuppressed(y);y=e.getElementAttr(d,"highlightRightSelection");g.setHighlightRightSelection("false"!=y);var A=e.getElementAttr(d,"confirmDone");g.setConfirmDone("true"===A?!0:"false"===A?!1:b.getFeedbackPolicy()===CTATMsgType.HIDE_ALL_FEEDBACK);g.setHintPolicy(e.getElementAttr(d,"hintPolicy"));g.setOutOfOrderMessage(e.getElementAttr(d,
"outOfOrderMessage"));for(var A=null,r=0;r<C.length;r++)switch(e.getElementName(C[r])){case "startNodeMessages":l=e.getElementChildren(C[r]);b.setStartStateMsgs(l);break;case "node":q++;var D;D=C[r];ctatdebug("processNode("+D+")");var z=e.getElementChildren(D),F=-1;D="";for(var H=[],J=0;J<z.length;J++)switch(e.getElementName(z[J])){case "uniqueID":F=parseInt(e.getNodeTextValue(z[J]));break;case "text":D=e.getNodeTextValue(z[J]);break;case "dimension":for(var x=e.getElementChildren(z[J]),G=0;G<x.length;G++)ctatdebug("grandkids "+
G+", "+x[G]+", "+e.getNodeTextValue(x[G])+", "+parseInt(e.getNodeTextValue(x[G]))),H[G]=parseInt(e.getNodeTextValue(x[G]));ctatdebug("grandkids d "+H)}z=new CTATExampleTracerNode(F,new Set);""!==D&&z.setNodeName(D);2<=H.length&&z.setDimension({x:H[0],y:H[1]});D=z;b.addNode(D);1==q&&(b.setStartNode(D),b.setStudentStartsHereNode(D));D.getNodeName()==b.getStudentStartStateNodeName()&&b.setStudentStartsHereNode(D);break;case "edge":b.addLink(a(C[r]));break;case "EdgesGroups":A=C[r];break;case "productionRule":J=
C[r];ctatdebug("processSkill()");H=D="";F=z=null;J=e.getElementChildren(J);for(x=0;x<J.length;x++)G=e.getElementName(J[x]),"ruleName"==G&&(D=e.getNodeTextValue(J[x]),ctatdebug("ruleName="+D)),"productionSet"==G&&(H=e.getNodeTextValue(J[x]),ctatdebug("productionSet="+H)),"label"==G&&(z=e.getNodeTextValue(J[x]),ctatdebug("label="+z)),"description"==G&&(F=e.getNodeTextValue(J[x]),ctatdebug("description="+F));D&&(J=new CTATExampleTracerSkill(H,D,CTATExampleTracerSkill.DEFAULT_P_GUESS,CTATExampleTracerSkill.DEFAULT_P_KNOWN,
CTATExampleTracerSkill.DEFAULT_P_SLIP,CTATExampleTracerSkill.DEFAULT_P_LEARN,CTATExampleTracerSkill.DEFAULT_HISTORY),null!=z?J.setLabel(z):J.setLabel(D),null!=F?J.setDescription(F):J.setDescription(D+(H?" "+H:"")),v.push(J))}if(A){q=e.getElementAttr(A,"ordered");if(null===q||"undefined"==typeof isordered)q=!u;ctatdebug("parseGraph() value of isOrdered = "+q);ctatdebug("parseGraph() value of isUnordered = "+u);ctatdebug("parseGraph() typeof isOrdered: "+typeof q);ctatdebug("parseGraph()typeof isUnordered: "+
typeof u);C=A;A=q;ctatdebug("processGroup()");m=b.getGroupModel();q=m.createIdToLinkMap();m.setGroupOrdered(m.getTopLevelGroup(),A);ctatdebug("processGroup() name of group: "+m.getGroupName(m.getTopLevelGroup()));ctatdebug("processGroup() group isOrdered?: "+m.isGroupOrdered(m.getTopLevelGroup()));ctatdebug("processGroup() order of group: isOrdered= "+A);ctatdebug("processGroup() order of group: isOrdered typeof= "+typeof A);C=e.getElementChildren(C);for(A=0;A<C.length;A++)switch(e.getElementName(C[A])){case "group":f(C[A],
q);break;case "outOfOrderMessage":m.getTopLevelGroup().setDefaultBuggyMsg(e.getNodeTextValue(C[A]))}b.addGroup(void 0)}q=g.getSkillBarVector(!1,!0);if(!q||1>q.length)ctatdebug("No existing skills. Add skills from BRD."),g.addGraphSkills(v),q=g.getSkillBarVector();h=(new CTATTutorMessageBuilder).createStateGraphMessage(n,u,p,g.isSourceFlash()?b.exitOnIncorrectDone():g.isFeedbackSuppressed(),y,String(g.getConfirmDone()),q);b.redoLinkDepths();c=b.getExampleTracer();c.resetTracer();b.forDebugging();ctatdebug("Graph loaded.");
...
l.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length "+b.length);for(var m=[],v=[],q=0;q<b.length;++q){var u=b[q];if(u.msg){var w=u.msgType,B=u.evt;l.ctatdebug("entering processInterfaceVariables() msgType "+w+", evt "+B);if(w){var y=c?c.getTracer():null;l.ctatdebug("entering processInterfaceVariables() et "+c+", tracer "+y);w=w.toLowerCase();(0===w.indexOf("correct")||0===w.indexOf("interfaceaction"))&&y&&y.addInterfaceVariablesFromEvent(B)}if(!(w=f(u)))if(w=u,B=v,CTATConfiguration.usingFlash()){var C=
y=void 0;if(!(w&&w.sai&&(y=w.sai.getAction())&&(C=CTATSAI.delayedActionRegExp.exec(y)))||3>C.length||1>=C[2])w=!1;else{var A=B.length-1,A=0>A?null:B[A];w.msg=w.msg.replace(y,C[1]);A&&A.timeout==C[2]?A.msgTuples.push(w):B.push({timeout:Number(C[2]),msgTuples:[w]});w=!0}}else w=!1;w||m.push(u.msg)}}l.ctatdebug("flushMessageTank(): msgBundle.length "+m.length+", delayedMsgsBundle.length "+v.length);for(q=0;q<v.length;++q)u=v[q],l.ctatdebug("processDelayedMsgs() delayedMsgs.timeout "+u.timeout+", .msgTuples.length "+
...
SCORMProblemSummary.SESSION_TIME);return g+f+d+a};CTATMsgType.prototype=Object.create(CTATBase.prototype);CTATMsgType.prototype.constructor=SCORMProblemSummary;"undefined"!==typeof module&&(module.exports=SCORMProblemSummary);var CTATExampleTracer=function(){function a(){return"example"===A&&z&&z.getModelInitialized()||"rule"===A&&F&&F.getModelInitialized()}function g(a,c){c?ea|=1<<a:(ea&=-65537>>16-a,b())}function f(a){if(r.isFeedbackSuppressed()){var b=new CTATSAI("hint","SetVisible","false"),b=(new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID",b);a.push(b)}}function d(){return"<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.INTERFACE_REBOOT+"</MessageType></properties></message>"}
function c(a){a.unshift(d());r.ctatdebug("sendStartStateMessageStrings(): "+a.length+" elts, "+T);r.sendBundle(a)}function b(){r.ctatdebug("workTheQueue() working "+ea+", workQueue.length "+Z.length+", restoreQueue.length "+W.length);if(0==ea)for(;0!=(ea=0<Z.length|(0<W.length)<<1);){var a,b=!1;0<W.length?(U=1,a=W.shift(),b=!0):(U=0,a=Z.shift());if(!e(a,b)){r.ctatdebug("workTheQueue() suspending workQueue.length "+Z.length+", restoreQueue.length "+W.length);r.stopWorking(b?1:0);break}r.ctatdebug("workTheQueue() bottom workQueue.length "+
Z.length+", restoreQueue.length "+W.length)}}function e(b,c){r.lastMessageAsString=b;var e=r.lastMessageAsXML=(new CTATXML).parseXML(b),f=r.lastMessage=new CTATMessage(e),g=f.getMessageType();r.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType "+g+")");switch(g){case CTATMsgType.SET_PREFERENCES:g=G;r.ctatdebug("handleSetPreferences ()");V=f.getProperty("problem_name");r.ctatdebug("SetPreferences.problem_name = "+V);f=g.getElementChildren(g.getElementChildren(e)[1]);for(e=0;e<f.length;e++){var h=
g.getElementName(f[e]);r.ctatdebug("SetPreferences eltName "+h);if(h)switch(h.toLowerCase()){case "source_id":P=g.getNodeTextValue(f[e]);break;case "question_file":D=g.getNodeTextValue(f[e]);break;case "skills":r.ctatdebug(" parseSkills("+f[e]+")");for(var h=[],l=G.getElementChildren(f[e]),m=0;m<l.length;m++){var n=G.getElementName(l[m]);if(n&&"skill"==n.toLowerCase()){var q=G.getElementAttr(l[m],"name");if(q&&""!=q.trim()){var n=G.getElementAttr(l[m],"label"),u=G.getElementAttr(l[m],"pSlip"),w=G.getElementAttr(l[m],
"description"),ra=G.getElementAttr(l[m],"pKnown"),x=G.getElementAttr(l[m],"category"),y=G.getElementAttr(l[m],"pLearn"),B=G.getElementAttr(l[m],"pGuess"),C=G.getElementAttr(l[m],"history"),q=new CTATExampleTracerSkill(x,q,B,ra,u,y,C);q.setLabel(n);q.setDescription(w);h.push(q)}}}r.getProblemSummary().setSkills(new CTATSkills(h));break;case "problem_state_status":T.transition(CTATMsgType.SET_PREFERENCES,g.getNodeTextValue(f[e]));Q||(Q=new ProblemStateRestorer(r));r.ctatdebug("SetPreferences problemStateRestorer "+
Q);break;case "curriculum_service_url":CTATConfiguration.set("curriculum_service_url",g.getNodeTextValue(f[e]));break;case "restore_problem_url":Q||(Q=new ProblemStateRestorer(r));r.ctatdebug("SetPreferences problemStateRestorer "+Q);CTATConfiguration.set("restoreProblemUrl",g.getNodeTextValue(f[e]));break;case "session_id":ka=g.getNodeTextValue(f[e]);break;case "authenticity_token":S.setAuthenticityToken(g.getNodeTextValue(f[e]))}}r.ctatdebug("questionFile "+D+", outputStatus "+T+", problemStateRestorer "+
Q);f="undefined"!=typeof sessionStorage&&sessionStorage?sessionStorage.getItem("Go-To-State"):null;null!=f&&(sessionStorage.removeItem("Go-To-State"),f=Number(f),!Number.isSafeInteger(f)||0>=f||(ia=f,T.transition(CTATMsgType.BEGIN_GO_TO_STATE,null)));r.ctatdebug("outputStatus "+T+", problemStateRestorer "+Q);ha.retrieveProblemFile(D,g,r);Q&&Q.retrieveMessages(T);return!1;case CTATMsgType.INTERFACE_IDENTIFICATION:return!0;case CTATMsgType.UNTUTORED_ACTION:return c&&r.sendBundle([b]),g=G,f=f.getTransactionID(),
r.ctatdebug("UntutoredAction ("+b+"), getTransactionID "+f),S.appendToProblemState(b,r.getOutputStatus(),!1),a()&&r.setVariablesFromSAI(e,g),!0;case CTATMsgType.INTERFACE_ACTION:c&&r.sendBundle([b]);r.ctatdebug("Interface action received.");g=f.getTransactionID();if(a())if(r.messageTank=new CTATMessageTank(r),r.ctatdebug("MessageTank "+r.messageTank),r.ctatdebug("InterfaceAction ("+b+"), getTransactionID "+g),h=f.getSelectionArray().slice(0),e=f.getActionArray().slice(0),r.ctatdebug("selectionArray "+
h+", message.getSelectionArray() "+f.getSelectionArray()),h[0]&&"_tutor"==h[0].toLowerCase())r.ctatdebug("handleInterfaceAction tutor cmd SAI "+f.getSAI()+";"),e[0]&&"function"===typeof r[e[0]]&&(g=f.getSAI().getInput(),r[e[0]](g)),g=!0;else if(!h[0]||"hint"!=h[0].toLowerCase()&&"help"!=h[0].toLowerCase())r.ctatdebug("calling doNewTrace("+A+", "+f.getSAI()+") sai.selectionArray "+f.getSAI().getSelectionArray()+" msg.selectionArray "+f.getSelectionArray()),g=v(A,[null,f.getSAI(),"student",!0,g,b]);
else{r.ctatdebug("handleInterfaceAction() hint request: hintPolicy "+R+", errorSAI "+I);R===CTATHintPolicyEnum.HINTS_UNBIASED?(1<h.length&&(h[1]=""),1<e.length&&(e[1]="")):R!==CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY&&(R===CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY?I&&I.getSelection()?(h.splice(1,0,I.getSelection()),e.splice(1,0,"PreviousFocus")):(h[1]="",e[1]=""):R===CTATHintPolicyEnum.HINTS_BIASED_BY_ALL&&I&&I.getSelection()&&(h.splice(1,0,I.getSelection()),e[1]=CTATMsgType.PREVIOUS_FOCUS.toString()));
...
l,null);e=new CTATExampleTracerEvent(r,f,"student");e.setHintRequest(!0);e.setWantReportableHints(!0);r.ctatdebug("CTATExampleTracerTracer --\x3e in doHint result: "+e);"example"===A?(f=z.doHint(e),g=p(e,g,f)):g=F.doHint(e,g,p)?e:null}else g=!1;return g;case CTATMsgType.PROBLEM_SUMMARY_REQUEST:return g=r.getProblemSummary(),r.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() "+r.getProblemSummary()),f="<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.PROBLEM_SUMMARY_RESPONSE+
"</MessageType>",f+=SCORMProblemSummary.getProblemSummaryElements(g),f+="<ProblemSummary>"+g.toXML(!0)+"</ProblemSummary>",f+="<end_of_transaction>true</end_of_transaction></properties></message>",e=[],e.push(f),r.sendBundle(e),T.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE,g.getCompletionStatus()),r.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '"+f+"';"),!0;case CTATMsgType.START_STATE_END:return T.transition(CTATMsgType.START_STATE_END),!0;case CTATMsgType.PROBLEM_RESTORE_END:return T.transition(CTATMsgType.PROBLEM_RESTORE_END),
...
a.getCustomFields(),a.getTraceOutcome());r.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES,n,a,null);b.msg&&r.messageTank.addToMessageTank(b.msgType,b.msg,a);I=e;d&&CTATExampleTracerLink.FIREABLE_BUGGY_ACTION==a.getResult()?(q=l(p?p.getNextNode():null,z.findCurrentState(!1,!1),r.lastMessage?r.lastMessage.getSAI():null,a))&&(a=q):a.isDoneStepFailed()&&r.messageTank.flushDelayedFeedback();return u()};if("example"===A)return y(a,x),b();"rule"===A&&C(a,x,b)}function y(a,b){var c=z.traceForHint(b);
r.ctatdebug("silent hint result: "+b+"; hintLink "+c);c||(c=z.getBestNextLink(!1,b),r.ctatdebug("getBestNextLink result: "+b+"; hintLink "+c));c&&((c=b.getTutorSAI())&&c.getSelection()&&a.setTutorSAI(c),a.setStepID(b.getStepID()),a.setAssociatedSkills(b.getAssociatedSkills()))}function C(a,b,c){r.ctatdebug("handleRuleTraceForHint result: "+a+";\n  hintResult: "+b);return F.doHint(b,a.getTransactionID(),function(d,e){r.ctatdebug("handleRuleTraceForHint cbk: "+d+";\n  rtnResult===hintResult: "+d===
b+"; txid===result.getTransactionID() "+e===a.getTransactionID());var f=d.getTutorSAI();f&&f.getSelection()&&a.setTutorSAI(f);a.setStepID(d.getStepID());a.setAssociatedSkills(d.getAssociatedSkills());a.setCustomFields(n(d.getCustomFields(),{rules:d.getAssociatedRules()}));c()})}CTATBase.call(this,"CTATExampleTracer","tracer");var A=null,r=this,D=null,z,F,H=null,J,x,G=new CTATXML;new XMLSerializer;var I=null,R,O=!0,L=!0,E=!1,M=null,V=null,P=null,S=new ProblemStateSaver(r);S.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
var Q=null,U=1,T=new CTATProblemStateStatus,W=[],Z=[],ea=0,ka="",ia=-1,fa=null;r.ctatdebug("CTATExampleTracer constructor outputStatus="+T);this.messageTank=this.lastSilentHintResult=this.lastResult=this.lastMessage=this.lastMessageAsXML=this.lastMessageAsString=null;var ha=new CTATCommLibrary;this.receiveFromInterface=function(a){r.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  "+a);(/<MessageType>SetPreferences<.MessageType>/i.test(a)?W:Z).push(a);b()};this.setVariablesFromSAI=function(a,
b){var c=CTATMsgType.getSAIArraysFromElement(a,b);switch(A){case "example":r.getTracer()&&r.getTracer().addInterfaceVariables(c.selection,c.input);break;case "rule":F.handleUntutoredAction(c)}};this.traceLinks=function(a){for(var b=[],c=r.getTracer().getBestInterpretation(),d=0;d<a.length&&null!==a[d];++d)c.getTraversalCount(a[d])<a[d].getMinTraversals()&&(r.messageTank=new CTATMessageTank(r,null),b.push(v("example",[a[d],a[d].getDefaultSAI(),a[d].getActor(),!1,null])),r.ctatdebug("traceLinks["+d+
"] result "+b[d]));return b};this.enqueueForRestore=function(b){r.ctatdebug("enqueueForRestore() tracerReady "+a()+": got "+(b?b.length:-1)+" message elements");null==H&&null!=b&&(H=b);null!=H&&(W=W.concat(H),H=null,b=(new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,null),W.push(b),U=1,a()&&r.startWorking())};this.restartWorking=function(){"rule"===A&&g(U,!1)};this.startWorking=function(){g(U,!1)};this.stopWorking=function(a){g("undefined"!=typeof a?a:U,!0)};this.goToStartState=
function(){var a=x.getStudentStartsHereNode()||x.getStartNode();a?r.goToState(a.getNodeName()):console.trace("goToStartState() did not find start node")};this.goToState=function(a){a=(a=x.findNode(a))?a.getNodeID():-1;0<a&&r.receiveFromInterface("<message><verb>NotePropertySet</verb><properties><MessageType>"+CTATMsgType.GO_TO_STATE+"</MessageType><nodeID>"+a+"</nodeID></properties></message>")};this.processXML=function(a){if(null!=a){A="example";r.ctatdebug("processXML (), tutorType = "+A);r.ctatdebug("No of children"+
G.getElementChildren(a).length);var b=new CTATGraphParser,d=b.parseGraph(a,r);x=d.gr;z=d.tracer;a=d.ssm;d=d.sgMsg;r.ctatdebug("sendStartStateMessages() nMsgs "+a.length+", outputStatus "+T);for(var e=[],g=new XMLSerializer,h=null,m=0;m<a.length;m++)if("message"==G.getElementName(a[m])){var n=g.serializeToString(a[m]),p=CTATMsgType.getMessageType(n);CTATMsgType.UNTUTORED_ACTION!=p&&CTATMsgType.INTERFACE_ACTION!=p||r.setVariablesFromSAI(a[m],G);CTATMsgType.START_STATE_END==p?(f(e),h=n,e.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()),
e.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))):e.push(n)}e.unshift(d);c(e);b=h;a:{a=[];d=x.getStartNode();e=CTATMsgType.START_STATE_END;g=d.getNodeID();h=null;m=ia;ia=-1;0>m&&(m=(m=x?x.getStudentStartsHereNode():null)?m.getNodeID():g);m==g?(console.trace("CTATExampleTracer.resetGoToState to transition1 destNodeID == noopNodeID",g),T.transition(e,null)):0<m&&(h=x.getNode(m));r.ctatdebug("CTATET.resetGoToState("+e+", null, "+g+") returns "+h);h||console.trace("CTATExampleTracer.resetGoToState to transition2 destNode",
g);e=h;if(null!==d&&null!==e&&d.getNodeID()!=e.getNodeID()){a=x.getBestSubpath(d,e);r.ctatdebug("advanceToStudentStartsHere() path "+a);if(!a)break a;a=a.getSortedLinks();a=r.traceLinks(a);r.ctatdebug("advanceToStudentStartsHere() results "+a)}e=d=null;0<a.length&&(e=a[a.length-1],a=e.getReportableLink(),null!==a&&(d=a.getNextNode()));r.ctatdebug("advanceToStudentStartsHere() to check for TPA "+d+", "+e);l(d,z.findCurrentState(!1,!1),null,e)}a=[];b&&a.push(b);T.canRestore()||a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END,
null));0<a.length&&r.sendBundle(a);z.setModelInitialized(!0)}r.startWorking()};this.processNools=function(a){var b=new CTATTutorMessageBuilder;A="rule";F=new CTATRuleTracer("nools",r);F.initEngine(a,function(a,d){r.ctatdebug("nools engine compiled");var e;e=new CTATTutorMessageBuilder;var g=d.suppressStudentFeedback;if(null===g||void 0===g)g=CTATMsgType.SHOW_ALL_FEEDBACK;r.setFeedbackSuppressed(g);var h=d.highlightRightSelection;r.setHighlightRightSelection("false"!=h);var l=d.confirmDone;r.setConfirmDone("true"===
l?!0:"false"===l?!1:g===CTATMsgType.HIDE_ALL_FEEDBACK);g=d.lockWidget;r.setHintPolicy(d.hintPolicy);r.setOutOfOrderMessage(d.outOfOrderMessage);e=e.createStateGraphMessage("false","false",g,r.isFeedbackSuppressed(),h,String(r.getConfirmDone()),[]);h=[];f(a);a.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd());a.push(b.createLockWidgetMsg(d.lockWidget));a.unshift(e);c(a);h.push("<message><verb>SendNoteProperty</verb><properties><MessageType>StartStateEnd</MessageType></properties></message>");
T.canRestore()||h.push(b.createMessage(CTATMsgType.PROBLEM_RESTORE_END,null));r.sendBundle(h);r.enqueueForRestore();r.startWorking()},function(a){console.log("error starting nools engine: "+a)},CTATConfiguration.get("use_backtracking"))};this.setConfirmDone=function(a){O=a};this.getConfirmDone=function(){return O};this.addGraphSkills=function(a){r.ctatdebug("adding graph skills: "+a.length);0<a.length&&(a=new CTATSkills(a),a.setExternallyDefined(!1),r.getProblemSummary().setSkills(a))};this.getGraphSkills=
function(){var a=r.getProblemSummary().getSkills();return a?a.getAllSkills():[]};this.sendBundle=function(a){r.ctatdebug("sending bundle #msgs = "+a.length+", outputStatus "+T);for(var b=0,c=0;c<a.length;c++){r.ctatdebug("Sending message #"+c);var d=a[c];0>=c&&(d='<?xml version="1.0" encoding="UTF-8"?>'+d);S.forwardToInterface(d,c>=a.length-1,T)&&++b}return 0<b};this.getHintPolicy=function(){return R};this.setHintPolicy=function(a){R=CTATHintPolicyEnum.lookup(a)};this.isHighlightRightSelection=function(){return L};
this.setHighlightRightSelection=function(a){L=a};this.updateSkills=function(a,b,c,d){var e=[];r.ctatdebug("in updateSkills("+b+") with step ID = "+c+", transaction result = "+a+", outputStatus "+r.getOutputStatus()+", actor "+d);if(!r.getOutputStatus().countForProblemSummary()||d&&!/^(student)?$/i.test(d))return e;var f=r.getProblemSummary().getSkills();if(!f)return e;b.forEach(function(b){(b=f.updateSkill(a,b,c))&&e.push(b)});return e};this.getSessionID=function(){return ka};this.getProblemSummary=
function(a){r.ctatdebug("Entering getProblemSummary() problemSummary "+M);if(null===M||"undefined"===typeof M){var b=r.getProblemName();M=null===b||"undefined"===typeof b||1>b.length?new CTATProblemSummary("NoProblemDefined",null,r.isFeedbackSuppressed()):new CTATProblemSummary(b,null,r.isFeedbackSuppressed())}a&&M.setRequiredSteps(a.countStepsForScore(x));return M};this.getProblemName=function(){return V};this.getSourceID=function(){return P};this.isSourceFlash=function(){return"string"==typeof P&&
P.match(/flash/i)};this.isFeedbackSuppressed=function(){return E};this.setFeedbackSuppressed=function(a){E="false"===a?!1:"true"===a?!0:a===CTATMsgType.SHOW_ALL_FEEDBACK?!1:a===CTATMsgType.HIDE_ALL_FEEDBACK?!0:a===CTATMsgType.HIDE_BUT_ENFORCE?!0:a===CTATMsgType.HIDE_BUT_COMPLETE?!0:!1;r.ctatdebug("setFeedbackSuppressed("+a+"): "+E);M&&M.setCountOnlyLastResults(E)};this.getSkillBarVector=function(a,b){var c=r.getProblemSummary().getSkills();return null===c||"undefined"===typeof c?null:"Student"!=w(b)?
null:"undefined"!=typeof a&&a?c.getSkillBarVector(!1,!1):c.getSkillBarVector(!0,!0)};this.startSkillTransaction=function(){var a=r.getProblemSummary().getSkills();a&&a.startTransaction()};this.getProblemStateSaver=function(){return S};this.isSendingSavedMsgsForRestore=function(){return r.getOutputStatus().isSendingSavedMsgsForRestore()};this.getOutputStatus=function(){return T};this.setOutputStatus=function(a){var b=T.getStatus();r.ctatdebug("setOutputStatus() old "+b+", new "+a);CTATProblemStateStatus[a]?
T.setStatus(CTATProblemStateStatus[a]):(console.error("CTATExampleTracer.setOutputStatus() unexpected argument "+a),T.setStatus(CTATProblemStateStatus.empty))};this.getFeedbackPolicy=function(){return x?x.getFeedbackPolicy():CTATMsgType.SHOW_ALL_FEEDBACK};this.getGraph=function(){return x};this.getTracer=function(){return z};this.getRuleTracer=function(){return F};this.getOutOfOrderMessage=function(){return J?J:CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE};this.setOutOfOrderMessage=function(a){J=a};this.getDelayedFeedback=
function(){null==fa&&(fa={});return fa};this.clearDelayedFeedback=function(){fa=null};this.getQuestionFile=function(a){if(!D||a)return D;a=D.split("/");return a[a.length-1]};this.addTPAToMessageTank=function(a,b,c,d){r.messageTank.enqueueToolActionToStudent(a,b,c,d)}};CTATExampleTracer.prototype=Object.create(CTATBase.prototype);CTATExampleTracer.prototype.constructor=CTATExampleTracer;"undefined"!==typeof module&&(module.exports=CTATExampleTracer);
