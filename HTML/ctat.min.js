...
(function(a) {
  var b = function() {
    ...
    "Africa/Johannesburg":["Asia/Gaza", "Africa/Cairo"]}, f = function(a) {
      ...
      a = a.getTime() + b;
      for (var f = (new Date(e)).getTimezoneOffset(), d = null;e < a - c;) {
        var g = new Date(e);
        if (g.getTimezoneOffset() !== f) {
          d = g;
          break;
        }
        e += c;
      }
      return 864E5 === b ? n(d, 36E5, 6E4) : 36E5 === b ? n(d, 6E4, 1E3) : d;
    }, h = function(a, b, c, e) {
      if ("N/A" !== c) {
        return c;
      }
      ...
      for (var f = {}, g = b.olson.dst_rules.zones, l = g.length, m = a[e], y = 0;y < l;y++) {
        var A = g[y], C;
        C = g[y];
        for (var E = 0, D = 0;D < c.length;D++) {
          if (C.rules[D] && c[D]) {
            if (c[D].s >= C.rules[D].s && c[D].e <= C.rules[D].e) {
              E = 0, E += Math.abs(c[D].s - C.rules[D].s), E += Math.abs(C.rules[D].e - c[D].e);
            } else {
              E = "N/A";
              break;
            }
      ...
      for (var w in f) {
        if (f.hasOwnProperty(w) && -1 != m.indexOf(w)) {
          return w;
        }
      }
      return e;
      ...
      var c = function() {
        for (var a = [], c = 0;c < b.olson.dst_rules.years.length;c++) {
          var f;
          f = b.olson.dst_rules.years[c];
          var d = (new Date(f, 0, 1, 0, 0, 1, 0)).getTime();
          f = (new Date(f, 12, 31, 23, 59, 59)).getTime();
          for (var g = (new Date(d)).getTimezoneOffset(), h = null, l = null;d < f - 864E5;) {
            var m = new Date(d), n = m.getTimezoneOffset();
            n !== g && (n < g && (h = m), n > g && (l = m), g = n);
            d += 864E5;
          }
          f = h && l ? {s:e(h).getTime(), e:e(l).getTime()} : !1;
          a.push(f);
        }
        return a;
      }();
    ...
    return {determine:function() {
      var e = c();
      e || (e = b.olson.timezones[g()], "undefined" !== typeof a[e] && (e = m(e)));
...
(function(a, b) {
  ...
  function d(a, b, c, e) {
    var f = ["opacity", b, ~~(100 * a), c, e].join("-");
    c = .01 + c / e * 100;
    e = Math.max(1 - (1 - a) / b * (100 - c), a);
    var d = n.substring(0, n.indexOf("Animation")).toLowerCase();
    p[f] || (r.insertRule("@" + (d && "-" + d + "-" || "") + "keyframes " + f + "{0%{opacity:" + e + "}" + c + "%{opacity:" + a + "}" + (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + e + "}}", r.cssRules.length), p[f] = 1);
    return f;
  }
  function f(a, b) {
    var c = a.style, e, f;
  ...
  function l() {
    ...
    h.prototype.lines = function(a, f) {
      function d() {
        return g(c("group", {coordsize:q + " " + q, coordorigin:-l + " " + -l}), {width:q, height:q});
      }
      function h(a, q, m) {
        b(n, b(g(d(), {rotation:360 / f.lines * a + "deg", left:~~q}), b(g(c("roundrect", {arcsize:f.corners}), {width:l, height:f.scale * f.width, left:f.scale * f.radius, top:-f.scale * f.width >> 1, filter:m}), c("fill", {color:e(f.color, a), opacity:f.opacity}), c("stroke", {opacity:0}))));
      }
      var l = f.scale * (f.length + f.width), q = 2 * f.scale * l, m = -(f.width + f.length) * f.scale * 2 + "px", n = g(d(), {position:"absolute", top:m, left:m});
      if (f.shadow) {
        for (m = 1;m <= f.lines;m++) {
    ...
    h.prototype.opacity = function(a, b, c, e) {
      ...
      a && b + e < a.childNodes.length && (a = (a = (a = a.childNodes[b + e]) && a.firstChild) && a.firstChild) && (a.opacity = c);
    };
  }
  var m = ["webkit", "Moz", "ms", "O"], p = {}, n, r, q = {lines:12, length:7, width:5, radius:10, scale:1, corners:1, color:"#000", opacity:.25, rotate:0, direction:1, speed:1, trail:100, fps:20, zIndex:2E9, className:"spinner", top:"50%", left:"50%", shadow:!1, hwaccel:!1, position:"absolute"};
  h.defaults = {};
  c(h.prototype, {spin:function(b) {
    this.stop();
    var c = this, e = c.opts, f = c.el = a(null, {className:e.className});
    g(f, {position:e.position, width:0, zIndex:e.zIndex, left:e.left, top:e.top});
    b && b.insertBefore(f, b.firstChild || null);
    f.setAttribute("role", "progressbar");
    c.lines(f, c.opts);
    if (!n) {
      var d = 0, h = (e.lines - 1) * (1 - e.direction) / 2, l, q = e.fps, m = q / e.speed, u = (1 - e.opacity) / (m * e.trail / 100), p = m / e.lines;
      (function z() {
        d++;
        for (var a = 0;a < e.lines;a++) {
          l = Math.max(1 - (d + (e.lines - a) * p) % m * u, e.opacity), c.opacity(f, a * e.direction + h, l, e);
        }
        c.timeout = c.el && setTimeout(z, ~~(1E3 / q));
      })();
    }
    return c;
  }, stop:function() {
    ...
    function h(b, c) {
      return g(a(), {position:"absolute", width:f.scale * (f.length + f.width) + "px", height:f.scale * f.width + "px", background:b, boxShadow:c, transformOrigin:"left", transform:"rotate(" + ~~(360 / f.lines * l + f.rotate) + "deg) translate(" + f.scale * f.radius + "px,0)", borderRadius:(f.corners * f.scale * f.width >> 1) + "px"});
    }
    for (var l = 0, q = (f.lines - 1) * (1 - f.direction) / 2, m;l < f.lines;l++) {
      m = g(a(), {position:"absolute", top:1 + ~(f.scale * f.width / 2) + "px", transform:f.hwaccel ? "translate3d(0,0,0)" : "", opacity:f.opacity, animation:n && d(f.opacity, f.trail, q + l * f.direction, f.lines) + " " + 1 / f.speed + "s linear infinite"}), f.shadow && b(m, g(h("#000", "0 0 4px #000"), {top:"2px"})), b(c, b(m, h(e(f.color, l), "0 0 1px rgba(0,0,0,.1)")));
    }
    return c;
  ...
  if ("undefined" !== typeof document) {
    ...
    !f(u, "transform") && u.adj ? l() : n = f(u, "animation");
  }
  return h;
});
...
function unhighlightall(a) {
  if (CTATShellTools.component_descriptions) {
    ...
    for (var b = 0;b < a.length;b++) {
      var d = a[b];
      d.setHintHighlight && d.setHintHighlight(!1, null);
    }
  }
}
...
CTATGlobalFunctions.isCTATObject = function(a) {
  return "object" == typeof testConfig && testConfig.getClassName ? !0 : !1;
};
CTATGlobalFunctions.getCTATClassname = function(a) {
  return "object" == typeof testConfig && testConfig.getClassName ? testConfig.getClassName() : "object";
};
...
var CTATShellTools = {ctat_base:new CTATBase("CTATShellTools", "shelltools"), component_descriptions:{}, registerComponentDescription:function(a) {
  ...
  $(".CTATComponent").each(function() {
    a.push($(this).data("CTATComponent"));
  });
  return a;
  ...
  if ("done" == a) {
    ...
    if ("hint" == a) {
      ...
      $(".CTATHintButton").each(function() {
        $(this).data("CTATComponent") && l.push($(this).data("CTATComponent"));
      });
      if (0 < l.length) {
        return l;
      }
  ...
  for (var m in d) {
    g = d[m];
    if (null === g) {
      return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index " + m), null;
    }
    if (null === g.name) {
      return CTATShellTools.ctat_base.ctatdebug("Internal error parsing component at index " + m + " (no name attribute available)"), null;
    }
    CTATShellTools.ctat_base.ctatdebug("Comparing " + g.name + " to: " + a);
    if (g.name == a) {
      if (null === g.getComponentPointer()) {
        return CTATShellTools.ctat_base.ctatdebug("Internal error, found a component description for [" + g.name + "], but component pointer is null"), null;
      }
      CTATShellTools.ctat_base.ctatdebug("Found a component description for [" + g.name + "], returning pointer (" + g.getComponentPointer() + ") ...");
      f = [];
      f.push(g.getComponentPointer());
      return f;
    }
    g.groupName == a && (CTATShellTools.ctat_base.ctatdebug("Found the component group (" + g.groupName + "), adding component instance for " + g.name + " ..."), f.push(g.getComponentPointer()));
  }
  return null === f ? (CTATShellTools.ctat_base.ctatdebug("Info (groupArray==null), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".") ? (d = a.split("."), this.findComponent(d[0])) : f) : 0 === f.length && (CTATShellTools.ctat_base.ctatdebug("Info (groupArray.length==0), no appropriate component found, perhaps this is a group component"), -1 != a.indexOf(".")) ? (d = a.split("."), this.findComponent(d[0])) : f;
...
var CTATArgument = function() {
  var a = "", b = "Undefined", d = "String", f = "text";
...
var CTATSAI = function(a, b, d, f) {
  ...
  var g = new CTATStringUtil, c = "undefined", e = [], h = [], l = [], m = [], p = null, n = this, p = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  this.getArguments = function() {
    return l;
  };
  this.getArgument = function(a) {
    if (0 == l.length) {
      var b = new CTATArgument;
      l.push(b);
    }
    return l[a];
  };
  this.getArgumentsTyped = function() {
    n.ctatdebug("getArgumentsTyped");
    for (var a = 0, b = [], a = 0;a < l.length;a++) {
      var c = l[a];
      "Boolean" === c.getType() ? (n.ctatdebug("Adding Boolean argument (" + c.getValue() + ") ..."), b.push(g.String2Boolean(c.getValue()))) : "Number" === c.getType() ? (n.ctatdebug("Adding Number argument (" + c.getValue() + ") ..."), b.push(Number(c.getValue()))) : "String" === c.getType() ? "No_Value" === c.getValue() ? (n.ctatdebug("Detected default argument (" + c.getValue() + "), setting contents to null instead"), b.push(null)) : b.push(String(c.getValue())) : n.ctatdebug("Unrecognized argument type: " + 
      c.getType() + " in " + n.toSerializedString() + " IGNORING IT!!!");
    }
    n.ctatdebug("Resulting arguments: " + b);
    return b;
  };
  this.addSelection = function(a, b) {
    var c = new CTATArgument;
    c.setValue(a);
    void 0 != b && null != b && c.setType(b);
    e.push(c);
  };
  ...
  this.checkDefaultArgument = function() {
    n.ctatdebug("checkDefaultArgument ()");
    if (0 === l.length) {
      n.ctatdebug("Adding default argument ...");
      var a = new CTATArgument;
      l.push(a);
    }
  };
  this.setArgument = function(a, b) {
    n.checkDefaultArgument();
  ...
  this.addArgument = function(a, b, c) {
    this.ctatdebug("addArgument (" + a + "," + b + "," + c + ")");
  ...
  this.setSAI = function(a, b, e, f, d) {
    n.setSelection(Array.isArray(a) ? 0 < a.length ? a[0] : "" : a);
    n.setAction(Array.isArray(b) ? 0 < b.length ? b[0] : "" : b);
    n.setInput(Array.isArray(e) ? 0 < e.length ? e[0] : "" : e);
    n.setType(f);
    c = d;
  };
  this.setInput = function(a) {
    n.ctatdebug("setInput(" + a + ")");
    n.checkDefaultArgument();
    n.getArgument(0).setValue(a);
  };
  this.getInputObject = function() {
    return 0 === l.length ? null : l[0];
  };
  this.getInput = function() {
    return 0 === l.length ? "" : n.getArgument(0).getValue();
  };
  this.setType = function(a) {
    n.checkDefaultArgument();
    n.getArgument(0).type = a;
  };
  this.getType = function() {
    return 0 === l.length ? "" : n.getArgument(0).type;
  };
  this.setFormat = function(a) {
    n.checkDefaultArgument();
    n.getArgument(0).setFormat(a);
  };
  this.getFormat = function() {
    return 0 === l.length ? "" : n.getArgument(0).getFormat();
  };
  this.toString = function() {
    return "[" + String(n.getSelection()) + "," + String(n.getAction()) + "," + String(n.getInput()) + "]";
  };
  this.setSelection = function(a, b) {
    var c = n.getSelectionObject();
    null == c ? (c = new CTATArgument, c.setValue(a), void 0 != b && null != b && c.setType(b), e.push(c)) : c.setValue(a);
  };
  ...
  this.getSelection = function() {
    ...
    var a = e[0];
    return "object" === typeof a ? a.getValue() : a;
  };
  this.setAction = function(a) {
    0 < h.length ? h[0] = a : h.push(a);
  };
  this.getAction = function() {
    return 0 == h.length ? null : h[0];
  };
  this.appendToSelectionArray = function(a, b) {
    var c = new CTATArgument;
    c.setValue(String(a));
    void 0 != b && null != b && c.setType(b);
    e.push(c);
  ...
  this.setSelectionArray = function(a) {
    e = [];
    for (var b = 0;b < a.length;b++) {
      n.appendToSelectionArray(a[b], "String");
    }
  };
  this.getSelectionArray = function() {
    for (var a = [], b = 0;b < e.length;b++) {
      var c = e[b];
      "object" === typeof c ? a.push(e[b].getValue()) : a.push(c);
    }
    return a;
  };
  this.appendToActionArray = function(a) {
    null == a ? h.push("") : h.push(String(a));
  };
  this.setActionArray = function(a) {
    h = null == a ? [] : Array.isArray(a) ? a.slice() : [String(a)];
  };
  this.getActionArray = function() {
    return h;
  };
  this.appendToInputArray = function(a) {
    n.ctatdebug("appendToInputArray (" + a + ")");
    null == a ? n.addArgument("", "String", "text") : n.addArgument(a, "String", "text");
  };
  this.setInputArray = function(a) {
    l = [];
    if (null != a) {
      for (var b = 0;b < a.length;b++) {
        n.appendToInputArray(a[b]);
      }
    }
  };
  this.getInputArray = function() {
    n.ctatdebug("getInputArray (" + l.length + ")");
    m = [];
    for (var a = 0;a < l.length;a++) {
      var b = l[a];
      "object" === typeof b ? (n.ctatdebug("Adding object value (" + b.getValue() + ") to temp input array"), m.push(b.getValue())) : (n.ctatdebug("Adding string value (" + b + ") to temp input array"), m.push(b));
    }
    return m;
  };
  ...
  this.propagate = function(a) {
    n.ctatdebug("propagate ()");
    a = a.getArguments();
    for (var b = 0;b < a.length;b++) {
      var c = a[b], e = l[b];
      if (null === c || null === e) {
        n.ctatdebug("Internal error: argument lists do not align between received SAI and source SAI");
        break;
      }
  ...
  this.fromXML = function(a) {
    ...
    for (var b = null, c = 0;c < a.length;c++) {
      var e = a[c];
      if ("selection" == p.getElementName(e) || "Selection" == p.getElementName(e)) {
        for (var f = p.getElementChildren(e), d = !1, g = 0;g < f.length;g++) {
          b = f[g], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > g ? n.setSelectionArray(b) : n.appendToSelectionArray(b), d = !0, n.setSelection(b));
        }
        !1 === d && (b = p.getNodeTextValue(e), n.setSelectionArray(b), n.setSelection(b));
      }
      if ("action" == p.getElementName(e) || "Action" == p.getElementName(e)) {
        f = p.getElementChildren(e);
        d = !1;
        for (g = 0;g < f.length;g++) {
          b = f[g], "value" == p.getElementName(b) && (b = p.getNodeTextValue(b), 1 > g ? n.setActionArray(b) : n.appendToActionArray(b), d = !0, n.setAction(b));
        }
        !1 === d && (b = p.getNodeTextValue(e), n.setActionArray(b), n.setAction(b));
      }
      if ("inputArray" == p.getElementName(e) || "value" == p.getElementName(e) || "Input" == p.getElementName(e)) {
        var b = p.getElementChildren(e), h = null;
        l = [];
        ...
        for (var m = 0;m < b.length;m++) {
          var r = b[m];
          "value" == p.getElementName(r) && (h = p.getElementChildren(r), null !== h ? (n.ctatdebug("Parsing SAI input ..."), n.ctatdebug("Childnodes: " + h.length), 1 === h.length ? (h = f.htmlDecode(p.getNodeTextValue(r)), n.ctatdebug("Setting new value to: " + h), d.setValue(h)) : (h = f.htmlDecode(p.getNodeTextValue(r)), n.ctatdebug("Setting new value to: " + h), d.setValue(h), d.setName(r.attributes.getNamedItem("name").value), d.setType(r.attributes.getNamedItem("type").value), d.setFormat(r.attributes.getNamedItem("format").value), 
          g++), 1 > m ? n.setInputArray(h) : n.appendToInputArray(h)) : (r = f.htmlDecode(p.getNodeTextValue(r)), n.ctatdebug("Setting new value to: " + r), d.setValue(r), 1 > m ? n.setInputArray(r) : n.appendToInputArray(r)));
        }
      }
      if ("prompt" == p.getElementName(e) || "Prompt" == p.getElementName(e)) {
        n.ctatdebug("Parsing prompt ..."), n.setPrompt(p.getNodeTextValue(e));
      }
    }
    n.checkDefaultArgument();
  };
  this.appendFromElement = function u(a, b, c, e, f) {
    n.ctatdebug("appendFromElement ()");
    e = String(p.getElementName(b)).toLowerCase();
    if (e == a || "value" == e) {
      if (e = p.getElementChildren(b), !Array.isArray(e) || 1 > e.length) {
        0 == f ? c.push(p.getNodeTextValue(b)) : n.appendToInputArray(p.getNodeTextValue(b));
      } else {
  ...
  this.setArrayFromElements = function(a) {
    n.ctatdebug("setArrayFromElements ()");
    if (!a || !Array.isArray(a) || 1 > a.length) {
      n.ctatdebug("can't get name: don't know whether selection, action or input");
    } else {
      var b = 0, c = String(p.getElementName(a[0])).toLowerCase();
      switch(c) {
        case "selection":
          n.ctatdebug("Processing selection field ...");
          e = [];
          for (b = 0;b < a.length;++b) {
            n.appendFromElement(c, a[b], e, b, !1);
          }
          break;
        case "action":
          n.ctatdebug("Processing action field ...");
          h = [];
          for (b = 0;b < a.length;++b) {
            n.appendFromElement(c, a[b], h, b, !1);
          }
          break;
        case "input":
          n.ctatdebug("Processing input field ...");
          l = [];
          for (b = 0;b < a.length;++b) {
            n.appendFromElement(c, a[b], l, b, !0);
          }
          break;
        default:
      ...
      n.ctatdebug("CTATSAI.setArrayFromElements() eltName " + c + ", length " + b + ", selectionArray " + n.getSelectionArray() + ", actionArray " + n.getActionArray() + ", inputArray " + n.getInputArray());
    }
  };
  this.fromXMLInternal = function(a) {
    n.ctatdebug("fromXMLInternal ()");
    new CTATXML;
    l = [];
    a = p.getElementChildren(a);
    for (var b = null, c = 0;c < a.length;c++) {
      ...
      if ("inputArray" == p.getElementName(e) || "Input" == p.getElementName(e)) {
        b = e.childNodes;
        l = [];
        var f = new CTATHTMLManager, d = new CTATArgument, g = 0, h = null;
        l.push(d);
        for (var m = 0;m < b.length;m++) {
          if (h = b[m], "value" == p.getElementName(h)) {
            var r = p.getElementChildren(h);
            null !== r ? (n.ctatdebug("Parsing SAI input ..."), n.ctatdebug("Childnodes: " + r.length), 1 === r.length ? (h = f.htmlDecode(p.getNodeTextValue(h)), n.ctatdebug("Setting new value to: " + h), d.setValue(h)) : (h = f.htmlDecode(p.getNodeTextValue(h)), n.ctatdebug("Setting new value to: " + h), d.setValue(h), d.setName(p.getElementAttr("name")), d.setType(p.getElementAttr("type")), d.setFormat(p.getElementAttr("format")), g++)) : (h = f.htmlDecode(p.getNodeTextValue(h)), n.ctatdebug("Setting new value to: " + 
            h), d.setValue(h));
            1 > m ? n.setInputArray(h) : n.appendToInputArray(h);
          }
        }
      }
      if ("prompt" == p.getElementName(e) || "Prompt" == p.getElementName(e)) {
  ...
  this.toXMLString = function(a) {
    n.ctatdebug("toXMLString ()");
    return a ? n.toLSxmlString() : n.toTSxmlString();
  };
  this.toLSxmlString = function() {
    n.ctatdebug("toLSxmlString ()");
    for (var a = "", b = 0;b < e.length;b++) {
      var c = e[b];
      "object" === typeof c ? (a = "String" != c.getType() ? a + ('<selection type="' + c.getType() + '">') : a + "<selection>", a += c.getValue() + "</selection>") : a += "<selection>" + c + "</selection>";
    }
    a += "<action>" + n.getAction();
    for (b = 1;b < h.length;b++) {
      a += "</action><action>" + h[b];
    }
    a += "</action>";
    for (b = 0;b < l.length;b++) {
      c = l[b], a = "object" === typeof c ? "String" != c.getType() ? a + ('<input type="' + c.getType() + '"><![CDATA[' + c.getValue() + "]]\x3e</input>") : a + ("<input><![CDATA[" + c.getValue() + "]]\x3e</input>") : a + ("<input><![CDATA[" + c + "]]\x3e</input>");
    }
    return a;
  };
  this.toTSxmlString = function() {
    n.ctatdebug("toTSxmlString ()");
    var a;
    a = "<Selection><value>" + n.getSelection();
    for (var b = 1;b < e.length;b++) {
      var c = e[b];
      a = "object" === typeof c ? a + ("</value><value>" + c.getValue()) : a + ("</value><value>" + c);
    }
    a += "</value></Selection><Action><value>" + n.getAction();
    for (b = 1;b < h.length;b++) {
      a += "</value><value>" + h[b];
    }
    ...
    if (1 < l.length) {
      for (b = 0;b < l.length;b++) {
        c = l[b], a += '<value fmt="text" name="' + c.getName() + '" type="' + c.getType() + '"><![CDATA[' + c.getValue() + "]]\x3e</value>";
      }
    } else {
      a += "<value><![CDATA[" + n.getInput() + "]]\x3e</value>";
    }
    return a + "</Input>";
  };
  this.toSerializedString = function() {
    var a;
    a = "" + ("<selection>" + n.getSelection() + "</selection><action>" + n.getAction() + "</action><inputArray>");
  ...
  this.clone = function() {
    n.ctatdebug("clone ()");
    for (var a = new CTATSAI(n.getSelection(), n.getAction(), n.getInput(), n.getPrompt()), b = 0;b < n.getArguments().length;++b) {
      a.setArgument(b, n.getArgument(b).clone());
    }
    a.setSelectionArray(n.getSelectionArray().slice());
    a.setActionArray(n.getActionArray().slice());
    a.setInputArray(n.getInputArray().slice());
    n.ctatdebug("CTATSAI.clone() this " + n + ", clone " + a + ", clone inputArray " + a.getInputArray());
    return a;
  };
  this.isDone = function() {
    var a = n.getSelection(), b = n.getAction();
    return null == a || null == b ? !1 : "done" == a.toString().toLowerCase() && "buttonpressed" == b.toString().toLowerCase();
  };
  var r = !1;
  if (Array.isArray(a) && Array.isArray(b) && (Array.isArray(d) || null == d) && (n.setSelectionArray(a), n.setActionArray(b), n.setInputArray(d), r = !0, 0 < a.length && 0 < b.length)) {
    n.setSAI(a[0], b[0], null == d ? null : d[0], "String", f);
    return;
  }
  null !== a && "" !== a && n.setSelection(a);
  null !== a && (n.setSAI(a, b, d, "String", f), r || (n.setSelectionArray(Array.isArray(a) ? a : [a]), n.setActionArray(Array.isArray(b) ? b : [b]), n.setInputArray(Array.isArray(d) ? d : [d]), r = !0));
};
...
var CTATSkill = function() {
  ...
  var a = "", b = "", d = "", f = "", g = 0, c = "", e = !1, h = "", l = "", m = "", p = "", n = "";
  ...
  this.toSetPreferencesXMLString = function() {
    var e = '<skill label="' + b + '" pSlip="' + l + '" description="' + c;
    return e += '" pKnown="' + m + '" category="' + d + '" pLearn="' + p + '" name="' + a + '" pGuess="' + h + '" history="' + n + '" />';
  };
...
var CTATSkillSet = function() {
      ...
      if (b = b.childNodes) {
        for (var d = 0;d < b.length;d++) {
          ...
          if ("Skill" == f.nodeName || "skill" == f.nodeName) {
            ...
            var g = f.attributes.getNamedItem("name");
            if (g = g ? g.value : "") {
              var c = f.attributes.getNamedItem("pKnown"), c = c ? c.value : "", e = f.attributes.getNamedItem("description"), e = e ? e.value : "", h = f.attributes.getNamedItem("label"), h = h ? h.value : "", l = f.attributes.getNamedItem("category"), l = l ? l.value : "", m = f.attributes.getNamedItem("pGuess"), m = m ? m.value : "", p = f.attributes.getNamedItem("pLearn"), p = p ? p.value : "", n = f.attributes.getNamedItem("pSlip"), n = n ? n.value : "", f = (f = f.attributes.getNamedItem("history")) ? 
              f.value : "";
              this.addSkill(g, c, .95, e, h, l, m, p, n, f);
            }
          }
        }
      } else {
  ...
  this.addSkill = function(a, d, f, g, c, e, h, l, m, p) {
    this.ctatdebug("addSkill() name = " + a + " level = " + d + " mastery = " + f + " aDescription = " + g + " adisplayName = " + c + " aCategory = " + e + " pguess= " + h + " plearn = " + l + " pslip = " + m + " history = " + p);
...
var CTATMessage = function(a) {
  ...
  var g = "ungraded", c = !1, e = !1, h = new CTATSkillSet, l = "", m = "", p = "", n = "", r = "", q, u = null, x = !1;
  ...
  this.parse = function() {
    ...
    if (null !== b) {
      ...
      "tool_message" == f.getElementName(b) ? (this.ctatdebug("Detected tool message"), l = "tool_message") : "message" != f.getElementName(b) ? (this.ctatdebug("Detected log message"), c = !0, l = f.getElementName(b)) : (this.ctatdebug("Detected regular message"), c = !1, this.parseMessageType());
    ...
    if ("tool_message" == l) {
      ...
      for (d = 0;d < a.length;d++) {
        if (g = a[d], "tool_message" == f.getElementName(g)) {
          for (g = f.getElementChildren(g), m = 0;m < g.length;m++) {
            x = g[m], "event_descriptor" == f.getElementName(x) && (u = new CTATSAI, u.fromXMLInternal(x));
          }
        }
      }
      e = !0;
      ...
      if (c) {
        ...
        for (var G = f.getElementChildren(b), t = 0;t < G.length;t++) {
          var F = G[t];
          if ("event_descriptor" == f.getElementName(F)) {
            for (var F = f.getElementChildren(F), H = 0;H < F.length;H++) {
              var z = F[H];
              "selection" == f.getElementName(z) && (a = f.getNodeTextValue(z), x.push(z));
              "action" == f.getElementName(z) && (d = f.getNodeTextValue(z), D.push(z));
              "input" == f.getElementName(z) && (g = f.getNodeTextValue(z), w.push(z));
              "prompt" == f.getElementName(z) && (m = f.getNodeTextValue(z));
            }
          }
        }
      } else {
        for (this.ctatdebug("!isLogMessage ..."), G = f.getElementChildren(b), t = 0;t < G.length;t++) {
          if (F = G[t], "properties" == f.getElementName(F)) {
            for (F = f.getElementChildren(F), H = 0;H < F.length;H++) {
              z = F[H], this.ctatdebug("Nodename: " + f.getElementName(z)), "URL" == f.getElementName(z) && (q = f.getNodeTextValue(z)), "Skills" == f.getElementName(z) && h.parseByValue(z), "SuccessMsg" == f.getElementName(z) && (p = a = f.getNodeTextValue(z)), "BuggyMsg" == f.getElementName(z) && (n = f.getNodeTextValue(z)), "Selection" == f.getElementName(z) && (a = f.getNodeTextValue(z), x.push(z)), "Action" == f.getElementName(z) && (d = f.getNodeTextValue(z), D.push(z)), "Input" == f.getElementName(z) && 
              (g = f.getNodeTextValue(z), w.push(z)), "prompt" == f.getElementName(z) && (m = f.getNodeTextValue(z)), "HighlightMsgText" == f.getElementName(z) && (r = f.getNodeTextValue(z));
            }
          }
        }
      }
      this.ctatdebug("SAI: " + a + "," + d + "," + g);
      "" !== a && null !== a ? (u = new CTATSAI(a, d, g, m), u.setArrayFromElements(x), u.setArrayFromElements(D), u.setArrayFromElements(w), e = !0) : (this.ctatdebug("No SAI found"), e = !1);
      this.ctatdebug("parseSAI () done, hassai: " + e + ", (" + a + "," + d + "," + g + "," + m + ")");
    }
  };
        ...
        for (var a = f.getElementChildren(b), e = 0;e < a.length;e++) {
          ...
          if ("properties" == f.getElementName(d)) {
            for (var d = f.getElementChildren(d), g = 0;g < d.length;g++) {
              var h = d[g];
              "transaction_id" == f.getElementName(h) && (m = f.getNodeTextValue(h));
            }
          }
        }
      }
    ...
    for (var a = f.getElementChildren(b), c = 0;c < a.length;c++) {
      ...
      if ("properties" == f.getElementName(e)) {
        for (var e = f.getElementChildren(e), d = 0;d < e.length;d++) {
          var g = e[d];
          "MessageType" == f.getElementName(g) && (l = f.getNodeTextValue(g));
        }
      }
    }
  ...
  this.getSAI = function() {
    return e ? u : new CTATSAI;
  };
  this.getSelection = function() {
    return e ? u.getSelection() : "";
  };
  this.getAction = function() {
    return e ? u.getAction() : "";
  };
  this.getInput = function() {
    return e ? u.getInput() : "";
  };
  this.getSelectionArray = function() {
    return e ? u.getSelectionArray() : [];
  };
  this.getActionArray = function() {
    return e ? u.getActionArray() : [];
  };
  this.getInputArray = function() {
    return e ? u.getInputArray() : [];
  };
...
var CTATCompBase = function(a, b, d, f, g, c) {
  ...
  var e = d || 0, h = f || 0, l = g || -2, m = c || -2, p = 50, n = 25, r = !1, q = !1, u = "", x = !1, B = !0, y = null, A = "", C = null;
  this.isTabIndexable = !0;
  var E = 0, D = null, w = this, G = null, t = "hidden", F = CTATGlobalFunctions.gensym.z_index(), H = CTATGlobalFunctions.gensym.div_id(), z = CTATGlobalFunctions.gensym.z_index(), I = CTATGlobalFunctions.gensym.div_id();
  ...
  this.setZIndex = function(a) {
    w.ctatdebug("Setting z index to: " + a);
    E = a;
  ...
  this.processCommShellEvent = function(a, b) {
    w.ctatdebug("processCommShellEvent (" + a + ")");
  };
  this.makeDivWrapper = function(a) {
    ...
    y.style.top = h + "px";
    y.style.zIndex = F;
    y.style.width = w.getWidth() + "px";
    y.style.height = w.getHeight() + "px";
  ...
  var L = this.setClassName;
  this.setClassName = function(a) {
    L(a);
    y && y.setAttribute("data-ctat-component", this.getClassName());
  };
  this.wrapComponent = function(a) {
    w.ctatdebug("wrapComponent ()");
    w.makeDivWrapper(a);
    w.ctatdebug("wrapComponent () done");
  };
  this.createCanvas = function() {
    w.ctatdebug("createCanvas ()");
    G = document.createElement("canvas");
    G.setAttribute("id", I);
    G.setAttribute("onkeypress", "return noenter(event)");
    G.setAttribute("width", l + canvasCalibrate + "px");
    G.setAttribute("height", m + canvasCalibrate + "px");
    G.setAttribute("style", "border: 1px " + this.borderColor + " solid; " + ("hidden" == t ? "visibility: hidden; " : "") + "z-index:" + z + ";");
  ...
  this.getWidth = function() {
    if (0 >= l) {
      var a;
      D ? a = window.getComputedStyle(D) : y && (a = window.getComputedStyle(y));
      if (a) {
  ...
  this.assignEnabled = function(a) {
    B = a;
    y.setAttribute("data-ctat-enabled", B);
  };
  this.setEnabled = function(a) {
    w.ctatdebug("setEnabled (" + a + ")");
    w.assignEnabled(a);
    D ? D.disabled = !B : w.ctatdebug("Error: component pointer is null");
  };
  this.lock = this.setEnabled.bind(w, !1);
  this.unlock = this.setEnabled.bind(w, !0);
  ...
  this.init = function() {
    w.ctatdebug("THIS IS THE BASE INIT METHOD");
  };
  this.initialize = function() {
    w.ctatdebug("initialize ()");
    w.configFromDescription();
    w.init();
    w.processSerialization();
    w.render();
    w.processTabOrder();
    w.ctatdebug("initialize () done");
  };
  this.getInitialized = function() {
    return x;
  };
  this.setInitialized = function(a) {
    w.ctatdebug("setInitialized (" + a + ")");
    x = a;
    !0 !== x || y ? w.ctatdebug("Not wrapping, initialized=" + x + ", divWrapper = " + y) : (w.ctatdebug("Wrapping a component and appending it to the top container div if one was never set ..."), (a = findPointOfAttachment(this.getName())) ? (w.ctatdebug("Attaching component to existing MovieClip ..."), w.wrapComponent(a.getDivWrapper())) : (w.ctatdebug("Attaching component to main div ..."), 0 < $("#" + ctatcontainer).length && w.wrapComponent(getSafeElementById(ctatcontainer))));
    w.getDivWrap().classList.add("CTATComponent");
    w.ctatdebug("setInitialized () done");
  };
  this.addSafeEventListener = function(a, b, c) {
    w.ctatdebug("addSafeEventListener (" + a + ")");
    w.ctatdebug("Adding event listener to: " + c);
    c ? c.addEventListener(a, b) : (D ? (w.ctatdebug("Adding eventlistener to component instead of target"), D.addEventListener(a, b)) : w.ctatdebug("Error: pointer to component is null, can't add event listener"), w.ctatdebug("addSafeEventListener () done"));
  };
  this.drawComponent = function() {
  };
  this.addComponentReference = function(a, b) {
    w.ctatdebug("addComponentReference (" + a.getName() + " -> " + b.getAttribute("id") + ")");
    CTATComponentReference.add(a, b);
    w.ctatdebug("addComponentReference ()");
  };
  this.getComponentFromID = function(a) {
    return CTATComponentReference.getComponentFromID(a);
  };
  this.processSerialization = function() {
    w.ctatdebug("processSerialization()");
    w.ctatdebug("implement in child class");
  };
  ...
  this.SetVisible = this.setVisible = function(a) {
    ...
    t = !0 === a ? "block" : "hidden";
    G && G.setAttribute("style", "border: 0px; position: absolute; " + (a ? "" : "visibility:hidden; ") + "; left:" + e + "px; top:" + h + "px; z-index:" + z + ";");
  ...
  this.setWidth = function(a) {
    w.ctatdebug("setWidth (" + a + ")");
    l = a;
    y ? y.style.width = l + "px" : w.ctatdebug("Internal error: no div wrapper available to set width");
  };
  this.setHeight = function(a) {
    w.ctatdebug("setHeight (" + a + ")");
    m = a;
    y ? y.style.height = m + "px" : w.ctatdebug("Internal error: no div wrapper available to set height");
  };
  ...
  this.processOnFocus = function() {
    w.ctatdebug("processOnFocus (" + w.getName() + ")");
    CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus;
    CTATGlobals.Tab.Focus != w ? (w.ctatdebug("CTATGlobals.Tab.Focus!=pointer, updating CTATGlobals.Tab.Focus ..."), CTATGlobals.Tab.Focus = w) : w.ctatdebug("CTATGlobals.Tab.Focus==pointer");
    w.ctatdebug("processOnFocus () done");
  };
  this.processFocus = function(a) {
    w.ctatdebug("processFocus ()");
    a.currentTarget.getAttribute("id");
    if (w) {
      mobileAPI && !0 === mobileAPI.getEnabled() && w.hideKeyboard();
      commShell && commShell.processComponentFocus(w);
      if (CTATGlobals.Tab.Focus) {
        w.ctatdebug("old focus: " + CTATGlobals.Tab.Focus.getName() + ", new focus:" + w.getName());
        if (CTATGlobals.Tab.Focus == w) {
          w.ctatdebug("We're already there!");
          return;
        }
        CTATGlobals.Tab.Focus.backgrade && CTATGlobals.Tab.Focus.processAction();
      } else {
        w.ctatdebug("No previously focused component yet, can't grade");
      }
      "hint" == w.getClassName() || "CTATHintButton" == w.getClassName() ? w.ctatdebug("Info: focus moved to hint, bump") : (CTATGlobals.Tab.previousFocus = CTATGlobals.Tab.Focus, CTATGlobals.Tab.Focus = w, w.ctatdebug("processFocus () done"));
    } else {
      w.ctatdebug("Error: component reference is null");
    }
  };
  this.processTabOrder = function() {
    w.ctatdebug("processTabOrder (" + C + ")");
    !0 === r ? w.ctatdebug("Component is an abstract component, bump") : D ? (w.ctatdebug("We have a component, actually assigning to html component ..."), null !== C && (D.tabIndex = C), D.onfocus = w.processOnFocus) : w.ctatdebug("Error: we don't have an html component yet, can't assign tab index");
  };
...
var CTATCSS = function() {
  ...
  this.addCSSAttribute = function(c, f) {
    b[a] = c;
    b[a + 1] = f;
    a += 2;
  };
  ...
  this.modifyCSSAttribute = function(a, c) {
    var f = b.indexOf(a);
    -1 == f ? this.addCSSAttribute(a, c) : b[f + 1] = c;
  };
  ...
  this.addSelectorAttribute = function(a, b, c) {
    ...
    a: {
      if (0 === d) {
        ...
        for (var p = 0;p < f.length && null !== f[p][0];p++) {
          if (f[p][0] == a) {
            a = p;
            break a;
          }
...
CTAT.Component.Base.Graphical = function(a, b, d, f, g, c, e) {
  ...
  var l = CTATGlobals.Visual.BackgroundColor, m = "white", p = 1, n = CTATGlobals.Visual.BorderColor, r = !1, q = "solid", u = 0, x = "1px", B = 0, y = CTATGlobals.Font.color, A = "black", C = CTATGlobals.Font.family, E = CTATGlobals.Font.size, D = !1, w = !1, G = !1;
  ...
  this.getBorderStyle = function() {
    return this.component ? $(this.component).css("border-style") : q;
  };
  this.setBorderStyle = function(a) {
    q = a;
    this.component && this.getBorderStyle() !== q && (this.component.style.borderStyle = q);
    return this;
  };
  this.getBorderWidth = function() {
    return this.component ? $(this.component).css("borderWidth") : x;
  };
  this.setBorderWidth = function(a) {
    x = parseInt(a);
    isNaN(x) && (x = 0);
    this.component && this.getBorderWidth() !== x && (this.component.style.borderWidth = x);
    return this;
  };
  this.getPadding = function() {
    return this.component ? parseInt($(this.component).css("padding-left")) : B;
  };
  this.setPadding = function(a) {
    B = parseInt(a);
    isNaN(B) && (B = 0);
    this.component && this.getPadding() !== B && (this.component.style.padding = B + "px");
    return this;
  };
  ...
  this.setFontSize = function(a) {
    a = parseInt(a);
    E = isNaN(a) ? CTATGlobals.Font.size : a;
    this.component && parseInt(this.getFontSize()) !== E && (this.component.style.fontSize = E + "pt");
    return this;
  };
  ...
  this.setShowBorder = function(a) {
    ...
    this.component && this.getShowBorder() !== r && (r ? (this.setBorderStyle(q), this.setBorderWidth(x)) : this.setBorderStyle("none"));
    return this;
  };
  ...
  this.getBolded = function() {
    return this.component ? "bold" === window.getComputedStyle(this.component).getPropertyValue("font-weight") : D;
  };
  this.setBolded = function(a) {
    D = CTATGlobalFunctions.stringToBoolean(a);
    this.component && this.getBolded() !== D && (this.component.style.fontWeight = D ? "bold" : null);
    return this;
  };
  this.getItalicized = function() {
    return this.component ? "italic" === window.getComputedStyle(this.component).getPropertyValue("font-style") : w;
  };
  this.setItalicized = function(a) {
    w = CTATGlobalFunctions.toBoolean(a);
    this.component && this.getItalicized() !== w && (this.component.style.fontStyle = w ? "italic" : null);
    return this;
  };
  var t = this;
  a = function(a) {
    ...
    return {setHandler:function(a, c) {
      ...
      if (b.hasOwnProperty(a)) {
        if (b[a]) {
          ...
          return b[a].apply(t, c);
        }
        t.ctatdebug("Error: NULL handler for " + a);
      } else {
        t.ctatdebug("Error: No handler set for " + a);
      }
    }};
  };
...
CTAT.Component.Base.Tutorable = function(a, b, d, f, g, c, e) {
  ...
  var h = !0, l = !0, m = !0, p = CTAT.Component.Base.Tutorable.Options.TutorComponent.TUTOR, n = this, r = !1;
  ...
  this.getTutorComponent = function() {
    ...
    return h && l && m ? a.TUTOR : h && l && !m ? a.TUTOR_NO_FEEDBACK : !h && l ? a.DO_NOT_TUTOR : p;
  };
  this.getDisableOnCorrect = function() {
    var a = $(this.getDivWrap()).attr("data-ctat-disable-on-correct");
    return a ? CTATGlobalFunctions.toBoolean(a) : !0;
  };
  this.setDisableOnCorrect = function(a) {
    $(this.getDivWrap()).attr("data-ctat-disable-on-correct", a);
  };
  ...
  var u = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  ...
  this.isCorrect = function() {
    return u === CTAT.Component.Base.Tutorable.Options.Status.CORRECT;
  };
  this.isIncorrect = function() {
    return u === CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;
  };
  this.isNotGraded = function() {
    return u === CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  };
  this.setCorrect = function(a) {
    this.setNotGraded();
    "CTATTableGoogle" != this.getClassName() && this.executeSAI(a);
    u = CTAT.Component.Base.Tutorable.Options.Status.CORRECT;
  ...
  this.setIncorrect = function(a) {
    ...
    this.setNotGraded();
    "CTATTableGoogle" != this.getClassName() && this.executeSAI(a);
    u = CTAT.Component.Base.Tutorable.Options.Status.INCORRECT;
  ...
  this.setNotGraded = function() {
    ...
    if (!this.isNotGraded() && (u = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED, this.removeCorrect(), this.removeInCorrect(), this.component)) {
  ...
  this.setHintHighlight = function(a, b) {
    ...
    if (q) {
      ...
      c !== r && (r = c, this.showHintHighlight(c, b));
    }
  };
  ...
  this.showInCorrect = function(a) {
    this.ctatdebug("showInCorrect(" + a + ")");
  ...
  this.resetTutoring = function() {
    ...
    u = CTAT.Component.Base.Tutorable.Options.Status.NOTGRADED;
  };
  this.grade = function() {
    this.updateSAI();
  ...
  this.processAction = function(a, b) {
    ...
    commShell && commShell.showFeedback(" ");
...
var CTATRadioButton = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    e.type = "radio";
    e.id = this.getName() + "_radio";
    e.value = c.getName();
    this.getComponentGroup() ? e.name = c.getComponentGroup() : this.getDivWrap() && $(this.getDivWrap()).attr("name") ? e.name = $(this.getDivWrap()).attr("name") : e.name = "radioButtonGroup";
    ...
    h.htmlFor = e.id;
    this.getText() ? h.textContent = c.getText() : a && (h.innerHTML = a);
    c.setComponent(e);
    ...
    e.addEventListener("focus", this.processFocus);
    e.onfocus = this.processOnFocus;
    this.setSelection(this.getComponentGroup());
  ...
  this.setText = function(a) {
    l(a);
    null !== h && (h.textContent = this.getText());
  };
  this.setStyleHandler("buttonLabel", this.setText);
  var m = this.setEnabled;
  this.setEnabled = function(a) {
    m(a);
    null !== e && (e.disabled = !this.getEnabled());
  };
  ...
  this.getRadioInput = function() {
    return e.checked ? e.value + ": " + h.textContent : "";
  };
  ...
  this.UpdateRadioButton = function(a) {
    0 <= a.indexOf(e.value) && c.setChecked(!0);
    c.ctatdebug("UpdateRadioButton ()");
  };
  this.updateSAI = function() {
    var a = $('div[data-ctat-component]:has(input[type="radio"][name="' + e.name + '"]:checked)'), b = "";
    1 === a.length && (b = $(a[0]).data("CTATComponent").getRadioInput());
    c.setSelection(e.name);
    c.setInput(b);
  };
  var p = function(a) {
    h.classList.add(a);
  ...
  this.showCorrect = function(a) {
    n("CTAT--hint");
    n("CTAT--incorrect");
    (a ? 0 === a.getInput().indexOf(e.value) : 1) ? p("CTAT--correct") : n("CTAT-correct");
  };
  this.removeCorrect = function() {
    n("CTAT--correct");
  };
  this.showInCorrect = function(a) {
    n("CTAT--hint");
    n("CTAT--correct");
    (a ? 0 === a.getInput().indexOf(e.value) : 1) ? p("CTAT--incorrect") : n("CTAT-incorrect");
  };
  this.removeInCorrect = n.bind(this, "CTAT--incorrect");
  this.showHintHighlight = function(a) {
    this.removeCorrect();
    this.removeInCorrect();
    a ? p("CTAT--hint") : n("CTAT--hint");
  };
};
...
var CTATButtonBasedComponent = function(a, b, d, f, g, c, e) {
  ...
  this.setImage = function(a) {
    ...
    a && h.component && (h.component.style.backgroundImage = "url('" + a + "')");
  };
  ...
  this.assignImages = function(a, b, c, e) {
    ...
    h.getDivWrap().setAttribute("data-ctat-image-disabled", e);
    this.setImage(c);
  };
...
var CTATImageButton = function(a, b, d, f, g) {
  CTATButtonBasedComponent.call(this, "CTATImageButton", "__undefined__", a, b, d, f, g);
  var c = this;
  this.init = function() {
    c.setInitialized(!0);
...
var CTATConfiguration = function() {
  ...
  var a = this, b = [], d = null, f = null, g = null, c = null, e = new CTATGuid;
  ...
  problem_started_url:"none", problem_state_status:"empty", question_file:"none", refresh_session_url:"none", remoteSocketPort:"80", remoteSocketURL:"127.0.0.1", restore_problem_url:"", reuse_swf:"false", run_problem_url:"none", school_name:"none", SessionLog:"true", session_id:e.guid(), session_timeout:"none", skills:"", source_id:"PACT_CTAT_HTML5", student_interface:"none", student_problem_id:"none", study_condition_name:"none", study_condition_type:"none", study_condition_description:"none", study_name:"Study1", 
  target_frame:"_parent", TutorShopDeliveryMethod:"sendandload", tutoring_service_communication:"javascript", user_guid:"none", wmode:"opaque", ssl:"off", sui:"", centerTutor:!1, previewMode:!1, width:550, height:450};
  ...
  this.getSingleParameterValues = function(b) {
    ...
    var e = a.getRawFlashVars(), f;
    for (f in b) {
      var d = b[f];
      e[d] && "none" != e[d] && c.push(e[d]);
    }
    return c;
  };
  this.generateDefaultConfiguration = function(b) {
    ...
    a.ctatdebug("generateDefaultConfiguration() nDefaults " + f + ", result['session_id'] " + c.session_id);
    f = b = null;
    if (window && window.frameElement && (f = window.frameElement.getAttribute("data-params"))) {
      b = jQuery.parseJSON(f);
      for (var d in b) {
    ...
    if (null == b) {
      for (d = $('object param[name="flashvars"]'), a.ctatdebug("generateDefaultConfiguration() objs " + d), b = 0;b < d.length;++b) {
        if (f = $(d[b]).attr("value"), a.ctatdebug("generateDefaultConfiguration() fVarsAsString " + f), f && (f = parseQueryStringArgs(f)) && f.question_file) {
          for (v in f) {
            c[v] = f[v];
          }
        }
    ...
    if (null == c) {
      ...
      if ("undefined" != typeof CTATTarget && "XBlock" != CTATTarget && "OLI" != CTATTarget) {
        ...
        f = "?" == b.charAt(0) ? b.substring(1) : b;
        b = {};
        if (f) {
          for (var f = f.split("&"), g = 0;g < f.length;g++) {
            var r = f[g].split("=");
            ctatdebug("Setting flashvar " + r[0] + ", to: " + decodeURIComponent(r[1].replace(/\+/g, " ")));
            b[decodeURIComponent(r[0])] = "";
            for (var q = 1;q < r.length;q++) {
              b[decodeURIComponent(r[0])] += (1 < q ? "=" : "") + decodeURIComponent(r[q].replace(/\+/g, " "));
            }
            ctatdebug("Decoded args: " + b[decodeURIComponent(r[0])]);
          }
        }
      ...
      for (var u in d) {
        if (d.hasOwnProperty(u)) {
          switch(ctatdebug("Processing external FlashVar " + u + "(" + d[u] + ")"), u) {
            case "GENERATED":
              "on" == d[u] && (c.session_id = e.guid(), b = !0);
              break;
            case "BRD":
              c.question_file = d[u];
              break;
            case "BRMODE":
              c.BehaviorRecorderMode = d[u];
              break;
            case "PROBLEM":
              c.problem_name = d[u];
              break;
            case "DATASET":
              ...
              break;
            case "LEVEL1":
              c.dataset_level_name1 = d[u];
              break;
            case "TYPE1":
              c.dataset_level_type1 = d[u];
              break;
            case "LEVEL2":
              c.dataset_level_name2 = d[u];
              break;
            case "TYPE2":
              c.dataset_level_type2 = d[u];
              break;
            case "LEVEL3":
              c.dataset_level_name3 = d[u];
              break;
            case "TYPE3":
              c.dataset_level_type3 = d[u];
              break;
            case "LEVEL4":
              c.dataset_level_name4 = d[u];
              break;
            case "TYPE4":
              c.dataset_level_type4 = d[u];
              break;
            case "USER":
              c.user_guid = d[u];
              break;
            case "SESSION":
              !1 === b && (c.session_id = d[u]);
              break;
            case "SOURCE":
              c.source_id = d[u];
              break;
            case "LOGTYPE":
              ...
              break;
            case "PORT":
              c.remoteSocketPort = d[u];
              break;
            case "REMOTEURL":
              c.remoteSocketURL = d[u];
              break;
            case "DISKDIR":
              c.log_to_disk_directory = d[u];
              break;
            case "log_service_url":
              c.log_service_url = d[u];
              break;
            case "URL":
              c.log_service_url = d[u];
              break;
            case "LOGURL":
              ...
              break;
            case "CONNECTION":
              c.tutoring_service_communication = d[u];
              break;
            case "SUI":
              c.sui = d[u];
              break;
            ...
            case "SessionLog":
              ...
              break;
            case "KEYBOARDGROUP":
              "Disabled" == d[u] && (c.keyboard = "disabled");
              "Auto" == d[u] && (c.keyboard = "auto");
              "On" == d[u] && (c.keyboard = "on");
              break;
            default:
              c[u] = d[u];
          }
  ...
  this.preParse = function() {
    ...
    for (e = !0;1 == e;) {
      e = !1;
      var f = "custom_field_name" + (c + 1), d = "custom_field_value" + (c + 1);
      a.ctatdebug("Trying : " + a.raw[f] + "," + a.raw[d]);
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[d]), b[a.raw[f]] = a.raw[d], e = !0, c++);
    }
  };
  ...
  this.getConditionNames = function() {
    ...
    for (var e = 0, f = !0;1 == f;) {
      var f = !1, d = "study_condition_name" + (e + 1);
      null != a.raw[d] && (a.ctatdebug("Adding: " + d + "," + a.raw[d]), b[e + c] = a.raw[d], f = !0, e++);
    }
    return b;
  };
  this.getConditionTypes = function() {
    ...
    for (var c = 0, e = !0;1 == e;) {
      ...
      null != a.raw[f] && (a.ctatdebug("Adding: " + f + "," + a.raw[f]), g[c + b] = a.raw[f], e = !0, c++);
    }
    return g;
  };
  this.getConditionDescriptions = function() {
    ...
    for (var e = 0, f = !0;1 == f;) {
      var f = !1, d = "study_condition_description" + (e + 1);
      null != a.raw[d] && (a.ctatdebug("Adding: " + d + "," + a.raw[d]), c[e + b] = a.raw[d], f = !0, e++);
    }
    return c;
  };
  this.get = function(b) {
...
var CTATJumble = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    e = this.getDivWrap();
    this.setComponent(e);
    this.addComponentReference(this, e);
    $(e).children().addClass("CTATJumble--item").attr({unselectable:"on", draggable:!0}).each(function() {
      this.addEventListener("dragstart", l, !1);
      this.addEventListener("dragenter", p, !1);
      this.addEventListener("dragover", m, !1);
      this.addEventListener("dragleave", n, !1);
      this.addEventListener("drop", r, !1);
      this.addEventListener("dragend", q, !1);
    });
    this.component.addEventListener("focus", this.processFocus);
  };
  var h = null, l = function(a) {
    a.target.classList.add("CTATJumble--item--home");
    h = a.target;
    ...
    $(e).children().removeClass("CTATJumble--item--over");
    if (h != this) {
  ...
  this.init_items = function(a) {
    if (e) {
      ...
      for (var c = a.length, f = 0;f < c;f++) {
        ...
        d.classList.add("CTATJumble--item");
        d.addEventListener("dragstart", l, !1);
        d.addEventListener("dragenter", p, !1);
        d.addEventListener("dragover", m, !1);
        d.addEventListener("dragleave", n, !1);
        d.addEventListener("drop", r, !1);
        d.addEventListener("dragend", q, !1);
        b.appendChild(d);
      }
      e.innerHTML = "";
      e.appendChild(b);
...
var CTATGraphicsTools = function(a, b, d, f, g, c) {
  ...
  var e = b || 1, h = d || "#000000", l = f || "#EEEEEE", m = g || !1, p = "Arial", n = a || null;
  a = c || !1;
  var r = 0, q = this;
  if (null == n) {
    return q.ctatdebug("--- Error: Must pass a canvas context. ---"), -1;
  }
  0 == a && (r = .5);
  ...
  this.drawLine = function(a, b, c, e, f, d) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawLine");
    a += r;
    c += r;
    b += r;
    e += r;
  ...
  this.drawCircle = function(a, b, c) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawCircle");
    a += r;
    b += r;
    n.strokeStyle = h;
    n.lineWidth = e;
  ...
  this.drawCircleFilled = function(a, b, c) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawCircleFilled");
    a += r;
    b += r;
    n.fillStyle = l;
    n.beginPath();
  ...
  this.drawRectangle = function(a, b, c, f) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangle");
    a += r;
    b += r;
    n.lineWidth = e;
    1 == m ? (n.fillStyle = l, n.fillRect(a, b, c, f)) : (n.strokeStyle = h, n.beginPath(), n.rect(a, b, c, f), n.stroke());
  };
  this.drawRectangleFilled = function(a, b, c, e) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawRectangleFilled");
    a += r;
    b += r;
    n.fillStyle = l;
    n.fillRect(a, b, c, e);
  };
  this.drawRoundedRect = function(a, b, c, f, d) {
    a += r;
    b += r;
    null != n && (n.strokeStyle = h, n.lineWidth = e, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + c - d, b + f), n.quadraticCurveTo(a + c, b + f, a + c, b + f - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke());
  };
  this.drawRoundedRectFilled = function(a, b, c, f, d) {
    a += r;
    b += r;
    null != n && (n.strokeStyle = h, n.lineWidth = e, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + c - d, b + f), n.quadraticCurveTo(a + c, b + f, a + c, b + f - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.stroke(), n.fillStyle = l, n.beginPath(), n.moveTo(a, b + d), n.lineTo(a, b + f - d), n.quadraticCurveTo(a, b + f, a + d, b + f), n.lineTo(a + 
    c - d, b + f), n.quadraticCurveTo(a + c, b + f, a + c, b + f - d), n.lineTo(a + c, b + d), n.quadraticCurveTo(a + c, b, a + c - d, b), n.lineTo(a + d, b), n.quadraticCurveTo(a, b, a, b + d), n.fill());
  };
  this.drawText = function(a, b, c) {
    if (null != n) {
      ...
      b += r;
      try {
        n.fillStyle = h, n.font = p + " 12pt", n.fillText(c, a, b);
      } catch (e) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTextFormatted = function(a, b, c, e, f, d, g, h, q, l) {
    if (null != n) {
      a += r;
      b += r;
      e = "";
      ...
      e += "12pt " + p;
      try {
        n.fillStyle = d, n.font = e, n.fillText(c, a, b);
      } catch (m) {
        throw alert(incompatibleBrowserMessage), Error("Browser does not support fillText");
      }
    }
  };
  this.drawTriangle = function(a, b, c, f, d, g) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangle");
    a += r;
    c += r;
    d += r;
    b += r;
  ...
  this.drawTriangleFilled = function(a, b, c, f, d, g) {
    null == n && q.ctatdebug("Error: canvas canvasCtx is NULL in drawTriangleFilled");
    a += r;
    c += r;
    d += r;
    b += r;
  ...
  this.clearCanvas = function(a, b, c, e) {
    "ctat" == CTATConfig.platform && n.clearRect(a, b, c, e);
  };
};
...
var CTATShape = function(a, b, d, f, g, c) {
  ...
  var h = [], l = [], m = g, p = c, n = b, r = void 0, q = "black", u = "black", x = "Arial", B = 12, y = [], A = 1, C = 5, E = document.createElement("canvas");
  E.id = n;
  E.width = m;
  E.height = p;
  var D = new CTATCSS;
  D.addCSSAttribute("position", "absolute");
  D.addCSSAttribute("left", d + "px");
  D.addCSSAttribute("top", f + "px");
  D.addCSSAttribute("visibility", "visible");
  D.addCSSAttribute("background-color", "rgba(0, 0, 0, 0)");
  D.addCSSAttribute("border-style", "none");
  E.setAttribute("style", D.toCSSString());
  getSafeElementById(a).appendChild(E);
  var w = new CTATGraphicsTools(E.getContext("2d"));
  w.setGraphicBorderWidth(A);
  w.setLineColor(q);
  w.setFillColor(u);
  ...
  this.setXPoints = function(a) {
    h = a;
    D.modifyCSSAttribute("left", h[0] + "px");
    E.setAttribute("style", D.toCSSString());
  };
  this.setYPoints = function(a) {
    l = a;
    D.modifyCSSAttribute("top", l[0] + "px");
    E.setAttribute("style", D.toCSSString());
  };
  this.setWidth = function(b) {
    m = b;
    "main-canvas" != a && (E.width = m);
  };
  this.setHeight = function(b) {
    p = b;
    "main-canvas" != a && (E.height = p);
  };
  this.setName = function(a) {
    n = a;
  };
  ...
  this.modifyCanvasCSS = function(a, b) {
    D.modifyCSSAttribute(a, b);
    E.setAttribute("style", D.toCSSString());
  };
  this.detatchCanvas = function() {
    a == ctatcontainer ? getSafeElementById(a).removeChild(E) : getSafeElementById("ctatdiv" + a).removeChild(E);
  };
  this.shapeMagicTrigFunctionX = function(a) {
    w.magicTrigFunctionX(a);
  };
  this.shapeMagicTrigFunctionY = function(a) {
    w.magicTrigFunctionY(a);
  };
  this.drawLine = function() {
    w.drawLine(h[0] + A, l[0] + A, h[1], l[1], q, A);
  };
  this.drawCircle = function() {
    w.drawCircle(h[0] + C, l[0] + C, C);
  };
  this.drawCircleFilled = function() {
    w.drawCircleFilled(h[0] + C, l[0] + C, C - 1);
  };
  this.drawRectangle = function(a, b, c, e) {
    w.drawRectangle(a[0] + A, b[0] + A, m - A, p - A);
  };
  this.drawRectangleFilled = function() {
    w.drawRectangleFilled(h[0], l[0], m, p);
  };
  this.drawRoundedRect = function() {
    w.drawRoundedRect(h[0] + A, l[0] + A, m - C - A, p - C - A, C);
  };
  this.drawRoundedRectFilled = function() {
    w.drawRoundedRectFilled(h[0] + A, l[0] + A, m - C - A, p - C - A, C);
  };
  this.drawText = function() {
    w.drawText(B / 2, B / 2, r);
  };
  this.drawTriangle = function() {
    w.drawTriangle(h[0] + A, l[0] + A, h[1], l[1], h[2], l[2]);
  };
  this.drawTriangleFilled = function() {
    w.drawTriangleFilled(h[0], l[0], h[1], l[1], h[2], l[2]);
  };
  this.save = function() {
    w.save();
  };
  ...
  this.erase = function() {
    ...
    D.addCSSAttribute("border-style", "none");
    E.setAttribute("style", D.toCSSString());
    a == ctatcontainer ? getSafeElementById(a).appendChild(E) : getSafeElementById("ctatdiv" + a).appendChild(E);
    for (var b = 0;b < y.length;b++) {
      E.addEventListener(y[b][0], y[b][1]);
    }
  };
};
...
var scrimIsUp = !1, errorScrim = !1, waitScrim = !0, warnScrim = !1, connectionScrim = !1, authorTimeSet = !0, inAuthorTime = !0, CTATScrim = function() {
  ...
  function b(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), x.ctatdebug("errScrimUp (" + a + ")"), 1 == errorScrim ? 1 == e && (e = !1, getSafeElementById(ctatcontainer).removeChild(q)) : 1 == warnScrim && (e = !0), x.scrimUp(a));
  }
  function d(a, b) {
    ...
    c.type = "button";
    c.value = b;
    null != a ? (x.ctatdebug("clickHandle!=null"), c.onclick = a) : (x.ctatdebug("clickHandle==null"), c.onclick = x.defaultClickHandler);
    c.id = b;
    c.setAttribute("class", "scrimButton");
    return c;
  }
  CTATBase.call(this, "CTATScrim", "__undefined__");
  var f = "", g = !1, c = !1, e = !1, h = null, l = null, m = new CTATCanvasComponent("CTAT Scrim"), p = [], n = null, r = null, q = null, u = null, x = this;
  this.scrimUp = function(b) {
    if ("google" != CTATConfig.platform) {
      if (x.ctatdebug("scrimUp ()"), b = CTATGlobals.languageManager.filterString(b), x.ctatdebug("Message: " + b), 1 == scrimIsUp ? (f = 1 == waitScrim ? b : f + (" \n " + b), m.removeComponent()) : (f = b, scrimIsUp = !0), x.ctatdebug("drawScrim ()"), "google" == CTATConfig.platform) {
        x.ctatdebug("This is not available for now when we're in this environment");
      } else {
        if ($('<div id="scrim" class="ctatpageoverlay"></div>').appendTo("body"), $("#scrim").css("z-index", 1E3), "google" != CTATConfig.platform && ($("#scrim").append('<div class="css3-windows-7"><div class="fenster"><h4 class="titel">CTAT Info Panel</h4><div id="scrimpanel" class="inhalt"><br>' + f + "<br><br></div></div></div>"), !0 === e && (q = d(a, "close"), $(q).appendTo("#scrimpanel")), !0 === g && (n = d(h, "yes"), $(n).appendTo("#scrimpanel")), !0 === c && (r = d(l, "no"), $(r).appendTo("#scrimpanel")), 
        1 == waitScrim)) {
          x.ctatdebug("Adding spinner ...");
          ...
          $("#scrimpanel").append(b);
          try {
            var p = (new Spinner({className:"scrim_spinner"})).spin();
            $("#scrim_spin").append(p.el);
          } catch (u) {
            (u instanceof ReferenceError || u instanceof TypeError) && x.ctatdebug('Spinner is not available, please include it in the build or add <script src="node_modules/spin.js/spin.min.js">\x3c/script> to the html file.', u, typeof u);
          }
        }
      }
    }
  ...
  this.waitScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), x.ctatdebug("waitScrimUp ()"), waitScrim = !0, x.scrimUp(CTATGlobals.languageManager.getString("LOADING")));
  };
  this.nextProblemScrimUp = function() {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), x.ctatdebug("nextProblemScrimUp ()"), x.scrimUp(CTATGlobals.languageManager.getString("NEXTPROBLEM")));
  };
  this.OKScrimUp = function(a, b) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), x.ctatdebug("OKScrimUp (" + a + "," + b + ")"), c = g = e = warnScrim = errorScrim = !1, x.scrimUp(a), u = d(b, "OK"), $(u).appendTo("#scrimpanel"));
  };
  this.confirmScrimUp = function(a, b, e) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), x.ctatdebug("confirmScrimUp (" + a + "," + b + "," + e + ")"), c = g = !0, l = e, h = b, x.scrimUp(a));
  };
  this.errorScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), 0 == authorTimeSet ? (x.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), p.push("ERROR: " + a), errorScrim = !0) : 0 == inAuthorTime ? x.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (errorScrim = !0, b("ERROR: " + a)));
  };
  this.warningScrimUp = function(a) {
    "google" != CTATConfig.platform && (1 == scrimIsUp && x.scrimDownForced(), 0 == authorTimeSet ? (x.ctatdebug("we don't know if we're in authorTime or not yet so we're just going to hold onto the messasge"), p.push("WARNING: " + a), warnScrim = !0) : 0 == inAuthorTime ? x.ctatdebug("We're not in authorTime, student's don't need to see our design mistakes") : (warnScrim = !0, b("WARNING: " + a)));
  };
  this.handleTSDisconnect = function() {
    connectionScrim = !0;
    x.scrimUp(CTATGlobals.languageManager.getString("TUTORDISCONNECTED"));
  };
  this.scrimDown = function() {
    "google" != CTATConfig.platform && (0 == scrimIsUp ? x.ctatdebug("The scrim isn't up, returning") : 1 == errorScrim ? x.ctatdebug("The scrim is up to describe errors to the user, leave it up!") : 1 == warnScrim ? x.ctatdebug("The scrim is up to display warnings to the user, leave it up!") : 1 == connectionScrim ? x.ctatdebug("The scrim is up for a connection issue leave it up!") : x.scrimDownForced());
  };
  ...
  this.setInAuthorTime = function(a) {
    ...
    inAuthorTime = a;
    if (!a) {
      warnScrim = errorScrim = !1, e && null.removeChild(q);
    } else {
...
window.jQuery ? $(document).ready(function() {
  ctatdebug("(Scrim) $ready (" + ("undefined" == typeof CTATTarget ? "CTATTarget undefined" : CTATTarget) + ")");
  CTATScrim.scrim = new CTATScrim;
  0 == noScrim && CTATScrim.scrim.waitScrimUp();
}) : alert("CTAT is unable to access JQuery, please make sure the library is referenced in your html file and loaded before CTAT.");
var CTATWSConnection = function(a) {
  CTATConnectionBase.call(this, "CTATWSConnection");
  var b = "", d = !1, f = this, g = null, c = [], e = !1, h = 0, l = 0, m = null, p = null;
  f.setSocketType("ws");
  this.setConsumed = function(a) {
    d = a;
  ...
  this.init = function() {
    ...
    null == g && (g = new WebSocket(f.getURL()), g.addEventListener("open", function(a) {
      ...
      l = (new Date).getTime();
      f.ctatdebug("STATUS: message after " + (l - h) + " ms");
      f.ctatdebug("Received: " + a.data);
      m ? m(a.data) : f.ctatdebug("Error: no processing function provided");
    }), g.addEventListener("close", function(a) {
      f.ctatdebug("STATUS: close; " + (a ? "code " + a.code + ", reason " + a.reason : "no event"));
      e = !1;
      g.close(1E3, a ? a.reason ? a.reason : "received close code " + a.code : "no close event received");
      p && p(a);
    }), g.addEventListener("error", function(a) {
      f.ctatdebug("STATUS: error; " + (a ? a.type : "no event"));
      e = !1;
      g.close(1E3, "client closing in response to error");
...
var bundleFormatter = "", inBundle = !1, useBundling = !1, useOLIEncoding = !1, CTATCommLibrary = function(a, b) {
  ...
  var d = authenticityToken = "", f = 0, g = [], c = a ? a : null, e = null == b ? !0 : b, h = !0, l = null, m = this, p = "http", n = "ERROR_CONN_TS", r = "";
  ...
  this.setConnectionRefusedMessage = function(a) {
    n = a;
  };
  this.setSocketType = function(a) {
    p = a;
  ...
  this.getURL = function() {
    m.ctatdebug("getURL ()");
    if ("" != d) {
      return m.ctatdebug("Returning fixedURL: " + d), d;
    }
  ...
  this.send_post_variables = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      var e = m.createConnection(CTATConfiguration.getRawFlashVars(), a);
  ...
  this.send_post = function(a, b) {
    ...
    if (!0 === globalCommDisabled) {
      ...
      "websocket" == m.getSocketType() ? (e = a.replace("http:", "ws:"), c = m.createConnection(c, e), c.setData(b), m.ctatdebug(b)) : (c = m.createConnection(c, e), c.setData(b));
      null != l && l.processOutgoing(b);
      c.send();
    }
  };
  this.processReply = function(a) {
    m.ctatdebug("processReply (" + g.length + "," + a + ")");
    var b = 0, f = !1;
    a = [];
    for (var d = 0, d = 0;d < g.length;d++) {
      var h = g[d], p = h.getHTTPObject();
      m.ctatdebug("Testing connection entry " + d + ", readyState: " + p.readyState + ", consumed: " + h.getConsumed() + ", status: " + p.status);
      4 == p.readyState && 0 == h.getConsumed() ? (m.ctatdebug("Investigating request response: " + b + " -> " + p.status + ", for: " + h.getURL()), f = !1, 0 === p.status && (f = !0, m.ctatdebug("Received message (status 0): (" + p.responseText + "), status: " + p.status), e && CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(n))), 408 == p.status && (f = !0, m.ctatdebug("Received message (status 408): " + p.responseText), e && CTATScrim.scrim.scrimDown()), 502 == p.status && 
      (f = !0, m.ctatdebug("Received message (status 502): " + p.responseText), e && CTATScrim.scrim.errorScrimUp(CTATGlobals.languageManager.filterString(ERROR_502))), 200 == p.status ? (f = !0, m.ctatdebug("Processing 200 response ..."), null !== c ? (a.push(p.responseText), null != l && l.processIncoming(p.responseText)) : m.ctatdebug("Error: httphandler is null, can't process response!")) : c && c.processError && (f = !0, m.ctatdebug("Processing non-200 response, status " + p.status), c.processError(p.status, 
      p.responseText)), !1 === f && m.ctatdebug("Error: status not handled for: " + p.status), m.ctatdebug("Marking connection as consumed ..."), h.setConsumed(!0)) : (0 === p.readyState && m.ctatdebug("Received message (status 0, request not initialized)"), 1 === p.readyState && m.ctatdebug("Received message (status 1, server connection established)"), 2 === p.readyState && m.ctatdebug("Received message (status 2, request received)"), 3 === p.readyState && m.ctatdebug("Received message (status 3, processing request)"));
      b++;
    }
    m.cleanup();
    for (b = 0;b < a.length;b++) {
      m.ctatdebug("Processing incoming message: " + b), f = a[b], -1 != f.indexOf("status=success") ? m.ctatdebug("Info: logging success message received, not propagating to message handler") : (m.ctatdebug("Processing incoming message: " + f), c.processMessage(f));
    }
  };
  ...
  this.checkEntries = function() {
    m.ctatdebug("checkEntries (" + g.length + ")");
    for (var a = 0, b = 0, b = 0;b < g.length;b++) {
      var c = g[b];
      if (!0 === c.getConsumed()) {
        return m.ctatdebug("Removing : " + c.getID()), g.splice(a, 1), !0;
      }
      var e = c.getHTTPObject();
      m.ctatdebug("Check, readyState: " + e.readyState + ", consumed: " + c.getConsumed());
      a++;
    }
    return !1;
  };
  this.retrieveXMLFile = function(a, b, c) {
    ...
    e.onreadystatechange = function() {
      ...
      if (4 == e.readyState) {
        if (200 == e.status) {
          var a = null;
          e.responseXML ? (m.ctatdebug("parsing brd xml using something else"), a = e.responseXML.documentElement) : (m.ctatdebug("parsing brd xml using node"), a = (b = new CTATXML).parseXML(e.responseText));
          if (null == a) {
            a = (new CTATTutorMessageBuilder).createErrorMessage("Error parsing xmlFile " + r);
            m.ctatdebug("Error parsing xmlFile " + r + ": " + a);
            CTAT.ToolTutor.sendToInterface(a, !0);
            return;
          }
          c.processXML(a);
        }
        404 == e.status && (a = (new CTATTutorMessageBuilder).createErrorMessage("Unable to download file", "(" + r + ") not found"), m.ctatdebug("Error loading xmlFile " + r + ": " + a), CTAT.ToolTutor.sendToInterface(a, !0));
      }
    };
    e.onerror = function() {
      var a = (new CTATTutorMessageBuilder).createErrorMessage("", "Unable to load: " + r + " - Either you are trying to use the  file:// protocol, there is a firewall between the tutor and BRD, or the BRD is on a different domain and permission to retrieve data from that server is denied.");
...
var CTATTutoringServiceMessageBuilder = function() {
  ...
  this.createInterfaceDescriptionMessage = function(a) {
    ...
    message += "<WidgetType>" + a.getClassName() + "</WidgetType>";
    message += "<CommName>" + a.getName() + "</CommName>";
    message += "<UpdateEachCycle>false</UpdateEachCycle>";
    message += "<serialized>";
    message += "<" + a.getClassName() + ' name="' + a.getName() + '" x="0" y="0" width="50" height="30" scaleX="1" scaleY="1" originalWidth="50" originalHeight="30" zIndex="-1" tabIndex="-1">';
    message += "<Parameters><selection>";
    if ("CTATRadioButton" == a.getClassName() || "CTATCheckBox" == a.getClassName()) {
      message += "<CTATComponentParameter>", message += "<name>group</name>", message += '<value fmt="text" name="Group Name" type="String" includein="sparse">' + a.getComponentGroup() + "</value>", message += "</CTATComponentParameter>";
    }
    message += "</selection></Parameters>";
    message += "</" + a.getClassName() + ">";
    message += "</serialized>";
  ...
  this.createURLResponse = function(a, b) {
    CTATGlobal.debug(classType, "createURLResponse ()");
    return "<message><verb>NotePropertySet</verb><properties><MessageType>GetURLResponse</MessageType><URL><![CDATA[ " + a + " ]]\x3e</URL><content><![CDATA[ " + btoa(b) + " ]]\x3e</content></properties></message>";
  };
...
var CTATLogMessageBuilder = function() {
  ...
  this.createContextMessage = function(b) {
    ...
    if (null != b && null != h) {
      ...
      for (var d = "<dataset>" + ("<name>" + c.dataset_name + "</name>"), l = 0;l < b.length;l++) {
        a.ctatdebug("Adding ..."), d += '<level type="' + b[l] + '">', d += "<name>" + h[l] + "</name>";
      }
      d += "<problem ";
    ...
    if (0 < b.length) {
      for (l = 0;l < b.length;l++) {
        c += "<condition><name>" + b[l] + "</name>", c += "" == d[l] ? "" : "<type>" + d[l] + "</type>", c += "" == h[l] ? "" : "<desc>" + h[l] + "</desc>", c += "</condition>";
      }
    }
    var e = e + c, c = flashVars.getCustomFields(), m;
    for (m in c) {
      c.hasOwnProperty(m) && (e += "<custom_field>", e += "<name>" + m + "</name>", e += "<value>" + c[m] + "</value>", e += "</custom_field>");
    }
    e += "</context_message>";
    a.ctatdebug("messageString = " + e);
    return e;
  };
  this.createSemanticEventToolMessage = function(f, g, c, e, h, l) {
    a.ctatdebug("createSemanticEventToolMessage(" + l + ")");
    var m = new Date;
    flashVars.getRawFlashVars();
    var p = '<tool_message context_message_id="' + this.getContextName() + '">';
    h || (p += this.makeMetaElement(m));
    g = '<semantic_event transaction_id="' + g + '" name="' + c + '"';
    "" != e && (g += ' subtype="' + e + '"');
    void 0 != l && "" != l && (g += ' trigger="' + l + '"');
    p += g + "/>";
    e = "<event_descriptor>";
    f = f.toXMLString(!0);
    e = e + f + "</event_descriptor>";
    p += e;
    p += this.createCustomFields(b, d);
    p += "</tool_message>";
  ...
  this.createUIEventToolMessage = function(f, g, c, e) {
    ...
    e || (l += this.makeMetaElement(h));
    l += '<ui_event name="' + g + '">' + c + "</ui_event>";
    f = "<event_descriptor>" + f.toSerializedString();
    l += f + "</event_descriptor>";
    l += this.createCustomFields(b, d);
    l += "</tool_message>";
    a.ctatdebug("messageString = " + l);
    return l;
  };
  this.createTutorMessage = function(f, g, c, e, h, l, m, p) {
    a.ctatdebug("createTutorMessage()");
    var n = new Date;
    flashVars.getRawFlashVars();
    var r = '<tutor_message context_message_id="' + this.getContextName() + '">';
    p || (r += this.makeMetaElement(n));
    g = '<semantic_event transaction_id="' + g + '" name="' + c + '"';
    "" !== l && (g += ' subtype="' + l + '"');
    r += g + "/>";
    f = "<event_descriptor>" + f.toXMLString(!0);
    r += f + "</event_descriptor>";
    f = "<action_evaluation ";
    e.hasClassification() && null != e.getAttributeString() && (f += e.getAttributeString());
    f += ">" + e.getEvaluation() + "</action_evaluation>";
    r += f;
    "" != h && (r += "<tutor_advice>" + h + "</tutor_advice>");
    null != m && (a.ctatdebug("Adding skills to log message ..."), r += m.toLogString());
    r += this.createCustomFields(b, d);
    r += "</tutor_message>";
    a.ctatdebug("messageString = " + r);
    return r;
  };
...
var CTATNameTranslator = function() {
  ...
  this.manufactorJSON = function(a, f) {
    ...
    var c = this.getA1Row(g[0]), e = this.getA1Col(g[0]), h = this.getA1Row(g[1]), l = this.getA1Col(g[1]);
    b.ctatdebug("Manufacturing json from: [" + c + "," + e + "] to: [" + h + "," + l + "]");
    g = "[";
    c = parseInt(h) - parseInt(c);
    e = parseInt(l) - parseInt(e);
    c++;
    e++;
  ...
  this.translateFromCTAT = function(d, f) {
    ...
    if (-1 != g.indexOf(".r")) {
      ...
      if (0 === g.indexOf("r")) {
        var h = g.indexOf("c"), l = parseInt(g.substr(1, h - 1)), g = parseInt(g.substr(h + 1)), c = l + 1, e = g;
        b.ctatdebug("Original row (2nd format) (columnindex: " + h + "): " + l + " -> " + c + ", original col: " + g + " -> " + e);
        e = colName(e, !1) + c;
...
var loggingDisabled = !1, CTATLoggingLibrary = function(a) {
  ...
  var b = this, d = !0, f = !1, g = !1, c = [], e = "undefined", h = "undefined", l = "undefined", m = "undefined", p = "undefined", n = "undefined", r = "undefined", q = "undefined", u = "UnassignedDataset", x = "UnassignedLevelName", B = "UnassignedLevelType", y = null, q = (new CTATGuid).guid();
  ...
  A.setName("commLoggingLibrary");
  A.setUseCommSettings(!1);
  A.setConnectionRefusedMessage("ERROR_CONN_LS");
  A.assignHandler(this);
  this.assignLogListener = function(a) {
    y = a;
  };
  ...
  this.setupExternalLibraryUsage = function() {
    ...
    c.session_id = "ctat_session_" + a.guid();
    c.source_id = "tutor";
    c.dataset_level_name1 = x;
    c.dataset_level_type1 = B;
  ...
  this.logSemanticEvent = function(a, c, e, d, f, g, h) {
    ...
    a = commLogMessageBuilder.createSemanticEventToolMessage(c, a, e, d, !0, h);
    this.sendMessage(a);
  };
  this.logTutorResponse = function(a, c, e, d, f, g, h, l, n) {
    b.ctatdebug("logTutorResponse ()");
    b.initCheck();
    var m = new Date;
    commLogMessageBuilder.resetCustomFields();
    commLogMessageBuilder.addCustomFields(l, n);
    ...
    l = "";
    void 0 != g && null != g ? l = "<![CDATA[" + CTATGlobals.languageManager.filterString(g) + "]]\x3e" : (b.ctatdebug("No feedback provided, using empty string"), l = "");
    b.ctatdebug("Creating tutor message ...");
    a = commLogMessageBuilder.createTutorMessage(c, a, e, f, l, d, h, !0);
    this.sendMessage(a);
  };
  this.processMessage = function(a) {
...
var CTATMessageHandler = function() {
  ...
  this.processSingleMessage = function(c) {
    ...
    for (var l = 0;l < c.length;l++) {
      var m = c[l];
      if ("properties" == f.getElementName(m)) {
        b.ctatdebug("Parsing properties ...");
        for (var p = f.getElementChildren(m), n = 0;n < p.length;n++) {
          var r = p[n];
          if ("MessageType" == f.getElementName(r)) {
            r = f.getNodeTextValue(r);
            b.ctatdebug("MessageType: " + r);
            "StateGraph" == r && (console.log("Setting inStartState to true"), inStartState = !0, commShell.setGotProblemRestoreEnd(!1), this.processStateGraph(m), commShell.propagateShellEvent("StateGraph", h));
            "StartProblem" == r && (b.ctatdebug("Setting inStartState to true"), inStartState = !0, commShell.setGotProblemRestoreEnd(!1), this.processStartProblem(p), commShell.propagateShellEvent("StartProblem", h));
            "InterfaceIdentification" == r && (this.processInterfaceIdentification(p), commShell.propagateShellEvent("InterfaceIdentification", h));
            "InterfaceDescription" == r && (this.processInterfaceDescription(p), commShell.propagateShellEvent("InterfaceDescription", h));
            "GetAllInterfaceDescriptions" == r && (commShell.getAllInterfaceDescriptions(), commShell.propagateShellEvent("GetAllInterfaceDescriptions", h));
            "SendWidgetLock" == r && (b.ctatdebug("Found: SendWidgetLock"), commShell.propagateShellEvent("SendWidgetLock", h));
            "CorrectAction" == r && (b.ctatdebug("Found: CorrectAction"), !0 === this.getInStartState() ? d.push(h) : a.processCorrectAction(h), commShell.propagateShellEvent("CorrectAction", h));
            "InCorrectAction" == r && (b.ctatdebug("Found: InCorrectAction"), !0 === inStartState ? d.push(h) : (b.ctatdebug("Handing incorrect message to messagehandler ..."), a.processInCorrectAction(h)), commShell.propagateShellEvent("InCorrectAction", h));
            "HighlightMsg" == r && (b.ctatdebug("Found: HighlightMsg"), a.processHighlightMsg(h), commShell.propagateShellEvent("HighlightMsg", h));
            "UnHighlightMsg" == r && (b.ctatdebug("Found: UnHighlightMsg"), a.processUnHighlightMsg(h), commShell.propagateShellEvent("UnHighlightMsg", h));
            if ("AssociatedRules" == r) {
              b.ctatdebug("Found: AssociatedRules (" + p.length + ")");
              for (var q = "", u = "", x = 0;x < p.length;x++) {
                var B = p[x];
                "TutorAdvice" == f.getElementName(B) && (q = f.getNodeTextValue(B));
                "Actor" == f.getElementName(B) && f.getNodeTextValue(B);
                "Indicator" == f.getElementName(B) && (u = f.getNodeTextValue(B));
                "StepID" == f.getElementName(B) && f.getNodeTextValue(B);
                "LogAsResult" == f.getElementName(B) && f.getNodeTextValue(B);
                "tool_selection" == f.getElementName(B) && f.getNodeTextValue(B);
                "Skills" == f.getElementName(B) && (b.ctatdebug("Processing skills ..."), null === skillSet && (b.ctatdebug("Interesting, there isn't a skillSet object yet. Creating ..."), skillSet = new CTATSkillSet), skillSet.parseByValue(B));
              }
              a.processAssociatedRules(h, u, q);
              commShell.propagateShellEvent("AssociatedRules", h);
            }
            "BuggyMessage" == r && (b.ctatdebug("Found: BuggyMessage"), a.processBuggyMessage(h), commShell.propagateShellEvent("BuggyMessage", h));
            "SuccessMessage" == r && (b.ctatdebug("Found: SuccessMessage"), a.processSuccessMessage(h), commShell.propagateShellEvent("SuccessMessage", h));
            "InterfaceAction" == r && (b.ctatdebug("Found: InterfaceAction"), !0 === inStartState ? (b.ctatdebug("inStartState==true => storing for later playback ..."), d.push(h)) : a.processInterfaceAction(h), commShell.propagateShellEvent("InterfaceAction", h));
            "InterfaceIdentification" == r && (b.ctatdebug("Found: InterfaceIdentification"), commShell.propagateShellEvent("InterfaceIdentification", h));
            "AuthorModeChange" == r && (b.ctatdebug("Found: AuthorModeChange"), a.globalReset(), commShell.propagateShellEvent("AuthorModeChange", h));
            "ResetAction" == r && (b.ctatdebug("Found: ResetAction"), a.globalReset(), commShell.propagateShellEvent("ResetAction", h));
            if ("ShowHintsMessage" == r) {
              b.ctatdebug("Found: ShowHintsMessage");
              q = !1;
              u = [];
              for (x = 0;x < p.length;x++) {
                if (B = p[x], "HintsMessage" == f.getElementName(B)) {
                  for (var B = f.getElementChildren(B), y = 0;y < B.length;y++) {
                    var A = B[y];
                    "value" == f.getElementName(A) && (u.push(f.getNodeTextValue(A)), q = !0);
                  }
                }
              }
              !0 === q ? a.processHintResponse(h, u) : b.ctatdebug("Error: incomplete hint message received");
              commShell.propagateShellEvent("ShowHintsMessage", h);
            }
            "ConfirmDone" == r && (b.ctatdebug("Found: ConfirmDone"), a.processConfirmDone(h), commShell.propagateShellEvent("ConfirmDone", h));
            "VersionInfo" == r && (b.ctatdebug("Found: VersionInfo"), a.processVersionInfo(p), commShell.propagateShellEvent("ConfirmDone", h));
            "TutoringServiceAlert" == r && (b.ctatdebug("Found: TutoringServiceAlert"), a.processTutoringServiceAlert(p), commShell.propagateShellEvent("TutoringServiceAlert", h));
            "TutoringServiceError" == r && (b.ctatdebug("Found: TutoringServiceError"), a.processTutoringServiceError(p), commShell.propagateShellEvent("TutoringServiceError", h));
            "ProblemSummaryResponse" == r && (b.ctatdebug("Found: ProblemSummaryResponse"), a.processProblemSummaryResponse(h), commShell.propagateShellEvent("ProblemSummaryResponse", h));
            if ("StartStateEnd" == r) {
            ...
            "ProblemRestoreEnd" == r && (b.ctatdebug("Found: ProblemRestoreEnd"), a.processProblemRestoreEnd(h), commShell.propagateShellEvent("ProblemRestoreEnd", h));
            "GetURL" == r && (b.ctatdebug("Found: GetURL"), a.processGetURL(h), commShell.propagateShellEvent("GetURL", h));
            "InterfaceReboot" == r && (r = "AUTHORING" == CTATTarget ? location.href : null, b.ctatdebug("Found: InterfaceReboot -- href " + r), r && 1 < ++g && location.replace(r));
          }
        }
      }
    }
  ...
  this.processInterfaceDescription = function(a) {
    ...
    for (var c = "Unknown", d = "Unknown", g = null, p = 0;p < a.length;p++) {
      var n = a[p];
      b.ctatdebug("Inspecting element: " + f.getElementName(n));
      "WidgetType" == f.getElementName(n) && (b.ctatdebug("Widget type: " + f.getNodeTextValue(n)), c = f.getNodeTextValue(n));
      "CommName" == f.getElementName(n) && (b.ctatdebug("Instance name: " + f.getNodeTextValue(n)), d = f.getNodeTextValue(n));
      if ("serialized" == f.getElementName(n)) {
        b.ctatdebug("Prepareing to de-serialize component ...");
        for (var r = f.getElementChildren(n), q = 0;q < r.length;q++) {
          var u = r[q];
          -1 != f.getElementName(u).indexOf("CTAT") && (g = u);
        }
      }
      "interface" == f.getElementName(n) && (b.ctatdebug("Storing interface for post start-state reconstruction ..."), CTATGlobals.interfaceElement = n);
      "script" == f.getElementName(n) && (b.ctatdebug("Storing and loading main javascript code as defined by the BRD ..."), scriptElement = f.getNodeTextValue(n));
    }
  ...
  this.deserializeComponent = function(a, c, d) {
    ...
    if (1 == ignoreInterfaceDescriptions) {
      ...
      if (null === f.getElementAttr(d, "x")) {
        ...
        var g = f.getElementAttr(d, "x"), p = f.getElementAttr(d, "y"), n = f.getElementAttr(d, "width"), r = f.getElementAttr(d, "height"), q = f.getElementAttr(d, "tabIndex"), u = f.getElementAttr(d, "zIndex");
        null === q && (q = -1);
        null === u && (u = 0);
        var x = new CTATComponentDescription;
        x.type = a;
        x.name = c;
        x.x = Math.floor(g);
        x.y = Math.floor(p);
        ...
        x.height = Math.floor(r);
        CTATShellTools.registerComponentDescription(x);
        d = f.getElementChildren(d);
        for (g = 0;g < d.length;g++) {
          p = d[g];
          f.getElementName(p);
          if ("Parameters" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component parameters ..."), n = f.getElementChildren(p)[0], n = f.getElementChildren(n), r = 0;r < n.length;r++) {
              var B = n[r];
              if ("CTATComponentParameter" == f.getElementName(B)) {
                this.ctatdebug("Processing parameter property (CTATComponentParameter) ...");
                for (var u = q = void 0, B = f.getElementChildren(B), y = 0;y < B.length;y++) {
                  var A = B[y];
                  "name" == f.getElementName(A) && (this.ctatdebug("Found parameter name: " + f.getNodeTextValue(A)), q = f.getNodeTextValue(A));
                  "value" == f.getElementName(A) && (this.ctatdebug("Found parameter value: " + f.getNodeTextValue(A)), u = f.getNodeTextValue(A).trim());
                }
                this.ctatdebug("Parameter name: " + q + ", value: " + u);
                void 0 !== q && (x.params[q] = u, "group" == q && (x.groupName = u));
              }
            }
          }
          if ("Styles" == f.getElementName(p)) {
            for (this.ctatdebug("Processing component styles ..."), p = f.getElementChildren(p)[0], p = f.getElementChildren(p), n = 0;n < p.length;n++) {
              if (u = p[n], "CTATStyleProperty" == f.getElementName(u)) {
                this.ctatdebug("Processing style property (CTATStyleProperty) ...");
                q = r = "";
                u = f.getElementChildren(u);
                for (B = 0;B < u.length;B++) {
                  y = u[B], "name" == f.getElementName(y) && (r = f.getNodeTextValue(y)), "value" == f.getElementName(y) && (q = f.getNodeTextValue(y).trim());
                }
                this.ctatdebug("Style (name: " + r + ", value: " + q + ")");
                "" !== r && (x.styles[r] = q);
              }
            }
          }
...
CTATTutorMessageBuilder.prototype.createErrorMessage = function(a, b) {
  var d;
  d = "<message><verb>SendNoteProperty</verb><properties><MessageType>TutoringServiceError</MessageType><ErrorType>" + a + "</ErrorType><Details>";
  d += b ? b : "";
...
CTATLMS.init.SCORM = function() {
  ...
  CTATLMS.initLMSConnection = function() {
    if (1 != a) {
      ...
      var b = CTATLMS.getValue("cmi.core.lesson_status");
      CTATConfiguration.set("problem_state_status", b);
      "not attempted" == b && CTATConfiguration.set("problem_state_status", "incomplete");
      "passed" == b && CTATConfiguration.set("problem_state_status", "completed");
      "failed" == b && CTATConfiguration.set("problem_state_status", "incomplete");
      "browsed" == b && CTATConfiguration.set("problem_state_status", "incomplete");
  ...
  CTATLMS.saveProblemState = function(a) {
    return CTATLMS.setValue("cmi.suspend_data", a.problem_state);
  };
  CTATLMS.getProblemState = function(a) {
    var d = CTATLMS.getValue("cmi.suspend_data");
    return a(d);
  };
  CTATLMS.gradeStudent = function(a, d) {
    CTATLMS.setValue("cmi.core.score.min", 0);
    CTATLMS.setValue("cmi.core.score.max", 100);
    return CTATLMS.setValue("cmi.core.score.raw", Number((a / d).toFixed(2).replace(/[.]/, "")));
  };
  CTATLMS.processProblemSummary = function(a) {
    ["cmi.core.lesson_status", "cmi.core.score.raw", "cmi.core.exit", "cmi.core.session_time"].forEach(function(a) {
      ...
      CTATLMS.setValue(a, $("<div>").html(b[0].innerHTML).text());
    }, a);
    CTATLMS.commit();
...
var CTATCommShell = function() {
  ...
  var a = null, b = this, d = null, f = null, g = {}, c = null, e = null, h = null, l = null, m = [], p = !1, f = "xml" == CTATConfig.parserType ? new CTATXML : new CTATJSON;
  this.init = function(c) {
    ...
    commLibrary.sendXMLURL(c, d + e.remoteSocketURL + ":" + e.remoteSocketPort);
  };
  this.getLoggingLibrary = function() {
    return commLoggingLibrary;
  };
  ...
  this.processStartProblem = function() {
    ...
    CTATLMS.initLMSConnection && CTATLMS.initLMSConnection();
  };
  ...
  this.sendInterfaceDescriptionMessages = function() {
    ...
    for (var a = CTATShellTools.getAllComponents(), c = '<?xml version="1.0" encoding="UTF-8"?><message><verb>NotePropertySet</verb><properties><MessageType>MessageBundle</MessageType><messages>', e = new CTATTutoringServiceMessageBuilder, d = 0;d < a.length;d++) {
      var f = a[d];
      b.ctatdebug("Getting component interface description message for: " + f.getName());
      c += e.createInterfaceDescriptionMessage(f);
    }
    c += "</messages></properties></message>";
    b.ctatdebug("Final bundle: " + c);
    commLibrary.sendXMLNoBundle(c);
  };
  this.processSerialization = function() {
  ...
  this.processComponentAction = function(a, c, e, d, f, g) {
    b.ctatdebug("processComponentAction(" + a.getName() + " -> " + a.getSelection() + "," + a.getAction() + "," + a.getInput() + ")");
    this.showFeedback("");
    e = (new CTATGuid).guid();
    null != commLoggingLibrary ? p && (b.ctatdebug("We're not in the start state, logging the action ..."), "scrim" == a.getSelection() ? ctatdebug("Not logging any scrim actions (for now)") : void 0 != f ? commLoggingLibrary.logSemanticEvent(e, a, f, "", "", "", g) : "hint" == a.getSelection() || "null.nextButton" == a.getSelection() || "null.previousButton" == a.getSelection() ? commLoggingLibrary.logSemanticEvent(e, a, "HINT_REQUEST", "", "", "", g) : commLoggingLibrary.logSemanticEvent(e, a, 
    "ATTEMPT", "", "", "", g)) : this.ctatdebug("Info: no logging library available!");
    f = new CTATTutoringServiceMessageBuilder;
    g = "";
    g = !1 !== c ? f.createInterfaceActionMessage(e, a) : f.createUntutoredActionMessage(e, a);
  ...
  this.requestHint = function() {
    ...
    if ("none" == CTATConfig.external) {
      ...
      if (b.clearFeedbackComponents(), "google" == CTATConfig.external) {
  ...
  this.processGetURL = function(a) {
    b.ctatdebug("processGetURL()");
    -1 != a.getURL().indexOf("http://") ? commLibrary.retrieveFile(a.getURL().substring(7), b.processClientBRDLoad) : commLibrary.retrieveFile(a.getURL(), b.processClientBRDLoad);
  };
  this.processClientBRDLoad = function(a) {
    b.ctatdebug("processClientBRDLoad()");
    var c = commLibrary.getURL();
    commLibrary.sendXML("<message><verb>NotePropertySet</verb><properties><MessageType>GetURLResponse</MessageType><URL><![CDATA[ " + c + " ]]\x3e</URL><content><![CDATA[ " + window.btoa(a) + " ]]\x3e</content></properties></message>");
  };
  this.processCorrectAction = function(a) {
    b.ctatdebug("processCorrectAction()");
    a.setGradeResult("correct");
    b.clearFeedbackComponents();
  ...
  this.processAssociatedRules = function(a, c, e) {
    ...
    if (0 == commMessageHandler.getInStartState()) {
      ...
      null != commLoggingLibrary ? p && commLoggingLibrary.logTutorResponse(a.getTransactionID(), logHintSAI, d, "", f, e, h, c, g) : this.ctatdebug("Info: no logging library available!");
  ...
  this.processInterfaceAction = function(a) {
    ...
    null != commLoggingLibrary ? p && commLoggingLibrary.logSemanticEvent(a.getTransactionID(), a.getSAI(), "ATTEMPT", "tutor-performed") : this.ctatdebug("Info: no logging library available!");
    if ("root" == a.getSelection() || "_root" == a.getSelection()) {
      ...
      if (c = CTATShellTools.findComponent(a.getSelection()), null === c) {
        ...
        if (0 == c.length) {
          ...
          for (var d = 0;d < c.length;d++) {
            b.ctatdebug("About to call " + a.getAction() + " (" + a.getInput() + ") on: " + a.getSelection()), c[d].executeSAI(a), b.ctatdebug("Method executed, continuing with post-processing ..."), commMessageHandler.getInStartState();
          }
  ...
  this.processProblemSummaryResponse = function(a) {
    ...
    CTATLMS.processProblemSummary && CTATLMS.processProblemSummary(a.getXMLObject());
    CTATLMS.closeLMSConnection && CTATLMS.closeLMSConnection();
    if (null != h) {
  ...
  this.setGotProblemRestoreEnd = function(a) {
    p = a;
  };
      ...
      if (e = e.getSelection(), null != e) {
        if (b.ctatdebug("Highlighting selection for hint: " + e), e = CTATShellTools.findComponent(e), null != e) {
          for (var d = 0;d < e.length;d++) {
            1 == detailedFeedback && e[d].setHintHighlight(!0, a);
          }
        } else {
  ...
  this.showFeedback = function(a) {
    null != a && void 0 != a && /\S/.test(a) && " " != a ? (b.ctatdebug("showFeedback(" + a + ") -> l: " + a.length), CTATShellTools.showFeedback(a), null != e && e(a)) : b.ctatdebug("showFeedback(): False alarm: empty message. This can happen when the commshell is trying to clear the hint window and there is no hint window.");
  };
...
var CTATProblem = function() {
  ...
  var a = "", b = "", d = "tutor", f = "", g = "", c = "notstarted";
...
var CTATPackage = function() {
  ...
  var a = this, b = new CTATXML, d = [], f = [];
  this.init = function(f) {
    a.ctatdebug("init ()");
    if (null == f) {
      a.ctatdebug("Error: document root to be parsed is null.");
    } else {
      a.ctatdebug("Root name: " + b.getElementName(f));
      f = b.getElementChildren(f);
      for (var c = 0;c < f.length;c++) {
        var e = f[c], h = b.getElementName(e);
        a.ctatdebug("Examining element: " + b.getElementName(e));
        if ("Problems" == h) {
          a.ctatdebug("Processing Problems ...");
          for (var e = b.getElementChildren(e), l = 0;l < e.length;l++) {
            var m = e[l];
            ...
            var p = new CTATProblem;
            p.setName(b.getElementAttr(m, "name"));
            p.setLabel(b.getElementAttr(m, "label"));
            p.setDescription(b.getElementAttr(m, "description"));
            p.setTutorFlag(b.getElementAttr(m, "tutor_flag"));
            p.setProblemFile(b.getElementAttr(m, "problem_file"));
            p.setStudentInterface(b.getElementAttr(m, "student_interface"));
            a.ctatdebug("Adding problem ...");
            d.push(p);
          }
        }
        "ProblemSets" == h && a.ctatdebug("Processing ProblemSets ...");
        "Assets" == h && a.ctatdebug("Processing Assets ...");
      }
    }
  };
...
var CTATScrollPaneComponent = function(a, b, d, f, g) {
  ...
  this.postProcess = function() {
    ...
    e.ctatdebug("Final location: " + e.getX() + "," + e.getY() + " with text: " + e.getText());
    null === commShell || void 0 === commShell ? e.ctatdebug("Error: can't add event listener to commshell, pointer is invalid") : commShell.addGlobalEventListener(this);
  };
...
var CTATButton = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    e.type = "button";
    e.name = c.getName();
    e.value = $(this.getDivWrap()).attr("value") || "-1";
    ...
    c.addComponentReference(c, e);
    c.getDivWrap().appendChild(e);
    e.addEventListener("click", c.processClick);
    e.addEventListener("focus", c.processFocus);
    e.addEventListener("mousedown", this.processBaseMousedown);
    e.addEventListener("mouseup", this.processBaseMouseup);
    e.addEventListener("mouseover", c.processBaseMouseover);
    e.addEventListener("mouseout", c.processBaseMouseout);
  }.bind(this);
  this.render = function() {
  };
  this.reset = function() {
...
var CTATSequencer = function() {
  ...
  var a = this, b = new CTATPackage, d = new CTATXML, f = null, g = "sequential", c = null;
  ...
  this.handlePackageRetrieval = function(e) {
    a.ctatdebug("handlePackageRetrieval ()");
    b.init(e);
    null != c && c();
  };
  this.processXML = function(e) {
    a.ctatdebug("parseXML ()");
    b.init(e);
    null != c && c();
  };
  this.init = function(b, g) {
    a.ctatdebug("init ()");
    c = g;
    f = new CTATCommLibrary(null, !1);
    f.retrieveXMLFile(b, d, this);
  };
...
var CTATComboBox = function(a, b, d, f, g) {
  ...
  a = function(a) {
    h = a;
    e && (e.innerHTML = "", this.addLabels(l, h));
  }.bind(this);
  ...
  this.init = function() {
    ...
    m && e.setAttribute("size", m);
    var a = this.getDivWrap().innerHTML;
    console.log('content:"', a.trim(), '"');
    this.getDivWrap().innerHTML = "";
    a.trim() && (e.innerHTML = a);
...
CTAT.Component.Base.UnitDisplay = function(a, b, d, f, g, c, e) {
  ...
  var l = "#FF00FF", m = 1, p = "#FF00FF", n = .2, r = "black", q = 1;
  ...
  this.clickHandler = function(a) {
    !0 === x.getEnabled() && (a = CTATGlobalFunctions.toBoolean(this.getAttributeNS(null, "data-selected")), y(this, !a), x.setActionInput("SetPieces", x.updateValue()), x.processAction());
  };
  this.updateSAI = function() {
    x.setActionInput("SetPieces", x.updateValue());
  };
  ...
  this.set_denominator = function(a) {
    x.setHintHighlight(!1);
    var b = "string" === typeof a ? parseInt(a) : a;
    if (!isNaN(b) && (b = D(b), this.get_denominator() != a)) {
      var c = x.evaluate();
      x.clear();
      a = [];
      c.set_denominator(b);
      ...
      b.equals(0) || (a.push(C(b, !0)), a.push(C(e.subtract(b), !1)), f--);
      for (b = 0;b < f;b++) {
        a.push(C(e, !1));
      }
      this.setValue(a.join("+"));
      x.setActionInput("SetPieces", h);
      x.processAction();
      return h;
    }
  };
  this.get_denominator = function() {
    return u.reduce(function(a, b, c, e) {
  ...
  d = function(a) {
    return (a = $(this.getDivWrap()).attr(a)) ? a.split(/\s*;\s*/).map(function(a) {
      return a.trim();
    }) : [];
  };
  a = d.bind(this, "data-ctat-ctrl-denominator");
  b = d.bind(this, "data-ctat-ctrl-partition");
  d = d.bind(this, "data-ctat-ctrl-numerator");
  f = function(a, b) {
    return 0 <= a().indexOf(b);
  };
  var w = f.bind(null, a), G = f.bind(null, b), t = f.bind(null, d), F = function(a) {
    var b = null;
    if (a instanceof CTAT.Component.Base.Tutorable) {
      a != this && (b = a.getName());
    } else {
      if (a instanceof CTATSAI) {
        a.getSelection() != x.getName() && (b = a.getSelection());
      } else {
        if (a instanceof String) {
          a != x.getName() && (b = a);
        } else {
          if (a instanceof Element) {
            a != x.getComponent() && (b = a.id);
          } else {
            return null;
          }
        }
    ...
    if (b) {
      ...
      if (t(b)) {
        return H.bind(this, this.change_numerator, this.set_numerator);
      }
      if (G(b)) {
        return H.bind(this, this.change_number_pieces, this.set_number_pieces);
      }
    }
    return null;
  }.bind(this);
...
try {
  ...
  if (console.log("WARNING: new DOMPoint():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("   Using shim!"), DOMPoint = function(b, d, f, g) {
...
var CTATPieChart = function(a, b, d, f, g) {
  ...
  var c = 3, e = 3, h = this, l, m, p, n = null, r = CTATGlobals.NameSpace.svg;
  this.init = function() {
    this.initSVG();
    ...
    n = document.createElementNS(r, "feOffset");
    n.setAttributeNS(null, "in", "SourceAlpha");
    n.setAttributeNS(null, "result", "offOut");
    n.setAttributeNS(null, "dx", e);
    n.setAttributeNS(null, "dy", e);
    l.appendChild(n);
    ...
    0 < e && this.baseGroup.setAttributeNS(null, "filter", p);
    this.drawPieces();
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      ...
      a.reduce(function(a, b, e, l) {
        if (1 <= b.valueOf()) {
          e = document.createElementNS(r, "circle"), e.classList.add("CTATPieChart--piece"), e.cx.baseVal.value = f.x, e.cy.baseVal.value = f.y, e.r.baseVal.value = d, this.addPieceElem(e, b, b.selected), g.appendChild(e);
        } else {
          e = document.createElementNS(r, "path");
          e.classList.add("CTATPieChart--piece");
          g.appendChild(e);
          window.getComputedStyle(e);
          var m = 2 * Math.PI * a.valueOf();
          l = f.add(CTAT.Geom.Point.polar(d, m));
          b.reduce();
          var q = f.add(CTAT.Geom.Point.polar(d, 2 * Math.PI * b.valueOf() + m)), p = f.clone();
          if (0 < c && c < d) {
            ...
            l = CTAT.Geom.Point.circle_intersection(p, l, f, d).reduce(n.bind(this, l));
            q = q.add(m);
            q = CTAT.Geom.Point.circle_intersection(p, q, f, d).reduce(n.bind(this, q));
          }
          m = CTAT.Geom.Point.to2DString;
          p = "M " + m(p);
          n = new DOMPoint(d, d);
          p += " L " + m(l);
          p += " A " + m(n) + " 0 " + (.5 < b.valueOf() ? 1 : 0) + ",1 " + m(q);
          e.setAttributeNS(null, "d", p + " Z");
  ...
  this.setDropShadowDistance = function(a) {
    e = parseInt(a);
    e = isNaN(e) ? 0 : e;
    n && (n.setAttributeNS(null, "dx", e), n.setAttributeNS(null, "dy", e), 0 >= e && this.baseGroup ? this.baseGroup.removeAttributeNS(null, "filter") : this.baseGroup.hasAttributeNS(null, "filter") || this.baseGroup.setAttributeNS(null, "filter", p));
  };
...
var CTATSubmitButton = function(a, b, d, f, g) {
  ...
  this.setParameterHandler("target_components", function(a) {
    this.getDivWrap().setAttribute("data-ctat-target", a);
    return this;
  });
  var e = null, h = this.init;
  this.init = function() {
    h();
    e = this.getDivWrap();
  ...
  var l = function(a) {
    var b = e ? e.getAttribute("data-ctat-target") : null;
    if (b && (targets = {}, String(b).split(/\s*[;,]\s*/).forEach(function(a) {
      return targets[a.trim()] = 1;
    }), 0 !== Object.keys(targets).length && a !== c)) {
      if (a instanceof CTAT.Component.Base.Tutorable) {
        return targets.hasOwnProperty(a.getName()) || targets.hasOwnProperty(a.getComponentGroup());
      }
      if (a instanceof CTATSAI) {
        return a.getSelection() != c.getName() && targets.hasOwnProperty(a.getSelection());
      }
      if (a instanceof String) {
        return a != c.getName() && targets.hasOwnProperty(a);
      }
      if (a instanceof Element) {
        return a != c.getComponent() && (targets.hasOwnProperty(a.id) || targets.hasOwnProperty(a.getAttribute("name")));
      }
    }
    return !1;
  };
  ...
  this.processClick = function(a) {
    if (!0 === c.getEnabled()) {
      for (var b in targets) {
        a = CTATShellTools.findComponent(b), null !== a && 0 < a.length && (a = a[0], a instanceof CTAT.Component.Base.Tutorable ? a.getEnabled() && a.grade(c) : this.ctatdebug("Invalid target component: " + a));
      }
    }
  };
};
...
var CTATGroupingComponent = function(a, b, d, f, g) {
  ...
  var c = this, e = c.isTabIndexable = !1, h = [], l = "";
  this.init = function() {
    c.ctatdebug("init (" + c.getName() + ")");
    _tutorComponent = CTAT.Component.Base.Tutorable.Options.TutorComponent.DO_NOT_TUTOR;
    c.addCSSAttribute("z-index", CTATGlobalFunctions.gensym.z_index());
    h = [];
    c.getDivWrap().getAttribute("data-ctat-scroll-to-highlighted");
    e = CTATGlobalFunctions.stringToBoolean(c.getDivWrap().getAttribute("data-ctat-use-componentlist"));
    c.ctatdebug("Use a component list? " + e);
    if (1 == e) {
      for (var a = c.getDivWrap().getAttribute("data-ctat-componentlist").split(","), b = 0;b < a.length;b++) {
        c.ctatdebug("Adding component to group: " + a[b].trim()), h.push(a[b].trim());
      }
      c.ctatdebug("Controlling " + h.length + " components");
    } else {
      a = c.getDivWrap().getAttribute("data-ctat-target-div"), null != a ? (l = a.trim(), c.ctatdebug("Controlling " + l + " target div")) : (c.ctatdebug("No target div provided, assuming we should use ourselves: " + c.getName()), l = c.getName());
    }
    1 == e && (c.setWidth(0), c.setHeight(0), a = c.getDivWrap(), null != a && (a.style.visibility = "hidden"));
    c.setInitialized(!0);
  };
  this.postProcess = function() {
  ...
  this.lock = function(a) {
    ...
    if (1 == e) {
      for (a = 0;a < h.length;a++) {
        var b = h[a];
        c.ctatdebug("Resolving component " + b + " to pointer ...");
        b = CTATShellTools.findComponent(b);
        void 0 != b && null != b ? b[0].lock() : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    }
  };
  this.highlight = function(a) {
    c.ctatdebug("highlight ()");
    if (1 == e) {
      for (a = 0;a < h.length;a++) {
        var b = h[a];
        c.ctatdebug("Resolving component " + b + " to pointer ...");
        b = CTATShellTools.findComponent(b);
        void 0 != b && null != b ? b[0].highlight() : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    } else {
      c.highlight();
    }
  ...
  this.unhighlight = function(a) {
    c.ctatdebug("unhighlight ()");
    if (1 == e) {
      for (a = 0;a < h.length;a++) {
        var b = h[a];
        c.ctatdebug("Resolving component " + b + " to pointer ...");
        b = CTATShellTools.findComponent(b);
        void 0 != b && null != b ? b[0].unhighlight() : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    } else {
      c.unhighlight();
    }
  ...
  this.move = function(a, b) {
    ...
    var d = a, f = b;
    void 0 == b || null == b ? (c.ctatdebug("Detected single argument call to this function, processing ..."), -1 != d.indexOf(",") && (c.ctatdebug("Processing string argument ..."), d = d.split(","), a = new Number(d[0].trim()), b = new Number(d[1].trim()))) : "object" === typeof b ? -1 != d.indexOf(",") && (c.ctatdebug("Processing string argument ..."), d = d.split(","), a = new Number(d[0].trim()), b = new Number(d[1].trim())) : (c.ctatdebug("Incoming arguments are two strings, converting to numbers ..."), 
    a = new Number(d), b = new Number(f));
    c.ctatdebug("move (" + a + "," + b + ")");
    if (1 == e) {
      for (d = 0;d < h.length;d++) {
        f = h[d], c.ctatdebug("Resolving component " + f + " to pointer ..."), f = CTATShellTools.findComponent(f), void 0 != f && null != f ? f[0].move(a, b) : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    } else {
      d = c.getDivWrap(), null != d && (d.style.left = c.getWidth() + a + "px", d.style.top = c.getHeight() + b + "px");
    }
  };
  ...
  this.setSize = function(a, b) {
    ...
    if (1 == e) {
      for (d = 0;d < h.length;d++) {
        f = h[d], c.ctatdebug("Resolving component " + f + " to pointer ..."), f = CTATShellTools.findComponent(f), void 0 != f && null != f ? f[0].setSize(a, b) : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    } else {
      d = c.getDivWrap(), null != d && (d.style.width = a + "px", d.style.height = b + "px");
    }
  };
  ...
  this.SetVisible = function(a) {
    ...
    c.ctatdebug("SetVisible (" + b + ")", "graphics");
    if (1 == e) {
      for (b = 0;b < h.length;b++) {
        var d = h[b];
        c.ctatdebug("Resolving component " + d + " to pointer ...");
        d = CTATShellTools.findComponent(d);
        void 0 != d && null != d ? d[0].SetVisible(a) : c.ctatdebug("Unable to resolve component name to component pointer");
      }
    } else {
      a = document.getElementById(l), void 0 != a && null != a && (a.style.visibility = 0 == b ? "hidden" : "visible");
    }
  };
};
...
var CTATSkillWindow = function(a, b, d, f, g) {
  ...
  this.setThreshold = function(a) {
    $(this.getDivWrap()).attr("data-ctat-threshold", a);
  };
    ...
    if (null === skillSet) {
      ...
      if (null === a) {
        ...
        if (0 >= a.length) {
          ...
          for (var b = document.createDocumentFragment(), d = this.getThreshold(), f = 0;f < a.length;f++) {
            var g = a[f];
            c.ctatdebug("Drawing skill " + f + " " + g.getDisplayName() + " level: " + g.getLevel() + " ...");
            var r = document.createElement("div");
            r.classList.add("CTATSkillWindow--skill");
            var q = document.createElement("div");
            q.classList.add("CTATSkillWindow--bar");
            var u = document.createElement("div"), x = g.getLevel();
            x < d ? u.classList.add("CTATSkillWindow--bar--nonmastered") : u.classList.add("CTATSkillWindow--bar--mastery");
            u.style.width = x > d ? "100%" : 100 * x + "%";
            q.appendChild(u);
            r.appendChild(q);
            b.appendChild(r);
            q = document.createElement("div");
            q.textContent = g.getDisplayName() || "no-name";
            q.classList.add("CTATSkillWindow--label");
            r.appendChild(q);
          }
          e.innerHTML = "";
          e.appendChild(b);
...
var CTATDoneButton = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    this.setComponent(a);
    var b = document.createElement("div");
    b.classList.add("CTAT-done-button--content");
    a.appendChild(b);
    var c = document.createElement("div");
    c.textContent = "\u2714";
    c.classList.add("CTAT-done-button--icon");
    b.appendChild(c);
    this.getText() && (c = document.createElement("div"), c.classList.add("CTAT-done-button--text"), c.textContent = this.getText(), b.appendChild(c));
    this.getDivWrap().appendChild(a);
    a.addEventListener("mouseenter", function(a) {
...
;var CTATMovieClip = function(a, b, d, f, g) {
  ...
  this.wrapComponent = function(a) {
    ...
    p.setAttribute("style", "z-index: " + c);
    p.setAttribute("width", f + "px");
    p.setAttribute("height", g + "px");
    p.setAttribute("style", "border: 0px; position: absolute; left:" + b + "px; top:" + d + "px; z-index:" + h + ";");
    a.appendChild(p);
    return p;
  };
...
var CTATTextBasedComponent = function(a, b, d, f, g, c, e) {
  ...
  var r = this.processAction.bind(this);
  this.processAction = function(a, b) {
    this.updateSAI();
    CTATGlobalFunctions.isBlank(this.getValue()) || r(a, b);
  };
  ...
  this.updateSAI = function() {
    h.ctatdebug("updateSAI ()");
    this.setInput(this.getValue());
    var a = this.getSAI();
    h.ctatdebug("SAI: " + a.toTSxmlString());
  };
};
...
var CTATTable = function(a, b, d, f, g) {
  CTAT.Component.Base.Tutorable.call(this, "CTATTable", "__undefined__", a, b, d, f, g);
  var c = this;
  c.isTabIndexable = !1;
  ...
  this.setParameterHandler("FirstRowIsHeader", function(a) {
    $(this.getDivWrap()).attr("data-ctat-has-header", a);
  });
  var e = 0;
  ...
  a = function(a) {
    a = parseInt($(this.getDivWrap()).attr(a));
    return isNaN(a) ? 2 : a;
  };
  var h = a.bind(this, "data-ctat-num-rows");
  this.set_row_count = function(a) {
    $(this.getDivWrap()).attr("data-ctat-num-rows", a);
  };
  var l = a.bind(this, "data-ctat-num-cols");
  this.set_col_count = function(a) {
    $(this.getDivWrap()).attr("data-ctat-num-cols", a);
  };
  this.setStyleHandler("inspBackgroundColor", null);
  this.setStyleHandler("HeaderBackground", null);
  this.init = function() {
    c.ctatdebug("init (" + c.getName() + ")");
    c.setInitialized(!0);
    var a = c.getDivWrap();
    ...
    this.get_first_row_is_header() ? (m(), e = 1) : e = 0;
  };
  var m = function() {
    $(this.getDivWrap()).children().first().addClass("CTATTable--headers").children().addClass("CTATTable--header");
  }.bind(this), p = function(a, b) {
    var c = document.createElement("div"), e = this.getName() + ".R" + a + "C" + b;
    c.id = e;
    c.classList.add("CTATTable--cell");
    c.classList.add("CTATTextArea");
    var d = new CTATTextArea;
    d.setName(e);
    d.setDivWrapper(c);
    d.processAttributes();
    d.init();
    d.processTabOrder();
    d.setEnabled(this.getEnabled());
    $(c).data("CTATComponent", d);
    return c;
  }.bind(this);
  this.addRow = function() {
    var a = document.createElement("div");
    a.classList.add("CTATTable--row");
    for (var b = h(), c = 0;c < l();c++) {
      var e = p(b, c);
      a.appendChild(e);
    }
    $(this.getDivWrap()).append(a);
    this.set_row_count(b + 1);
  };
  this.addColumn = function() {
    var a = l(), b = 0;
    $(this.getDivWrap()).children().each(function() {
      var c = $(this), d = p(b, a);
      b < e && d.classList.add("CTATTable--header");
      c.append(d);
      b++;
    });
    this.set_col_count(a + 1);
  };
  var n = function(a) {
    var b = document.createElement("div");
    a = this.getName() + ".R0C" + a;
    b.id = a;
    b.classList.add("CTATTable--header");
    b.classList.add("CTATTextField");
    var c = new CTATTextField;
    c.setName(a);
    c.setDivWrapper(b);
    c.processAttributes();
    c.init();
    c.processTabOrder();
    $(b).data("CTATComponent", c);
    return b;
  }.bind(this);
  (function() {
    c.ctatdebug("begin header creation");
    var a = document.createElement("div");
    a.classList.add("CTATTable--headers");
    a.classList.add("CTATTable--row");
    $(this.getDivWrap()).prepend(a);
    for (var b = 0;b < l();b++) {
      var d = n(b);
      a.appendChild(d);
    }
  ...
  this.adjustTableContents = function() {
    ...
    for (var a = 0;a < h();a++) {
      var b = document.createElement("div");
      b.classList.add("CTATTable--row");
      $(this.getDivWrap()).append(b);
      for (var e = 0;e < l();e++) {
        var d = c.getName() + ".R" + a + "C" + e, f = CTATShellTools.findComponent(d);
        null === f || 0 === f.length || f[0].getName() !== d ? (d = p(a, e), b.appendChild(d)) : (f[0].getDivWrap().classList.add("CTATTable--cell"), b.appendChild(f[0].getDivWrap()));
      }
    }
  };
};
...
;var CTATAudioButton = function(a, b, d, f, g) {
  ...
  this.setSource = function(a) {
    this.getDivWrap().setAttribute("data-ctat-src", a);
    return this;
  };
  ...
  this.logAudioEvent = function(a) {
    ...
    if (void 0 !== e.duration) {
      if (null !== commShell) {
        a = new CTATSAI(c.getName(), a, c.toHHMMSS(e.currentTime) + ".000", "");
        a.addSelection(encodeURIComponent(e.currentSrc), "media_file");
        a.addSelection(c.toHHMMSS(e.duration) + ".000", "clip_length");
        var b = a.getInputObject();
        null !== b && b.setType("time");
        commShell.processComponentAction(a, !1, !0, c, "AUDIO_ACTION", "USER");
      } else {
        c.ctatdebug("Error: commShell is null, can't send untutored tool message");
      }
    } else {
      c.ctatdebug("Error: audio file not loaded yet, can't obtain duration");
    }
  };
  this.processClick = function(a) {
    c.ctatdebug("processClick (" + a.currentTarget.getAttribute("id") + " -> " + a.eventPhase + ")");
    !0 === c.getEnabled() ? (a = this.getSource(), c.ctatdebug("Playing audio file: " + a), e.setAttribute("src", a), e.play(), h = "play", c.processAction()) : c.ctatdebug("Component is disabled, not grading");
  }.bind(this);
  this.play = function() {
    c.ctatdebug("play");
...
var CTATVideo = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    this.getDivWrap() && $(e.getDivWrap()).attr("data-ctat-controls") ? h.controls = CTATGlobalFunctions.toBoolean($(this.getDivWrap()).attr("data-ctat-controls")) : h.controls = !0;
    h.autocontrols = !1;
    e.ctatdebug("Auto play: " + $(e.getDivWrap()).attr("data-ctat-autoplay"));
    this.getDivWrap() && $(e.getDivWrap()).attr("data-ctat-autoplay") ? h.autoplay = CTATGlobalFunctions.toBoolean($(this.getDivWrap()).attr("data-ctat-autoplay")) : h.autoplay = !0;
    e.ctatdebug("Auto play: " + h.autoplay);
    h.name = e.getName();
    ...
    e.ctatdebug("Resizing component to: " + $(e.getDivWrap()).width() + "," + $(e.getDivWrap()).height());
    h.addEventListener("focus", this.processFocus);
    h.addEventListener("canplay", function() {
      e.ctatdebug("Video loaded and ready for play");
    }, !0);
    h.addEventListener("play", function() {
      e.ctatdebug("Video loaded and ready for play");
      e.logVideoEvent("play");
    }, !0);
    h.addEventListener("pause", function() {
      e.ctatdebug("Video loaded and ready for play");
      e.logVideoEvent("pause");
    }, !0);
    h.setAttribute("width", $(e.getDivWrap()).width());
    h.setAttribute("height", $(e.getDivWrap()).height());
  };
  this.logVideoEvent = function(a) {
    e.ctatdebug("logVideoEvent (" + a + ")");
    if (void 0 !== h.duration) {
      if (null !== commShell) {
        a = new CTATSAI(e.getName(), a, e.toHHMMSS(h.currentTime) + ".000", "");
        a.addSelection(encodeURIComponent(h.currentSrc), "media_file");
        a.addSelection(e.toHHMMSS(h.duration) + ".000", "clip_length");
        var b = a.getInputObject();
        null !== b && b.setType("time");
        commShell.processComponentAction(a, e.getTutorComponent, !0, e, "VIDEO_ACTION", "USER");
      } else {
        e.ctatdebug("Error: commShell is null, can't send untutored tool message");
      }
    } else {
      e.ctatdebug("Error: audio file not loaded yet, can't obtain duration");
    }
  };
...
var CTATNumericStepper = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    "autofocus defaultValue placeholder value max min readOnly step".split(" ").forEach(function(c) {
      var d = a.attr(c);
      d && b.attr(c, d);
    });
    this.getDivWrap().innerHTML = "";
...
var CTATHintWindow = function(a, b, d, f, g) {
  ...
  var c = this;
  c.isTabIndexable = !1;
  var e = null, h = null, l = null, m = null, p = CTATGlobals.languageManager.getString("NEXT"), n = CTATGlobals.languageManager.getString("PREVIOUS"), r = null;
  ...
  this.init = function() {
    ...
    m.appendChild(e);
    e.classList.add("CTATHintWindow--hint-content");
    var a = document.createElement("div");
    a.classList.add("CTATHintWindow--hint-button-area");
    m.appendChild(a);
    if (q) {
      h = document.createElement("button"), h.classList.add("CTATHintWindow--previous"), h.innerHTML = q;
    } else {
      h = document.createElement("button");
      h.classList.add("CTATHintWindow--previous");
      var b = document.createElement("span");
      b.classList.add("CTATHintWindow--button-icon");
      b.textContent = "\u25c0";
      h.appendChild(b);
      n && (b.style.cssFloat = "left", h.appendChild(document.createTextNode(n)));
    }
    h.addEventListener("click", function(a) {
      CTATShellTools.showPrevHint();
    }, !1);
    a.appendChild(h);
    r ? (l = document.createElement("button"), l.classList.add("CTATHintWindow--next"), l.innerHTML = r) : (l = document.createElement("button"), l.classList.add("CTATHintWindow--next"), b = document.createElement("span"), b.classList.add("CTATHintWindow--button-icon"), b.textContent = "\u25b6", p && (b.style.cssFloat = "right", l.appendChild(document.createTextNode(p))), l.appendChild(b));
    ...
    var d = function(a) {
      this.disabled = !a;
      a || (this.classList.remove("CTAT-hint-button--hover"), this.classList.remove("CTAT-hint-button--clicked"));
    };
...
var CTATTextInput = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    var d = $(e);
    "autofocus defaultValue maxLength pattern placeholder readOnly size title".split(" ").forEach(function(a) {
      var c = b.attr(a);
      c && d.attr(a, c);
    });
    c.setInitialized(!0);
...
var CTATDragNDrop = function() {
  ...
  var a = function(a) {
    ...
    var c = $(this).parent().attr("name"), d = $(this).parent().attr("id");
    b.dataTransfer.setData("ctat/group", c);
    b.dataTransfer.setData("ctat/source", d);
    b.dataTransfer.setData("text", this.id);
    var e = a(this.id);
    CTATDragNDrop.dragging[e] = {id:this.id, group:c, source:d};
  ...
  this.init = function() {
    ...
    this.setComponent(f);
    CTATComponentReference.add(this, f);
    $(f).children().addClass("CTATDragNDrop--item").attr({unselectable:"on", draggable:!0}).each(function() {
    ...
    this.component.addEventListener("drop", function(a) {
      ...
      if (b.getEnabled()) {
        ...
        a.dataTransfer.getData("ctat/source");
        a = document.getElementById(c);
        this.appendChild(a);
        $("#" + c).removeClass("CTAT--correct CTAT--incorrect CTAT--hint");
        b.setActionInput("Add", c);
        b.processAction();
      }
    }, !1);
  ...
  this.setEnabled = function(a) {
    g(a);
    f && ($(f).children().attr("draggable", a), this.getDisableOnCorrect() && $(f).find(".CTAT--correct").attr("draggable", !1));
  };
  this.Add = function(a) {
    a = $("#" + a);
    0 < a.length && $(a).detatch().appendTo(this.getDivWrap());
    $(a).hasClass("CTATDragNDrop--item") || ($(a).addClass("CTATDragNDrop--item").attr({unselectable:"on", draggable:!0}), a.addEventListener("dragstart", b, !1), a.addEventListener("dragend", d, !1));
  };
  ...
  var c = this.showCorrect.bind(this);
  this.showCorrect = function(a) {
    switch(a.getAction()) {
      case "Add":
        this.setEnabled(!0);
        a = a.getInput();
        $("#" + a).addClass("CTAT--correct");
        this.getDisableOnCorrect() && $("#" + a).attr("draggable", !1);
        break;
      default:
        c(a);
    }
  };
  var e = this.showInCorrect.bind(this);
  this.showInCorrect = function(a) {
    switch(a.getAction()) {
      case "Add":
        a = a.getInput();
        $("#" + a).addClass("CTAT--incorrect");
        break;
      default:
        e(a);
    }
...
try {
  ...
  if (console.log("WARNING: new DOMRect():", a, typeof a), a instanceof ReferenceError || a instanceof TypeError) {
    console.log("    Using shim!"), DOMRect = function(b, d, f, g) {
      this.x = b || 0;
      this.y = d || 0;
      this.width = f || 0;
      this.height = g || 0;
...
var CTATNumberLine = function(a, b, d, f, g) {
  ...
  a = function(a, b, d, f, g) {
    ...
    this.generate = function() {
      if (this.numberline) {
        ...
        g && $(d).find("text.CTATNumberLine--tickmark-label").each(function() {
  ...
  var h = new a(this, new c(1), 30, "CTATNumberLine--large-tickmark", "CTATNumberLine--large-tickmark-label");
  ...
  var l = new a(this, new c(1, 2), 20, "CTATNumberLine--small-tickmark", "CTATNumberLine--small-tickmark-label");
  ...
  var m = new a(this, new c(0), 25, "CTATNumberLine--denominator-tickmark", "CTATNumberLine--denominator-tickmark-label");
  ...
  this.setPointSize = function(a) {
    n = Number(a);
    x && (x.setAttributeNS(null, "r", n), $(this._point_group).find("circle").each(function() {
      $(this).attr("r", n);
    }));
  };
  ...
  this.genTickmark = function(a, b, c) {
    ...
    if (!this._tickmarks.some(function(b) {
      ...
      if ("" !== b) {
        ...
        g.classList.add("CTATNumberLine--tickmark-label");
        g.setAttributeNS(null, "text-anchor", "middle");
        d.appendChild(g);
        if (null === b || void 0 === b) {
          if (1 == a.denominator) {
            g.appendChild(document.createTextNode(String(a.numerator.toPrecision(S)))), g.setAttributeNS(null, "x", c.x), g.setAttributeNS(null, "y", c.y);
          } else {
            b = "" + String(a.numerator);
            h = "" + String(a.denominator);
            g.style.fontSize = "0.6em";
            g.setAttributeNS(null, "text-align", "center");
            var l = document.createElementNS(e, "tspan"), m = document.createElementNS(e, "tspan");
  ...
  var q = function() {
    if (null !== this.X_Axis && null !== this.X_Axis.svg_group) {
      var a = this.getBoundingBox(), b = window.getComputedStyle(this._axis_line_group), b = parseInt(b.getPropertyValue("stroke-width")), a = CTAT.Geom.Rectangle.inflate(a, -b, -b), c = new DOMPoint(a.width / 2, a.height / 2), d = c.add(CTAT.Geom.Point.polar(Math.min(40, a.height, a.width) / 4, this.theta)), f = Math.sin(this.theta), g = -Math.cos(this.theta), q = f * c.x + g * c.y, p = -a.height * g, n = -f * a.width, b = new DOMPoint(a.left, c.y), c = new DOMPoint(a.right, c.y);
      if (0 < Math.abs(CTAT.Math.round(p))) {
        var p = new DOMPoint(a.left, (q - f * a.left) / g), r = new DOMPoint(a.right, (q - f * a.right) / g);
        if (a.contains(p) || a.contains(r)) {
          d.distance(p) < d.distance(r) ? (b = r, c = p) : (b = p, c = r);
        }
      }
      0 < Math.abs(CTAT.Math.round(n)) && (n = new DOMPoint((q - g * a.top) / f, a.top), f = new DOMPoint((q - g * a.bottom) / f, a.bottom), a.contains(n) || a.contains(f)) && (d.distance(n) < d.distance(f) ? (b = f, c = n) : (b = n, c = f));
  ...
  }.bind(this), u = 0, x = null, B = new DOMPoint(-30, -30), y = !1, A = function(a) {
    B.x = a.clientX;
    B.y = a.clientY;
  }, C = function(a) {
    ...
    if (!0 === this.getEnabled() && 0 < p) {
      this.setHintHighlight(!1);
      var b;
      r ? (a = t(a.clientX, a.clientY), b = a.location, a = a.data) : (a = w(a.clientX, a.clientY), b = this.X_Axis.getProjectedPoint(a), a = this.X_Axis.getAxisValue(a));
      var c = document.createElementNS(e, "circle");
      c.classList.add("CTATNumberLine--point");
  ...
  this.init = function() {
    ...
    x = document.createElementNS(e, "circle");
    x.setAttributeNS(null, "r", n);
    x.classList.add("CTATNumberLine--cursor");
    x.setAttributeNS(null, "transform", "translate(-30,-30)");
    ...
    this.component.addEventListener("mouseenter", function() {
      !0 === a() && 0 < p && (y = !0, x.style.visibility = null, u = requestAnimationFrame(F));
    });
    this.component.addEventListener("click", E);
    this.component.addEventListener("focus", this.processFocus);
  };
  var D = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"), w = function(a, b) {
    ...
    if (D) {
      var d = $(this.component), e = parseInt(d.css("borderLeftWidth")) + parseInt(d.css("paddingLeft")) + parseInt(d.css("marginLeft")), d = parseInt(d.css("borderTopWidth")) + parseInt(d.css("paddingTop")) + parseInt(d.css("marginTop"));
      c.x -= e;
      c.y -= d;
    }
    return c;
  }.bind(this), G = function(a, b) {
    return this.getProjectedPoint(w(a, b));
  }.bind(this.X_Axis), t = function(a, b) {
    for (var c = G(a, b), d = null, e = Number.POSITIVE_INFINITY, f, g, h = 0;h < this._tickmarks.length;h++) {
      f = this._tickmarks[h], g = c.distance(f.location), g < e && (d = f, e = g);
    }
    return d;
  }.bind(this), F = function() {
    if (y && !0 === this.getEnabled()) {
      if (r) {
        var a = t(B.x, B.y);
        x.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(a.location, !0));
      } else {
        x.setAttributeNS(null, "transform", "translate" + CTAT.Geom.Point.to2DString(G(B.x, B.y), !0));
      }
  ...
  var H = function(a, b) {
    ...
    var c = b.clone();
    c.setAction(a.getSAI().getAction());
    c.setSelection(a.getName());
    return c;
  };
  this.showCorrect = function(a) {
    a.getInput();
    var b = a.getAction(), c = function(b) {
      b.setCorrect(H(b, a));
    };
    switch(b) {
      case "AddPoint":
        0 < this._point_group.children.length && (b = [].slice.call(this._point_group.children), c = b[b.length - 1], c.classList.remove("CTAT--incorrect"), c.classList.remove("CTAT--hint"), c.classList.add("CTAT--correct"), this.getDisableOnCorrect() && (b.length >= this.Max_Points && b.every(function(a) {
          return a.classList.contains("CTAT--correct");
      ...
      case "Points":
        ...
        for (c = 0;c < b.length;c++) {
          var d = b[c];
          d.classList.remove("CTAT--incorrect");
          d.classList.remove("CTAT--hint");
          d.classList.add("CTAT--correct");
        }
        break;
      case "set_minimum":
        P(O()).forEach(c);
      ...
      case "set_denominator":
        ...
        break;
      default:
        console.log("Unhandled Action in", this.getName(), b);
    }
  };
  this.showInCorrect = function(a) {
    a.getInput();
    var b = a.getAction(), c = function(b) {
      b.setIncorrect(H(b, a));
    };
    switch(b) {
      case "AddPoint":
        0 < this._point_group.children.length && (b = [].slice.call(this._point_group.children), b = b[b.length - 1], b.classList.remove("CTAT--correct"), b.classList.remove("CTAT--hint"), b.classList.add("CTAT--incorrect"));
        break;
      case "Points":
        b = this._point_group.children;
        for (c = 0;c < b.length;c++) {
          var d = b[c];
          d.classList.remove("CTAT--correct");
          d.classList.remove("CTAT--hint");
          d.classList.add("CTAT--incorrect");
        }
        break;
      case "set_minimum":
        P(O()).forEach(c);
  ...
  var L = function() {
    this.setActionInput("set_large_step", h.step.toString());
  }.bind(this);
  this.set_small_step = a.bind(this, l);
  var J = function() {
    this.setActionInput("set_small_step", l.step.toString());
  }.bind(this);
  this.set_denominator = function(a) {
  ...
  var N = function() {
    var a = 0 === m.step.valueOf() ? 0 : m.step.reciprocal();
    this.setActionInput("set_denominator", a.toString());
  }.bind(this);
  a = function(a, b) {
    if (0 !== (new c(b)).valueOf()) {
      var d = a.step.add(b);
      0 > d.valueOf() && d.set(0, 1);
      a.setStep(d);
      this.render();
    }
  };
  ...
  this.AddPoint = function(a, b) {
    var d = new c(a), f = this.X_Axis.getPosition(d), g = document.createElementNS(e, "circle");
    g.classList.add("CTATNumberLine--point");
    g.setAttributeNS(null, "cx", f.x);
    g.setAttributeNS(null, "cy", f.y);
    g.setAttributeNS(null, "r", n);
    g.value = d;
    [].slice.call(this._point_group.children).some(function(a) {
      return d.equals(a.value);
    }) || this._point_group.appendChild(g);
  };
  ...
  var Q = function(a, b, c, d) {
    switch(d.getAction()) {
      ...
      ;
      case "UpdateTextArea":
        b.call(this, d.getInput());
    }
    c.call();
    this.processAction(!1, !0);
  };
  a = function(a) {
    return (a = $(this.getDivWrap()).attr(a)) ? a.split(/\s*;\s*/).map(function(a) {
      return a.trim();
  ...
  var K = a.bind(this, "data-ctat-ctrl-max"), O = a.bind(this, "data-ctat-ctrl-min"), R = a.bind(this, "data-ctat-ctrl-large-tick"), M = a.bind(this, "data-ctat-ctrl-small-tick"), T = a.bind(this, "data-ctat-ctrl-denominator"), P = function(a) {
    return a.map(function(a) {
      return $("#" + a).data("CTATComponent");
    });
  }, Z = function(a) {
    var b = null;
    if (a instanceof CTAT.Component.Base.Tutorable) {
      ...
      if (a instanceof CTATSAI) {
        a.getSelection() != pointer.getName() && (b = a.getSelection());
      } else {
        if (a instanceof String) {
          a != pointer.getName() && (b = a);
        } else {
          if (a instanceof Element) {
            a != pointer.getComponent() && (b = a.id);
          } else {
            return null;
          }
        }
    ...
    if (b) {
      if (U(b)) {
        return Q.bind(this, this.change_denominator, this.set_denominator, N);
      }
      if (V(b)) {
        return Q.bind(this, this.change_small_step, this.set_small_step, J);
      }
      if (W(b)) {
        return Q.bind(this, this.change_large_step, this.set_large_step, L);
      }
      if (X(b)) {
        return Q.bind(this, this.change_minimum, this.set_minimum, z);
      }
      if (Y(b)) {
        return Q.bind(this, this.change_maximum, this.set_maximum, I);
      }
    }
    return null;
  }.bind(this);
  ...
  var Y = a.bind(null, K), X = a.bind(null, O), W = a.bind(null, R), V = a.bind(null, M), U = a.bind(null, T);
  this.grade = function(a) {
    a = a.getDivWrap().id;
    Y(a) ? (this.setAction("set_maximum"), this.setInput(this.Maximum.toString())) : X(a) ? (this.setAction("set_minimum"), this.setInput(this.Minimum.toString())) : W(a) ? (this.setAction("set_large_step"), this.setInput(h.step.toString())) : V(a) ? (this.setAction("set_small_step"), this.setInput(l.step.toString())) : U(a) ? (this.setAction("set_denominator"), this.setInput(m.step.reciprocal().toString())) : this.updateSAI();
    this.processAction(!0);
  };
  this.updateSAI = function() {
  ...
  this.drawPieces = function() {
    if (this.baseGroup) {
      for (var a = this.parseValue(), b = 0, d = document.createDocumentFragment(), f = 0;f < a.length;f++) {
        var g = a[f], n = 100 * g, r = document.createElementNS(c, "rect");
        r.classList.add("CTATFractionBar--piece");
        r.setAttributeNS(null, "height", "100%");
        r.setAttributeNS(null, "width", n + "%");
        r.setAttributeNS(null, "y", 0);
        r.setAttributeNS(null, "x", b + "%");
        this.addPieceElem(r, g, g.selected);
        d.appendChild(r);
        var q = document.createElementNS(c, "text");
        q.classList.add("CTATFractionBar--label");
        q.setAttributeNS(null, "text-anchor", "middle");
        q.setAttributeNS(null, "dominant-baseline", "middle");
        d.appendChild(q);
        var r = "" + String(g.numerator), g = "" + String(g.denominator), u = document.createElementNS(c, "tspan"), x = document.createElementNS(c, "tspan");
        u.appendChild(document.createTextNode(r));
        x.appendChild(document.createTextNode(g));
        q.appendChild(u);
        q.appendChild(x);
        q = b + n / 2;
        u.setAttributeNS(null, "x", q + "%");
        u.setAttributeNS(null, "y", "60%");
        u.setAttributeNS(null, "dy", "-1em");
        x.setAttributeNS(null, "x", q + "%");
        x.setAttributeNS(null, "y", "60%");
        r.length > g.length ? u.style.textDecoration = "underline" : x.style.textDecoration = "overline";
        b += n;
      }
      this.baseGroup.innerHTML = "";
      this.baseGroup.appendChild(d);
      var B = this.baseGroup.getBBox().width - 1;
      Array.prototype.slice.call(this.baseGroup.childNodes).forEach(function(a) {
        if ("rect" == a.nodeName) {
          ...
          1 > b.x ? d -= c / 2 : (e += c / 2, d = b.x + b.width >= B ? d - c / 2 : d - c);
...
var CTATTextField = function(a, b, d, f, g) {
  ...
  this.init = function() {
    e = this.getDivWrap();
    c.setComponent(e);
    this.getText() && (e.innerHTML = c.getText());
    c.setInitialized(!0);
    c.addComponentReference(c, e);
    c.setEditable(!1);
    c.setEnabled(!1);
    c.render();
    c.addSafeEventListener("focus", c.processFocus, e);
    0 < e.innerHTML.trim().length && (console.log(e.innerHTML), this.setInput(e.innerHTML.toString()), this.processAction());
  };
  this.setText = function(a) {
    c.ctatdebug("setText (" + a + ")");
    c.assignText(a);
...
var CTATCheckBox = function(a, b, d, f, g) {
  ...
  this.init = function() {
    ...
    c.type = "checkbox";
    c.setAttribute("id", this.getName() + "_check");
    c.classList.add("CTATCheckBox--button");
    this.getText() ? c.value = h.getText() : this.getDivWrap() && this.getDivWrap().textContent ? c.value = this.getDivWrap().textContent : c.value = c.id;
    this.getComponentGroup() ? c.name = h.getComponentGroup() : this.getDivWrap() && $(this.getDivWrap()).attr("name") ? c.name = $(this.getDivWrap()).attr("name") : c.name = "checkBoxGroup";
    !0 === h.getEnabled() ? c.disabled = !1 : c.disabled = !0;
    h.ctatdebug("Final location: " + h.getX() + "," + h.getY() + " with text: " + h.getText());
    h.addComponentReference(h, c);
    var a = this.getDivWrap().innerHTML;
    this.getDivWrap().innerHTML = "";
    $(h.getDivWrap()).append(c);
    e = document.createElement("label");
    e.htmlFor = c.id;
    e.classList.add("CTATCheckBox--label");
    this.getText() ? e.textContent = this.getText() : a && (e.innerHTML = a);
    $(this.getDivWrap()).append(e);
    h.setComponent(c);
    c.addEventListener("click", l.bind(this));
    c.addEventListener("focus", h.processFocus);
    ...
    $("." + a).each(function() {
      if (!$(this).data("CTATComponent")) {
        ...
        if (0 == a.isFeedbackComponent()) {
          var f = new CTATComponentDescription;
          f.type = a.getClassName();
          f.name = a.getName();
          f.setComponentPointer(a);
          CTATShellTools.registerComponentDescription(f);
        }
    ...
    for (var b in CTATShellTools.component_descriptions) {
      ...
      if (-1 == a.name.indexOf("null.")) {
        if (ctatdebug("Component: " + a.name + ", type: " + a.type), "CTATCommShell" == a.type) {
          ...
          CTAT.ComponentRegistry.hasOwnProperty(a.type) ? (ctatdebug("Creating (" + a.type + ") :" + a.name), d = new CTAT.ComponentRegistry[a.type](a, a.x, a.y, a.width, a.height), d.setName(a.name), "CTATTextInput" != a.type && "CTATTextArea" != a.type || d.setEnabled(!0), d.setTabIndex(a.tabIndex), a.setComponentPointer(d), d.initialize(), ctatdebug(d.getDivWrap())) : ctatdebug("ERROR: Unrecognized component type " + a.type + " for " + a.name);
        }
      }
    }
    this.postProcess();
...
CTATTutor.createStaticInterface = function(a, b, d) {
  ...
  for (a = 0;a < b.length;a++) {
    ...
    var e, h, l, m;
    "shape" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), c = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating shape: " + c + " at: " + e + "," + h + "," + l + "," + m), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), m = new Image, m.setAttribute("style", "position: absolute; top: " + h + "px; left:" + e + "px; z-index:" + 
    CTATGlobalFunctions.gensym.z_index() + ";"), m.setAttribute("id", c), m.setAttribute("src", l), f.appendChild(m));
    "statictext" == this.parser.getElementName(g) && (e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), c = this.parser.getElementAttr(g, "instance"), ctatdebug("Creating static text: " + c + " at: " + e + "," + h + "," + l + "," + m), l = "data:image/png;base64, " + this.parser.getNodeTextValue(g), m = new Image, m.setAttribute("style", "position: absolute; top: " + h + "px; left:" + 
    e + "px; z-index:" + CTATGlobalFunctions.gensym.z_index() + ";"), m.setAttribute("id", c), m.setAttribute("src", l), f.appendChild(m));
    "statictext" == this.parser.getElementName(g) && (c = this.parser.getElementAttr("instance"), ctatdebug("Creating movieclip: " + c), e = this.parser.getElementAttr(g, "x"), h = this.parser.getElementAttr(g, "y"), l = this.parser.getElementAttr(g, "width"), m = this.parser.getElementAttr(g, "height"), e = new CTATMovieClip(c, e, h, l, m), h = e.wrapComponent(f), ctatdebug("Created movieclip: " + c + " at: " + e.x + "," + e.y + "," + e.width + "," + e.height), movieclips.push(e), g = this.parser.getElementChildren(g), 
...
CTATTutor.initTutor = function(a, b, d, f) {
  ctatdebug("initTutor() #aFlashVars " + (a ? a.length : null) + ", usingFlash " + f);
  1 != CTATTutor.tutorInitialized && (CTATConfiguration.generateDefaultConfigurationObject(), CTATConfiguration.setParams(a), null == f && (f = CTATConfiguration.getSingleParameterValues(["student_interface", "swf_name"]).some(function(a) {
  ...
  {jnlp_href:"/ctat_applet/TSApplet.jnlp"}, "1.6"), f || CTATTutor.runTutor(a), CTATTutor.tutorInitialized = !0);
};
...
Array.from || (Array.from = function() {
  ...
  return function(a) {
    ...
    for (var l = b(this) ? Object(new this(h)) : Array(h), m = 0, p;m < h;) {
      p = g[m], l[m] = c ? "undefined" === typeof e ? c(p, m) : c.call(e, p, m) : p, m += 1;
    }
    l.length = h;
    return l;
  };
...
String.fromCodePoint || function() {
  var a = function() {
    ...
    var a = [], c, e, f = -1, l = arguments.length;
    if (!l) {
      return "";
    }
    for (var m = "";++f < l;) {
...
(function(a) {
  ...
  var f = /[^s]/, g = /[def]/, c = /^[^\x25]+/, e = /^\x25{2}/, h = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/, l = /^([a-z_][a-z_\d]*)/i, m = /^\.([a-z_][a-z_\d]*)/i, p = /^\[(\d+)\]/, n = /^[\+\-]/;
  b.format = function(a, c) {
    var e = 1, h = a.length, l = "", m = [], p, r, D, w, G = !0, t = "";
    for (p = 0;p < h;p++) {
      if (l = d(a[p]), "string" === l) {
        m[m.length] = a[p];
      } else {
        if ("array" === l) {
          D = a[p];
          if (D[2]) {
            for (l = c[e], r = 0;r < D[2].length;r++) {
              if (!l.hasOwnProperty(D[2][r])) {
                throw Error(b("[sprintf] property '%s' does not exist", D[2][r]));
              }
              l = l[D[2][r]];
            }
          } else {
          ...
          "function" == d(l) && (l = l());
          if (f.test(D[8]) && "number" != d(l) && isNaN(l)) {
            throw new TypeError(b("[sprintf] expecting number but found %s", d(l)));
          }
          g.test(D[8]) && (G = 0 <= l);
          switch(D[8]) {
            case "b":
            ...
            case "d":
              ...
              break;
            case "e":
              l = D[7] ? l.toExponential(D[7]) : l.toExponential();
              break;
            case "f":
              l = D[7] ? parseFloat(l).toFixed(D[7]) : parseFloat(l);
              break;
            case "o":
              l = l.toString(8);
              break;
            case "s":
              l = (l = String(l)) && D[7] ? l.substring(0, D[7]) : l;
              break;
            case "u":
              l >>>= 0;
              break;
          ...
          if (!G || g.test(D[8]) && D[3]) {
            t = G ? "+" : "-", l = l.toString().replace(n, "");
          }
          r = D[4] ? "0" == D[4] ? "0" : D[4].charAt(1) : " ";
          w = D[6] - (t + l).length;
          w = D[6] ? Array(w + 1).join(r) : "";
          m[m.length] = D[5] ? t + l + w : 0 == r ? t + w + l : w + t + l;
        }
      }
    }
    return m.join("");
        ...
        if (null !== (b = e.exec(a))) {
          ...
          if (null !== (b = h.exec(a))) {
            if (b[2]) {
              var f = f | 1, g = [], n = b[2], r = [];
              if (null !== (r = l.exec(n))) {
                for (g[g.length] = r[1];"" !== (n = n.substring(r[0].length));) {
                  if (null !== (r = m.exec(n))) {
                    g[g.length] = r[1];
                  } else {
                    if (null !== (r = p.exec(n))) {
  ...
  "undefined" !== typeof exports ? (exports.sprintf = b, exports.vsprintf = r) : (a.sprintf = b, a.vsprintf = r, "function" === typeof define && define.amd && define(function() {
    return {sprintf:b, vsprintf:r};
  }));
...
var ProblemStateSaver = function(a) {
  ...
  this.tracer = a;
  var b = this, d = [], f = null, g = "", c = "", e = 0;
  this.saveAsYouGo = function(f) {
    b.ctatdebug("saveAsYouGo() curriculum_service_url " + g + ", tracer " + a);
    if (a && f) {
      var l = {};
      ...
      for (var m = 0;m < d.length;++m) {
        d[m] && (l.problem_state += d[m]);
      }
      l.problem_state += ProblemStateSaver.MESSAGES_TAG.replace("<", "</");
      ++e;
      b.ctatdebug("saveAsYouGo[" + e + "] to send problem_state length " + l.problem_state.length);
      CTATLMS.saveProblemState && CTATLMS.saveProblemState(l);
      CTATLMS.gradeStudent && CTATLMS.gradeStudent(parseInt(f.getCorrect()), parseInt(f.getRequiredSteps()));
      CTATLMS.commit && CTATLMS.commit();
    } else {
  ...
  this.setCurriculumServiceUrl = function(a) {
    b.ctatdebug("ProblemStateSaver.setCurriculumServiceUrl() old " + g + ", new " + a);
    g = a;
  };
...
ProblemStateSaver.prototype.replaceInProblemState = function(a, b, d, f) {
  this.ctatdebug("PSS.replaceInProblemState(" + CTATMsgType.getMessageType(a) + ", " + d + ", " + f + ")");
  if (b.mustSaveForRestore() && ProblemStateSaver.mustSaveForRestore(CTATMsgType.getMessageType(a))) {
    b = this.getProblemState();
    a = this.editForProblemState(a);
    if (!f) {
      d = ProblemStateSaver.makeStepKey(d);
      f = this.getStepToIndexMap();
      this.ctatdebug("PSS.replaceInProblemState() stepKey" + d + ", index " + f.get(d) + ")");
      if (f.has(d)) {
        var g = f.get(d);
        b[g] = null;
      }
...
var ProblemStateRestorer = function(a) {
  ...
  this.retrieveMessages = function(d) {
    ...
    d.mustRetrieveProblemState() ? (a.stopWorking(1), CTATLMS.getProblemState && CTATLMS.getProblemState(b.process)) : console.log("Retrieval status indicates that we should not retrieve");
  };
      ...
      if (d.slice(0, ProblemStateSaver.MESSAGES_TAG.length) != ProblemStateSaver.MESSAGES_TAG) {
        ...
        if ("string" == typeof d && (d = d.split(/<\/?messages>/), b.ctatdebug("msgsArr.length " + d.length + ", msgsArr[1].length " + (d[1] ? d[1].length : -1)), !(2 > d.length))) {
          ...
          for (var c = 0, e = !1, h = 1;h < d.length;++h) {
            var l = "<message>" + d[h], m = CTATMsgType.getMessageType(l);
            CTATMsgType.STATE_GRAPH == m ? e = !0 : CTATMsgType.START_STATE_END == m ? e = !1 : e ? c++ : CTATMsgType.INTERFACE_ACTION == m && h == d.length - 1 && CTATMsgType.isDoneMessage(l) && a.getOutputStatus().isComplete() || (a.getProblemStateSaver().appendToProblemState(l, null, !0), g.push(l));
            b.ctatdebug("problemStateArr[" + h + "] " + (e ? "omit " : "keep ") + m + " omitted " + c + " kept " + g.length);
          }
        }
...
var CTATProblemSummary = function(a, b, d) {
  ...
  var f = !0, g = Number.MAX_VALUE, c = b, e = d, h = 0, l = new Date, m = {}, p = 0, n = 0, r = 0, q = 0, u = 0, x = 0, B = 0, y = CTATMsgType.CompletionValue[0], A = this;
  ...
  this.getUniqueErrors = function() {
    if (!A.getCountOnlyLastResults()) {
      return B;
    }
    var a = 0, b;
    for (b in m) {
      m[b].getLastResult() == CTATStep.StepResult[1] && a++;
    }
    return a;
  };
  this.getUniqueCorrect = function() {
    ...
    var a = 0, b;
    for (b in m) {
      m[b].getLastResult() == CTATStep.StepResult[3] && a++;
    }
    return a;
  };
  ...
  this.getHintsOnly = function() {
    var a = 0, b;
    for (b in m) {
      CTATStep.StepResult[2] == m[b].getResult() && 1 > m[b].getNErrors() && ++a;
    }
    return a;
  };
  this.getErrorsOnly = function() {
    var a = 0, b;
    for (b in m) {
      CTATStep.StepResult[1] == m[b].getResult() && 1 > m[b].getNFirstHints() && ++a;
    }
    return a;
  };
  ...
  this.toXML = function(b) {
    var c, d = "";
    c = "" + (' ProblemName="' + a + '"');
    c += ' CompletionStatus="' + y + '"';
    f && (c += ' Correct="' + p + '"', c += ' UniqueCorrect="' + A.getUniqueCorrect() + '"', c += ' UniqueCorrectUnassisted="' + x + '"', c += ' Hints="' + n + '"', c += ' UniqueHints="' + q + '"', c += ' HintsOnly="' + A.getHintsOnly() + '"', c += ' Errors="' + r + '"', c += ' UniqueErrors="' + A.getUniqueErrors() + '"', c += ' ErrorsOnly="' + A.getErrorsOnly() + '"', c += ' UniqueSteps="' + A.getUniqueSteps() + '"', c += ' RequiredSteps="' + A.getRequiredSteps() + '"');
    c += ' TimeElapsed="' + h + '"';
    f && (d = A.getSkills() ? A.getSkills().toXML(b) : "");
  ...
  this.addHint = function(a) {
    A.ctatdebug("addHint(" + a + ")");
    var b = m[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNFirstHints() && ++q, b.incrementFirstHints()) : (b = new CTATStep(a, CTATStep.StepResult[2]), m[a] = b, q++);
    n++;
    b.setLastResult(CTATStep.StepResult[2]);
    A.ctatdebug("exiting addHint() hint count " + n + ", trial " + b);
  };
  this.addError = function(a) {
    A.ctatdebug("addError(" + a + ")");
    var b = m[a];
    null !== b && "undefined" !== typeof b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && ++B, b.incrementErrors()) : (b = new CTATStep(a, CTATStep.StepResult[1]), m[a] = b, B++);
    r++;
    b.setLastResult(CTATStep.StepResult[1]);
    A.ctatdebug("exiting addError() error count " + r + ", trial " + b);
  };
  this.addCorrect = function(a) {
    var b = m[a];
    A.ctatdebug("entering addCorrect(" + a + ") trial " + b);
    b ? (1 > b.getNCorrect() && 1 > b.getNErrors() && (++u, 1 > b.getNFirstHints() && x++), b.incrementNCorrect()) : (A.ctatdebug("to call CTATStep(" + a + ", StepResult " + CTATStep.StepResult[3]), b = new CTATStep(a, CTATStep.StepResult[3]), m[a] = b, u++, x++);
    p++;
    b.setLastResult(CTATStep.StepResult[3]);
    A.ctatdebug("exiting addCorrect() correct count " + p + ", trial " + b);
  };
  this.setShowCounts = function(a) {
    f = a;
  };
  this.setCompletionStatus = function(a, b) {
    A.ctatdebug("setCompletionStatus(" + a + ", " + b + ")");
    if (CTATMsgType.CompletionValue[1] != y || b) {
      y = a;
    }
  };
  ...
  a = function(a) {
    ...
    d.prototype.combineSimilar = function() {
      ...
      this.factors.forEach(function(b) {
        ...
        })) ? d[1] += (null != (f = p[1]) ? f.evaluate() : void 0) || 1 : a.push([p[0], (null != (g = p[1]) ? g.evaluate() : void 0) || 1]);
      });
    ...
    d.prototype.compare = function(a, b) {
      var f, l;
      return (l = d.__super__.compare.apply(this, arguments)) || this.countVariables() - a.countVariables() || (f = a.factors.slice(0).reverse()) && this.factors.slice(0).reverse().some(function(a, c) {
        return l = a.compare(f[c], b);
...
var CTATAlgebraGrammar = {}, parser = function() {
  ...
  var b = function(a, b, c, d) {
    ...
    return c;
  }, d = [1, 6], f = [1, 7], g = [1, 10], c = [1, 11], e = [1, 12], h = [1, 13], l = [1, 21], m = [1, 22], p = [5, 7, 8, 9, 10, 11, 12, 13, 15, 26], n = [1, 23], r = [1, 24], q = [1, 26], u = [1, 27], x = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 24, 25, 26, 27, 28], B = [5, 7, 8, 9, 10, 11, 12, 13, 15, 16, 18, 20, 21, 23, 24, 25, 26, 27, 28], b = {trace:function() {
  ...
  }, table:[{3:1, 4:2, 6:3, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {1:[3]}, {5:[1, 14]}, {5:[2, 8], 7:[1, 15], 8:[1, 16], 9:[1, 17], 10:[1, 18], 11:[1, 19], 12:[1, 20], 13:l, 15:m}, b(p, [2, 11], {22:9, 19:25, 16:n, 18:r, 20:q, 21:u, 24:g, 25:c, 27:e, 28:h}), b(x, [2, 17]), {13:d, 15:f, 17:28, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:29, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(x, [2, 20]), b(x, [2, 23], {23:[1, 30]}), {13:d, 15:f, 17:31, 19:8, 22:9, 24:g, 25:c, 27:e, 
  28:h}, {6:32, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(B, [2, 25]), b(B, [2, 26]), {1:[2, 1]}, {6:33, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {6:34, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {6:35, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {6:36, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {6:37, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {6:38, 13:d, 14:4, 15:f, 17:5, 19:8, 22:9, 
  24:g, 25:c, 27:e, 28:h}, {13:d, 14:39, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 14:40, 15:f, 17:5, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:41, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:42, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(x, [2, 14]), {13:d, 15:f, 17:43, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, {13:d, 15:f, 17:44, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(x, [2, 18]), b(x, [2, 19]), {13:d, 15:f, 17:45, 19:8, 22:9, 24:g, 25:c, 27:e, 28:h}, b(x, [2, 22]), {13:l, 
  15:m, 26:[1, 46]}, {5:[2, 2], 13:l, 15:m}, {5:[2, 3], 13:l, 15:m}, {5:[2, 4], 13:l, 15:m}, {5:[2, 5], 13:l, 15:m}, {5:[2, 6], 13:l, 15:m}, {5:[2, 7], 13:l, 15:m}, b(p, [2, 9], {22:9, 19:25, 16:n, 18:r, 20:q, 21:u, 24:g, 25:c, 27:e, 28:h}), b(p, [2, 10], {22:9, 19:25, 16:n, 18:r, 20:q, 21:u, 24:g, 25:c, 27:e, 28:h}), b(x, [2, 12]), b(x, [2, 13]), b(x, [2, 15]), b(x, [2, 16]), b(x, [2, 21]), b(B, [2, 24])], defaultActions:{14:[2, 1]}, parseError:function(a, b) {
    if (b.recoverable) {
      this.trace(a);
    } else {
      var c = function(a, b) {
    ...
    var b = [0], c = [null], d = [], e = this.table, f = "", g = 0, h = 0, l = 0, m = d.slice.call(arguments, 1), q = Object.create(this.lexer), n = {}, p;
    for (p in this.yy) {
    ...
    for (var u, x, B, K, O = {}, R, M;;) {
      ...
      if ("undefined" === typeof K || !K.length || !K[0]) {
        ...
        M = [];
        for (R in e[B]) {
          this.terminals_[R] && 2 < R && M.push("'" + this.terminals_[R] + "'");
        }
        T = q.showPosition ? "Parse error on line " + (g + 1) + ":\n" + q.showPosition() + "\nExpecting " + M.join(", ") + ", got '" + (this.terminals_[u] || u) + "'" : "Parse error on line " + (g + 1) + ": Unexpected " + (1 == u ? "end of input" : "'" + (this.terminals_[u] || u) + "'");
        this.parseError(T, {text:q.match, token:this.terminals_[u] || u, line:q.yylineno, loc:p, expected:M});
      }
      if (K[0] instanceof Array && 1 < K.length) {
        throw Error("Parse Error: multiple actions possible at state: " + B + ", token: " + u);
      }
      switch(K[0]) {
        case 1:
          b.push(u);
          ...
          b.push(K[1]);
          u = null;
          x ? (u = x, x = null) : (h = q.yyleng, f = q.yytext, g = q.yylineno, p = q.yylloc, 0 < l && l--);
          break;
        case 2:
          M = this.productions_[K[1]][1];
          O.$ = c[c.length - M];
          ...
          r && (O._$.range = [d[d.length - (M || 1)].range[0], d[d.length - 1].range[1]]);
          B = this.performAction.apply(O, [f, h, g, n, K[1], c, d].concat(m));
...
(function() {
  var a, b, d, f, g, c, e, h, l, m, p, n = [].slice;
  g = /^(\d+)?(?:$|(?:\s|^)(\d+)\/(\d+)$)/;
  f = /^\d+(\.\d\d)?$/;
  ...
  a = function() {
    ...
    a.matchWithPrecision = function(a, c) {
      var d, e;
      return (d = String(a).match(m)) && (e = String(c).match(m)) && p(d) === p(e) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    a.matchWithoutPrecision = function(a, c) {
      var e, f;
      return (e = String(a).match(m)) && (f = String(c).match(m)) && (a = p(e) > p(f) ? (+a).toFixed(d(f)) : String(a)) && b(a, c, function(a, b) {
        return a === b;
      });
    };
    ...
    a.pointInRange = function(a, b, c, d, e) {
      var f, g, h;
      if (f = null != b ? "function" === typeof b.match ? b.match(l) : void 0 : void 0) {
        e = [f[1], f[8], c, d], b = e[0], c = e[1], d = e[2], e = e[3];
      }
      null == d && (d = 0);
      null == e && (e = d);
      return (f = a.match(l)) && b - d <= (g = f[1]) && g <= +b + +d && c - e <= (h = f[8]) && h <= +c + +e;
    };
    ...
    a.columnCell = function(a, b, c, d, e, f, g, h, l, m) {
      switch(l) {
        case "r1c1":
        ;
        case "r2c1":
    ...
    a.goToState = function(a) {
      return CTAT.ToolTutor.tutor.goToState(a);
    };
  ...
  a = function() {
    ...
    a.prototype.evaluate = function(a, c, l, m) {
      ...
      try {
        ...
        B = null != (x = a.match(b)) ? x : [];
        n = 0;
        for (q = B.length;n < q;n++) {
          r = B[n], 0 > g.call(d, r) && CTATFormulaFunctions.assign(r, void 0);
        }
        for (r in y = this.variableTable.getTable()) {
          u[r] = y[r];
        }
        ...
        }).apply(u, [c, l, m].concat(f.call(this.values)));
      } catch (A) {
        return console.log(A), null;
      } finally {
        for (r in u) {
          null != r && 0 > g.call(p, r) && (y[r] = u[r], delete u[r]);
        }
      }
    };
    ...
    a.prototype.interpolate = function(a, b, c, d) {
      var f, g, r, q, u;
      q = a.split(this.interpolateSplitPattern);
      u = [];
      a = g = 0;
      for (r = q.length;g < r;a = ++g) {
        f = q[a], u.push(a % 2 ? this.evaluate(f, b, c, d) : f);
      }
      return u.join("");
    };
    return a;
...
var CTATSingleMatcher = function(a, b) {
  ...
  this.evaluateReplacement = function(a, b, f) {
    ...
    d.ctatdebug("CTATSingleMatcher calling CTATFormulaParser.evaluate(" + g + ", " + l + ", " + m + ", " + a + ")");
    try {
      f = b.evaluate(g, l, m, a);
    } catch (p) {
      d.ctatdebug("CTATSingleMatcher error from CTATFormulaParser.evaluate(" + g + ") " + p.name + ": " + p.message), f = null;
    }
...
var CTATExpressionMatcher = function(a, b) {
  function d(a, b, d, e, g) {
    ...
    var q = CTATVariableTable.standardizeType(d);
    h.ctatdebug("CTATExpressionMatcher.testVector typeof input " + typeof d + "; inputConv " + q + ", typeof " + typeof q);
    d = h.evaluate(a, b, q, g);
    h.ctatdebug("CTATExpressionMatcher.testVector evaluate(" + a + ", " + b + ", " + q + ", " + g + ") returned " + d + ", type " + typeof d);
    g = null;
    switch(e) {
...
var CTATVectorMatcher = function(a, b, d, f) {
  function g(a, b, d, f, g) {
    m.ctatdebug("CTATVectorMatcher --\x3e in _match(" + a + ", " + b + ", " + d + ", " + f + ")");
    if (0 === c.length || 0 === e.length || 0 === h.length) {
      c.push(new CTATExactMatcher(CTATMatcher.SELECTION, m.array2ConcatString(m.getDefaultSelectionArray()))), e.push(new CTATExactMatcher(CTATMatcher.ACTION, m.array2ConcatString(m.getDefaultActionArray()))), h.push(new CTATExactMatcher(CTATMatcher.INPUT, m.array2ConcatString(m.getDefaultInputArray())));
    }
    var x = [];
    x[CTATMatcher.SELECTION] = a;
    x[CTATMatcher.ACTION] = b;
    x[CTATMatcher.INPUT] = d;
    for (var B = 0;3 > B;B++) {
      var y = l[B][0], A = y instanceof CTATExpressionMatcher ? y.matchConcatenation(a, b, d, f) : y.matchConcatenation(x[B]);
      m.ctatdebug("CTATVectorMatcher --\x3e in _match[" + B + "] after " + y + ".concat returns: " + A);
      if (g) {
        g.push(A);
      } else {
        if (!1 === A) {
  ...
  var c = a instanceof Array ? a : [], e = b instanceof Array ? b : [], h = d instanceof Array ? d : [], l = [];
  l[CTATMatcher.SELECTION] = c;
  l[CTATMatcher.ACTION] = e;
  ...
  this.getAction = function() {
    return 0 === e.length ? m.getDefaultAction() : e[0].getAction();
  };
  ...
  this.setDefaultAction = function(a) {
    return 0 === e.length ? m.internalSetDefaultAction(a) : e[0].setDefaultAction(a);
  };
...
var CTATExampleTracerLink = function(a, b, d) {
  ...
  var f = "undefined" === typeof a || null === a ? null : a, g = null, c = "undefined" === typeof b || null === b ? null : b, e = "undefined" === typeof d || null === d ? null : d, h = null, l = 1, m = 1, p = "CORRECT_ACTION", n = [], r = !1, q = null, u = "", x = null, B = null, y = this;
  ...
  this.isCorrect = function() {
    return p == CTATExampleTracerLink.CORRECT_ACTION;
  };
  ...
  this.addSkillName = function(a) {
    y.ctatdebug("ETLink[" + f + "].addSkillName(" + a + ")");
    if ("unnamed" !== a) {
      if (null === B || "undefined" === typeof B) {
        B = [];
      }
      -1 < B.indexOf(a) || (B.push(a), y.ctatdebug("ETLink.addSkillName() return with skillNames " + B));
    }
  };
  ...
  this.setIsPreferredLink = function(a) {
    y.ctatdebug("ETLink.setIsPreferredLink() was " + r + ", now " + a);
    r = a;
  };
...
var CTATExampleTracerSkill = function(a, b, d, f, g, c, e) {
  ...
  var h = null == a || "" == a.trim() ? b : b + " " + a, l = Number(d);
  Number.isNaN(l) && (l = CTATExampleTracerSkill.DEFAULT_P_GUESS);
  var m = Number(f);
  Number.isNaN(m) && (m = CTATExampleTracerSkill.DEFAULT_P_KNOWN);
  var p = Number(c);
  Number.isNaN(p) && (p = CTATExampleTracerSkill.DEFAULT_P_LEARN);
  var n = Number(g);
  Number.isNaN(n) && (n = CTATExampleTracerSkill.DEFAULT_P_SLIP);
  var r = /^0*[xX]([0-9a-fA-F]+)$/.test(e) ? parseInt(e, 16) : /^(\-|\+)?[0-9]+$/.test(e) ? parseInt(e, 10) : CTATExampleTracerSkill.DEFAULT_HISTORY, q = 0, u = 0, x = CTATExampleTracerSkill.SKILL_BAR_DELIMITER_v2_11, B = CTATExampleTracerSkill.DEFAULT_MASTERY_THRESHOLD, y = null, A = null, C = this;
  this.getSkillName = function() {
    return h;
  };
  this.getCategory = function() {
  ...
  this.updatePKnown = function(a) {
    return m = CTATExampleTracerSkill.updatePKnownStatic(a, l, m, n, p);
  };
  this.updateHistory = function(a) {
    return r = CTATExampleTracerSkill.updateHistoryStatic(a, r);
  };
  ...
  this.toXML = function(a) {
    ...
    b += ' pLearn="' + Number(p).toFixed(2) + '"';
    b += ' pGuess="' + Number(l).toFixed(2) + '"';
    b += ' pSlip="' + Number(n).toFixed(2) + '"';
    b += ' history="' + r + '"';
    b += ' opportunityCount="' + u + '"';
    return a ? "&lt;Skill" + b + " /&gt;" : "<Skill" + b + " />";
  };
  this.hasReachedMastery = function() {
    return null === m || "undefined" === typeof m ? !1 : m >= B;
  };
  this.getLabel = function() {
    return !y || 1 > y.length ? CTATExampleTracerSkill.getName(h) : y;
  };
  this.getDescription = function() {
    return !A || 1 > A.length ? h : A;
  };
  this.setVersion = function(a) {
    null !== a && "undefined" !== typeof a && 0 < a.length && (x = CTATExampleTracerSkill.versionToSkillBarDelimiter(a));
  };
...
var CTATExampleTracerPathComparator = function() {
  ...
  this.breakByLowerLinkID = function(b, d) {
    ...
    var f = b.getSortedLinks(), g = d.getSortedLinks(), c = null, e = null, h = 0, l = 0;
    do {
      a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID in do while"), l >= f.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 1 is shorter"), h = -1) : l >= g.length ? (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path 2 is shorter"), h = 1) : (a.ctatdebug("CTATExampleTracerPathComparator --\x3e in breakByLowerLinkID path are same, compare IDS"), c = f[l], e = g[l]), l++;
...
var CTATExampleTracerPath = function(a) {
  ...
  var d = null, f = null, g = null, c = null, e = null, h = null, l = this;
...
var CTATExampleTracerInterpretation = function(a) {
  ...
  this.updateVariableTable = function(a, b, c) {
    ...
    f.put(b, e);
    f.put(CTATVariableTable.nameAsString(b), CTATVariableTable.valueAsString(e));
...
var CTATExampleTracerEvent = function(a, b, d) {
  ...
  var f = "", g = !1, c = CTATExampleTracerLink.NO_MODEL, e = !1, h = null, l = null, m = "student", p = null, n = null, r = "", q = null, u = null, x = null, B = null, y = null, A = [], C = !1, E = null, D = null, w = this;
  this.getActor = function() {
    return m;
  };
  this.setActor = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e setActor(" + a + ")");
    m = a;
  };
  this.getStudentSAI = function() {
    w.ctatdebug("CTATExampleTracerEvent.getStudentSAI() returning type " + typeof h + ", value " + h);
    return h;
  };
  this.setStudentSAI = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setStudentSAI(" + a + ")");
    null !== a && "undefined" !== typeof a && (h = a);
    w.ctatdebug("CTATExampleTracerEvent --\x3e out of setStudentSAI");
  };
  this.getPreloadedLinkMatches = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getPreloadedLinkMatches");
    return u;
  };
  this.setTutorSAI = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setTutorSAI");
    null !== a && "undefined" !== typeof a && (l = a);
    w.ctatdebug("CTATExampleTracerEvent --\x3e out of setTutorSAI");
  };
  this.setNumberOfInterpretations = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setNumberOfInterpretations( " + a + " )");
  };
  this.getTransactionID = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getTransactionID() returning " + f);
    return f;
  };
  this.setTransactionID = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setTransactionID( " + a + " )");
    f = a;
  };
  this.setDoneStepFailed = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setDoneStepFailed( " + a + " )");
    g = a;
  };
  ...
  this.setResult = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setResult( " + a + " )");
    c = a;
  };
  this.isSolverResult = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in isSolverResult");
    return !1;
  };
  this.getResult = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getResult() returning " + c);
    return c;
  };
  this.setReportableLink = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableLink(" + a + ")");
    p = a;
  };
  this.setReportableInterpretation = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableInterpretation(" + a + ")");
    n = a;
  };
  this.setStepID = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setStepID(" + a + ")");
    r = a ? a.toString() : "";
  };
  ...
  this.setSuccessOrBuggyMsg = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setSuccessOrBuggyMsg(" + a + ")");
    y = a;
  };
  this.setReportableHints = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setReportableHints(" + a + ")");
    A = Array.isArray(a) && 0 < a.length ? a : [];
  };
  this.getWantReportableHints = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getWantReportableHints() returning " + C);
    return C;
  };
  this.setOutOfOrder = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setOutOfOrder(" + a + ")");
    q = a;
  };
  this.isOutOfOrder = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getOutOfOrder() returning " + q);
    return q;
  };
  this.setEvaluatedInput = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setEvaluatedInput(" + a + ")");
  ...
  this.addPreloadedLinkMatch = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in addPreloadedLinkMatch(" + a + ")");
    if (null === u || "undefined" === typeof u) {
      u = [];
    }
    u.push(a);
  ...
  this.setInterpolatedSAI = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedSAI(" + a + ")");
    a && (E = a);
  };
  this.getInterpolatedSAI = function() {
    return E ? E : w.getStudentSAI();
  };
  this.setInterpolatedHints = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setInterpolatedHints(" + a + ")");
    null !== D && "undefined" !== typeof D && (D.length = 0);
    null !== a && "undefined" !== typeof a && (D = a.slice(0));
    w.ctatdebug("CTATExampleTracerEvent --\x3e out of setInterpolatedHints");
  };
  this.setWantReportableHints = function(a) {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in setWantReportableHints(" + a + ")");
    C = a;
  };
  this.getSuccessOrBuggyMsg = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getSuccessOrBuggyMsg() returning " + y);
    return y;
  };
  this.getReportableHints = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableHints() returning " + A);
    return A;
  };
  this.getReportableLink = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableLink() returning " + p);
    return p;
  };
  this.getReportableVariableTable = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableVariableTable() returning " + B);
    return B;
  };
  this.getReportableInterpretation = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getReportableInterpretation() returning " + n);
    return n;
  };
  this.getStepID = function() {
    w.ctatdebug("CTATExampleTracerEvent --\x3e in getStepID() returning " + r);
    return r;
  };
  ...
  this.getTutorInput = function() {
    return null !== x && "undefined" !== typeof x ? w.getEvaluatedInputArray() : null !== l && "undefined" !== typeof l ? l.getInputArray() : null;
  };
  ...
  this.toString = function() {
    var a;
    a = "[" + w.getResult();
    null !== w.getStudentSAI() && "undefined" !== typeof w.getStudentSAI() && (a += ", StudentSAI " + w.getStudentSAI());
    null !== w.getReportableLink() && "undefined" !== typeof w.getReportableLink() && (a += ", reportableLink " + w.getReportableLink());
    !0 === w.isDoneStepFailed() && (a += ", doneStepFailed");
    null !== w.getTutorSAI() && "undefined" !== typeof w.getTutorSAI() && (a += ", TutorSAI " + w.getTutorSAI());
    return a + "]";
  };
...
var CTATExampleTracerTracer_count = 0, CTATExampleTracerTracer = function(a, b) {
  function d(a, b, c) {
    ...
    b = new CTATFormulaParser(b);
    t.ctatdebug("CTATETT.interpolate(" + a + ",vt," + c + ")");
    var d = c.getSelection(), e = c.getAction();
    c = c.getInput();
    c = CTATVariableTable.standardizeType(c);
    t.ctatdebug("CTATETT.interpolate() calling CTATFP.interpolate(" + a + ", " + d + ", " + e + ", " + c);
    a = b.interpolate(a, d, e, c);
    t.ctatdebug("CTATETT.interpolate() returning " + a);
    return a;
  }
  function f(a, b, c, e, f, g) {
    null == e && (e = f.getLastMatchedLink());
    if (b) {
      t.ctatdebug("finishEvaluate -- in if Branch doUpdate()");
      ...
      if (c.toString() === CTATExampleTracerLink.CORRECT_ACTION.toString() || c.toString() === CTATExampleTracerLink.FIREABLE_BUGGY_ACTION.toString()) {
        t.ctatdebug("In evaluate -- in first branch doUpdate()");
        g.forEach(function(a) {
          a.getLastMatchedLink().getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString() && (t.ctatdebug("In evaluate -- deleting an incorrect interp"), g["delete"](a));
        });
        t.ctatdebug("In evaluate -- to call setInterpretations(), if 0 < newInterps.size " + g.size);
        0 < g.size && (n(g), w = f);
        for (var h in A) {
          A.hasOwnProperty(h) && delete A[h];
        }
        t.ctatdebug("In evaluate -- out of DoUpdate if branch");
      } else {
        t.ctatdebug("In evaluate -- in else branch of doUpdate");
    ...
    a.isSolverResult() || (t.ctatdebug("In evaluate inside the solver result if condition + " + c), a.setResult(c));
    t.ctatdebug("In evaluate out the solver result if condition");
    a.setReportableLink(e);
    a.setReportableInterpretation(f);
    a.setReportableVariableTable(f.getVariableTable());
    a.getHintRequest() || (b = e.getTutorSAI(a.getInterpolatedSAI(), f.getVariableTable()), t.ctatdebug("In evaluate -- TUTORSAI: " + b + ", studentSAI was " + a.getStudentSAI()), a.setTutorSAI(b));
    ...
    a.getHintRequest() && (f = e.interpolateHints(f.getVariableTable()), a.setInterpolatedHints(f), t.ctatdebug("In evaluate after calling setInterpolatedHints"), Array.isArray(f) && 0 < f.length ? a.setReportableHints(f) : a.setReportableHints(e.getHints()), t.ctatdebug("In evaluate --\x3e after setReportableHints"));
    t.ctatdebug("In evaluate after fireExampleTracerEvent");
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of finishEvaluate");
    return c.toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString();
  }
  function g(a, b, c, d) {
    t.ctatdebug("checkDoneStep() hintTrace " + b + ", sai " + a.getStudentSAI() + ", exitOnIncorrectDone " + E.exitOnIncorrectDone() + ", hideButRequireSteps " + E.hideButRequireSteps() + ", nInterps " + d.size);
    if (!a.getStudentSAI().isDone()) {
      return t.ctatdebug("checkDoneStep() not isDone(), so setDoneStepFailed(false) & return null "), null;
    }
    if (E.exitOnIncorrectDone()) {
      return a.setDoneStepFailed(!1), t.ctatdebug("checkDoneStep() exitOnIncorrectDone() with setDoneStepFailed(false), so return null "), null;
    }
    if (!b && E.hideButRequireSteps()) {
      b = E.getDoneLinks();
      t.ctatdebug("checkDoneStep getDoneLinks().size " + b.size);
      b = b.values();
      for (var e;!(e = b.next()).done;) {
        if (E.pathToLinkIsSubset(e.value, G)) {
          return a.setDoneStepFailed(!1), 1 > d.size ? f(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, t.getBestInterpretation(), t.getInterpretationsInternal()) : f(a, c, CTATExampleTracerLink.CORRECT_ACTION, e.value, p(d), d);
        }
      }
    }
  ...
  function c(a, b, c) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e _evaluate(" + a + ", " + b + ", " + c + ")");
    D = a;
    var d = new Set, n = a.getPreloadedLinkMatches();
    t.ctatdebug("interps # : " + y.length);
    t.ctatdebug("interps: " + y);
    y.forEach(function(f) {
      t.ctatdebug("In evaluate -- entered the interpretations loop");
      if ("undefined" === typeof n || null === n) {
        t.ctatdebug("In evaluate -- entered if check for saiLinkMatches"), n = h(a.getStudentSAI(), a.getActor(), b, f.getVariableTable(), a), t.ctatdebug("In evaluate -- exiting if check for saiLinkMatches");
      } else {
        for (var g = 0;g < n.length;++g) {
          e(a.getStudentSAI(), !0, n[g], n[g].getActor(), f.getVariableTable());
        }
      }
      t.ctatdebug("Link matches # : " + n.length);
      n.forEach(function(b) {
        t.ctatdebug("In evaluate -- entered the saiLinkMatches loop + " + b);
        if (!E.relaxOrderConstraints() && f.getTraversalCount(b) >= b.getMaxTraversals()) {
          return t.ctatdebug("In evaluate -- skipped a saiLinkMatches loop \n Skipped due to max traversals" + b.getMaxTraversals()), !1;
        }
        var e = f.clone();
        t.ctatdebug("In evaluate size of getPaths " + e.getPaths().size);
        e.getPaths().forEach(function(c) {
          t.ctatdebug("In evaluate -- looping through the newInterp.getPaths()\n Examining path: " + c);
          !1 === l(b, e, c, !1, a) && (t.ctatdebug("In evaluate -- in if condition, checking if isPathOK"), e.getPaths()["delete"](c), t.ctatdebug("In evaluate -- out of if condition, checking if isPathOK\n Tried to delete path."));
        });
        t.ctatdebug("In evaluate -- done looping through the newInterp.getPaths(), size " + e.getPaths().size);
        if (0 < e.getPaths().size) {
          t.ctatdebug("In evaluate -- if number of paths is greater than 0");
          e.addLink(b);
          t.ctatdebug("In evaluate -- new link added");
          if (!0 === c) {
            t.ctatdebug("In evaluate -- we are in the doUpdate if condition");
            var g = m(b, a.getStudentSAI(), e);
            t.ctatdebug("In evaluate -- updatingVariable table");
            a.setInterpolatedSAI(e.updateVariableTable(a.getStudentSAI(), g, b));
            t.ctatdebug("In evaluate -- done updatingVariable table: " + e.getVariableTable());
          }
          d.add(e);
          t.ctatdebug("In evaluate -- added new interp");
        }
        t.ctatdebug("In evaluate -- out of saiLinkMatches loop");
      });
      t.ctatdebug("In evaluate -- out of interpretation loops");
    });
    a.setNumberOfInterpretations(d.size);
    t.ctatdebug("In evaluate -- number of interpretations " + d.size + " set");
    var q = g(a, b, c, d);
    if (null !== q) {
      return q;
    }
    if (0 === d.size) {
      return t.ctatdebug("In evaluate -- if condition no new interpretations"), 0 !== n.length && !0 === n[0].isDone() && a.setDoneStepFailed(!0), a.setResult(CTATExampleTracerLink.NO_MODEL), t.ctatdebug("In evaluate -- if condition no new interpretations returning false"), !1;
    }
    q = p(d);
    t.ctatdebug("In evaluate -- just found bestInterp");
    var r = null;
    !0 === a.isSolverResult() ? (t.ctatdebug("In evaluate -- in if branch of isSolverResult"), r = CTATExampleTracerLink.NO_MODEL.toString().toUpperCase() === a.getResult().toString().toUpperCase() ? CTATExampleTracerLink.BUGGY_ACTION.toString() : a.getResult().toString()) : (t.ctatdebug("In evaluate -- in else branch of isSolverResult"), r = q.getLastMatchedLink().getType());
    return f(a, c, r, null, q, d);
  }
  function e(a, b, c, d, e) {
    ...
    t.ctatdebug("updateMatchedSelections(): link " + c.getUniqueID() + ", matched " + b + ", newResult " + f + ", matchedSelections[link] " + G[c.getUniqueID()]);
  }
  function h(a, b, c, d, f) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in findSAIMatchingLinks(" + a + ", " + b + ", " + c + ")");
    var g = [];
    E.getLinks().forEach(function(h) {
      if (!1 === c) {
        t.ctatdebug("Calling link.matchesSAI() on link " + h + ", sai " + a);
        var l = h.matchesSAI(a, b, d);
        t.ctatdebug("Result from link.matchesSAI() on link " + h + ": " + l + ", typeof " + typeof l);
        !0 === l && g.push(h);
        E.hideButRequireSteps() && e(a, l, h, b, d);
      } else {
        !0 === h.matchesSAIforHint(a, b, f, d) && g.push(h);
      }
    });
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of findSAIMatchingLinks: #matchingLinks " + g.length);
    return g;
  }
  function l(a, b, c, d, e) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK");
    var f = null;
    if (!0 === d) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK in demonstrate mode");
      var g = b.getMatchedLinks().slice();
      g.push(a);
      f = c.getLinksRestricted(g);
    } else {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK NOT in demonstrate mode"), f = c.getLinks();
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK path.getLinks() " + c.getLinks().size);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK pathLinks " + f.size);
    if (!0 === d) {
      var h = [], l = !0;
      b.getMatchedLinks().forEach(function(a) {
        !1 !== l && (!1 === E.observesOrderingConstraints(h, a, f, e) || !1 === q(b, a, f) ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false1"), l = !1) : h.push(a));
      });
      if (!1 === l) {
        return t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false2"), !1;
      }
    }
    if (a.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      if (!1 === E.isIncorrectLinkOK(b.getMatchedLinks(), a, f, b)) {
        return t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false3"), !1;
      }
    } else {
      if (!1 === E.observesOrderingConstraints(b.getMatchedLinks(), a, f, e)) {
        return t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false4"), !1;
      }
      if (!1 === q(b, a, f)) {
        return t.ctatdebug("CTATExampleTracerTracer --\x3e in isPathOK returning false5"), !1;
      }
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of isPathOK returning true");
    return !0;
  }
  function m(a, b, c) {
    t.ctatdebug("CTATExampleTracerTracer.replaceInput(" + a + ", " + b + ", ...)");
    if (null === a || "undefined" === typeof a || !1 === a.replaceInput()) {
      return t.ctatdebug("replaceInput false, returning null"), null;
    }
    a = a.evaluateReplacement(b, c.getVariableTable(), t);
    t.ctatdebug("CTATExampleTracerTracer.replaceInput() returning " + a);
    return a;
  }
  function p(a) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation");
    var b = new CTATExampleTracerInterpretationComparator, c = null;
    a.forEach(function(a) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation iteration");
      null === c || "undefined" === typeof c ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation first if condition"), c = a) : (t.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation else of first if condition"), 0 < b.compare(a, c) && (t.ctatdebug("CTATExampleTracerTracer --\x3e in findBestInterpretation second if condition"), c = a));
    });
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of findBestInterpretation");
    return c;
  }
  function n(a) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in setInterpretations");
    y.length = 0;
    0 === a.size ? t.ctatdebug("CTATExampleTracerTracer --\x3e returning from setInterpretations") : (t.ctatdebug("CTATExampleTracerTracer --\x3e setInterpretations c.size: " + a.size), a.forEach(function(a) {
      y.push(a);
    }), w = null, t.ctatdebug("CTATExampleTracerTracer --\x3e out of setInterpretations"));
  }
  function r() {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths");
    var a = E.findAllPaths();
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths: #paths " + a.size);
    a.forEach(function(a) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths loopring through paths");
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getAllPaths size of path" + a.getLinks().size);
    });
    return a;
  }
  function q(a, b, c) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in doneStepOK: link " + b + ", isDone() " + b.isDone());
    if (null === b || "undefined" === typeof b || !1 === b.isDone()) {
      return t.ctatdebug("doneStepOK in first if condition"), !0;
    }
    if (b.isDone() && E.exitOnIncorrectDone()) {
      return !0;
    }
    if (b.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      return t.ctatdebug("doneStepOK in second if condition"), !0;
    }
    t.ctatdebug("doneStepOK before loop");
    var d = !0;
    c.forEach(function(c) {
      if (!1 === d) {
        t.ctatdebug("CTATExampleTracerTracer --\x3e we are breaking from the loop");
      } else {
        if (c.getUniqueID() === b.getUniqueID()) {
          t.ctatdebug("CTATExampleTracerTracer --\x3e inside second if condition");
        } else {
          var e = a.getTraversalCount(c);
          E.hideButRequireSteps() && (0 < e || 1 > c.getMinTraversals()) || !(e < c.getMinTraversals()) || (t.ctatdebug("CTATExampleTracerTracer --\x3e we should return false from the second if condition"), d = !1);
        }
      }
    });
    if (!1 === d) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning false"), !1;
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of doneStepOK returning true");
    return !0;
  }
  function u(a, b) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink");
    var c = null !== b && "undefined" !== typeof b && null !== b[0] && "undefined" !== typeof b[0] ? b[0] : null;
    if (null === c || "undefined" === typeof c) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink first if condition"), c = t.getBestInterpretation();
    }
    null !== b && "undefined" !== typeof b && (b[0] = c);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink interp.getPaths(): " + c.getPaths().size);
    var d = CTATExampleTracerPath.getBestPath(c.getPaths());
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink path: " + d);
    var e = x(c, d, a, !1);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink highestLink: " + e);
    if (null !== e && "undefined" !== typeof e) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning highestLink"), e;
    }
    var f = null;
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning path.getLinks() " + d.getLinks().size);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink returning path.getSortedLinks() " + d.getSortedLinks());
    var g = !1, h = null;
    d.getSortedLinks().forEach(function(b) {
      !0 !== g && (t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in for loop" + b), f = b, c.getTraversalCount(b) < b.getMaxTraversals() && (!1 === a || 0 < t.nonEmptyHints(b, c.getVariableTable())) && E.observesOrderingConstraints(c.getMatchedLinks(), b, d.getLinks(), null) && q(c, b, d.getLinks()) && (t.ctatdebug("CTATExampleTracerTracer --\x3e in _getBestNextLink in link: " + b), h = b, g = !0));
    });
    if (!0 === g) {
      return h;
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of _getBestNextLink, returning: " + f);
    return null;
  }
  function x(a, b, c, d) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink");
    var e = new CTATExampleTracerEvent(t, null, CTATMsgType.DEFAULT_STUDENT_ACTOR), f = !0, g = [];
    b.getSortedLinks().forEach(function(b) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop link.getUniqueID(): " + b.getUniqueID());
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop interp.isTraversed(link, countOptionalAsTraversed): " + a.isTraversed(b, d));
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in loop isNoOp(link): " + B(b));
      !0 === a.isTraversed(b, d) || !0 === B(b) ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in if condition"), f = !0) : (!0 === f && (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink in second if condition"), E.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
        c && 1 > t.nonEmptyHints(b, a.getVariableTable()) || a.getTraversalCount(b) >= b.getMaxTraversals() || (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink pushing outlink: " + b.getUniqueID()), g.push(b));
      })), f = null === b || "undefined" === typeof b ? !1 : b.getMinTraversals() <= a.getTraversalCount(b));
    });
    g.sort(function(b, c) {
      return (new CTATExampleTracerLinkComparator(a, t)).compare(b, c);
    });
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink before sorting");
    var h = !1, m = null;
    g.forEach(function(c) {
      !0 !== h && (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in fro loop"), !0 === l(c, a, b, !1, e) ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting first if"), m = c, h = !0) : a.getPaths().forEach(function(d) {
        !0 !== h && (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting in inner loop"), b !== d && (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting second if"), !0 === l(c, a, d, !1, e) && (t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink after sorting third if"), m = c, h = !0)));
      }));
    });
    if (!0 === h) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e in getHighestUntraversedLink returning: " + m.getUniqueID()), m;
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of getHighestUntraversedLink");
    return null;
  }
  function B(a) {
  ...
  var y = null, A = null, C = null, E = a, D = null;
  ...
  this.goToState = function(a, b) {
    ...
    var c = "done" == a.toString().toLowerCase(), d = "start" == a.toString().toLowerCase(), e = null;
    if (!c && !d && !(e = E.findNode(a))) {
      return !1;
    }
    if (d = d || e == E.getStartNode()) {
      throw c = location.href.replace(/problem_state_status=[^&]*/, "problem_state_status=empty"), 1 > c.search(/problem_state_status=empty/) && (c += c.search(/[?&]/g) ? "&" : "?", c += "problem_state_status=empty"), console.log("CTATExampleTracerTracer.goToState(" + a + ") to call location.replace(" + c + ")"), location.replace(c), c;
    }
    if ((d = t.getBestInterpretation()) && (c ? t.goToDone(d, E, b) : t.advanceToNode(e, E, b))) {
      return !0;
    }
    for (var f = 0;f < y.length;++f) {
      var g = y[f];
      if (g != d && (c ? t.goToDone(g, E, b) : t.advanceToNode(e, E, b))) {
        return !0;
      }
    }
    return !1;
  ...
  this.advanceToNode = function(a, b, c) {
    ...
    t.ctatdebug("advanceToNode() path " + a);
    a && (a = a.getSortedLinks(), results = c.traceLinks(a), t.ctatdebug("advanceToNode() results " + results));
  };
  this.getMatchedSelections = function() {
    return G;
  };
  this.getLastResult = function() {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getResult");
    return D;
  };
  this.resetTracer = function() {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer entering");
    null === y || "undefined" === typeof y ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer making interpretations array"), y = []) : (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer clearing interpretations array"), y.length = 0);
    var a = new CTATExampleTracerInterpretation(r());
    t.ctatdebug("CTATExampleTracerTracer tempInterp--\x3e in resetTracer tempInterp " + a);
    null !== b && "undefined" !== typeof b && (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer startStateVT if condition"), a.setVariableTable(b));
    y.push(a);
    w = a;
    if (null === A || "undefined" === typeof A) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer incorrectActionMatches if condition"), A = {};
    } else {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of incorrectActionMatches if condition");
      for (var c in A) {
        A.hasOwnProperty(c) && delete A[c];
      }
    }
    G = {};
    null === C || "undefined" === typeof C ? (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer last if condition"), C = []) : (t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer else branch of last if condition"), C.length = 0);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in resetTracer before iterating over all the links in the graphs");
    E.getLinks().forEach(function(a) {
      a.getMatcher().resetMatcher();
    });
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of resetTracer");
  };
  this.evaluate = function(a) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in public evaluate(), calling private _evaluate; given event " + a);
    return c(a, !1, !0);
  };
  this.nonEmptyHints = function(a, b) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints");
    if (null === a || "undefined" === typeof a) {
      return 0;
    }
    var c = a.interpolateHints(b);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in nonEmptyHints: link.interpolateHints() " + a.interpolateHints().length);
    ...
    t.ctatdebug("CTATExampleTracerTracer --\x3e returning from nonEmptyHints " + d);
    return d;
  };
  this.traceForHint = function(a) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint");
    var b = c(a, !0, !1);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint return from evaluate " + b);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint result from evaluate " + a.getResult().toString());
    t.ctatdebug("CTATExampleTracerTracer --\x3e in traceForHint link   from evaluate " + a.getReportableLink());
    if (a.getResult().toString() === CTATExampleTracerLink.CORRECT_ACTION.toString()) {
      return b = a.getReportableLink(), a.setTutorSAI(new CTATSAI(a.getStudentSAI().getSelection(), b.getDefaultSAI().getAction(), b.getDefaultSAI().getInput())), a.setActor(CTATMsgType.DEFAULT_STUDENT_ACTOR), t.ctatdebug("CTATExampleTracerTracer --\x3e traceForHint returning hintLink " + b + ", result " + a), b;
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of traceForHint, returning null");
    return null;
  };
  this.matchForHint = function(a) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint");
    var b = null, b = null === a.getStudentSAI() || "undefined" === typeof a.getStudentSAI() ? null : a.getStudentSAI().getSelectionArray();
    if (null !== b && "undefined" !== typeof b && 0 < b.length && (t.ctatdebug("CTATExampleTracerTracer --\x3e in matchForHint first if"), a.setWantReportableHints(!0), b = t.traceForHint(a), null !== b && "undefined" !== typeof b && 0 < a.getReportableHints().length)) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint via traceForHint returning " + b + ", result " + a), b;
    }
    b = t.getBestNextLink(!0, a);
    t.ctatdebug("CTATExampleTracerTracer --\x3e matchForHint() traceForHint via getBestNextLink returning " + b);
    return b;
  };
  this.getBestNextLink = function(a, b) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink");
    var c = [], d = u(a, c);
    if (null === d || "undefined" === typeof d) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink returning null"), null;
    }
    if (d.getType().toString() === CTATExampleTracerLink.BUGGY_ACTION.toString()) {
      return t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return null no correct suboptimal step"), null;
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink else branch");
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink got interp " + (null == c ? "null" : c[0]));
    if (b) {
      var e = d.interpolateHints(c[0].getVariableTable());
      b.setInterpolatedHints(e);
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink setInterpolatedHints");
      Array.isArray(e) && 0 < e.length ? b.setReportableHints(e) : b.setReportableHints(d.getHints());
      t.ctatdebug("In evaluate --\x3e after setReportableHints");
      b.setReportableLink(d);
      b.setReportableInterpretation(c[0]);
      b.setResult(d.getType());
      b.setTutorSAI(d.getDefaultSAI());
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestNextLink return etLink");
    return d;
  };
  this.doHint = function(a, b, c, d, e, f) {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint");
    var g = c = c = null;
    if (f && null !== b && "undefined" !== typeof b && 1 < b.length && b[1].toString() === CTATMsgType.PREVIOUS_FOCUS.toString() && null !== a && "undefined" !== typeof a && 1 < a.length && null !== a[1] && "undefined" !== typeof a[1] && a[1].toString() !== "null".toString() && (t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint first if condition"), c = [], c.push(a[1]), 2 < b.length)) {
      for (t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint inner if condition"), g = [], a = 2;a < b.length;a++) {
        t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint for loop " + a), g.push(b[a]);
      }
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint out of if condition");
    b = new CTATExampleTracerEvent(t, new CTATSAI(c, g, null), d);
    b.setHintRequest(!0);
    t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint result: " + b);
    c = t.matchForHint(b);
    Array.isArray(e) && (t.ctatdebug("CTATExampleTracerTracer --\x3e in doHint last if condition"), e.push(b));
    t.ctatdebug("CTATExampleTracerTracer --\x3e returning from doHint: " + c);
    return c;
  };
  this.getBestInterpretation = function() {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation");
    if (null === w || "undefined" === typeof w) {
      t.ctatdebug("CTATExampleTracerTracer --\x3e in getBestInterpretation in if condition"), w = p(t.getInterpretationsInternal());
    }
    t.ctatdebug("CTATExampleTracerTracer --\x3e out of getBestInterpretation " + (null === w || void 0 === w));
    return w;
  };
  this.getInterpretationsInternal = function() {
    t.ctatdebug("CTATExampleTracerTracer --\x3e in getInterpretationsInternal");
    return y;
  };
  this.toString = function() {
    var a = "TracerState\n";
    null === y ? a += "(no interpretations)\n" : y.forEach(function(b) {
      a += b.toString() + "\n";
    });
    return a;
  };
  this.addInterfaceVariablesFromEvent = function(a) {
    if (a) {
      ...
      a = a.getTutorInput();
      t.addInterfaceVariables(b, a);
    }
  };
  this.addInterfaceVariables = function(a, c) {
    t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables(" + a + ", " + c + ")");
    if (a && c) {
      var d = a.length;
      ...
      t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() startStateVT " + b);
      y && y.forEach(function(b) {
        if (b = b.getVariableTable()) {
          for (var e = 0;e < d;e++) {
            a[e] && (b.put(a[e], CTATVariableTable.standardizeType(c[e])), b.put(CTATVariableTable.nameAsString(a[e]), CTATVariableTable.valueAsString(c[e])));
          }
          t.ctatdebug("CTATExampleTracerTracer.addInterfaceVariables() interp.vt " + b);
        }
      });
    }
  };
  this.findCurrentState = function() {
    t.ctatdebug("Entering findCurrentState");
    var a = t.getBestInterpretation();
    return a && a.getLastMatchedLink() && a.getLastMatchedLink().isDone() ? a.getLastMatchedLink().getNextNode() : (a = u(!1, [a])) ? a.getPrevNode() : E ? E.getStartNode() : null;
  };
};
...
var CTATDefaultLinkGroup = function(a, b, d, f) {
  ...
  this.getIsReenterable = function() {
    n.ctatdebug("CTATDefaultLinkGroup --\x3e in getIsReenterable: " + e);
    return e;
  };
...
var CTATDefaultGroupModel = function() {
  ...
  function d(a, b) {
    ...
    l.getGroupSubgroups(b).forEach(function(b) {
      !0 !== e && !0 === l.isLinkInGroup(b, a) && (c = d(a, b), f = null !== c && "undefined" !== typeof c ? c : b, e = !0);
    });
    return !0 === e ? f : null;
  }
  function f(a, b) {
    ...
    b.forEach(function(e) {
      if (!0 !== c) {
        if (!1 === l.isLinkInGroup(a, e)) {
          throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
        }
        l.getGroupSubgroups(a).forEach(function(g) {
          !0 !== c && !0 === l.isLinkInGroup(g, e) && (l.getGroupLinkCount(g) >= b.size ? (d = f(g, b), c = !0) : l.getGroupLinks(g).forEach(function(c) {
            if (!1 === b.has(c)) {
              throw new CTATExampleTracerException("Invalid link selection: Partial overlap with existing group: " + a);
            }
          }));
  ...
  function g(a, b) {
    ...
    l.getGroupSubgroups(a).forEach(function(d) {
      ...
      if (0 === e.size) {
        ...
        !0 === l.isLinkInGroup(b, f) && (l.getGroupSubgroups(a)["delete"](d), c(b, d));
      }
    });
    c(a, b);
  }
  ...
  this.addLinkToGroup = function(a, b) {
    ...
    for (l.removeLinkFromGroup(e, b);null !== a && "undefined" !== typeof a;a = l.getGroupParent(a)) {
      var c = a, d = b;
  ...
  this.getGroupsContainingLink = function(a) {
    l.ctatdebug("CTATDefaultGroupModel --\x3e in getGroupsContainingLink(" + a + "): TopLevel " + e + ", typeof(TopLevel) " + typeof e);
  ...
  this.getLowestLevelGroupOfLink = function(a) {
    ...
    var b = d(a, e);
    return null !== b && "undefined" !== typeof b ? b : !0 === l.isLinkInGroup(e, a) ? e : null;
  };
  this.getGroupSubgroups = function(a) {
  ...
  this.createIdToLinkMap = function() {
    ...
    var a = {};
    l.getGroupLinks(e).forEach(function(b) {
      a[b.getUniqueID()] = b;
    });
    return a;
  };
  this.getGroupByName = function(a) {
    l.ctatdebug("CTATDefaultGroupModel --\x3e in getGroupByName TopLevel has: " + e.getSubgroups().size);
...
var CTATExampleTracerGraph = function(a, b, d) {
  function f(a, b, d) {
    ...
    if (z.relaxOrderConstraints() || b.isDone() && z.exitOnIncorrectDone()) {
      return !0;
    }
    for (var f = c(b), g = 0;g < f.length;g++) {
      var l = f[g];
      if (!0 === F.isGroupOrdered(l)) {
        if (g !== f.length - 1) {
          if (!1 === e(l, h(f[g + 1], d), a, d)) {
            return !1;
          }
        } else {
          if (!1 === e(l, b, a, d)) {
  ...
  function g(a, b, d) {
    ...
    for (var e = !0, f = 0;f < b.length;f++) {
      if (!0 === e && !1 === F.isGroupReenterable(b[f])) {
        for (var e = !1, g = 0;g < a.length;g++) {
          if (!0 === F.isLinkInGroup(b[f], a[g])) {
            e = !0;
          } else {
            if (!0 === e) {
              return !1;
    ...
    if (0 !== a.length) {
      ...
      z.ctatdebug("CTATETGraph.isReentrableOK: exitedGroups.length after removing newLink's groups: " + h.length);
      for (k = h.length - 1;0 <= k;k--) {
        F.isGroupReenterable(h[k]) && h.splice(k, 1);
      }
      z.ctatdebug("CTATETGraph --\x3e in isReentrableOK: exitedGroups after removing reenterables: " + h.length);
      z.ctatdebug("CTATETGraph --\x3e in isReentrableOK: traversedLinks: " + a + ", path: " + d);
      var n = !0;
      h.forEach(function(b) {
        !1 !== n && d.forEach(function(c) {
          !1 !== n && l(a, c) < c.getMinTraversals() && !0 === F.isLinkInGroup(b, c) && (n = !1);
        });
      });
      if (!1 === n) {
        return !1;
  ...
  function c(a) {
    z.ctatdebug("in findGroupsOfLink(link " + a + "): typeof(groupModel) " + typeof F);
    a = F.getGroupsContainingLink(a);
    ...
    b.sort(function(a, b) {
      return F.getGroupLinkCount(b) - F.getGroupLinkCount(a);
    });
    return b;
  }
  function e(a, b, c, d) {
    var e = -1, f = null, g = Number.MAX_VALUE, m = null;
    F.getGroupSubgroups(a).forEach(function(a) {
      if (!1 === F.isLinkInGroup(a, b) && 0 !== F.getGroupLinkCount(a)) {
        var l = h(a, d);
        null !== l && "undefined" !== typeof l && (l = l.getDepth(), l < b.getDepth() && l > e && (!1 === p(a) || !0 === n(a, c)) && (e = l, f = a), l > b.getDepth() && l < g && (!1 === p(a) || !0 === n(a, c)) && (g = l, m = a));
      }
    });
    F.getUniqueLinks(a).forEach(function(a) {
      if (!0 === d.has(a)) {
        var h = a.getDepth();
    ...
    if (null !== f && "undefined" !== typeof f) {
      if (f instanceof CTATExampleTracerLink) {
        ...
        if (f instanceof CTATLinkGroup && !1 === r(f, c, d)) {
          return !1;
        }
      }
    }
    return null !== m && "undefined" !== typeof m && (m instanceof CTATExampleTracerLink && -1 < c.indexOf(m) || m instanceof CTATLinkGroup && !0 === n(m, c)) ? !1 : !0;
  }
  function h(a, b) {
    var c = Number.MAX_VALUE, d = null;
    F.getGroupLinks(a).forEach(function(a) {
  ...
  function l(a, b) {
    ...
    z.ctatdebug("CTATETGraph.getTraversalCount(" + b + "): " + c);
    return c;
  }
  function m(a, b, c) {
    var d = !1, e = !0, f = !1;
    (new CTATExampleTracerPath(b)).getSortedLinks().forEach(function(b) {
      if (!1 !== e && !0 !== f) {
        if (!1 === d) {
          !0 === F.isLinkInGroup(a, b) && (d = !0);
        } else {
          if (!1 === F.isLinkInGroup(a, b)) {
            f = !0;
            return;
          }
        }
  ...
  var B = null, y = null, A = null, C = null, E = null, D = null, w = new Set, G = new Set, t = null, F = null, H = CTATMsgType.SHOW_ALL_FEEDBACK, z = this;
  this.getFeedbackPolicy = function() {
    return H;
  };
  this.setFeedbackPolicy = function(a) {
    z.ctatdebug("Graph.setFeedbackPolicy(" + a + ") old policy " + H);
    H = "false" === a ? CTATMsgType.SHOW_ALL_FEEDBACK : "true" === a ? CTATMsgType.HIDE_ALL_FEEDBACK : a;
  };
  this.hideButRequireSteps = function() {
    return H == CTATMsgType.HIDE_BUT_COMPLETE;
  };
  this.hideAllFeedback = function() {
    return H == CTATMsgType.HIDE_ALL_FEEDBACK;
  };
  this.relaxOrderConstraints = function() {
    return z.hideAllFeedback() || z.hideButRequireSteps() || H == CTATMsgType.DELAY_FEEDBACK;
  };
  ...
  this.getDefaultBuggyMsg = function() {
    return F.getTopLevelGroup() ? F.getTopLevelGroup().getDefaultBuggyMsg() : null;
  };
  this.getLinks = function() {
  ...
  this.addLink = function(a, b) {
    ...
    null === b || "undefined" === typeof b ? F.addLinkToGroup(F.getTopLevelGroup(), a) : F.addLinkToGroup(b, a);
  ...
  this.observesOrderingConstraints = function(a, b, c, d) {
    ...
    null !== d && "undefined" !== typeof d && (z.ctatdebug("CTATExampleTracerGraph --\x3e in observesOrderingConstraints initializing out of order false"), d.setOutOfOrder(!1));
    if (null === c || "undefined" === typeof c || 0 === c.size || null === b || "undefined" === typeof b) {
      return z.ctatdebug("CTATExampleTracerGraph --\x3e returning first true observesOrderingConstraints"), !0;
    }
    if (b.isDone() && z.exitOnIncorrectDone()) {
      return z.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning true for doneStep && exitOnIncorrectDone"), !0;
    }
    if (!0 === c.has(b) && !0 === f(a, b, c) && !0 === g(a, b, c)) {
      return z.ctatdebug("CTATExampleTracerGraph.observesOrderingConstraints --\x3e returning isOrderOK true && isisReenteringOK() true"), !0;
    }
  ...
  this.isIncorrectLinkOK = function(a, b, c, d) {
    ...
    var e = !1, g = null, h = !0, l = !1;
    z.getNode(b.getPrevNode()).getOutLinks().forEach(function(b) {
      !0 !== l && !1 !== h && b.getType().toString() !== CTATExampleTracerLink.BUGGY_ACTION.toString() && !0 === c.has(b) && (e = !0, !1 === f(a, b, c) ? h = !1 : (g = b, l = !0));
    });
    ...
    if (!0 === e && (b = z.getSmallestContainingGroup(b), !0 === F.isLinkInGroup(b, g) && !1 === F.isGroupOrdered(b) && !0 === m(b, c, d))) {
      return !1;
    }
  ...
  this.getStartNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getStartNode() returning " + E);
    return E;
  };
  ...
  this.getStudentStartsHereNode = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e getStudentStartsHereNode() returns " + D);
    return D;
  };
  ...
  this.getExampleTracer = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getExampleTracer() returning " + B);
    return B;
  };
  ...
  this.getSmallestContainingGroup = function(a) {
    return F.getLowestLevelGroupOfLink(a);
  };
  ...
  this.getVisualData = function() {
    z.ctatdebug("CTATExampleTracerGraph --\x3e in getVisualData() returning " + t);
    return t;
  };
  ...
  (function(a, b) {
    ...
    C = {};
    if (null === F || "undefined" === typeof F) {
      F = new CTATDefaultGroupModel, z.ctatdebug("CTATExampleTracerGraph --\x3e created a group model from here");
    }
    F.clear();
    F.setDefaultReenterable(!b);
    F.setGroupOrdered(F.getTopLevelGroup(), a);
    F.setGroupName(F.getTopLevelGroup(), CTATExampleTracerGraph.TOP_LEVEL);
    B = new CTATExampleTracerTracer(z, d);
...
var CTATGraphParser = function() {
  function a(a) {
    ...
    for (var d = new CTATExampleTracerLink(null, null, null), f = e.getElementChildren(a), g, h, l, n, m, r = a = -1, w = CTATMsgType.DEFAULT_ACTOR, G = !1, t = 0;t < f.length;t++) {
      "sourceID" === e.getElementName(f[t]) && (a = parseInt(e.getNodeTextValue(f[t])), d.setPrevNode(a));
      "destID" === e.getElementName(f[t]) && (r = parseInt(e.getNodeTextValue(f[t])), d.setNextNode(r));
      if ("rule" === e.getElementName(f[t])) {
        for (var F = e.getElementChildren(f[t]), H = 0;H < F.length;H++) {
          "text" === e.getElementName(F[H]) && d.addSkillName(e.getNodeTextValue(F[H]).toString());
        }
      }
      if ("actionLabel" === e.getElementName(f[t])) {
        for (d.setIsPreferredLink("false" != e.getElementAttr(f[t], "preferPathMark")), d.setMinTraversalsStr(e.getElementAttr(f[t], "minTraversals")), d.setMaxTraversalsStr(e.getElementAttr(f[t], "maxTraversals")), F = e.getElementChildren(f[t]), H = 0;H < F.length;H++) {
          "uniqueID" === e.getElementName(F[H]) && (m = e.getNodeTextValue(F[H]), d.setUniqueID(parseInt(e.getNodeTextValue(F[H]))));
          "message" === e.getElementName(F[H]) && (n = new CTATMessage(F[H]));
          "actionType" === e.getElementName(F[H]) && d.setActionType(e.getNodeTextValue(F[H]));
          "buggyMessage" === e.getElementName(F[H]) && d.setBuggyMsg(e.getNodeTextValue(F[H]));
          "successMessage" === e.getElementName(F[H]) && d.setSuccessMsg(e.getNodeTextValue(F[H]));
          "hintMessage" === e.getElementName(F[H]) && d.addHint(e.getNodeTextValue(F[H]));
          if ("matchers" === e.getElementName(F[H])) {
            for (var z = e.getElementChildren(F[H]), I = 0;I < z.length;I++) {
              "Selection" === e.getElementName(z[I]) && (g = b(z[I], 0)), "Action" === e.getElementName(z[I]) && (h = b(z[I], 1)), "Input" === e.getElementName(z[I]) && (l = b(z[I], 2)), "Actor" === e.getElementName(z[I]) && (w = e.getNodeTextValue(z[I]), G = (G = e.getElementAttr(z[I], "linkTriggered")) && "false" != G.toLowerCase().trim() ? !0 : !1);
            }
          }
          if ("matcher" === e.getElementName(F[H])) {
            h = F[H];
            g = e.getElementAttr(h, "replacementFormula");
            h = e.getElementChildren(h);
            var I = z = w = l = void 0, L = CTATMsgType.DEFAULT_ACTOR;
            l = new CTATExactMatcher(CTATMatcher.SELECTION, null);
            for (var w = new CTATExactMatcher(CTATMatcher.ACTION, null), J = 0;J < h.length;J++) {
              if ("matcherType" === e.getElementName(h[J]) && ("ExactMatcher" === e.getNodeTextValue(h[J]) && (I = CTATExactMatcher), "RegexMatcher" === e.getNodeTextValue(h[J]) && (I = CTATRegexMatcher), "AnyMatcher" === e.getNodeTextValue(h[J]) && (I = CTATAnyMatcher), "RangeMatcher" === e.getNodeTextValue(h[J]) && (I = CTATRangeMatcher), "WildcardMatcher" === e.getNodeTextValue(h[J]) && (I = CTATWildcardMatcher), "ExpressionMatcher" === e.getNodeTextValue(h[J]) && (I = CTATExpressionMatcher)), 
              "matcherParameter" === e.getElementName(h[J])) {
                var N = e.getElementAttr(h[J], "name");
                "selection" == N && l.setParameter(e.getNodeTextValue(h[J]));
                "action" == N && w.setParameter(e.getNodeTextValue(h[J]));
                "input" == N && (z = z ? z : new I(CTATMatcher.INPUT, null), z.setParameter(e.getNodeTextValue(h[J])));
                "actor" == N && (L = e.getNodeTextValue(h[J]));
                "minimum" == N && (z = z ? z : new I(CTATMatcher.INPUT, null), z.setParameter(e.getNodeTextValue(h[J]), "minimum"));
                "maximum" == N && (z = z ? z : new I(CTATMatcher.INPUT, null), z.setParameter(e.getNodeTextValue(h[J]), "maximum"));
              }
            }
    ...
    c.getStartNode() && r == c.getStartNode().getNodeID() && console.log("***WARNING*** edge " + m + " destination is graph startNode " + c.getStartNode());
    m = new CTATVectorMatcher(g, h, l, w);
    m.setDefaultSAI(n.getSAI());
    m.setCaseInsensitive(p);
    m.setLinkTriggered(G);
    d.setMatcher(m);
    ctatdebug("GraphParser.processEdge() " + a + "->" + r + ", edge " + d);
  ...
  function b(a, b) {
    ...
    for (var c = e.getElementChildren(a), d = [], g = 0;g < c.length;g++) {
      if ("matcher" === e.getElementName(c[g])) {
        for (var h = null, l = e.getElementAttr(c[g], "replacementFormula"), m = e.getElementChildren(c[g]), n = 0;n < m.length;n++) {
          if ("matcherType" === e.getElementName(m[n])) {
            switch(h = e.getNodeTextValue(m[n]), f.ctatdebug("CTATGraphParser.processMatchers() matcherType[" + n + "] = " + h), h) {
              case "ExactMatcher":
          ...
          if ("matcherParameter" === e.getElementName(m[n])) {
            var p = e.getElementAttr(m[n], "name");
            "single" === p ? h.setParameter(e.getNodeTextValue(m[n])) : "minimum" === p ? h.setParameter(e.getNodeTextValue(m[n]), "minimum") : "maximum" === p ? h.setParameter(e.getNodeTextValue(m[n]), "maximum") : h.setParameter(m[n], p, e);
          }
        }
  ...
  function d(a, b) {
    ...
    var g = "true" === e.getElementAttr(a, "ordered"), h = "true" === e.getElementAttr(a, "reenterable");
    ...
    for (var l = function(a) {
      c.add(a);
    }, n = e.getElementChildren(a), p = 0;p < n.length;p++) {
      if ("link" === e.getElementName(n[p])) {
        var r = Number(e.getElementAttr(n[p], "id")), G = b[r];
        if (null !== G || void 0 !== G) {
          ctatdebug("Added link ID : " + r), c.add(G);
        }
      }
      "group" === e.getElementName(n[p]) && (ctatdebug("encountered a subgroup"), d(n[p], b).forEach(l));
    }
    m.addGroup(f, g, c);
    m.setGroupReenterable(m.getGroupByName(f), h);
    return c;
  }
  CTATBase.call(this, "CTATGraphParser", "__undefined__");
  var f = this, g, c, e = new CTATXML, h = null, l = [];
  new XMLSerializer;
  var m, p = !0, n = !0, r = [];
  ...
  this.parseGraph = function(b, f) {
    ctatdebug("parseBRD()");
    var x = 0, B = e.getElementAttr(b, "startStateNodeName"), y = "true" === e.getElementAttr(b, "unordered");
    p = "false" != String(e.getElementAttr(b, "caseInsensitive")).toLowerCase();
    n = e.getElementAttr(b, "lockWidget");
    var A = new CTATVariableTable;
    c = new CTATExampleTracerGraph(y, !1, A);
    var C = e.getElementChildren(b), A = e.getElementAttr(b, "suppressStudentFeedback");
    if (null === A || void 0 === A) {
    ...
    var E = e.getElementAttr(b, "confirmDone");
    "true" !== E && "false" !== E && (E = c.getFeedbackPolicy() === CTATMsgType.HIDE_ALL_FEEDBACK ? "true" : "false");
    f.setHintPolicy(e.getElementAttr(b, "hintPolicy"));
    f.setOutOfOrderMessage(e.getElementAttr(b, "outOfOrderMessage"));
    for (var D = null, w = 0;w < C.length;w++) {
      switch(e.getElementName(C[w])) {
        case "startNodeMessages":
          l = e.getElementChildren(C[w]);
          break;
        case "node":
          x++;
          var G;
          ...
          var t = e.getElementChildren(G), F = -1;
          G = "";
          for (var H = 0;H < t.length;H++) {
            switch(e.getElementName(t[H])) {
              case "uniqueID":
                F = parseInt(e.getNodeTextValue(t[H]));
                break;
              case "text":
                G = e.getNodeTextValue(t[H]);
            }
          }
          t = new CTATExampleTracerNode(F, new Set);
          "" !== G && t.setNodeName(G);
          G = t;
          c.addNode(G);
          1 == x && (c.setStartNode(G), c.setStudentStartsHereNode(G));
          G.getNodeName() == B && c.setStudentStartsHereNode(G);
          break;
        case "edge":
          c.addLink(a(C[w]));
          break;
        ...
        case "productionRule":
          ...
          for (var t = G = "", H = F = null, z = e.getElementChildren(z), I = 0;I < z.length;I++) {
            var L = e.getElementName(z[I]);
            "ruleName" == L && (G = e.getNodeTextValue(z[I]), ctatdebug("ruleName=" + G));
            "productionSet" == L && (t = e.getNodeTextValue(z[I]), ctatdebug("productionSet=" + t));
            "label" == L && (F = e.getNodeTextValue(z[I]), ctatdebug("label=" + F));
            "description" == L && (H = e.getNodeTextValue(z[I]), ctatdebug("description=" + H));
          }
          G && (z = new CTATExampleTracerSkill(t, G, CTATExampleTracerSkill.DEFAULT_P_GUESS, CTATExampleTracerSkill.DEFAULT_P_KNOWN, CTATExampleTracerSkill.DEFAULT_P_SLIP, CTATExampleTracerSkill.DEFAULT_P_LEARN, CTATExampleTracerSkill.DEFAULT_HISTORY), null != F ? z.setLabel(F) : z.setLabel(G), null != H ? z.setDescription(H) : z.setDescription(G + (t ? " " + t : "")), r.push(z));
      }
    }
    if (D) {
      x = e.getElementAttr(D, "ordered");
      if (null === x || "undefined" == typeof isordered) {
        x = !y;
      }
      ctatdebug("parseGraph() value of isOrdered = " + x);
      ctatdebug("parseGraph() value of isUnordered = " + y);
      ctatdebug("parseGraph() typeof isOrdered: " + typeof x);
      ctatdebug("parseGraph()typeof isUnordered: " + typeof y);
      B = D;
      C = x;
      ctatdebug("processGroup()");
      m = c.getGroupModel();
      x = m.createIdToLinkMap();
      ...
      for (C = 0;C < B.length;C++) {
        switch(e.getElementName(B[C])) {
          case "group":
            d(B[C], x);
            break;
          case "outOfOrderMessage":
            m.getTopLevelGroup().setDefaultBuggyMsg(e.getNodeTextValue(B[C]));
        }
      }
    }
    x = f.getSkillBarVector(!1, !0);
    if (!x || 1 > x.length) {
      ctatdebug("No existing skills. Add skills from BRD."), f.addGraphSkills(r), x = f.getSkillBarVector();
    }
    h = (new CTATTutorMessageBuilder).createStateGraphMessage(p, y, n, f.isSourceFlash() ? c.exitOnIncorrectDone() : f.isFeedbackSuppressed(), A, E, x);
    c.redoLinkDepths();
    g = c.getExampleTracer();
    g.resetTracer();
    c.forDebugging();
    ctatdebug("Graph loaded.");
    return {gr:c, tracer:g, ssm:l, sgMsg:h};
  };
};
...
var CTATMessageTank = function(a, b) {
  function d(a) {
    ...
    a && e.forEach(function(b) {
      if (b.msgType == CTATMsgType.ASSOCIATED_RULES) {
        ...
        if (d) {
          if (c && c.getOutputStatus().isComplete()) {
            a.setCompletionStatus(CTATMsgType.CompletionValue[1], !1), a.setShowCounts(!1);
          } else {
            b = d.getResult();
            d.getHintRequest() && (b = CTATExampleTracerLink.HINT_ACTION);
            var e = CTATMsgType.CompletionValue[0], f = b && b == CTATExampleTracerLink.CORRECT_ACTION, g = !1, h = null, l = d.getStudentSAI();
            l && (h = l.getSelection()) && (g = "done" == String(h).toLowerCase());
            a.setCompletionStatus(e, CTATGlobals.confirmDone);
            n.ctatdebug("updateProblemSummary() Completion status " + e + ", doneStep " + g + ", correct " + f);
  ...
  var c = a, e = null, h = null, l = null, m = new Set;
  m.add("SuccessMessage");
  m.add("BuggyMessage");
  m.add("HighlightMsg");
  m.add("NotDoneMessage");
  var p = b, n = this, r = /^([^:]+):([0-9]+)$/;
  this.toString = function() {
    n.ctatdebug("toString tank " + e);
    if (!e || 1 > e.length) {
  ...
  this.flushMessageTank = function(a, b) {
    ...
    if (e && !(1 > e.length)) {
      d(a);
      n.ctatdebug("flushMessageTank() after updateProblemSummary; messageTank.length " + e.length + ", transaction_id " + p);
      for (var m = [], B = [], y = 0;y < e.length;++y) {
        var A = e[y];
        if (A.msg) {
          var C = A.msgType, E = A.evt;
          n.ctatdebug("entering processInterfaceVariables() msgType " + C + ", evt " + E);
          C && (n.ctatdebug("entering processInterfaceVariables() et " + c + ", tracer " + (c ? c.getTracer() : null)), C = C.toLowerCase(), 0 !== C.indexOf("correct") && 0 !== C.indexOf("interfaceaction") || c.getTracer().addInterfaceVariablesFromEvent(E));
          if (!(C = f(A))) {
            var C = A, E = B, D = void 0, w = void 0;
            if (!(C && C.sai && (D = C.sai.getAction()) && (w = r.exec(D))) || 3 > w.length || 1 >= w[2]) {
              C = !1;
            } else {
              var G = E.length - 1, G = 0 > G ? null : E[G];
              C.msg = C.msg.replace(D, w[1]);
              G && G.timeout == w[2] ? G.msgTuples.push(C) : E.push({timeout:Number(w[2]), msgTuples:[C]});
              C = !0;
            }
          }
          C || m.push(A.msg);
      ...
      n.ctatdebug("flushMessageTank(): msgBundle.length " + m.length + ", delayedMsgsBundle.length " + B.length);
      for (y = 0;y < B.length;++y) {
        A = B[y], n.ctatdebug("processDelayedMsgs() delayedMsgs.timeout " + A.timeout + ", .msgTuples.length " + A.msgTuples.length), setTimeout(g, A.timeout, c, A.msgTuples);
      }
      0 < m.length && (n.ctatdebug("Bottom of flushMessageTank(); to send bundle of length " + m.length + " via " + c), c.sendBundle(m) && (n.ctatdebug("CTATMessageTank.shouldSaveNow() resultTypes " + l + ", msgTypes " + h), (l[CTATExampleTracerLink.CORRECT_ACTION] || l[CTATExampleTracerLink.FIREABLE_BUGGY_ACTION] || h.CorrectAction || h.InterfaceAction || h.UntutoredAction || c.isFeedbackSuppressed() && h.AssociatedRules) && c.isSendingSavedMsgsForRestore() && (CTATGlobalFunctions.isInstructorMode() ? 
      n.ctatdebug("We're in reviewer mode: we shouldn't save as we go") : c.getProblemStateSaver().saveAsYouGo(a))), n.ctatdebug("Exiting flushMessageTank() #CorrectAction " + h.CorrectAction + ", #InterfaceAction " + h.InterfaceAction + ", #UntutoredAction " + h.UntutoredAction));
      h = e = p = null;
    }
  };
...
Object.defineProperty(CTATProblemStateStatus, "completedEarlier", {enumerable:!1, configurable:!1, writable:!1, value:"completedEarlier"});
...
CTATProblemStateStatus.prototype.transition = function(a, b) {
  ...
  if (CTATProblemStateStatus.completedEarlier != d) {
    if (CTATProblemStateStatus.complete == d && b == CTATProblemStateStatus.completedEarlier) {
      this.setStatus(CTATProblemStateStatus.completedEarlier);
    } else {
      switch(a) {
        case CTATMsgType.SET_PREFERENCES:
          CTATProblemStateStatus[b] && (CTATProblemStateStatus.incomplete == CTATProblemStateStatus[b] ? this.setStatus(CTATProblemStateStatus.incompleteStartState) : CTATProblemStateStatus.complete == CTATProblemStateStatus[b] ? this.setStatus(CTATProblemStateStatus.completedEarlier) : this.setStatus(CTATProblemStateStatus.startState));
          break;
...
var CTATSkills = function(a) {
  ...
  this.toXML = function(a, d) {
    d || (d = "");
    var f = a ? "&lt;Skills&gt;" : "<Skills>", g = f.length, m;
    for (m in b) {
      b.hasOwnProperty(m) && b[m] && (f += d + b[m].toXML(a));
    }
    f += d && f.length > g ? "\n" : "";
    return f + (a ? "&lt;/Skills&gt;" : "</Skills>");
  };
  this.updateSkill = function(a, b, h) {
    var l = null, m = g.getSkill(b);
    null !== m && "undefined" !== typeof m && (m.setTransactionNumber(d), b = h + " " + b, f.has(b) || (f.add(b), m.updatePKnown(a), m.updateHistory(a), m.changeOpportunityCount(1)), CTATExampleTracerSkill.CORRECT.toString().toUpperCase() === a.toString().toUpperCase() && f["delete"](b), l = m);
    return l;
  };
...
var CTATExampleTracer = function() {
  function a(a, c) {
    c ? N |= 1 << a : (N &= -65537 >> 16 - a, b());
  }
  function b() {
    q.ctatdebug("workTheQueue() working " + N + ", workQueue.length " + J.length + ", restoreQueue.length " + L.length);
    if (0 == N) {
      for (;0 != (N = 0 < J.length | (0 < L.length) << 1);) {
        var a = null, b = !1;
        0 < L.length ? (a = L.shift(), b = !0) : a = J.shift();
        if (!d(a, b)) {
          q.ctatdebug("workTheQueue() suspending workQueue.length " + J.length + ", restoreQueue.length " + L.length);
          q.stopWorking(b ? 1 : 0);
          break;
        }
        q.ctatdebug("workTheQueue() bottom workQueue.length " + J.length + ", restoreQueue.length " + L.length);
      }
    }
  }
  function d(a, b) {
    q.lastMessageAsString = a;
    var d = q.lastMessageAsXML = (new CTATXML).parseXML(a), e = q.lastMessage = new CTATMessage(d), h = e.getMessageType();
    q.ctatdebug("CTATExampleTracer.handleMessageFromInterface(msgType " + h + ")");
    switch(h) {
      case CTATMsgType.SET_PREFERENCES:
        return f(a, e, A, d), !1;
      ...
      case CTATMsgType.UNTUTORED_ACTION:
        return b && q.sendBundle([a]), g(a, e, A, d), !0;
      case CTATMsgType.INTERFACE_ACTION:
        return b && q.sendBundle([a]), c(a, e, A, d), !0;
      case CTATMsgType.PROBLEM_SUMMARY_REQUEST:
        return setTimeout(function(a) {
          a = q.getProblemSummary();
          q.ctatdebug("CTATExampleTracer.ProblemSummaryRequest getProblemSummary() " + q.getProblemSummary());
          ...
          d.push(c);
          q.sendBundle(d);
          I.transition(CTATMsgType.PROBLEM_SUMMARY_RESPONSE, a.getCompletionStatus());
          q.ctatdebug("CTATExampleTracer.handleProblemSummaryRequest() sent result '" + c + "';");
          q.startWorking(b ? 1 : 0);
        }, 4E3), !1;
      case CTATMsgType.START_STATE_END:
        return I.transition(CTATMsgType.START_STATE_END), !0;
      case CTATMsgType.PROBLEM_RESTORE_END:
        return r(), !0;
      default:
        return console.log("CTATExampleTracer.handleMessageFromInterface(restoring " + b + ") " + (b ? "sending" : "unprocessed") + " message, type " + h + "\n  " + a), b && q.sendBundle([a]), !0;
    }
  }
  function f(a, b, c, d) {
    q.ctatdebug("handleSetPreferences ()");
    S = !1;
    t = b.getProperty("problem_name");
    q.ctatdebug("SetPreferences.problem_name = " + t);
    a = c.getElementChildren(c.getElementChildren(d)[1]);
    for (b = 0;b < a.length;b++) {
      if (d = c.getElementName(a[b]), q.ctatdebug("SetPreferences eltName " + d), d) {
        switch(d.toLowerCase()) {
          case "source_id":
            F = c.getNodeTextValue(a[b]);
            break;
          case "question_file":
            u = c.getNodeTextValue(a[b]);
            break;
          case "skills":
            q.ctatdebug(" parseSkills(" + a[b] + ")");
            d = [];
            for (var e = A.getElementChildren(a[b]), f = 0;f < e.length;f++) {
              var g = A.getElementName(e[f]);
              if (g && "skill" == g.toLowerCase()) {
                var h = A.getElementAttr(e[f], "name");
                if (h && "" != h.trim()) {
                  var g = A.getElementAttr(e[f], "label"), l = A.getElementAttr(e[f], "pSlip"), n = A.getElementAttr(e[f], "description"), m = A.getElementAttr(e[f], "pKnown"), p = A.getElementAttr(e[f], "category"), r = A.getElementAttr(e[f], "pLearn"), w = A.getElementAttr(e[f], "pGuess"), x = A.getElementAttr(e[f], "history"), h = new CTATExampleTracerSkill(p, h, w, m, l, r, x);
                  h.setLabel(g);
                  h.setDescription(n);
                  d.push(h);
                }
            ...
            q.getProblemSummary().setSkills(new CTATSkills(d));
            break;
          case "problem_state_status":
            I.transition(CTATMsgType.SET_PREFERENCES, c.getNodeTextValue(a[b]));
            z || (z = new ProblemStateRestorer(q));
            q.ctatdebug("SetPreferences problemStateRestorer " + z);
            break;
          ...
          case "restore_problem_url":
            ...
            break;
          case "session_id":
            Q = c.getNodeTextValue(a[b]);
            break;
          case "authenticity_token":
            H.setAuthenticityToken(c.getNodeTextValue(a[b]));
        }
      }
    }
    q.ctatdebug("outputStatus " + I + ", problemStateRestorer " + z);
    a = u;
    q.ctatdebug("retrieveBRD (" + a.indexOf("data:file/brd;base64,") + ")");
    0 == a.indexOf("data:file/brd;base64,") && (q.ctatdebug("Found Base 64 encoded data in question file, decoding and processing ..."), c = a.substring(21), b = window.atob(c), b = (c = new CTATXML).parseXML(b), q.processXML(b));
    q.ctatdebug("Using network retrieval to obtain BRD ...");
    O.retrieveXMLFile(a, c, q);
    z && z.retrieveMessages(I);
  }
  function g(a, b, c, d) {
    b = b.getTransactionID();
    q.ctatdebug("UntutoredAction (" + a + "), getTransactionID " + b);
    H.appendToProblemState(a, q.getOutputStatus(), !1);
    if (!S) {
      return !1;
    }
    q.setVariablesFromSAI(d, c);
    return !0;
  }
  function c(a, b, c, d) {
    q.ctatdebug("Interface action received.");
    c = b.getTransactionID();
    if (!S) {
      return !1;
    }
    q.messageTank = new CTATMessageTank(q, c);
    q.ctatdebug("MessageTank " + q.messageTank);
    q.ctatdebug("InterfaceAction (" + a + "), getTransactionID " + c);
    var e = b.getSelectionArray().slice(0);
    d = b.getActionArray().slice(0);
    q.ctatdebug("selectionArray " + e + ", message.getSelectionArray() " + b.getSelectionArray());
    if (e[0] && "_tutor" == e[0].toLowerCase()) {
      return q.ctatdebug("handleInterfaceAction tutor cmd SAI " + b.getSAI() + ";"), d[0] && "function" === typeof q[d[0]] && (c = b.getSAI().getInput(), q[d[0]](c)), !0;
    }
    !e[0] || "hint" != e[0].toLowerCase() && "help" != e[0].toLowerCase() ? (q.ctatdebug("calling doNewExampleTrace(null, " + b.getSAI() + ") sai.selectionArray " + b.getSAI().getSelectionArray() + " msg.selectionArray " + b.getSelectionArray()), m(null, b.getSAI(), "student", !0, c, a)) : (q.ctatdebug("handleInterfaceAction() hint request: hintPolicy " + E + ", errorSAI " + C), E === CTATHintPolicyEnum.HINTS_UNBIASED ? (1 < e.length && (e[1] = ""), 1 < d.length && (d[1] = "")) : E !== CTATHintPolicyEnum.HINTS_BIASED_BY_CURRENT_SELECTION_ONLY && 
    (E === CTATHintPolicyEnum.HINTS_BIASED_BY_PRIOR_ERROR_ONLY ? C && C.getSelection() ? (e.splice(1, 0, C.getSelection()), d.splice(1, 0, "PreviousFocus")) : (e[1] = "", d[1] = "") : E === CTATHintPolicyEnum.HINTS_BIASED_BY_ALL && C && C.getSelection() && (e.splice(1, 0, C.getSelection()), d[1] = CTATMsgType.PREVIOUS_FOCUS.toString())), q.startSkillTransaction(), a = [], d = x.doHint(e, d, b.getInputArray(), "student", a, !0), b = a[0], a = b.getReportableHints(), e = d ? "" + d.getUniqueID() : 
    "", b.setStepID(e), q.updateSkills(CTATExampleTracerSkill.HINT, d ? d.getSkillNames() : [], e), q.ctatdebug("Before building hint message: tutorSAI " + b.getTutorSAI() + ", hints " + a + ", edge # " + e), d = (new CTATTutorMessageBuilder).createHintMessage(a, b.getTutorSAI(), e, c), q.messageTank.addToMessageTank(CTATMsgType.SHOW_HINTS_MESSAGE, d, b, null), c = (new CTATTutorMessageBuilder).createAssociatedRulesMessageForHint(a, b.getTutorSAI(), p(CTATMsgType.DEFAULT_STUDENT_ACTOR), q.getSkillBarVector(!0), 
    e, c), q.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, c, b, null), c = q.getProblemSummary(b.getReportableInterpretation()), q.messageTank.flushMessageTank(c, !0), q.ctatdebug("handleInterfaceAction() sent hint result " + b), C = null);
    return !0;
  }
  function e(a, b, c) {
    ...
    q.ctatdebug("CTATET.createBuggyMessage() past getReportableLink()");
    ...
    q.ctatdebug("CTATET.createBuggyMessage() past isDoneStepFailed()");
    ...
    q.ctatdebug("CTATET.createBuggyMessage() past hintSelection0 " + e + ", studentSelection0 " + f);
    if (a.getResult() == CTATExampleTracerLink.NO_MODEL && a.isOutOfOrder() && e && e != f) {
      ...
      d.msgType = "BuggyMessage", q.ctatdebug("createBuggyMessage() out of order without highlight; rtn: " + d)), d;
    }
    if (b = y.getDefaultBuggyMsg()) {
      return d.tutorAdvice = b, d.msg = c.createBuggyMessage(a.getTransactionID, d.tutorAdvice), d.msgType = "BuggyMessage", q.ctatdebug("createBuggyMessage() default buggy msg: " + d), d;
    }
    q.ctatdebug("createBuggyMessage() no buggy msg: " + d);
    return d;
  }
  function h(a, b, c, d) {
    q.ctatdebug("checkForTutorAction(" + a + ", " + b + ", " + c + ", " + d + ")");
    var e = [];
    e[0] = l(y.getNode(a), !0);
    e[1] = l(y.getNode(b), !1);
    q.ctatdebug("checkForTutorAction() links[0] " + e[0] + ", links[1] " + e[1] + ";");
    a = 0;
    if (e[0] === e[1]) {
      e[1] = null;
    } else {
    ...
    b = null;
    q.messageTank || (q.messageTank = new CTATMessageTank(q, null));
    ...
    q.ctatdebug("checkForTutorAction() returning " + b + ";");
    return b;
  }
  function l(a, b) {
  ...
  function m(a, b, c, d, e, f) {
    q.ctatdebug("doNewExampleTrace (link " + a + ", sai " + b + ", actor " + c + ", doTutorPerformedSteps " + d + ", transactionID " + e + ", origMsgTxt " + f);
    var g = e;
    e = new CTATExampleTracerEvent(q, b, c);
    if (q.getOutputStatus().isComplete() && b.isDone()) {
      return e.setResult(CTATExampleTracerLink.CORRECT_ACTION), e.setTutorSAI(b), e.setTransactionID(g), e = n(e, b, c, !1), q.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + d + ", " + g + ") returns " + e), e;
    }
    q.startSkillTransaction();
    a && e.addPreloadedLinkMatch(a);
    var h = x.evaluate(e);
    q.ctatdebug("Evaluate returned : " + h + ", given link " + a + ", result " + e);
    a ? (q.ctatdebug("result.getTutorSelection() " + e.getTutorSelection()), q.ctatdebug("result.getTutorAction() " + e.getTutorAction()), q.ctatdebug("result.getTutorInput() " + e.getTutorInput()), q.ctatdebug("typeof(messageTank) " + typeof messageTank), f = e.getTutorSelection(), g = e.getTutorAction(), h = e.getTutorInput(), (g = q.messageTank.enqueueToolActionToStudent(f, g, h, CTATTutorMessageBuilder.TUTOR_PERFORMED)) && q.messageTank.setTransaction_id(g)) : q.isFeedbackSuppressed() ? H.replaceInProblemState(f, 
    q.getOutputStatus(), e.getStudentSAI(), y.getFeedbackPolicy() == CTATMsgType.HIDE_BUT_ENFORCE) : e.getResult() != CTATExampleTracerLink.CORRECT_ACTION && e.getResult() != CTATExampleTracerLink.FIREABLE_BUGGY_ACTION || H.appendToProblemState(f, q.getOutputStatus(), !1);
    e.setTransactionID(g);
    e = n(e, b, c, d);
    q.ctatdebug("doNewExampleTrace(" + a + ", " + b + ", " + c + ", " + d + ", " + g + ") returns " + e);
    return e;
  }
  function p(a) {
  ...
  function n(a, b, c, d) {
    q.ctatdebug("finishNewExampleTrace(" + a + ", " + b + ", " + c + ", " + d + ")");
    b = a.getStudentSAI();
    var f = a.getTutorSAI(), g = a.getTransactionID(), l = new CTATTutorMessageBuilder, n = "", m = [];
    null !== a.getReportableLink() && "undefined" !== typeof a.getReportableLink() ? m[0] = a.getReportableLink() : m[0] = null;
    var m = m[0], r = null;
    if (a.isSolverResult()) {
      a.getResult();
    } else {
      if (a.getResult() === CTATExampleTracerLink.CORRECT_ACTION) {
        n = m ? "" + m.getUniqueID() : "", a.setStepID(n), CTATMsgType.UNGRADED_TOOL_ACTOR.toUpperCase() != c.toUpperCase() && q.messageTank.addToMessageTank(CTATMsgType.CORRECT_ACTION, l.createCorrectActionMessage(g, f), a, f), null !== m && "undefined" !== typeof m && q.updateSkills(CTATExampleTracerSkill.CORRECT, m.getSkillNames(), m.getUniqueID()), n = a.getSuccessOrBuggyMsg(), q.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, l.createAssociatedRulesMessageForAction(a.getResult(), 
        f, p(c), b, q.getSkillBarVector(!0, c), m ? m.getUniqueID() : -1, g, n), a, f), q.ctatdebug("finishNewExampleTrace() successMsg " + n), n && q.messageTank.addToMessageTank("SuccessMessage", l.createSuccessMessage(g, n), a, null), C = null, d && (r = h(m ? m.getNextNode() : null, x.findCurrentState(!1, !1), q.lastMessage ? q.lastMessage.getSAI() : null, a)) && (a = r);
      } else {
        q.messageTank.addToMessageTank(CTATMsgType.INCORRECT_ACTION, l.createInCorrectActionMessage(g, a.getInterpolatedSAI()), a, null);
        q.ctatdebug("about to do silent traceForHint(" + b + "), selectionArray " + b.getSelectionArray());
        var t = q.lastSilentHintResult = new CTATExampleTracerEvent(q, b, c);
        t.setHintRequest(!0);
        r = x.traceForHint(t);
        q.ctatdebug("silent hint result: " + t + "; hintLink " + r);
        r || (r = x.getBestNextLink(!1, t), q.ctatdebug("getBestNextLink result: " + t + "; hintLink " + r));
        f = null;
        r && ((f = t.getTutorSAI()) && f.getSelection() && a.setTutorSAI(f), n = "" + r.getUniqueID(), a.setStepID(n));
        t = e(a, t, l);
        q.ctatdebug("createBuggyMessage() tutorAdvice: " + t.tutorAdvice + ";\n  msg " + t.msg);
        q.updateSkills(CTATExampleTracerSkill.INCORRECT, r ? r.getSkillNames() : [], n);
        q.messageTank.addToMessageTank(CTATMsgType.ASSOCIATED_RULES, l.createAssociatedRulesMessageForAction(a.getResult(), f && f.getSelection() ? f : b, p(c), b, q.getSkillBarVector(!0, c), n, g, t.tutorAdvice), a, null);
        t.msg && q.messageTank.addToMessageTank(t.msgType, t.msg, a);
        C = b;
        d && CTATExampleTracerLink.FIREABLE_BUGGY_ACTION == a.getResult() ? (r = h(m ? m.getNextNode() : null, x.findCurrentState(!1, !1), q.lastMessage ? q.lastMessage.getSAI() : null, a)) && (a = r) : a.isDoneStepFailed() && q.messageTank.flushDelayedFeedback();
      }
    }
    q.lastResult = a;
    c = q.getProblemSummary(a.getReportableInterpretation());
    q.ctatdebug("finishNewExampleTrace() to flushMessageTank");
    q.messageTank.flushMessageTank(c, !0);
    q.ctatdebug("finishNewExampleTrace() sent result " + a.getResult() + ", studentSAI " + b);
    return a;
  }
  function r() {
    I.transition(CTATMsgType.PROBLEM_RESTORE_END);
    var a = q.getSkillBarVector(), b = [], c = new CTATTutorMessageBuilder;
    b.push(c.createMessage(CTATMsgType.PROBLEM_RESTORE_END, a ? {Skills:a} : null));
    q.sendBundle(b);
  }
  CTATBase.call(this, "CTATExampleTracer", "tracer");
  var q = this, u = null, x, B, y, A = new CTATXML;
  new XMLSerializer;
  var C = null, E, D = !0, w = !1, G = null, t = null, F = null, H = new ProblemStateSaver(q);
  H.setAuthenticityToken(CTATCommLibrary.getAuthenticityToken());
  var z = null, I = new CTATProblemStateStatus, L = [], J = [], N = 0, S = !1, Q = "", K = null;
  q.ctatdebug("CTATExampleTracer constructor outputStatus=" + I);
  ...
  this.receiveFromInterface = function(a) {
    q.ctatdebug("CTATExampleTracer.receiveFromInterface() \n  " + a);
    J.push(a);
    b();
  };
  this.setVariablesFromSAI = function(a, b) {
    var c = CTATMsgType.getSAIArraysFromElement(a, b);
    q.getTracer() && q.getTracer().addInterfaceVariables(c.selection, c.input);
  };
  this.traceLinks = function(a) {
    for (var b = [], c = q.getTracer().getBestInterpretation(), d = 0;d < a.length && null !== a[d];++d) {
      c.getTraversalCount(a[d]) < a[d].getMinTraversals() && (q.messageTank = new CTATMessageTank(q, null), b.push(m(a[d], a[d].getDefaultSAI(), a[d].getActor(), !1, null)), q.ctatdebug("traceLinks[" + d + "] result " + b[d]));
    }
    return b;
  };
  this.enqueueForRestore = function(a) {
    q.ctatdebug("enqueueForRestore: got " + a.length + " message elements");
    L = L.concat(a);
  ...
  this.goToState = function(a) {
    x.resetTracer();
    return x.goToState(a, q);
  };
  this.processXML = function(a) {
    q.ctatdebug("processXML ()");
    if (null != a) {
      q.ctatdebug("No of children" + A.getElementChildren(a).length);
      var b = new CTATGraphParser, c = b.parseGraph(a, q);
      y = c.gr;
      x = c.tracer;
      a = c.ssm;
      c = c.sgMsg;
      q.ctatdebug("sendStartStateMessages() nMsgs " + a.length + ", outputStatus " + I);
      for (var d = [], e = new XMLSerializer, f = null, g = 0;g < a.length;g++) {
        if ("message" == A.getElementName(a[g])) {
          var l = e.serializeToString(a[g]), m = CTATMsgType.getMessageType(l);
          CTATMsgType.UNTUTORED_ACTION != m && CTATMsgType.INTERFACE_ACTION != m || q.setVariablesFromSAI(a[g], A);
          CTATMsgType.START_STATE_END == m ? (f = d, y.getFeedbackPolicy() != CTATMsgType.SHOW_ALL_FEEDBACK && (m = new CTATSAI("hint", "SetVisible", "false"), m = (new CTATTutoringServiceMessageBuilder).createInterfaceActionMessage("dummyTransactionID", m), f.push(m)), f = l, d.push((new CTATTutoringServiceMessageBuilder).createInterfaceConfigurationEnd()), d.push((new CTATTutorMessageBuilder).createLockWidgetMsg(b.getLockWidget()))) : d.push(l);
        }
      }
      d.unshift(c);
      q.ctatdebug("sendStartStateMessages(): " + a.length + " elts, " + d.length + " strings, " + I);
      q.sendBundle(d);
      b = f;
      a: {
        a = [];
        c = y.getStartNode();
        d = y.getStudentStartsHereNode();
        if (null !== c && null !== d && c.getNodeID() != d.getNodeID()) {
          a = y.getBestSubpath(c, d);
          q.ctatdebug("advanceToStudentStartsHere() path " + a);
          if (!a) {
            break a;
          }
          a = a.getSortedLinks();
          a = q.traceLinks(a);
          q.ctatdebug("advanceToStudentStartsHere() results " + a);
        }
        d = c = null;
        0 < a.length && (d = a[a.length - 1], a = d.getReportableLink(), null !== a && (c = a.getNextNode()));
        q.ctatdebug("advanceToStudentStartsHere() to check for TPA " + c + ", " + d);
        h(c, x.findCurrentState(!1, !1), null, d);
      }
      a = [];
      b && a.push(b);
      I.canRestore() || a.push((new CTATTutorMessageBuilder).createMessage(CTATMsgType.PROBLEM_RESTORE_END, null));
      0 < a.length && q.sendBundle(a);
      S = !0;
    }
    q.startWorking(0);
  };
  this.addGraphSkills = function(a) {
    q.ctatdebug("adding graph skills: " + a.length);
    0 < a.length && (a = new CTATSkills(a), a.setExternallyDefined(!1), q.getProblemSummary().setSkills(a));
  };
  this.sendBundle = function(a) {
    q.ctatdebug("sending bundle #msgs = " + a.length + ", outputStatus " + I);
    for (var b = 0, c = 0;c < a.length;c++) {
      q.ctatdebug("Sending message #" + c);
      var d = a[c];
      0 >= c && (d = '<?xml version="1.0" encoding="UTF-8"?>' + d);
      H.forwardToInterface(d, c >= a.length - 1, I) && ++b;
    }
    return 0 < b;
  };
  ...
  this.updateSkills = function(a, b, c) {
    var d = [];
    q.ctatdebug("in updateSkills(" + b + ") with step ID = " + c + ", transaction result = " + a);
    var e = q.getProblemSummary().getSkills();
    if (null === e || "undefined" === typeof e) {
      return d;
    }
    b.forEach(function(b) {
  ...
  this.getProblemSummary = function(a) {
    q.ctatdebug("Entering getProblemSummary() problemSummary " + G);
    if (null === G || "undefined" === typeof G) {
      var b = q.getProblemName();
      if (null === b || "undefined" === typeof b || 1 > b.length) {
        b = "NoProblemDefined";
      }
      G = new CTATProblemSummary(b, null, q.isFeedbackSuppressed());
    }
    a && G.setRequiredSteps(a.countStepsForScore(y));
    return G;
  };
  ...
  this.isSourceFlash = function() {
    return "string" == typeof F && F.match(/flash/i);
  };
  this.isFeedbackSuppressed = function() {
    return w;
  };
  this.setFeedbackSuppressed = function(a) {
    w = "false" === a ? !1 : "true" === a ? !0 : a === CTATMsgType.SHOW_ALL_FEEDBACK ? !1 : a === CTATMsgType.HIDE_ALL_FEEDBACK ? !0 : a === CTATMsgType.HIDE_BUT_ENFORCE ? !0 : a === CTATMsgType.HIDE_BUT_COMPLETE ? !0 : !1;
    q.ctatdebug("setFeedbackSuppressed(" + a + "): " + w);
    G && G.setCountOnlyLastResults(w);
  };
  this.getSkillBarVector = function(a, b) {
    var c = q.getProblemSummary().getSkills();
    return null === c || "undefined" === typeof c ? null : "Student" != p(b) ? null : "undefined" != typeof a && a ? c.getSkillBarVector(!1, !1) : c.getSkillBarVector(!0, !0);
  };
  this.startSkillTransaction = function() {
    var a = q.getProblemSummary().getSkills();
  ...
  this.isSendingSavedMsgsForRestore = function() {
    return q.getOutputStatus().isSendingSavedMsgsForRestore();
  };
  ...
  this.setOutputStatus = function(a) {
    var b = I.getStatus();
    q.ctatdebug("setOutputStatus() old " + b + ", new " + a);
    CTATProblemStateStatus[a] ? I.setStatus(CTATProblemStateStatus[a]) : (console.error("CTATExampleTracer.setOutputStatus() unexpected argument " + a), I.setStatus(CTATProblemStateStatus.empty));
  };
  this.getFeedbackPolicy = function() {
  ...
  this.getOutOfOrderMessage = function() {
    return B ? B : CTATMsgType.DEFAULT_OUT_OF_ORDER_MESSAGE;
  };
